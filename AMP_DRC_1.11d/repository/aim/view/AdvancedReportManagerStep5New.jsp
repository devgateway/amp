														...
														<TR>
																	...
																	<TR>
																		<TD>
																			<TABLE width="100%" cellPadding=2 cellSpacing=1 vAlign="top" align="top" bgcolor="#aaaaaa" border=0>
																				<c:if test="${!empty aimAdvancedReportForm.columnsSelection}">

																						<!-- Donor Funding -->
																						<c:if test="${aimAdvancedReportForm.arReportType == 'donor' }">
																						<logic:iterate name="aimAdvancedReportForm" property="columnsSelection" id="reportColumn" type="org.digijava.module.aim.dbentity.AmpReportColumn" indexId="counter">
																							<bean:define name="reportColumn" property="column" id="addedColumns" type="org.digijava.module.aim.dbentity.AmpColumns"/>
																							<bean:define name="reportColumn" property="level" id="level" type="org.digijava.module.aim.dbentity.AmpCategoryValue"/>
															...
															<TD width="50%" vAlign="top" align="left" bgcolor="#eeeeee">
																<TABLE width="100%" cellPadding="2" cellSpacing="1" vAlign="top" align="top" bgcolor="#eeeeee" border=0>
																	...
																	<tr height=10>	<td>	</td>	</tr>
																	<TR>
																		<c:if test="${!empty aimAdvancedReportForm.hierarchiesSelection}">
																		<TD>
																			<TABLE width="100%" cellPadding=2 cellSpacing=1 vAlign="top" align="top" bgcolor="#aaaaaa" border=0>
																				
																				<% int i =0; %>
																					<logic:iterate name="aimAdvancedReportForm" id="reportHierarchie"	property="hierarchiesSelection" type="org.digijava.module.aim.dbentity.AmpReportHierarchy" indexId="counter" >
																						<bean:define name="reportHierarchie" property="column" id="columnHierarchie" type="org.digijava.module.aim.dbentity.AmpColumns"/>
																						<bean:define name="reportHierarchie" property="level" id="level" type="org.digijava.module.aim.dbentity.AmpCategoryValue"/>
																					<% i = i + 1; %>
																						<tr bgcolor=#ffffff>
