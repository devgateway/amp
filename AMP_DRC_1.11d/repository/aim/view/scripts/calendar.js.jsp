...
var names = new makeArray0('<digi:trn key='calendar:January'>January</digi:trn>','<digi:trn key='calendar:February'>February</digi:trn>','<digi:trn key='calendar:March'>March</digi:trn>','<digi:trn key='calendar:April'>April</digi:trn>','<digi:trn key='calendar:May'>May</digi:trn>','<digi:trn key='calendar:June'>June</digi:trn>','<digi:trn key='calendar:July'>July</digi:trn>','<digi:trn key='calendar:August'>August</digi:trn>','<digi:trn key='calendar:September'>September</digi:trn>','<digi:trn key='calendar:October'>October</digi:trn>','<digi:trn key='calendar:November'>November</digi:trn>','<digi:trn key='calendar:December'>December</digi:trn>');
var days  = new makeArray0(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
var dow   = new makeArray0('<digi:trn key='calendar:Sun'>Sun</digi:trn>','<digi:trn key='calendar:Mon'>Mon</digi:trn>','<digi:trn key='calendar:Tue'>Tue</digi:trn>','<digi:trn key='calendar:Wed'>Wed</digi:trn>','<digi:trn key='calendar:Thu'>Thu</digi:trn>','<digi:trn key='calendar:Fri'>Fri</digi:trn>','<digi:trn key='calendar:Sat'>Sat</digi:trn>');
