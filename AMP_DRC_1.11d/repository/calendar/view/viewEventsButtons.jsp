...
<table id="tbl" border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td <c:if test="${calendarViewForm.view == 'monthly'}">id="clicked"</c:if> align="center"><a href="#" onclick="submitFilterForm('monthly', '${calendarViewForm.timestamp}'); return(false);"><digi:trn key="calendar:MonthlyView">Monthly View</digi:trn></a></td>
        <td style="border:none;width:5px">&nbsp;</td>
