 ...
 */
YAHOOAmp.widget.TreeView = function(id) {
    if (id) { this.init(id); }
};

YAHOOAmp.widget.TreeView.prototype = {
    ...
    setExpandAnim: function(type) {
        this._expandAnim = (YAHOOAmp.widget.TVAnim.isValid(type)) ? type : null;
    },
    ...
    setCollapseAnim: function(type) {
        this._collapseAnim = (YAHOOAmp.widget.TVAnim.isValid(type)) ? type : null;
    },
    ...
    animateExpand: function(el, node) {
        ...
        if (this._expandAnim && this._animCount < this.maxAnim) {
            // this.locked = true;
            var tree = this;
            var a = YAHOOAmp.widget.TVAnim.getAnim(this._expandAnim, el, 
    ...
    animateCollapse: function(el, node) {
        ...
        if (this._collapseAnim && this._animCount < this.maxAnim) {
            // this.locked = true;
            var tree = this;
            var a = YAHOOAmp.widget.TVAnim.getAnim(this._collapseAnim, el, 
    ...
    init: function(id) {
        ...
        YAHOOAmp.widget.TreeView.trees[this.id] = this;

        // Set up the root node
        this.root = new YAHOOAmp.widget.RootNode(this);

        var LW = YAHOOAmp.widget.LogWriter;
    ...
    removeChildren: function(node) { 
        ...
        if (node.expanded) {
            ...
            if (this._collapseAnim) {
                ...
                YAHOOAmp.widget.Node.prototype.collapse.call(node);
                return;
            }
        ...
        if (node.isRoot()) {
            YAHOOAmp.widget.Node.prototype.expand.call(node);
        }
    ...
    generateId: function(el) {
        ...
        if (!id) {
            id = "yui-tv-auto-id-" + YAHOOAmp.widget.TreeView.counter;
            ++YAHOOAmp.widget.TreeView.counter;
        }
...
YAHOOAmp.augment(YAHOOAmp.widget.TreeView, YAHOOAmp.util.EventProvider);
 ...
 * @static
 */
YAHOOAmp.widget.TreeView.nodeCount = 0;
 ...
 * @private
 */
YAHOOAmp.widget.TreeView.trees = [];

/**
 * Counter for generating a new unique element id
 * @property YAHOOAmp.widget.TreeView.counter
 * @static
 * @private
 */
YAHOOAmp.widget.TreeView.counter = 0;
 ...
 * @static
 */
YAHOOAmp.widget.TreeView.getTree = function(treeId) {
    var t = YAHOOAmp.widget.TreeView.trees[treeId];
    return (t) ? t : null;
};
 ...
 * @static
 */
YAHOOAmp.widget.TreeView.getNode = function(treeId, nodeIndex) {
    var t = YAHOOAmp.widget.TreeView.getTree(treeId);
    return (t) ? t.getNodeByIndex(nodeIndex) : null;
};

/**
 * Add a DOM event
 * @method YAHOOAmp.widget.TreeView.addHandler
 * @param el the elment to bind the handler to
 * @param {string} sType the type of event handler
 * @param {function} fn the callback to invoke
 * @static
 */
YAHOOAmp.widget.TreeView.addHandler = function (el, sType, fn) {
...
/**
 * Remove a DOM event
 * @method YAHOOAmp.widget.TreeView.removeHandler
 * @param el the elment to bind the handler to
 * @param {string} sType the type of event handler
 * @param {function} fn the callback to invoke
 * @static
...
YAHOOAmp.widget.TreeView.removeHandler = function (el, sType, fn) {
 ...
 * @static
 */
YAHOOAmp.widget.TreeView.preload = function(e, prefix) {
    prefix = prefix || "ygtv";
    ...
    YAHOOAmp.widget.TreeView.removeHandler(window, 
                "load", YAHOOAmp.widget.TreeView.preload);

};

YAHOOAmp.widget.TreeView.addHandler(window, 
                "load", YAHOOAmp.widget.TreeView.preload);
...
YAHOOAmp.widget.Node.prototype = {
    ...
    */
    ...
    getToggleLink: function() {
        return "YAHOOAmp.widget.TreeView.getNode(\'" + this.tree.id + "\'," + 
            this.index + ").toggle()";
    },
...
YAHOOAmp.extend(YAHOOAmp.widget.TextNode, YAHOOAmp.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        var getNode = 'YAHOOAmp.widget.TreeView.getNode(\'' +
...
YAHOOAmp.extend(YAHOOAmp.widget.HTMLNode, YAHOOAmp.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        if (this.hasIcon) {
            ...
            if (this.hasChildren(true)) {
                sb[sb.length] = ' onmouseover="this.className=';
                sb[sb.length] = 'YAHOOAmp.widget.TreeView.getNode(\'';
...
YAHOOAmp.register("treeview", YAHOOAmp.widget.TreeView, {version: "2.5.2", build: "1076"});
