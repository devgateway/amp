...
//	public final static String NPO_PERCENTAGE="National Planning Objectives Percentage";
	...
	public static final String TOTAL_ACTUAL_DISBURSEMENT_PREV_MONTHS = "TOTAL_ACTUAL_DISBURSEMENT_CURR_YEAR";
	public static final String TOTAL_ACTUAL_DISBURSEMENT_CUR_MONTH = "TOTAL_ACTUAL_DISBURSEMENT_CUR_MONTH";
	
	public static final String TOTAL_ACTUAL_DISBURSEMENT_LAST_YEAR = "TOTAL_ACTUAL_DISBURSEMENT_LAST_YEAR";
	public final static String TOTAL_PLANNED_DISBURSEMENT_CURRENT_YEAR= "TOTAL_PLANNED_DISBURSEMENT_CURRENT_YEAR";
	public final static String TOTAL_PLANNED_DISBURSEMENT_LAST_YEAR= "TOTAL_PLANNED_DISBURSEMENT_LAST_YEAR";
	public final static String TOTAL_PLANNED_DISBURSEMENT_LAST_2YEAR= "TOTAL_PLANNED_DISBURSEMENT_LAST_2YEAR";
	public final static String TOTAL_PLANNED_DISBURSEMENT_LAST_3YEAR= "TOTAL_PLANNED_DISBURSEMENT_LAST_3YEAR";
