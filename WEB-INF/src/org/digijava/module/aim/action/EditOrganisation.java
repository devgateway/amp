...
public class EditOrganisation extends DispatchAction {
    ...
    public ActionForward delete(ActionMapping mapping, ActionForm form,
        ...
        if (flag || flag2) {
            ...
            //org.setSurvey(null);
            try {
            	List<AmpOrganisationContact> orgConts=ContactInfoUtil.getOrganizationContacts(org.getAmpOrgId());
    ...
    public ActionForward addOrgInfo(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        if (sessionChk(request)) {
            return mapping.findForward("index");
        ...
        if (percent != null && !percent.equals("")) {
            ...
            info.setPercent(Double.parseDouble(percent));
        }
    ...
    public ActionForward deleteOrgInfo(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        if (sessionChk(request)) {
            return mapping.findForward("index");
    ...
    public ActionForward save(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (editForm.getRecipients() != null) {
            ...
            while (recipientIter.hasNext()) {
                ...
                if (recipient.getAmpOrgRecipientId()!=null&&recipient.getAmpOrgRecipientId()!=0) {
                    AmpOrgRecipient newRecipient = (AmpOrgRecipient) DbUtil.get(AmpOrgRecipient.class, recipient.getAmpOrgRecipientId());
        ...
        if (editForm.getOrgInfos() != null) {
            ...
            while (infoIter.hasNext()) {
                ...
                newInfo.setYear(info.getYear());
                newInfo.setType(info.getType());
                newInfo.setPercent(info.getPercent());
    ...
    public static void clean(AddOrgForm form) throws DgException {
        try {
         ...
         //   form.setContacts(null);
            ...
            form.setPrimaryOrgContIds(null);
            form.setResetPrimaryOrgContIds(null);
