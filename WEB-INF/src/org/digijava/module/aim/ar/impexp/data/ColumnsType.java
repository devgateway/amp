 ...
 *       &lt;sequence>
 *         &lt;element name="column" type="{http://dgfoundation.org/2009/ReportMetadata}columnLikeType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ColumnsType {
    ...
    protected List<ColumnLikeType> column;
     ...
     * 
     */
    public List<ColumnLikeType> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnLikeType>();
        }
        return this.column;
    }
