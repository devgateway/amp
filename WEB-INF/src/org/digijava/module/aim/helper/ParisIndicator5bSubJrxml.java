...
public class ParisIndicator5bSubJrxml {
    public void createJrxml(String filePath, List data) throws IOException {
        ...
        p.println("		 name='indicator5bpdf_subreport0'");
        ...
        for (ListIterator dnIter = data.listIterator(); dnIter.hasNext(); ) {
            ...
            if (dnIter.nextIndex() == 1) {
                ...
                p.println("						<font/>");
                p.println("					</textElement>");
                p.println("				<text><![CDATA[Percent of donors that use national procurement systems]]></text>");
                p.println("				</staticText>");
                p.println("				<staticText>");
                p.println("					<reportElement");
