...
public class ProjectbyDonorDatasource 
implements JRDataSource {
	
private static Logger logger = Logger.getLogger(ProjectbyDonorDatasource.class);
private Object data[][];
private int index;
public int val = 0;
public int colCnt;
...
public ProjectbyDonorDatasource() {
data = null;
index = -1;
}

public ProjectbyDonorDatasource(Object[][] obj) {
