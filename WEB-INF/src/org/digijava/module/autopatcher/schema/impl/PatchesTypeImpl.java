...
public class PatchesTypeImpl implements org.digijava.module.autopatcher.schema.PatchesType, com.sun.xml.bind.JAXBObject, org.digijava.module.autopatcher.schema.impl.runtime.UnmarshallableObject, org.digijava.module.autopatcher.schema.impl.runtime.XMLSerializable, org.digijava.module.autopatcher.schema.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Patch;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.digijava.module.autopatcher.schema.PatchesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getPatch() {
        if (_Patch == null) {
            _Patch = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Patch;
    }
    ...
    public org.digijava.module.autopatcher.schema.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.digijava.module.autopatcher.schema.impl.runtime.UnmarshallingContext context) {
        return new org.digijava.module.autopatcher.schema.impl.PatchesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Patch == null)? 0 :_Patch.size());
        while (idx1 != len1) {
            context.startElement("http://digijava.org/module/autopatcher/schema.xml", "patch");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Patch.get(idx_0 ++)), "Patch");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Patch.get(idx_1 ++)), "Patch");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Patch.get(idx1 ++)), "Patch");
            context.endElement();
        }
    }
...
+"\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u00000org.digijav"
+"a.module.autopatcher.schema.PatchTypet\u0000+http://java.sun.com/"
...
+"\u0000\u0005patcht\u00001http://digijava.org/module/autopatcher/schema.xmls"
...
+"ol;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\"q\u0000~\u0000\fq\u0000~\u0000\u0010q\u0000~\u0000\u000fx"));
        ...
        extends org.digijava.module.autopatcher.schema.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.digijava.module.autopatcher.schema.impl.PatchesTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("author" == ___local)&&("" == ___uri)) {
                            _getPatch().add(((org.digijava.module.autopatcher.schema.impl.PatchTypeImpl) spawnChildFromEnterAttribute((org.digijava.module.autopatcher.schema.impl.PatchTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  3 :
