...
public class CategoryConstants {
	...
	public static final String COMPONET_TYPE_NAME = "Components Type";
	public static final String COMPONET_TYPE_KEY = "Components_Type_Key";
	...
	public static final String LINE_MINISTRY_RANK   = "line_ministry_rank";
	public static final String MINISTRY_PLANNING_RANK = "ministry_planning_rank";

	public static final long NONE_TYPE = 0;
	public static final long COUNTRY_TYPE = 1;
	public static final long REGION_TYPE = 2;

	public static final HardCodedCategoryValue TYPE_OF_ASSITANCE_GRANT = new CategoryConstants.HardCodedCategoryValue(
			"type_of_assistence", "Grant", true);

	public static final HardCodedCategoryValue LOGFRAME_OBJECTIVE = new CategoryConstants.HardCodedCategoryValue(
			"logframe", "Objective", true);
	public static final HardCodedCategoryValue LOGFRAME_PURPOSE = new CategoryConstants.HardCodedCategoryValue(
			"logframe", "Purpose", true);
	public static final HardCodedCategoryValue LOGFRAME_RESULTS = new CategoryConstants.HardCodedCategoryValue(
			"logframe", "Results", true);

	public static final HardCodedCategoryValue TEAM_TYPE_MULTILATERAL = new CategoryConstants.HardCodedCategoryValue(
			"team_type", "Multilateral", false);
	public static final HardCodedCategoryValue TEAM_TYPE_BILATERAL = new CategoryConstants.HardCodedCategoryValue(
			"team_type", "Bilateral", false);

	public static final HardCodedCategoryValue MTEF_PROJECTION_PROJECTION = new CategoryConstants.HardCodedCategoryValue(
			"mtef_projection", "projection", false);
	public static final HardCodedCategoryValue MTEF_PROJECTION_PIPELINE = new CategoryConstants.HardCodedCategoryValue(
			"mtef_projection", "pipeline", false);

	public static final HardCodedCategoryValue ACTIVITY_STATUS_PROPOSED = new CategoryConstants.HardCodedCategoryValue(
			"activity_status", "proposed", false);

	public static final HardCodedCategoryValue FIN_INSTR_BUDGET_SUPPORT = new CategoryConstants.HardCodedCategoryValue(
			"financing_instrument", "Budget Support", false);

	public static final HardCodedCategoryValue IMPLEMENTATION_LOCATION_COUNTRY = new CategoryConstants.HardCodedCategoryValue(
			"implementation_location", "Country", true);
	public static final HardCodedCategoryValue IMPLEMENTATION_LOCATION_REGION = new CategoryConstants.HardCodedCategoryValue(
			"implementation_location", "Region", true);
	public static final HardCodedCategoryValue IMPLEMENTATION_LOCATION_ZONE = new CategoryConstants.HardCodedCategoryValue(
			"implementation_location", "Zone", true);
	public static final HardCodedCategoryValue IMPLEMENTATION_LOCATION_DISTRICT = new CategoryConstants.HardCodedCategoryValue(
			"implementation_location", "District", true);
	
	public static final HardCodedCategoryValue IMPLEMENTATION_LEVEL_INTERNATIONAL = new CategoryConstants.HardCodedCategoryValue(
			"implementation_level", "International", true);
	...
	public static class HardCodedCategoryValue {
		...
		private HardCodedCategoryValue(String categoryKey, String valueKey,
				boolean protectOnDelete) {
