...
public class SaveCMSSettings
  ...
  public ActionForward execute(ActionMapping mapping,
    ...
    String forward = "saveCMSSettings";
    ...
    if (cms != null) {
      cms.setModerated(cmsAdminForm.isModerated());
      cms.setPrivateMode(cmsAdminForm.isPrivateMode());

      cms.setSendApproveMsg(cmsAdminForm.isSendApproveMsg());
      cms.setSendRejectMsg(cmsAdminForm.isSendRejectMsg());
      cms.setSendRevokeMsg(cmsAdminForm.isSendRevokeMsg());


      DbUtil.updateCMSItem(cms);
    }
