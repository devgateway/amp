...
public class ActivityCurrentCompletionDateTrigger extends Trigger {
    ...
    public ActivityCurrentCompletionDateTrigger(Object source) {
    ...
    protected Event generateEvent() {
        Event e=new Event(ActivityCurrentCompletionDateTrigger.class);
