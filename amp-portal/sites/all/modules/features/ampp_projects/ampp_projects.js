...
Drupal.behaviors.ampp_projects = {
  attach: function (context, settings) {
    if ($('#ampp-search-form').length === 0) {
      return;
    }
    ...
    if ( $("#edit-sector").length > 0 ) {
      $("#edit-sector").tokenInput(lang_prefix + "ampp_search/sectors", {
        ...
        method: "POST",
        queryParam: "string",
        prePopulate: settings.ampp_projects.form_settings.selectedSectors,
        onAdd: getResultCount,
        onDelete:  getResultCount
      });
    }
    if ( $("#edit-primary-sector").length > 0 ) {
      $("#edit-primary-sector").tokenInput(lang_prefix + "ampp_search/primarysectors", {
        theme: "facebook",
        method: "POST",
        queryParam: "string",
        prePopulate: settings.ampp_projects.form_settings.selectedPrimarySectors,
        onAdd: getResultCount,
        onDelete:  getResultCount
      });
    }
    if ( $("#edit-secondary-sector").length > 0 ) {
      $("#edit-secondary-sector").tokenInput(lang_prefix + "ampp_search/secondarysectors", {
        theme: "facebook",
        method: "POST",
        queryParam: "string",
        prePopulate: settings.ampp_projects.form_settings.selectedSecondarySectors,
        onAdd: getResultCount,
        onDelete:  getResultCount
      });
    }
    if ( $("#edit-program").length > 0 ) {
      $("#edit-program").tokenInput(lang_prefix + "ampp_search/programs", {
        theme: "facebook",
        method: "POST",
        queryParam: "string",
        prePopulate: settings.ampp_projects.form_settings.selectedPrograms,
        onAdd: getResultCount,
        onDelete:  getResultCount
      });
    }
    if ( $("#edit-donor").length > 0 ) {
      $("#edit-donor").tokenInput(lang_prefix + "ampp_search/donors", {
        theme: "facebook",
        queryParam: "string",
        method: "POST",
        prePopulate: settings.ampp_projects.form_settings.selectedDonors,
        onAdd: getResultCount,
        onDelete:  getResultCount
      });
    }
    if ( $("#edit-agency").length > 0 ) {
      $("#edit-agency").tokenInput(lang_prefix + "ampp_search/agencies", {
        theme: "facebook",
        queryParam: "string",
        method: "POST",
        prePopulate: settings.ampp_projects.form_settings.selectedAgencies,
        onAdd: getResultCount,
        onDelete:  getResultCount
      });
    }
    if ( $("#edit-region").length > 0 ) {
      $("#edit-region").tokenInput(lang_prefix + "ampp_search/regions", {
        theme: "facebook",
        method: "POST",
        queryParam: "string",
        prePopulate: settings.ampp_projects.form_settings.selectedLocations,
        onAdd: getResultCount,
        onDelete:  getResultCount
      });
    }

    $("#edit-period-start-datepicker-popup-0").val(settings.ampp_projects.form_settings.selectedPeriodStart);
    $("#edit-period-start-datepicker-popup-0").bind('change', function(e){
      getResultCount();
    });

    $("#edit-period-end-datepicker-popup-0").val(settings.ampp_projects.form_settings.selectedPeriodEnd);
    ...
    $('input[name=budget][value='+settings.ampp_projects.form_settings.selectedBudget+']').attr('checked', 'checked');

    if (settings.ampp_projects.form_settings.selectedRegionalProjects != 0) {
    ...
    $("#edit-keyword").val(settings.ampp_projects.form_settings.selectedKeywords.join(','));
...
function getResultCount(){
  ...
  $.getJSON(Drupal.settings.basePath + 'ampp_search/search_result_count', {
    'sectors': currenSectorsIds,
    'primarysectors': currenPrimarySectorsIds,
    'secondarysectors': currenSecondarySectorsIds,
    'programs': currenProgramsIds,
    'donors': currentDonorsIds,
    'agencies': currentAgenciesIds,
    'locations': currentRegionsIds,
