...
<body >
<div class="print_version_header">
<div class="container-gradient-top"><div class="container-gradient-bottom">
  ...
  <div class="master-container">
    <div class="container_12">
      ...
      <div class="section-header">
        <div class="grid_12">
          <div class="grid_6 logo-container alpha">
            <h2 class="grid_3 alpha">
              <a href="/" id="dg_logo_anchor" title="Development Gateway">Development Gateway</a>
            </h2>
          </div>
          <div class="clear"></div>
        </div>
      ...
      <div id="section-content">
        <div class="grid_12">The site is currently not available due to technical problems. Thank you for your patience.</div>
        <div class="clear"></div>
      </div>
...
</div></div>  <!-- END .container-gradient-bottom, END .container-gradient-top -->
<?php print $closure; ?>
</div>
</body>
</html>