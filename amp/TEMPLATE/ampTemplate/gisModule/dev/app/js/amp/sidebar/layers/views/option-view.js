...
module.exports = Backbone.View.extend({
  ...
  createTooltip: function(obj){
	  ...
	  if(obj.createdOn){
	     tooltip += '<br/> ' + this.app.translator.translateSync('amp.gis-layers-manager:tooltip-CreatedOn','Created on') + ' ' + obj.createdOn;
	  }
	  if(obj.createdBy){
		 tooltip += ' ' + this.app.translator.translateSync('amp.gis-layers-manager:tooltip-CreatedBy','by') + ' ' + obj.createdBy;
	  }	
	  return tooltip;
  },
  render: function() {
