...
<script language="javascript">
	...
	if (showDevinfo) {
			...
			var href="/gis/pdfExport.do?isPublic=true&mapMode=DevInfo&publicMode=true&selectedFromYear=" + selectedFromYear+ "&selectedToYear=" + selectedToYear + "&sectorId=" + sectorId + "&mapLevel=" + mapLevel + "&indicatorId=" + indicatorId + "&subgroupId=" + subgroupId + "&indYear=" + timeInterval;
