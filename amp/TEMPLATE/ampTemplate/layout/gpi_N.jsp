...
<link rel="stylesheet" href="<digi:file src="/src/main/webapp/WEB-INF/repository/gpi/view/css/gpi_styles.css"/>">
		            ...
		            <tr>
		                <td class="td_right_left1">
                            <logic:equal name="gpiForm" property="gpiReport.indicatorCode" value="1">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/gpi/view/gpi_1.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="gpiForm" property="gpiReport.indicatorCode" value="5a">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/gpi/view/gpi_5a.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="gpiForm" property="gpiReport.indicatorCode" value="6">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/gpi/view/gpi_6.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="gpiForm" property="gpiReport.indicatorCode" value="9b">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/gpi/view/gpi_9b.jsp"></jsp:include>
                            </logic:equal>
	                    </td>
	                </tr>
	                <tr>
