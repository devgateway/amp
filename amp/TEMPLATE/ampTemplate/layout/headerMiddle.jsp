...
<DIV id="menu">
<UL>
		<LI class="noLink" vAlign="center" align="center">
...
<DIV id="menu" bgcolor=#F7F9E4>
	<UL>
		...
		<LI>
			...
			<logic:empty name="TID" scope="session">
				<digi:link styleClass="head-menu-link" href="/" module="aim" onclick="return quitRnot()">
				::: <digi:trn key="aim:reports">REPORTS</digi:trn> |</digi:link>asas
			</logic:empty>			
			</div></LI> 
