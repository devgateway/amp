...
<link rel="stylesheet" href="<digi:file src="/WEB-INF/repository/parisindicator/view/css/pi_styles.css"/>">
		            ...
		            <tr>
		                <td class="td_right_left1">
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="3">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_3.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="4">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_4.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="5a">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_5a.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="5b">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_5b.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="6">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_6.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="7">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_7.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="9">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_9.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="10a">
                                <jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_10a.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="10b">
	                        	<jsp:include page="/WEB-INF/repository/parisindicator/view/parisindicator_10b.jsp"></jsp:include>
							</logic:equal>
	                    </td>
	                </tr>
	                <tr>
