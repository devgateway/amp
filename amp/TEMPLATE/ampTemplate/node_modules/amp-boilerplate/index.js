...
_.extend(Widget.prototype, Backbone.Events, {
	...
	initialize : function(options) {
		...
		this.bubbleViewEvents();
		
		$.when(this.menu.menuRendered, this.layoutFetched).then(function() {
			self.header.refreshUserSection();
		 ...
		 _.bindAll(this, 'createTranslator', 'createViews','bubbleViewEvents');
	},
	...
	createViews : function(options) {
		...
		options.model = this.layoutModel;
		...
		this.layoutModel.fetch().then(function(layout) {
			self.header.model = layout;
			self.footer.model = layout;
