...
_.extend(Widget.prototype, Backbone.Events, {
  ...
  getAllFilters: function() {
    ...
    return this.loaded.then(function(){
      return self.view.serialize({includeUnselected: true, wholeModel: true});
    });
  },
...
var Backbone = _dereq_('backbone');
var TitleTemplate = "<li><a href=\"#\"><span data-i18n=\"amp.gis:pane-subfilters-<%= name.replace(/ /g,'') %>\"><%= name %></span>   <span class='filter-count small pull-right'>all</span></a></li>\n";
