!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.ampFilter=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
//     Backbone.js 1.1.2
...
},{"underscore":9}],2:[function(_dereq_,module,exports){
/*!
...
},{"jquery":8}],4:[function(_dereq_,module,exports){
var jQuery = _dereq_('jquery');
_dereq_('./core');
...
},{"./core":3,"jquery":8}],5:[function(_dereq_,module,exports){
var jQuery = _dereq_('jquery');
_dereq_('./core');
_dereq_('./mouse');
_dereq_('./widget');
...
},{"./core":3,"./mouse":6,"./widget":7,"jquery":8}],6:[function(_dereq_,module,exports){
var jQuery = _dereq_('jquery');
_dereq_('./widget');
...
},{"./widget":7,"jquery":8}],7:[function(_dereq_,module,exports){
var jQuery = _dereq_('jquery');
...
},{"jquery":8}],8:[function(_dereq_,module,exports){
/*!
...
var GenericFilterModel = _dereq_('../models/generic-filter-model');
var OrgRoleFilterModel = _dereq_('../models/org-role-filter-model');
var YearsFilterModel = _dereq_('../models/years-filter-model');
...
},{"../models/generic-filter-model":14,"../models/org-role-filter-model":15,"../models/years-filter-model":16,"backbone":1,"jquery":8,"underscore":9}],11:[function(_dereq_,module,exports){
/*
...
_dereq_('jquery-ui/draggable');
_dereq_('bootstrap/dist/js/bootstrap');


var FilterView = _dereq_('./views/filters-view');
...
_.extend(Widget.prototype, Backbone.Events, {
  ...
  // TODO: change so returns promise, and waits for filters to finish loading....
  // return models of all filters, even unselected ones..
  getAllFilters: function() {
    return this.view.getAllFilters();
  },
...
},{"./views/filters-view":20,"backbone":1,"bootstrap/dist/js/bootstrap":2,"jquery":8,"jquery-ui/draggable":5,"underscore":9}],13:[function(_dereq_,module,exports){
var Backbone = _dereq_('backbone');
...
},{"backbone":1}],14:[function(_dereq_,module,exports){
var _ = _dereq_('underscore');

var BaseFilterModel = _dereq_('../models/base-filter-model');
var TreeNodeModel = _dereq_('../tree/tree-node-model');
...
},{"../models/base-filter-model":13,"../tree/tree-node-model":17,"underscore":9}],15:[function(_dereq_,module,exports){
var $ = _dereq_('jquery');
...
},{"../models/generic-filter-model":14,"../tree/tree-node-model":17,"jquery":8}],16:[function(_dereq_,module,exports){
var $ = _dereq_('jquery');
var BaseFilterModel = _dereq_('../models/base-filter-model');
...
module.exports = BaseFilterModel.extend({
  ...
  deserialize: function(obj) {
    if(obj.date){
      this.set('selectedStart', this._dateConvert(obj.date.start));
      this.set('selectedEnd', this._dateConvert(obj.date.end));
    }
  },
...
},{"../models/base-filter-model":13,"jquery":8}],17:[function(_dereq_,module,exports){
var _ = _dereq_('underscore');
var Backbone = _dereq_('backbone');
    ...
    if (children.length > 0) {
      ...
      if (this.get('selected')) {
        if(this.get('filterId')){
          tmp[this.get('filterId')] = ((options && options.wholeModel)? [this]:[this.id]);
        } else{
          tmp['default'] = ((options && options.wholeModel)? [this]:[this.id]);
        }
      }
    }
...
},{"backbone":1,"underscore":9}],18:[function(_dereq_,module,exports){
...
},{"backbone":1,"jquery":8,"underscore":9}],19:[function(_dereq_,module,exports){

var _ = _dereq_('underscore');
var $ = _dereq_('jquery');

var Backbone = _dereq_('backbone');
var TitleTemplate = "<li><a href=\"#\"><%= name %>   <span class='filter-count small pull-right'>all</span></a></li>\n";
...
},{"backbone":1,"jquery":8,"underscore":9}],20:[function(_dereq_,module,exports){

var $ = _dereq_('jquery');
var _ = _dereq_('underscore');
var Backbone = _dereq_('backbone');

var TopLevelFilterView = _dereq_('../views/top-level-filter-view');
var AllFilterCollection = _dereq_('../collections/all-filters-collection');


var Template = "\n<div class=\"panel-heading\">\n  <button type=\"button\" class=\"close cancel\"  aria-hidden=\"true\">&times;</button>\n  <h3 class=\"panel-title\">Filters</h3>\n</div>\n<div class=\"panel-body filter-body\">\n\n  <ul class=\"nav nav-tabs filter-titles\" role=\"tablist\">\n  </ul>\n  \n  <div class=\"tab-content filter-options\">    \n    <img src=\"img/loading-icon.gif\" />\n  </div>\n</div>\n<div class=\"panel-footer\">\n  &nbsp;\n  <div class=\"pull-right\" style=\"display: inline-block; margin-bottom: 5px;\">\n    <button type=\"button\" class=\"btn btn-sm btn-danger reset\" title=\"Turn of all filters.\">Reset</button>   \n    <button type=\"button\" class=\"btn btn-sm btn-warning cancel\"  title=\"Revert filters to state when opened.\">Cancel</button>    \n    <button type=\"button\" class=\"btn btn-sm btn-success apply\" >Apply</button>\n  </div>\n</div>\n";
var TitleTemplate = "<li class=\"\"><a href=\"#filter-pane-<%= name %>\" role=\"tab\" data-toggle=\"tab\"><%= name %></a></li>\n";
...
module.exports = Backbone.View.extend({
  ...
  _createTopLevelFilterViews: function() {
    this.filterViewsInstances = {
      donors: new TopLevelFilterView({name:'Donor'}),
      ...
      allAgencies: new TopLevelFilterView({name:'AllAgencies'}),
  ...
  serialize: function(options) {
    ...
    this.allFilters.each(function(filter) {
      ...
      _.extend(self.serializedFilters, filter.serialize(options));
    });

    //remove empty / false values.
    _.each(this.serializedFilters, function(v, k) {
      if(!v || _.isEmpty(v)) {
        delete self.serializedFilters[k];
      }
    });
  ...
  getAllFilters: function(options) {
    var self = this;
    this.allFiltersKeyed = {};

    this.allFilters.each(function(filter) {
      //TODO: build a util for bettermerge that concat's array if duplicate keys in objects...
      if(filter.getAllFilters){
        _.extend(self.allFiltersKeyed, filter.getAllFilters(options));
      }
    });

    //remove empty / false values.
    _.each(this.allFiltersKeyed, function(v, k) {
      if(!v || _.isEmpty(v)) {
        delete self.serializedFilters[k];
      }
    });

    return this.allFiltersKeyed;
  },
...
},{"../collections/all-filters-collection":10,"../views/top-level-filter-view":22,"backbone":1,"jquery":8,"underscore":9}],21:[function(_dereq_,module,exports){

var _ = _dereq_('underscore');

// var GenericFilterModel = require('../models/generic-filter-model');
var TreeNodeView = _dereq_('../tree/tree-node-view');
var BaseFilterView = _dereq_('../views/base-filter-view');
var Template = "<div class=\"search-form\">\n  <div class=\"input-group form-group\">\n    <input type=\"text\" class=\"form-control search-text\" placeholder=\"Search...\">\n    <span class=\"input-group-btn\">\n      <button  class=\"btn btn-success\">Go</button>\n    </span>\n  </div><!-- /input-group -->\n</div>\n<div class=\"toggle-all\">\n  <em>\n    <a href=\"#\" class=\"select-all\" >select all</a> /\n    <a href=\"#\" class=\"select-none\" >deselect all</a>\n  </em>\n</div>\n\n<div class=\"tree tree-container\" style=\"\"></div><!--display:none;-->\n";
  ...
  renderFilters:function() {
    ...
    this.model.getTree().then(function(treeModel) {
      ...
      if (treeModel) {
        ...
        self.$('.tree-container').append("Hi, report to David");
      }
    })
    .fail(function(){
...
},{"../tree/tree-node-view":18,"../views/base-filter-view":19,"underscore":9}],22:[function(_dereq_,module,exports){
...
var GenericFilterView = _dereq_('../views/generic-filter-view');
var YearsFilterView = _dereq_('../views/years-filter-view');
...
},{"../models/years-filter-model":16,"../views/generic-filter-view":21,"../views/years-filter-view":23,"backbone":1,"underscore":9}],23:[function(_dereq_,module,exports){

var _ = _dereq_('underscore');
var BaseFilterView = _dereq_('../views/base-filter-view');

_dereq_('../lib/jquery.nouislider.min.js');
_dereq_('jquery-ui/datepicker');
...
},{"../lib/jquery.nouislider.min.js":11,"../views/base-filter-view":19,"jquery-ui/datepicker":4,"underscore":9}]},{},[12])
(12)
});