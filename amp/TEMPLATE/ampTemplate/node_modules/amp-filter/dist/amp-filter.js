...
module.exports = GenericFilterModel.extend({
  ...
  //   GenericFilterModel.prototype.deserialize.apply(this, [blob]);
  // },
  ...
  serialize: function() {
    ...
    if (children.length > 0) {
      children.each(function(child) {
        var serializedChild = child.serialize();
...
module.exports = Backbone.View.extend({
  ...
  serialize: function() {
    ...
    //TODO: build a util for bettermerge that concat's array if duplicate keys in objects...
      _.extend(self.serializedFilters, filter.serialize());
    });
