...
var Backbone = _dereq_('backbone');
var TitleTemplate = "<li><a href=\"#\"><span data-i18n=\"amp.gis:pane-subfilters-<%= name.replace(/ /g,'') %>\"><%= name %></span>   <span data-i18n=\"amp.gis:pane-filters-all\" class='filter-count small pull-right'>all</span></a></li>\n";
...
var Translator = _dereq_('amp-translate');
...
var Template = "\n<div class=\"panel-heading\">\n  <a type=\"button\" class=\"close cancel\"  aria-hidden=\"true\">&times;</a>\n  <h3 data-i18n=\"amp.gis:title-filters\" class=\"panel-title\">Filters</h3>\n</div>\n<div class=\"panel-body filter-body\">\n\n  <ul class=\"nav nav-tabs filter-titles\" role=\"tablist\">\n  </ul>\n\n  <div class=\"tab-content filter-options\">\n    <img src=\"img/loading-icon.gif\" />\n  </div>\n</div>\n<div class=\"panel-footer\">\n  &nbsp;\n  <div class=\"pull-right\" style=\"display: inline-block; margin-bottom: 5px;\">\n    <button type=\"button\" class=\"btn btn-sm btn-danger reset\"  data-i18n=\"amp.gis:button-reset\"  title=\"Turn off all filters.\">Reset</button>\n    <button type=\"button\" class=\"btn btn-sm btn-warning cancel\"  data-i18n=\"amp.gis:button-cancel\"  title=\"Revert filters to state when opened.\">Cancel</button>\n    <button type=\"button\" class=\"btn btn-sm btn-success apply\"  data-i18n=\"amp.gis:button-apply\" >Apply</button>\n  </div>\n</div>\n";
var TitleTemplate = "<li class=\"\" id=\"<%= name.replace(/ /g,'') %>\"><a  href=\"#filter-pane-<%= name.replace(/ /g,'') %>\" role=\"tab\" data-toggle=\"tab\"><span data-i18n=\"amp.gis:pane-filters-<%= name.replace(/ /g,'') %>\" ><%= name %></span> <small><span class=\"title-count small\"></span></small></a></li>\n";
  ...
  render: function() {
    ...
    if (this.firstRender) {
      ...
      this._getFilterList().done(function() {
        ...
        if (self.translator) {
          self.translator.addTranslatorOptions({defaultKeys: filterTranslateKeys});
          self.translator.translateDOM(self.el);
        } else {
          self.translator = new Translator({defaultKeys: filterTranslateKeys});
          /*TODO line here to handle language from page*/
          self.translator.translateDOM(self.el);
        }
      });
...
},{"../collections/all-filters-collection":10,"../views/top-level-filter-view":22,"amp-translate":24,"backbone":1,"jquery":8,"underscore":9}],21:[function(_dereq_,module,exports){
...
},{"../models/years-filter-model":16,"../views/generic-filter-view":21,"../views/years-filter-view":23,"backbone":1,"jquery":8,"underscore":9}],23:[function(_dereq_,module,exports){
...
},{"../lib/jquery.nouislider.min.js":11,"../views/base-filter-view":19,"jquery-ui/datepicker":4,"underscore":9}],24:[function(_dereq_,module,exports){
...
},{"backbone":25,"jquery":26,"underscore":27}],25:[function(_dereq_,module,exports){
module.exports=_dereq_(1)
},{"underscore":27}],26:[function(_dereq_,module,exports){
