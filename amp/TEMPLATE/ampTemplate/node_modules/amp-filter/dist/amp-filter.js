...
module.exports = Backbone.View.extend({
  ...
  initialize:function(options) {
    ...
    this._getFilterList().then(function() {
      self.allFilters.each(function(model) {
    	if(model.attributes.tree !== undefined && model.attributes.tree.attributes.children.length>0){  
  ...
  _createTopLevelFilterViews: function() {
    this.filterViewsInstances = {
      ...
      locations: new TopLevelFilterView({name:'Location'}),
...
module.exports = BaseFilterView.extend({
  ...
  renderTitle:function() {
    var self = this;
    if (self.model.attributes.data == undefined && self.model.attributes.tree.attributes.children.length >0){
    	BaseFilterView.prototype.renderTitle.apply(this);
    	this._updateCountInMenu();
    }else if (self.model.attributes.data != undefined && self.model.attributes.data.length>0){
    	BaseFilterView.prototype.renderTitle.apply(this);
    	this._updateCountInMenu();
    }
    return this;
...
},{"dup":1,"underscore":27}],26:[function(require,module,exports){
