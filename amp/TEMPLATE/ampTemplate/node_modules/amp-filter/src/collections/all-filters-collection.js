...
_sortByName: function(items, filterId) {
	  ...
	  return items.sort(function(a, b) {	
		...
		//if sector, extract name without code
		 var isSector = (filterId && filterId.indexOf('sector') !== -1);
		 var aName = isSector ? self._extractName(a.name) : a.name;
		 var bName = isSector ? self._extractName(b.name) : b.name;		
		 
		 return Collator.compare(aName, bName);			 
	  });
},
//replace digits with empty string in code + name combination
_extractName: function(codeAndName) {
	return codeAndName.replace(/[0-9]/g, "");	
},
