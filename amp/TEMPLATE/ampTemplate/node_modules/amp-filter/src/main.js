...
_.extend(Widget.prototype, Backbone.Events, {
  ...
  formatDate: function(date){
    ...
    serialize: function () {
        ...
        // Set the setting/filter parameter for Saiku/Reports BE.
        if (ser['include-location-children'] !== undefined) {
            ser.filters.includeLocationChildren = ser['include-location-children'];
        }
        return ser;
    },
