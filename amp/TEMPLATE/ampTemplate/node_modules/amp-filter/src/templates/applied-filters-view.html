       ...
       <li>
           ...
           <% if (item.modelType === 'TREE' && item.children) { %>
               <ul class="prev_nested">
                   ...
                   <li>Node B</li>
                   <li>
                       <span class="prev_caret">Node C</span>
                       <ul class="prev_nested">
                           <li>Node C-0</li>
                           <li>Node C-1</li>
                           <li>
                               <span class="prev_caret">Node C-3</span>
                               <ul class="prev_nested">
                                   <li>Node C-3-a</li>
                                   <li>Node C-3-b</li>
                                   <li>Node C-3-c</li>
