<% if (!empty) { %>
	...
	<% if (isLocationFilter) {%>
	  <div class="toggle-nav">
	 	 <input class="include-location-children" checked=<%= obj['include-location-children'] ? "checked" : "" %> type="checkbox" class="include-children-toggle"><label data-i18n="amp.gis:include-location-children">Include locations with children</label>
	  </div>
	<% } %>
	  <em>
