...
TreeNodeModel = Backbone.Model.extend({
  ...
  initialize:function(obj) {
    ...
    this.on('change:reset', self._onReset);
...
_serializeChildren: function(tmpSerialized, children, options){
  ...
  _onReset: function(value) {
    this.set('selected', value);
    // this.set('numSelected', 0);
    if (!this.get('children').isEmpty()) {
      this._updateChildNodes(true, value);
      this._updateChildNodes(true, !value);
    }
  },
  ...
  _isLocationAndDontIncludeChildren: function () {
    var result = false;
    if (this.get('name') === 'Locations' || this.get('filterId') === 'communal-section' ||
        this.get('filterId') === 'district' ||
