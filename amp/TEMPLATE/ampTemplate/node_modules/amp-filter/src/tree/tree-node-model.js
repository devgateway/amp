...
serialize: function(options) {
    ...
    if (children.length > 0) {
    	  ...
    	  if (Constants.LOCATIONS === options.group) {
...
_serializeChildren: function(tmpSerialized, children, options){
  ...
  _isLocationAndDontIncludeChildren: function () {
    var includeChildren = $('.include-location-children').is(':checked');
    if (!includeChildren &&
        (this.get('filterId') === 'communal-section' || this.get('filterId') === 'district' ||
            this.get('filterId') === 'zone' || this.get('filterId') === 'region' ||
            this.get('filterId') === 'country')) {
      return true;
    }
    return false;
  },
  ...
  _hasAnySelectedChildren: function () {
    // this.get('children').models[0].get('children').models[0].attributes
  ...
  _findChildrenSelected: function (object) {
    ...
    if (object.get('children').length === 0) {
      ...
      _.each(object.get('children').models, function (item) {
