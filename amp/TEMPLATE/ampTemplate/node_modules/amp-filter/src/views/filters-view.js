...
module.exports = Backbone.View.extend({
  ...
  _createFilterViews: function(tmpModel) {
	...
	//console.log("Donors:" + this.filterViewsInstances.donors.filterCollection.length);
	//console.log("Sectors:" +this.filterViewsInstances.sectors.filterCollection.length);
