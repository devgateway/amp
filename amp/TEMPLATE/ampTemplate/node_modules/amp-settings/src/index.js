...
_.extend(Widget.prototype, Backbone.Events, {	
	...
	initialize : function(options) {
		...
		_.bindAll(this, 'loadData', 'show', 'toAPIFormat', 'restoreFromSaved', 'setElement');				
	},
	loadData: function(){		
		var deferred = [];
		deferred.push(this.definitions.load());		    
		var loadDataPromise = $.when.apply($, this.deferred).then(function () {});
