...
module.exports = Backbone.View.extend({
	...
	optionChanged : function(evt) {
		...
		if (id === Constants.CALENDAR_ID) {
			...
			self.settingsData.get(Constants.CURRENCY_ID).set('options', [], {
				silent : true
			});
			...
			$.each(availableCurrenciesForCalendar, function(index, object) {
				...
				self.settingsData.get(Constants.CURRENCY_ID).get('options').push(_.find(self.allCurrencies, function(item) {
					return item.id === object
				}));
			});
