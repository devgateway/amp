...
module.exports = Backbone.View.extend({
  ...
  initialize:function(options) {
      ...
      this.def.push(this.settings.fetch())
  },
  render: function() {
	  var self = this;
      ...
      $.when.apply($, this.def).then(function () {
          ...
          self.$el.html(self.template({
              ...
              columns: {name: 'Name', email: 'Username', createdOn: 'CreationDate', accessType: 'AccessType'},
              language:language
          }));
  ...
  sortBy: function (e) {
      ...
      var order = columnHeader.hasClass(ASC)? DESC : columnHeader.hasClass(DESC) ? ASC: DESC;
