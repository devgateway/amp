...
module.exports = Backbone.View.extend({
  ...
  loadData: function(){
	  ...
	  this.layers.page.set('recordsPerPage',999999);	  
  ...
  saveAndClose: function () {
	  ...
	  if(selectedIds.length > 0){
		  ...
		  $.ajax({
		         ...
		         success : function(data) {	  
		        	 MessageUtils.displaySuccessMessage(self.$el, "Population layers set successfully");
		         },
		         error: function(data){ 
		        	 MessageUtils.displayErrors(self.$el, ["A server error occurred while setting the population layers"]);
		         }
		  });  
	  }
