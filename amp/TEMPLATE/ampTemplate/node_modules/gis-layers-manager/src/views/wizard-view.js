		  ...
		  $.ajax({
			  ...
			  success : function(data) {	        	 
				  if(!_.isUndefined(data.values)){	
					  ...
					  MessageUtils.displaySuccessMessage(self.$el, self.translator.translateSync('amp.gis-layers-manager:message-ImportSuccessful','The file was imported successfully.'));		        		 
				  }else{
					  MessageUtils.displayErrors(self.$el, [self.translator.translateSync('amp.gis-layers-manager:message-CouldNotImportFile','Could not import file. Please check the file format.')]);  
				  }		        	 
