...
module.exports = Backbone.View.extend({
  ...
  render: function() {	 
	    ...
	    this.$el.html(this.template({model:this.model.toJSON(),languages:this.languages}));
	    this.renderColorSelector();
	    this.renderADMDropdown();
	    this.renderAccessTypeDropdown();
	    this.renderIndicatorLayerTypes();
  ...
  exportFile: function(){	  
	  ...
	  this.save().then(function(){
		  window.open('/rest/indicator/indicator-layer/export?admLevelId=' + self.model.get('admLevelId') + '&id=' + self.model.get('id'), '_blank');	
	  });	    
  },
  save: function(){
	  var deffereds = [];
  ...
  importFile: function(currentStep){
	  ...
	  this.save().then(function(){
		  ...
		  if(selectedFile){
			  ...
			  formData.append('indicatorId',self.model.get('id'));	
