...
module.exports = Backbone.View.extend({
  ...
  render: function() {	 
	    ...
	    this.loadCollections().then(function() {		  
			    self.setAccessType();			    
			    self.$el.html(self.template({model:self.model.toJSON(), languages:self.languages, admLevels: self.admLevels,accessTypes: self.accessTypes, indicatorTypes: self.indicatorTypes, colors: self.colors }));			     
