(function () {
	...
	(function () {
		this.onMouseDown = function (e) {
			...
			return !t || this.$clickSelection || e.getShiftKey() || r.inMultiSelectMode ? this.startSelect(n) : t && (this.mousedownEvent.time = (new Date).getTime(), this.startSelect(n)),
			this.captureMouse(e),
			e.preventDefault()
		},
	...
	(function () {
		...
		this.getTokenizer = function () {
			return this.$tokenizer || (this.$highlightRules = new this.HighlightRules, this.$tokenizer = new r(this.$highlightRules.getRules())),
			this.$tokenizer
		},
	...
	function u() {
		...
		this.foldAll = function (e, t, n) {
			...
			for (var i = e; i < t; i++) {
				...
				o = s.end.row;
				if (s && s.isMultiLine() && o <= t && s.start.row >= e)
					try {
		...
		this.update = function (e) {
			...
			for (; ; ) {
				...
				if (g) {
					...
					c.foldWidget != null && (c.element.removeChild(c.foldWidget), c.foldWidget = null);
				p++
			}
