							...
							.save(
									{},
									{
										...
										error : function() {
											Saiku.ui.unblock();
											if ($('body').find(
													'.error_loading_query').length < 1) {
												var message = (Saiku.i18n && Saiku.i18n.po_file['error_loading_query']) ? Saiku.i18n.po_file['error_loading_query']
														: null;
												if (!message) {
													message = "Error Loading Query";
													$(
															'<span class="i18n error_loading_query">'
																	+ message
																	+ '</span>')
															.hide().appendTo(
																	'body');
