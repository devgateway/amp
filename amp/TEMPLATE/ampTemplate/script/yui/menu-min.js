...
http://developer.YAHOOAmp.net/yui/license.txt
version: 2.5.2
*/
...
* </ul>
* @title Menu
* @namespace YAHOOAmp.widget
* @requires Event, Dom, Container
*/
(function () {

    var Dom = YAHOOAmp.util.Dom,
        Event = YAHOOAmp.util.Event;
    ...
    * @static
    */
    YAHOOAmp.widget.MenuManager = function () {
        ...
        * passed back by the event utility (YAHOOAmp.util.Event).
        */
            ...
            if (oMenu) {
                ...
                */
                ...
                for (var i in m_oVisibleMenus) {
                    ...
                    if (YAHOOAmp.lang.hasOwnProperty(m_oVisibleMenus, i)) {
        
                        oMenu = m_oVisibleMenus[i];

                        if (oMenu.cfg.getProperty("clicktohide") && 
                            !(oMenu instanceof YAHOOAmp.widget.MenuBar) && 
        ...
        * was fired.
        * @param {YAHOOAmp.widget.Menu} p_oMenu The menu that fired the event.
        */
        ...
        */
        function onItemAdded(p_sType, p_aArgs) {
            ...
            if (oItem instanceof YAHOOAmp.widget.MenuItem) { 
        ...
        return {
            ...
            * @param {YAHOOAmp.widget.Menu} p_oMenu Object specifying the Menu  
            ...
            */
            addMenu: function (p_oMenu) {
                ...
                if (p_oMenu instanceof YAHOOAmp.widget.Menu && p_oMenu.id && 
                    !m_oMenus[p_oMenu.id]) {
            ...
            * (excluding instances of YAHOOAmp.widget.MenuBar).
            */
            hideVisible: function () {
                ...
                for (var i in m_oVisibleMenus) {
                    ...
                    if (YAHOOAmp.lang.hasOwnProperty(m_oVisibleMenus, i)) {
                        ...
                        if (!(oMenu instanceof YAHOOAmp.widget.MenuBar) && 
                            oMenu.cfg.getProperty("position") == "dynamic") {
            ...
            * be retrieved.
            * @return {YAHOOAmp.widget.MenuItem}
            */
...
* @class Menu
* @constructor
* @extends YAHOOAmp.widget.Overlay
*/
YAHOOAmp.widget.Menu = function (p_oElement, p_oConfig) {
    ...
    YAHOOAmp.widget.Menu.superclass.constructor.call(this, p_oElement, p_oConfig);
...
var Dom = YAHOOAmp.util.Dom,
    Event = YAHOOAmp.util.Event,
    Module = YAHOOAmp.widget.Module,
    Overlay = YAHOOAmp.widget.Overlay,
    Menu = YAHOOAmp.widget.Menu,
    MenuManager = YAHOOAmp.widget.MenuManager,
    CustomEvent = YAHOOAmp.util.CustomEvent,
    Lang = YAHOOAmp.lang,
    UA = YAHOOAmp.env.ua,
...
YAHOOAmp.lang.extend(Menu, Overlay, {
...
* @default YAHOOAmp.widget.MenuItem
* @final
* @type YAHOOAmp.widget.MenuItem
*/
ITEM_TYPE: null,
...
* @type YAHOOAmp.util.CustomEvent
*/
mouseOutEvent: null,
...
init: function (p_oElement, p_oConfig) {
    ...
    if (!this.ITEM_TYPE) {
        ...
        this.ITEM_TYPE = YAHOOAmp.widget.MenuItem;
...
* item belongs.
* @param {YAHOOAmp.widget.MenuItem} p_oItem Object reference for the MenuItem 
...
_execHideDelay: function () {
    ...
    function hideMenu() {
        ...
        if (oRoot == me && !(me instanceof YAHOOAmp.widget.MenuBar) && 
...
* @private
* @param {YAHOOAmp.widget.Menu} p_oMenu Object specifying the menu that should 
* be made visible.
*/
...
* @private
* @param {YAHOOAmp.widget.Menu} p_oSubmenu Object specifying the submenu that  
* should be hidden.
        ...
        if (!oItem.handledMouseOutEvent && ((oRelatedTarget != oItem.element &&  
            ...
            if (!bMovingToSubmenu) {
                ...
                if (oSubmenu) {
                    ...
                    if (!(this instanceof YAHOOAmp.widget.MenuBar) && 
                        nSubmenuHideDelay > 0 && 
...
* back by the event utility (YAHOOAmp.util.Event).
* @param {YAHOOAmp.widget.Menu} p_oMenu Object representing the menu that 
* fired the event.
*/
			...
			*/
			...
			if (!oSubmenu) {
				...
				*/
				...
				if (oRoot instanceof YAHOOAmp.widget.MenuBar || 
        ...
        switch(oEvent.keyCode) {
            ...
            case 37:    // Left arrow
                ...
                if (oParentItem) {
                    ...
                    if (oParentMenu instanceof YAHOOAmp.widget.MenuBar) {
...
_onBeforeShow: function (p_sType, p_aArgs) {
    ...
    if (!(this instanceof YAHOOAmp.widget.MenuBar) && bDynamicPos) {
        ...
        if (nMaxHeight === 0) {
            ...
            if (this.parent && 
                this.parent.parent instanceof YAHOOAmp.widget.MenuBar) {
               
                oRegion = YAHOOAmp.util.Region.getRegion(this.parent.element);
...
_onShow: function (p_sType, p_aArgs) {
    ...
    if (oParent) {
        ...
        if (!oParentMenu.cfg.getProperty("autosubmenudisplay") && 
            (oParentMenu instanceof YAHOOAmp.widget.MenuBar || 
...
* was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {YAHOOAmp.widget.Menu} p_oSubmenu Object representing the submenu that 
...
* that was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {YAHOOAmp.widget.MenuItem} p_oItem Object representing the menu item 
...
enforceConstraints: function (type, args, obj) {
	...
	YAHOOAmp.widget.Menu.superclass.enforceConstraints.apply(this, arguments);
...
* @param {Array} p_aArgs Collection of arguments sent when the event 
* was fired.
* @param {YAHOOAmp.widget.Menu} p_oMenu The Menu instance fired
* the event.
*/
configMaxHeight: function (p_sType, p_aArgs, p_oMenu) {
    ...
    Dom.removeClass(oBody, "yuiamp-menu-body-scrolled");
...
* @param {YAHOOAmp.widget.Menu} p_oMenu The Menu instance fired the event.
*/
...
onRender: function (p_sType, p_aArgs) {
    ...
    function addShadowVisibleClass() {
        ...
        Dom.addClass(this._shadow, "yuiamp-menu-shadow-visible");
    ...
    function removeShadowVisibleClass() {
        ...
        Dom.removeClass(this._shadow, "yuiamp-menu-shadow-visible");
        ...
        if (!oShadow) {
            ...
            if (!m_oShadowTemplate) {
                ...
                m_oShadowTemplate.className = 
                    "yuiamp-menu-shadow yui-menu-shadow-visible";
...
* @param {YAHOOAmp.widget.MenuItem} p_oObject Object reference for the MenuItem 
...
removeItem: function (p_oObject, p_nGroupIndex) {
    ...
    if (typeof p_oObject != "undefined") {
        ...
        if (p_oObject instanceof YAHOOAmp.widget.MenuItem) {
...
* @constructor
*/
YAHOOAmp.widget.MenuItem = function (p_oObject, p_oConfig) {
...
var Dom = YAHOOAmp.util.Dom,
    Module = YAHOOAmp.widget.Module,
    Menu = YAHOOAmp.widget.Menu,
    MenuItem = YAHOOAmp.widget.MenuItem,
    CustomEvent = YAHOOAmp.util.CustomEvent,
    Lang = YAHOOAmp.lang,
...
MenuItem.prototype = {
    ...
    * @default "yuiampmenuitem"
    * @final
    * @type String
    */
    CSS_CLASS_NAME: "yuiampmenuitem",
    ...
    * @default "yuiampmenuitemlabel"
    * @final
    * @type String
    */
    CSS_LABEL_CLASS_NAME: "yuiampmenuitemlabel",
    ...
    */
	...
	/**
    * @property browser
    * @deprecated Use YAHOOAmp.env.ua
    ...
    */
    init: function (p_oObject, p_oConfig) {
        ...
        this.cfg = new YAHOOAmp.util.Config(this);
    ...
    */    
    configSelected: function (p_sType, p_aArgs, p_oItem) {
        ...
        if (this.hasFocus() && YAHOOAmp.env.ua.opera) {
        ...
        */
        ...
        if (!this._oOnclickAttributeValue && typeof oObject == "object" && 
            ...
            this.clickEvent.subscribe(oObject.fn, 
                ((!YAHOOAmp.lang.isUndefined(oObject.obj)) ? oObject.obj : this), 
                oObject.scope);
	...
	*/
	initDefaultConfig : function () {
        ...
        * [<a href="YAHOOAmp.widget.Menu.html#itemData">array of values for 
    ...
    focus: function () {
        ...
        function setFocus() {
            ...
            try {
                ...
                if (YAHOOAmp.env.ua.ie && !document.hasFocus()) {
    ...
    */
    hasFocus: function () {
        ...
        return (YAHOOAmp.widget.MenuManager.getFocusedMenuItem() == this);
...
Lang.augmentProto(MenuItem, YAHOOAmp.util.EventProvider);
...
* @class ContextMenu
* @constructor
* @extends YAHOOAmp.widget.Menu
* @namespace YAHOOAmp.widget
*/
YAHOOAmp.widget.ContextMenu = function(p_oElement, p_oConfig) {

    YAHOOAmp.widget.ContextMenu.superclass.constructor.call(this, 
            p_oElement, p_oConfig);

};


var Event = YAHOOAmp.util.Event,
    ContextMenu = YAHOOAmp.widget.ContextMenu,
    ...
    */
    EVENT_TYPES = {
        ...
        "CONTEXT_MENU": (YAHOOAmp.env.ua.opera ? "mousedown" : "contextmenu"),
        "CLICK": "click"
...
YAHOOAmp.lang.extend(ContextMenu, YAHOOAmp.widget.Menu, {
...
init: function(p_oElement, p_oConfig) {
    ...
    // Call the init of the superclass (YAHOOAmp.widget.Menu)
...
initEvents: function() {
    ...
    this.triggerContextMenuEvent.signature = YAHOOAmp.util.CustomEvent.LIST;
...
* by the event utility (YAHOOAmp.util.Event).
* @param {YAHOOAmp.widget.ContextMenu} p_oMenu Object representing the context 
...
_onTriggerContextMenu: function(p_oEvent, p_oMenu) {
    ...
    */
    ...
    YAHOOAmp.widget.MenuManager.hideVisible();
    ...
    if(!this._bCancelled) {
        ...
        if (!YAHOOAmp.util.Dom.inDocument(this.element)) {
...
* @constructor
* @extends YAHOOAmp.widget.MenuItem
* @deprecated As of version 2.4.0 items for YAHOOAmp.widget.ContextMenu instances
* are of type YAHOOAmp.widget.MenuItem.
*/
YAHOOAmp.widget.ContextMenuItem = YAHOOAmp.widget.MenuItem;
(function () {
...
* @namespace YAHOOAmp.widget
*/
YAHOOAmp.widget.MenuBar = function(p_oElement, p_oConfig) {

    YAHOOAmp.widget.MenuBar.superclass.constructor.call(this, 
        p_oElement, p_oConfig);
...
var Event = YAHOOAmp.util.Event,
    MenuBar = YAHOOAmp.widget.MenuBar,
    ...
    */
    DEFAULT_CONFIG = {
        ...
        "AUTO_SUBMENU_DISPLAY": { 
            key: "autosubmenudisplay", 
            value: false, 
            validator: YAHOOAmp.lang.isBoolean,
            suppressEvent: true
        }
...
YAHOOAmp.lang.extend(MenuBar, YAHOOAmp.widget.Menu, {
...
init: function(p_oElement, p_oConfig) {
    ...
    if(!this.ITEM_TYPE) {
        ...
        this.ITEM_TYPE = YAHOOAmp.widget.MenuBarItem;
...
* @default "yuiampmenubar"
* @final
* @type String
*/
CSS_CLASS_NAME: "yuiampmenubar",
...
* was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {YAHOOAmp.widget.MenuBar} p_oMenuBar Object representing the menu bar 
* that fired the event.
*/
...
* @extends YAHOOAmp.widget.MenuItem
*/
YAHOOAmp.widget.MenuBarItem = function(p_oObject, p_oConfig) {

    YAHOOAmp.widget.MenuBarItem.superclass.constructor.call(this, 
        p_oObject, p_oConfig);

};

YAHOOAmp.lang.extend(YAHOOAmp.widget.MenuBarItem, YAHOOAmp.widget.MenuItem, {
...
init: function(p_oObject, p_oConfig) {
    ...
    if(!this.SUBMENU_TYPE) {
        ...
        this.SUBMENU_TYPE = YAHOOAmp.widget.Menu;

    }


    /* 
        Call the init of the superclass (YAHOOAmp.widget.MenuItem)
        Note: We don't pass the user config in here yet 
        because we only want it executed once, at the lowest 
        subclass level.
    */ 

    YAHOOAmp.widget.MenuBarItem.superclass.init.call(this, p_oObject);  
...
* @description String representing the CSS class(es) to be applied to the 
* <code>&#60;li&#62;</code> element of the menu bar item.
* @default "yuiampmenubaritem"
* @final
* @type String
*/
CSS_CLASS_NAME: "yuiampmenubaritem",
...
* @default "yuiampmenubaritemlabel"
* @final
* @type String
*/
CSS_LABEL_CLASS_NAME: "yuiampmenubaritemlabel",
...
YAHOOAmp.register("menu", YAHOOAmp.widget.Menu, {version: "2.5.2", build: "1076"});
