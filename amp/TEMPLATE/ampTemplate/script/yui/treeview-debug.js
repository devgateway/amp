 ...
 *
 * @class TreeView
 * @uses YAHOOAmp.util.EventProvider
 * @constructor
 ...
 * 
 */
YAHOOAmp.widget.TreeView = function(id, oConfig) {
    if (id) { this.init(id); }
	if (oConfig) {
...
TV.prototype = {
     ...
     * @param node {YAHOOAmp.util.Node} the node that was expanded
    ...
    /**
         ...
         * @event animStart
         * @type CustomEvent
         * @param {YAHOOAmp.widget.Node} node the node that is expanding/collapsing
         ...
         * @event collapse
         * @type CustomEvent
         * @param {YAHOOAmp.widget.Node} node the node that is collapsing
         */
         ...
         * @type CustomEvent
         * @param {YAHOOAmp.widget.Node} node the node that was collapsed
         */
         ...
         * @event expand
         * @type CustomEvent
         * @param {YAHOOAmp.widget.Node} node the node that is expanding
         */
         ...
         * @type CustomEvent
         * @param {YAHOOAmp.widget.Node} node the node that was expanded
         */
    ...
    /**
         ...
         * @type CustomEvent
         * @param {YAHOOAmp.widget.Node} node the node that has the focus
         */
	...
	* The listener may return false to cancel toggling and focusing on the node.
         ...
         * @param oArgs.node {YAHOOAmp.widget.Node} node the node that was clicked
         */
	...
	* @deprecated use clickEvent or dblClickEvent
        ...
        // YAHOOAmp.util.Event.onContentReady(this.id, this.handleAvailable, this, true);
        // YAHOOAmp.util.Event.on(this.id, "click", this.handleClick, this, true);
    },
...
target.className = target.className.replace(/ygtv([lt])([mp])/gi, 'ygtv$1$2h').replace(/h+/, 'h');
			...
			Event.on(
				...
				function (ev) {
					var target = Event.getTarget(ev),
						...
						newNode = node,
						KEY = YAHOOAmp.util.KeyListener.KEY;
  ...
  /**
     ...
     * @return {YAHOOAmp.widget.Node} a node reference or null
     */
...
YAHOOAmp.augment(TV, YAHOOAmp.util.EventProvider);

/**
 * Running count of all nodes created in all trees.  This is 
 * used to provide unique identifies for all nodes.  Deleting
 * nodes does not change the nodeCount.
 * @property YAHOOAmp.widget.TreeView.nodeCount
 * @type int
 * @static
 */
TV.nodeCount = 0;
 ...
 * @property YAHOOAmp.widget.TreeView.trees
 * @type Array
 * @static
 * @private
 */
 ...
 * tree html.
 * @method YAHOOAmp.widget.TreeView.getTree
 ...
 * tree html.
 * @method YAHOOAmp.widget.TreeView.getNode
 * @param treeId {String} the id of the tree instance
 ...
 * @method YAHOOAmp.widget.TreeView.preload
...
TV.preload = function(e, prefix) {
    ...
    YAHOOAmp.log("Preloading images: " + prefix, "info", "TreeView");
 ...
 * @constructor
 */
YAHOOAmp.widget.Node = function(oData, oParent, expanded) {
    if (oData) { this.init(oData, oParent, expanded); }
};

YAHOOAmp.widget.Node.prototype = {

    /**
     * The index for this instance obtained from global counter in YAHOOAmp.widget.TreeView.
     * @property index
     * @type int
     */
    index: 0,
...
*/
    ...
    */
    ...
    init: function(oData, oParent, expanded) {
        ...
        this.data       = oData;
        this.children   = [];
        this.index      = YAHOOAmp.widget.TreeView.nodeCount;
        ++YAHOOAmp.widget.TreeView.nodeCount;
        ...
        this.logger     = new YAHOOAmp.widget.LogWriter(this.toString());
	...
	focus: function () {
		...
		var removeListeners = function () {
			...
			while ((el = self._focusHighlightedItems.shift())) {  // yes, it is meant as an assignment, really
				Dom.removeClass(el,YAHOOAmp.widget.TreeView.FOCUS_CLASS_NAME );
			}
		};
		removeListeners();
		...
		Dom.getElementsBy  ( 
			...
			function (el) {
				Dom.addClass(el, YAHOOAmp.widget.TreeView.FOCUS_CLASS_NAME );
				if (!focused) { 
...
YAHOOAmp.augment(YAHOOAmp.widget.Node, YAHOOAmp.util.EventProvider);
})();
(function () {
	var Dom = YAHOOAmp.util.Dom,
		Lang = YAHOOAmp.lang,
 ...
 * @param oParent {YAHOOAmp.widget.Node} this node's parent node
 * @param expanded {boolean} the initial expanded/collapsed state (deprecated; use oData.expanded) 
 */
YAHOOAmp.widget.TextNode = function(oData, oParent, expanded) {
...
YAHOOAmp.extend(YAHOOAmp.widget.TextNode, YAHOOAmp.widget.Node, {
...
/**
    ...
    // overrides YAHOOAmp.widget.Node
	getContentHtml: function() { 
        var sb = [];
  ...
  /**
     ...
     */
    getNodeDefinition: function() {
		var def = YAHOOAmp.widget.TextNode.superclass.getNodeDefinition.call(this);
		if (def === false) { return false; }
    ...
    toString: function() { 
        return YAHOOAmp.widget.TextNode.superclass.toString.call(this) + ": " + this.label;
    },
...
/**
 * A custom YAHOOAmp.widget.Node that handles the unique nature of 
 * the virtual, presentationless root node.
 * @namespace YAHOOAmp.widget
 * @class RootNode
 * @extends YAHOOAmp.widget.Node
 * @param oTree {YAHOOAmp.widget.TreeView} The tree instance this node belongs to
 * @constructor
 */
YAHOOAmp.widget.RootNode = function(oTree) {
...
YAHOOAmp.extend(YAHOOAmp.widget.RootNode, YAHOOAmp.widget.Node, {
 ...
 */
YAHOOAmp.widget.HTMLNode = function(oData, oParent, expanded, hasIcon) {
    if (oData) { 
        this.init(oData, oParent, expanded);
...
YAHOOAmp.extend(YAHOOAmp.widget.HTMLNode, YAHOOAmp.widget.Node, {
...
/**
     ...
     */
    getNodeDefinition: function() {
		var def = YAHOOAmp.widget.HTMLNode.superclass.getNodeDefinition.call(this);
		if (def === false) { return false; }
		def.html = this.html;
		return def;
 ...
 * @constructor
 */
YAHOOAmp.widget.MenuNode = function(oData, oParent, expanded) {
	YAHOOAmp.widget.MenuNode.superclass.constructor.call(this,oData,oParent,expanded);
...
YAHOOAmp.extend(YAHOOAmp.widget.MenuNode, YAHOOAmp.widget.TextNode, {
...
(function () {
	var Dom = YAHOOAmp.util.Dom,
		Lang = YAHOOAmp.lang,
		Event = YAHOOAmp.util.Event,
		Calendar = YAHOOAmp.widget.Calendar;
		
/**
 * A Date-specific implementation that differs from TextNode in that it uses 
 * YAHOOAmp.widget.Calendar as an in-line editor, if available
 ...
 * @constructor
 */
YAHOOAmp.widget.DateNode = function(oData, oParent, expanded) {
	YAHOOAmp.widget.DateNode.superclass.constructor.call(this,oData, oParent, expanded);
};

YAHOOAmp.extend(YAHOOAmp.widget.DateNode, YAHOOAmp.widget.TextNode, {
	...
	*/
	...
	/** 
	 *  If YAHOOAmp.widget.Calendar is available, it will pop up a Calendar to enter a new date.  Otherwise, it falls back to a plain &lt;input&gt;  textbox
	 * @method fillEditorContainer
	 * @param editorData {YAHOOAmp.widget.TreeView.editorData}  a shortcut to the static object holding editing information
	 * @return void
	 */
	fillEditorContainer: function (editorData) {
		...
		if (Lang.isUndefined(Calendar)) {
			...
			YAHOOAmp.widget.DateNode.superclass.fillEditorContainer.call(this, editorData);
			return;
		}
...
(function () {
	...
	* <li>whoHasIt {YAHOOAmp.widget.TreeView} TreeView instance that is currently using the editor</li>
	...
	* <li>node {YAHOOAmp.widget.Node} reference to the Node being edited</li>
	...
	* @method _nodeEditing
	* @param node {YAHOOAmp.widget.Node} the node to be edited
	...
	*/
	...
	TVproto.onEventEditNode = function (oArgs) {
		if (oArgs instanceof YAHOOAmp.widget.Node) {
			oArgs.editNode();
		} else if (oArgs.node instanceof YAHOOAmp.widget.Node) {
			oArgs.node.editNode();
		}
	};
	...
	*/
	...
	var Nproto = YAHOOAmp.widget.Node.prototype;
	
	/**
	* Signals if the label is editable.  (Ignored on TextNodes with href set.)
	* @property editable
	* @type boolean
         * @for YAHOOAmp.widget.Node
	*/
	...
	* @method saveEditorValue
	...
	var TNproto = YAHOOAmp.widget.TextNode.prototype;
 ...
 * @static
 */
YAHOOAmp.widget.TVAnim = function() {
    return {
        /**
         ...
         * @return {YAHOOAmp.util.Animation} the animation instance
         * @static
         */
        getAnim: function(type, el, callback) {
            if (YAHOOAmp.widget[type]) {
                return new YAHOOAmp.widget[type](el, callback);
            } else {
                return null;
            }
        },
 ...
 */
YAHOOAmp.widget.TVFadeIn = function(el, callback) {
    /**
...
YAHOOAmp.widget.TVFadeIn.prototype = {
    /**
    ...
    animate: function() {
        ...
        var dur = 0.4; 
        var a = new YAHOOAmp.util.Anim(this.el, {opacity: {from: 0.1, to: 1, unit:""}}, dur);
 ...
 * @param callback {Function} function to invoke when the animation is finished
 */
YAHOOAmp.widget.TVFadeOut = function(el, callback) {
    /**
     * The element to animate
     * @property el
     * @type HTMLElement
...
YAHOOAmp.widget.TVFadeOut.prototype = {
    /**
     * Performs the animation
     * @method animate
     */
    animate: function() {
        var tvanim = this;
        var dur = 0.4;
        var a = new YAHOOAmp.util.Anim(this.el, {opacity: {from: 1, to: 0.1, unit:""}}, dur);
        a.onComplete.subscribe( function() { tvanim.onComplete(); } );
        a.animate();
    },
...
YAHOOAmp.register("treeview", YAHOOAmp.widget.TreeView, {version: "2.6.0", build: "1321"});
