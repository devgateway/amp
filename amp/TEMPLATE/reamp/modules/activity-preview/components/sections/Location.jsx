...
class Location extends Component {
  ...
  render() {
    ...
    const topContent = [];
    topContent.push(<td key={IMPLEMENTATION_LEVEL}>{this.props.buildSimpleField(activity, IMPLEMENTATION_LEVEL, noDataValue, true)} </td>);
    topContent.push(<td key={IMPLEMENTATION_LOCATION}>{this.props.buildSimpleField(activity, IMPLEMENTATION_LOCATION, noDataValue, true)} </td>);
