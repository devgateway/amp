...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log(_ampTemplateNode_modulesAmpBoilerplateDistAmpBoilerplateJs2["default"]);
	...
	function update(action, model) {
	  ...
	  if (action instanceof NewRate.Action) {
	    if (action instanceof NewRate.YearSubmitted) {
	      return model.setIn(['current', 'currencies', model.current().currentCurrencyCode(), 'inflationRates', action.year()], Rate.model.year(action.year()));
	    }
	...
	var Model = (function () {
	  ...
	  _createClass(Model, [{
	    ...
	    value: function equals(b) {
	      ...
	      _ref4 = this.keys().length == b.keys().length && this.keys().every(function (key) {
