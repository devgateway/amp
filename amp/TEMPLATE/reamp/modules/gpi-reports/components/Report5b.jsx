...
export default class Report5b extends Component {
     ...
     generatePaginationLinks() {
          ...
          for (var i = 1; i <= this.props.mainReport.page.totalPageCount; i++) {
               ...
               paginationLinks.push(<li className={classes} key={i}><a data-page={i} className="page-link"
                                                                       onClick={this.goToClickedPage}>{i}</a></li>);
          }
          ...
          if (this.props.mainReport && this.props.mainReport.page) {
               ...
               return (
                   <div>
                             ...
                             <div className="col-md-5b no-padding">
                                  ...
                                  <div className="btn-action-nav">
                                       <button type="button" className="btn btn-action"
                                               onClick={this.showFilters}>{this.props.translations['amp.gpi-reports:filter-button']}</button>
                                       <button type="button" className="btn btn-action"
                                               onClick={this.showSettings}>{this.props.translations['amp.gpi-reports:settings-button']}</button>
                                  </div>
                             </div>
                        </div>
                        ...
                        <div className="container-fluid indicator-stats no-padding">
                             <div className="col-md-3">
                                  <div className="indicator-stat-wrapper">
                                       <div
                                           className="stat-value">{this.props.mainReport.summary[Constants.INDICATOR_5B]}</div>
                                       <div
                                           className="stat-label">{this.getLocalizedColumnName(Constants.INDICATOR_5B)}</div>
                                  </div>
                             </div>
                        </div>
                        }
                        <div className="container-fluid no-padding">
                             <ul className="year-nav">
                                  {( ( years.length > 3 ) ? years.splice(years.length - 3, 3).reverse() : years.reverse() ).map(year =>
                                      <li className={this.state.selectedYear == year ? 'active' : ''} key={year}><a
                                          data-year={year} onClick={this.onYearClick}>{year}</a></li>
                                  )}
                                  <li >
                                       <div className="dropdown">
                                            <a className={years.includes( this.state.selectedYear ) ? 'btn dropdown-toggle btn-years btn-years-active' : 'btn dropdown-toggle btn-years'}
                                               type="button" id="years" data-toggle="dropdown">
                                            ...
                                            <ul className="dropdown-menu dropdown-years" role="menu">
                                                 {years.length > 3 && years.reverse().map(year =>
                                                     <li role="presentation"
                                                         ...
                                                         key={year}><a data-year={year}
                                                                       onClick={this.onYearClick}>{year}</a></li>
                                                 )}
                        ...
                        <div className="container-fluid no-padding">
                             <div className="dropdown">
                                  <select name="donorAgency" className="form-control donor-dropdown"
                                          value={this.state.selectedDonor} onChange={this.onDonorFilterChange}>
                             ...
                             <div className="pull-right">
                                  <h4>{this.props.translations['amp.gpi-reports:currency']} {this.props.mainReport.settings['currency-code']}</h4>
                             </div>
                        </div>
                        <div className="section-divider"></div>
                        ...
                        <table className="table table-bordered table-striped indicator-table">
                             ...
                             <tr>
                                  ...
                                  {MTEFYears.map((year, i) =>
                                      <th className="col-md-2" key={i}><HeaderToolTip
                                          column={year}
                                          headers={this.props.mainReport.page.headers}/>{year}</th>
                                  )}
                                  <th className="col-md-2"><HeaderToolTip
                                      column={Constants.INDICATOR_5B} imgType={IMG_VALUE}
                                      headers={this.props.mainReport.page.headers}/>{this.props.translations['amp-gpi-reports:indicator-5b']}
                                  </th>
                             </tr>
                             </thead>
                             <tbody>
                                  ...
                                  <div className="col-md-8 pull-right pagination-wrapper">
                                       ...
                                       <div className="col-md-4">
                                            <ul className="pagination">
                                                 ...
                                                 <li className="next"><a onClick={this.goToNextPage}><span
                                                     aria-hidden="true">&rarr;</span></a></li>
                                                 <li className="page-item"><a onClick={this.goToLastPage}
                                       ...
                                       <div className="col-md-2">
                                        ...
                                        <span className="input-group-addon" id="basic-addon1">
                                            <span className="glyphicon glyphicon-arrow-right"
                                                  onClick={this.updateRecordsPerPage}></span>
                                        </span>
                                                 <input type="text" className="form-control" ref="recordsPerPage"
                                                        placeholder="" defaultValue={this.state.recordsPerPage}/>
                                            </div>
                                       </div>
