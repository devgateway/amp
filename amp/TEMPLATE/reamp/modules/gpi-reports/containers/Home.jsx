    ...
    render() {       
      ...
      return (
            <div >             
             ...
             <li role="presentation"  ><a href="#indicator5a" aria-controls="indicator5a" role="tab" data-toggle="tab" data-indicator="5a" onClick={this.tabChanged}>{this.props.translations['amp.gpi-reports:indicator5a-title']}</a></li>
             ...
             <div className="tab-content panel">
               ...
               <div role="tabpanel" className = 'tab-pane' id="indicator5a"> 
               {this.state.currentReport == '5a' &&
                   <Report5a/> 
                }
               </div>              
