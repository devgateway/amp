    ...
    render() {  
        ...
        return (
            <div >
                ...
                {this.props.verifiedOrgList.length > 0 && <li role="presentation" className="active"><a href="#indicator1" aria-controls="indicator1" role="tab" data-toggle="tab">{this.props.translations['amp.gpi-data-donor-notes:title']}</a></li>}                
                ...
                <div className="tab-content panel">
                  {this.props.verifiedOrgList.length > 0 &&
                      <div role="tabpanel" className="tab-pane active" id="indicator1"><DonorNotesList/></div>
                  }                     
