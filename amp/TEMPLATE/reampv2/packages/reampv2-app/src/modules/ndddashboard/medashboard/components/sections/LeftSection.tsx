    ...
    return (
        <div>
            <div style={{
                ...
                <h4>{
                    translations['amp.ndd.dashboard:indicators-by-program']
                }</h4>
            </div>
            <div style={{
                minHeight: '350px'
            ...
            {(level1Child && indicators.length > 0 && !indicatorsByProgramReducer.loading)? (
                <>
                    <div>
                    ...
                    <Row md={12} style={{
                        ...
                        <Button className={styles.button} onClick={handleAddIndicator}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-database-add" viewBox="0 0 16 16">
                                <path
                            ...
                            <span
                                className={styles.button_text}>{translations['amp.ndd.dashboard:me-add-indicator']}</span>
                        </Button>
                    </Row>
                </>
            ): (
                <>
                    {!indicatorsByProgramReducer.loading && (
