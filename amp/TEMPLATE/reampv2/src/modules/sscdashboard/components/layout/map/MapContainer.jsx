...
class MapContainer extends Component {
    ...
    populateFilters() {
        ...
        const {selectedCountries, selectedYears, selectedSectors, selectedModalities} = this.props.selectedFilters;
        ...
        return (
            <div className="col-md-10 col-md-offset-2 map-wrapper">
                ...
                <PopupOverlay show={this.props.showEmptyProjects}>
                    <SimplePopup message={translations['amp.ssc.dashboard:no-data']}
