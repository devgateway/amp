...
class CountryPopupHeader extends Component {
  ...
  render() {
    ...
    const {
      country, projectsBySectors, columnCount, countriesForExport
    } = this.props;
      ...
      country ? (
        <div className="header row">
          ...
          <div className={`col-md-${columnCount === 1 ? '2' : '3'} col-xs-3 projects`}>
            <span
              className="count">
              {projectsBySectors.uniqueProjects.size.toString()
                .padStart(SECTOR_MIN_SIZE, SECTOR_LEADING_LEFT)}
            </span>
          ...
          <div className={`col-md-${columnCount === 1 ? '3' : '4'} col-xs-4 projects`}>
            <span
              className="count">
              {projectsBySectors.sectors.length.toString()
                .padStart(SECTOR_MIN_SIZE, SECTOR_LEADING_LEFT)}
            </span>
