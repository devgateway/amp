...
Note: id and text are is required for ToggleSwitch component to function. Name, currentValue, defaultChecked, big, small and onChange are optional.
...
class ToggleSwitch extends Component {
    ...
    render() {
        const {id, name, big, currentValue, defaultChecked, disabled, text, small} = this.props;
        return (
