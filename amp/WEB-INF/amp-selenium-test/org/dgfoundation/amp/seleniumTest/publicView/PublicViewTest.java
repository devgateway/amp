...
public class PublicViewTest extends SeleneseTestCase {
    ...
    public static void testPublicView(LoggingSelenium selenium) throws Exception {
        ...
        if (selenium.isElementPresent("//a[contains(@href, \"/TEMPLATE/reampv2/build/index.html#/report_generator?profile=T\")]")) {
        ...
        if (selenium.isElementPresent("//a[contains(@href, \"/TEMPLATE/reampv2/build/index.html#/report_generator?profile=R\")]")) {
