...
/*		return "SELECT amp_activity_id from amp_activity WHERE name IN ('Eth Water', 'mtef activity 1', 'mtef activity 2', 'ptc activity 1', 'ptc activity 2', 'SSC Project 1', " + 
		...
		//return "SELECT amp_activity_id from amp_activity WHERE name IN ('Eth Water', 'Activity with Directed MTEFs', 'Activity with Directed Commitments', 'Activity With Directed Comms and Disbs', 'pledged 2', 'Second activity with directed MTEFs')";
		//return "SELECT amp_activity_id from amp_activity WHERE name IN ('Activity With Directed Comms and Disbs')";
		//return "SELECT amp_activity_id from amp_activity WHERE name IN ('ptc activity 1', 'ptc activity 2', 'Eth Water')";
		return TEAM_FILTER;
