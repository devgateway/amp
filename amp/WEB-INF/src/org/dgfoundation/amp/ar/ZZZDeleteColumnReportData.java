 ...
 * 
 */
public class ZZZDeleteColumnReportData extends ReportData<Column> {
	...
	public ZZZDeleteColumnReportData(String name) {
		super(name);
	...
	public GroupReportData horizSplitByCateg(String columnName)
		...
		HashMap<ZZZDeleteColumnReportData, Set<Long>> catToIds			= new HashMap<ZZZDeleteColumnReportData, Set<Long>> ();
		...
		for (Cell cat:cats)
		{
			...
			ZZZDeleteColumnReportData crd = new ZZZDeleteColumnReportData((String) cat.getColumnId() + ": " + cat.toString());
		...
		Iterator<ZZZDeleteColumnReportData> cellIter			= catToIds.keySet().iterator();
		while ( cellIter.hasNext() ) {
			ZZZDeleteColumnReportData crd	= cellIter.next();
