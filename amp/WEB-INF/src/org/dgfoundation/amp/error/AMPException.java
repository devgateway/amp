...
public class AMPException extends Exception implements AMPTaggedExceptions {
    ...
    public AMPException(AMPException ae){ //error get's propagated -- tags get inherited -- tag on this level will be added to the back
        super(ae);
    ...
    public AMPException(AMPUncheckedException ae){ //error get's propagated -- tags get inherited -- tag on this level will be added to the back
        super(ae);
        this.continuable = ae.isContinuable();
        this.level = ae.getLevel();
        this.tags = ae.getTags();
    ...
    public AMPException(int level, boolean continuable){
        super();
        this.level = level;
        this.continuable = continuable;
    }
    
    public AMPException(int level, boolean continuable, AMPException cause){
        super(cause);
        this.level = level;
        this.continuable = continuable;
    ...
    public AMPException(int level, boolean continuable, AMPUncheckedException cause){
        super(cause);
        this.level = level;
        this.continuable = continuable;
        this.tags = cause.getTags();
    ...
    public AMPException(int level, boolean continuable, Throwable cause){
        super(cause);
        this.level = level;
        this.continuable = continuable;
    }
