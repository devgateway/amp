...
public final class TokenNames
{
	...
	public static final String SELECTED_YEAR_PLANNED_DISBURSEMENTS = "selectedYearPlannedDisbursements";
	public static final String PRIOR_ACTUAL_DISBURSEMENTS = "priorActualDisbursements";
	public static final String CLOSED_MONTH_ACTUAL_DISBURSEMENTS = "closedMonthActualDisbursements";
	...
	/**
	 * no constructor - this is just a container class
	 */
	private TokenNames()
	{
