...
//      
    ...
    private boolean iterateEtlEntities(Set<Long> activities, Set<Long> pledges, Set<Long> components, Set<Long> agreements) {
        ...
        activities.addAll(SQLUtils.fetchLongs(conn, "SELECT DISTINCT(amp_activity_id) FROM amp_components WHERE " + componentIdCondition));
        ...
        components.addAll(SQLUtils.fetchLongs(conn, "SELECT DISTINCT(amp_component_id) FROM amp_components WHERE amp_activity_id IN (" + Util.toCSStringForIN(activities) + ")"));
