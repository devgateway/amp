...
public class PaginatedReport {
	...
	public PaginatedReport(ReportArea rootElement) {
		...
		this.parents = Collections.unmodifiableMap(mapParents(this.rootElement, new IdentityHashMap<ReportArea, ReportArea>()));
		this.indexedLeaves = Collections.unmodifiableList(indexLeaves(this.rootElement, new ArrayList<ReportArea>()));
