 ...
 *
 */
public class AmpNiReportsGenerator/* implements ReportExecutor */ /*, ReportOutputFormatter*/ {
	
//	protected static final Logger logger = Logger.getLogger(NiReportsGenerator.class);
//	
//	public final NiReportsSchema schema;
//	
//	public AmpNiReportsGenerator(NiReportsSchema schema) {
//		this.schema = schema;
//	}
//
//	@Override
//	public GeneratedReport executeReport(ReportSpecification report) {
//		new NiReportsGenerator(schema).executeReport(report, this);
//	}
//
//	@Override
//	public GeneratedReport executeReport(ReportSpecification report, BiFunction<ReportData, NiReportsEngine> outputFormatter) {
//		NiReportsEngine engine = new NiReportsEngine(schema, report);
//		ReportData reportOutput = engine.execute();
//		GeneratedReport apiReport = outputFormatter.apply(reportOutput, engine);
//		return apiReport;
//	}
//	
//	
