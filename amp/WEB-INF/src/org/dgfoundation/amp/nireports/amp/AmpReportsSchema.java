...
public class AmpReportsSchema extends AbstractReportsSchema {
	...
	protected AmpReportsSchema() {
		...
		addTextColumn(ColumnConstants.AC_CHAPTER, "v_ac_chapters");
		addTextColumn(ColumnConstants.ACCESSION_INSTRUMENT, "v_accession_instruments");
		addTextColumn(ColumnConstants.ACTIVITY_CREATED_BY, "v_activity_creator");
		addTextColumn(ColumnConstants.AUDIT_SYSTEM, "v_audit_system");
		addTextColumn(ColumnConstants.BUDGET_CODE_PROJECT_ID, "v_budget_code_project_id");
		addTextColumn(ColumnConstants.BUDGET_DEPARTMENT, "v_budget_department");
		addTextColumn(ColumnConstants.BUDGET_SECTOR, "v_budget_sector");
		addTextColumn(ColumnConstants.CAPITAL___EXPENDITURE, "v_capital_and_exp");
		addTextColumn(ColumnConstants.CRIS_NUMBER, "v_cris_number");
		addTextColumn(ColumnConstants.CURRENT_COMPLETION_DATE_COMMENTS, "v_actual_completion_date_comments");
		addTextColumn(ColumnConstants.DONOR_CONTACT_EMAIL, "v_donor_cont_email");
		addTextColumn(ColumnConstants.DONOR_CONTACT_FAX, "v_donor_cont_fax");
		addTextColumn(ColumnConstants.DONOR_CONTACT_NAME, "v_donor_cont_name");
		addTextColumn(ColumnConstants.DONOR_CONTACT_PHONE, "v_donor_cont_phone");
		addTextColumn(ColumnConstants.DONOR_CONTACT_TITLE, "v_donor_cont_title");
		addTextColumn(ColumnConstants.FINAL_DATE_FOR_DISBURSEMENTS_COMMENTS, "v_disbursements_date_comments");
		addTextColumn(ColumnConstants.FUNDING_ORGANIZATION_ID, "v_funding_org_id");
		addTextColumn(ColumnConstants.FY, "v_budget_extras_fy");
		addTextColumn(ColumnConstants.GOVERNMENT_AGREEMENT_NUMBER, "v_gov_agreement_number");
		addTextColumn(ColumnConstants.IMPLEMENTING_EXECUTING_AGENCY_CONTACT_EMAIL, "v_impl_ex_cont_email");
		addTextColumn(ColumnConstants.IMPLEMENTING_EXECUTING_AGENCY_CONTACT_FAX, "v_impl_ex_cont_fax");
		addTextColumn(ColumnConstants.IMPLEMENTING_EXECUTING_AGENCY_CONTACT_NAME, "v_impl_ex_cont_name");
		addTextColumn(ColumnConstants.IMPLEMENTING_EXECUTING_AGENCY_CONTACT_ORGANIZATION, "v_impl_ex_cont_org");
		addTextColumn(ColumnConstants.IMPLEMENTING_EXECUTING_AGENCY_CONTACT_PHONE, "v_impl_ex_cont_phone");
		addTextColumn(ColumnConstants.IMPLEMENTING_EXECUTING_AGENCY_CONTACT_TITLE, "v_impl_ex_cont_title");
		addTextColumn(ColumnConstants.JOINT_CRITERIA, "v_yes_no_joint_criteria");
		addTextColumn(ColumnConstants.MINISTRY_CODE, "v_minsitry_code");
		addTextColumn(ColumnConstants.MINISTRY_OF_FINANCE_CONTACT_EMAIL, "v_mofed_cont_email");
		addTextColumn(ColumnConstants.MINISTRY_OF_FINANCE_CONTACT_FAX, "v_mofed_cont_fax");
		addTextColumn(ColumnConstants.MINISTRY_OF_FINANCE_CONTACT_NAME, "v_mofed_cont_name");
		addTextColumn(ColumnConstants.MINISTRY_OF_FINANCE_CONTACT_ORGANIZATION, "v_mofed_cont_org");
		addTextColumn(ColumnConstants.MINISTRY_OF_FINANCE_CONTACT_PHONE, "v_mofed_cont_phone");
		addTextColumn(ColumnConstants.MINISTRY_OF_FINANCE_CONTACT_TITLE, "v_mofed_cont_title");
		addTextColumn(ColumnConstants.MULTI_DONOR, "v_multi_donor");
		addTextColumn(ColumnConstants.PHYSICAL_PROGRESS_DESCRIPTION, "v_physical_description");
		addTextColumn(ColumnConstants.PHYSICAL_PROGRESS_TITLE, "v_physical_title");
		addTextColumn(ColumnConstants.PROJECT_CODE, "v_project_code");
		addTextColumn(ColumnConstants.PROJECT_COORDINATOR_CONTACT_EMAIL, "v_proj_coordr_cont_email");
		addTextColumn(ColumnConstants.PROJECT_COORDINATOR_CONTACT_FAX, "v_proj_coordr_cont_fax");
		addTextColumn(ColumnConstants.PROJECT_COORDINATOR_CONTACT_NAME, "v_proj_coordr_cont_name");
		addTextColumn(ColumnConstants.PROJECT_COORDINATOR_CONTACT_ORGANIZATION, "v_proj_coordr_cont_org");
		addTextColumn(ColumnConstants.PROJECT_COORDINATOR_CONTACT_PHONE, "v_proj_coordr_cont_phone");
		addTextColumn(ColumnConstants.PROJECT_COORDINATOR_CONTACT_TITLE, "v_proj_coordr_cont_title");
		addTextColumn(ColumnConstants.PROPOSED_PROJECT_LIFE, "v_proposed_project_life");
		addTextColumn(ColumnConstants.REPORTING_SYSTEM, "v_reporting_system");
		addTextColumn(ColumnConstants.SECTOR_MINISTRY_CONTACT_EMAIL, "v_sect_min_cont_email");
		addTextColumn(ColumnConstants.SECTOR_MINISTRY_CONTACT_FAX, "v_sect_min_cont_fax");
		addTextColumn(ColumnConstants.SECTOR_MINISTRY_CONTACT_NAME, "v_sect_min_cont_name");
		addTextColumn(ColumnConstants.SECTOR_MINISTRY_CONTACT_PHONE, "v_sect_min_cont_phone");
		addTextColumn(ColumnConstants.SECTOR_MINISTRY_CONTACT_TITLE, "v_sect_min_cont_title");
		addTextColumn(ColumnConstants.SUB_VOTE, "v_subvote");
		addTextColumn(ColumnConstants.VOTE, "v_vote");
