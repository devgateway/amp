	...
	public AmpActivityFormFeature(String id, final IModel<AmpActivityVersion> am,
		...
		activityForm.add(new Behavior(){
			...
			public void renderHead(Component component, IHeaderResponse response) {
				...
				response.renderJavaScriptReference(new PackageResourceReference(AmpActivityFormFeature.class, "saveNavigationPanel.js"));
			}
		});
		...
		preview.getButton().add(new AttributeModifier("class", true, new Model<String>("sideMenuButtons")));
		if (am.getObject().getAmpActivityId() == null)
