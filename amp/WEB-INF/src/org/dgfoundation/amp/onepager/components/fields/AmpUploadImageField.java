 ...
 * @author mmoras
 */
public class AmpUploadImageField extends AmpFeaturePanel {
	...
	public AmpUploadImageField(String id, IModel model, String fmName, final AmpResourcesFormTableFeature resourcesList, boolean newResourceIsWebLink) throws Exception {
