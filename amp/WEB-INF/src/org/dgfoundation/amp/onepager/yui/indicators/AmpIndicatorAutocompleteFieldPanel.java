package org.dgfoundation.amp.onepager.yui.indicators;
...
public abstract class AmpIndicatorAutocompleteFieldPanel extends
        AmpAutocompleteFieldPanel<AmpIndicator> {
    private static final long serialVersionUID = 1L;
    private static Map<Long,AmpContact> reusableObjects = new HashMap<Long,AmpContact>();


    public AmpIndicatorAutocompleteFieldPanel(
            String id,
            String fmName,
            boolean hideLabel,
            Class<? extends AbstractAmpAutoCompleteModel<AmpIndicator>> objectListModelClass,
            String aditionalTooltipKey, boolean showTooltipIfLabelHidden) {
        super(id, fmName, hideLabel, objectListModelClass,
                AmpIndicatorAutocompleteFieldPanel.class,
