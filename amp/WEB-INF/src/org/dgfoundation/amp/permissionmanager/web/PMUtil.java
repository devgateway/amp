...
//		cp.setName(cpModel.getObject().getName());
	...
	public static void initializeAndSaveGatePermission(Session session, CompositePermission cp, AmpPMGateReadEditWrapper ampPMGateWrapper) throws HibernateException {
	...
	public static void assignGlobalPermission(PermissionMap pm, Set<AmpPMGateReadEditWrapper> gatesSet) {
		// TODO Auto-generated method stub
		Session session = null;
			try {
	...
	public static void generateGatesList(Object o, Set<AmpPMGateReadEditWrapper> gatesSet){
	...
	public static void generateDefaultGatesList(Set<AmpPMGateReadEditWrapper> gatesSet){
