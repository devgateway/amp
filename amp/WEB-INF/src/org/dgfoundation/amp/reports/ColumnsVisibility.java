...
public class ColumnsVisibility extends DataVisibility {
	...
	protected static final Map<String, String> modulesToColumnsMap = new HashMap<String, String>() {{
		...
		put("/Activity Form/Related Organizations/Beneficiary Agency", ColumnConstants.BENEFICIARY_AGENCY);
		put("/Activity Form/Related Organizations/Contracting Agency", ColumnConstants.CONTRACTING_AGENCY);
		put("/Activity Form/Related Organizations/Donor Organization", ColumnConstants.DONOR_AGENCY);
		put("/Activity Form/Related Organizations/Executing Agency", ColumnConstants.EXECUTING_AGENCY);
		put("/Activity Form/Related Organizations/Implementing Agency", ColumnConstants.IMPLEMENTING_AGENCY);
		put("/Activity Form/Related Organizations/Regional Group", ColumnConstants.REGIONAL_GROUP);
		put("/Activity Form/Related Organizations/Responsible Organization", ColumnConstants.RESPONSIBLE_ORGANIZATION);
		put("/Activity Form/Related Organizations/Sector Group", ColumnConstants.SECTOR_GROUP);
