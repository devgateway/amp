...
public class ColumnsVisibility extends DataVisibility implements FMSettings {
	...
	protected static final Map<String, String> fieldsToColumnsMap = new HashMap<String, String>() {{
		...
		put("Cumulative Commitment", MeasureConstants.CUMULATIVE_COMMITMENT);
		put("Cumulative Disbursement", MeasureConstants.CUMULATIVE_DISBURSEMENT);
		...
		put(MeasureConstants.UNCOMMITTED_CUMULATIVE_BALANCE, MeasureConstants.UNCOMMITTED_CUMULATIVE_BALANCE);
		put(MeasureConstants.UNDISBURSED_CUMULATIVE_BALANCE, MeasureConstants.UNDISBURSED_CUMULATIVE_BALANCE);
