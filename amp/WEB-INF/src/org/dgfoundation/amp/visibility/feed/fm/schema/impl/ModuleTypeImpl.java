...
public class ModuleTypeImpl implements org.dgfoundation.amp.visibility.feed.fm.schema.ModuleType, com.sun.xml.bind.JAXBObject, org.dgfoundation.amp.visibility.feed.fm.schema.impl.runtime.UnmarshallableObject, org.dgfoundation.amp.visibility.feed.fm.schema.impl.runtime.XMLSerializable, org.dgfoundation.amp.visibility.feed.fm.schema.impl.runtime.ValidatableObject
{
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Feature == null)? 0 :_Feature.size());
        if (!has_Visible) {
        ...
        while (idx1 != len1) {
            ...
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Feature.get(idx_0 ++)), "Feature");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Feature.get(idx_1 ++)), "Feature");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Feature.get(idx1 ++)), "Feature");
            context.endElement();
        }
    }
...
+"w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0007featuret\u00009http:/"
...
+"\u0000~\u00008q\u0000~\u0000Dq\u0000~\u00001sq\u0000~\u0000 t\u0000\u0004namet\u0000\u0000sq\u0000~\u0000\u0016ppsq\u0000~\u0000\'ppsr\u0000$com.sun.ms"
+"v.datatype.xsd.BooleanType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000,q\u0000~\u00001t\u0000\u0007booleanq\u0000"
                ...
                switch (state) {
                    ...
                    case  7 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _getFeature().add(((org.dgfoundation.amp.visibility.feed.fm.schema.impl.FeatureTypeImpl) spawnChildFromEnterAttribute((org.dgfoundation.amp.visibility.feed.fm.schema.impl.FeatureTypeImpl.class), 8, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  3 :
