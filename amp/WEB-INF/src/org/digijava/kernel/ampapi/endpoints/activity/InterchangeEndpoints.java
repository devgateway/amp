...
public class InterchangeEndpoints implements ErrorReportingEndpoint {
	...
	@ApiMethod(authTypes = {AuthRule.AUTHENTICATED, AuthRule.IN_WORKSPACE}, id = "getValues", ui = false)
	...
	@Path("fields")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	@ApiMethod(authTypes = {AuthRule.AUTHENTICATED, AuthRule.IN_WORKSPACE}, id = "getFields", ui = false)
	...
	@Path("/projects")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	@ApiMethod(authTypes = {AuthRule.AUTHENTICATED, AuthRule.IN_WORKSPACE}, id = "getProjectList", ui = false)
	...
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	@ApiMethod(authTypes = {AuthRule.AUTHENTICATED, AuthRule.VIEW_ACTIVITY}, id = "getProject", ui = false)
	...
	@Path("/projects/{projectId}")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	@ApiMethod(authTypes = {AuthRule.AUTHENTICATED, AuthRule.VIEW_ACTIVITY}, id = "getProjectsFilter", ui = false)
	...
	@Path("/")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	@ApiMethod(authTypes = {AuthRule.AUTHENTICATED, AuthRule.ADD_ACTIVITY}, id = "addProject", ui = false)
	...
	@Path("/{projectId}")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	@ApiMethod(authTypes = {AuthRule.AUTHENTICATED, AuthRule.EDIT_ACTIVITY}, id = "updateProject", ui = false)
