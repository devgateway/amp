...
public final class ValidationErrors {
    ...
    public static final ApiErrorMessage INDICATORS_NOT_BELONG_TO_PROGRAM_SCHEME = new ApiErrorMessage(ERROR_CLASS_ACTIVITY_ID, 23,
            "Some indicators in this activity do not belong to the set Program Scheme.");
