...
public class FMSettingsConfig {
    ...
    @JsonProperty(EPConstants.DETAILS_FLAT)
    @ApiModelProperty(value = "if to detail as a flat list or in a tree form", example = "true")
    private Boolean detailsFlat = true;
