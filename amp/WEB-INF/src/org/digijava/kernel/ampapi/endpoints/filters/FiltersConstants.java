...
public class FiltersConstants {
    ...
    public static final String PLEDGES_SECTORS_SUB_SECTORS = "pledges-sub-sectors";
    public static final String PLEDGES_SECTORS_SUB_SUB_SECTORS = "pledges-sub-sub-sectors";
    public static final String PLEDGES_SECONDARY_SECTORS = "pledges-secondary-sectors";
    public static final String PLEDGES_SECONDARY_SECTORS_SUB_SECTORS = "pledges-secondary-sub-sectors";
    public static final String PLEDGES_SECONDARY_SECTORS_SUB_SUB_SECTORS = "pledges-secondary-sub-sub-sectors";
    public static final String PLEDGES_TERTIARY_SECTORS = "pledges-tertiary-sectors";
    public static final String PLEDGES_TERTIARY_SUB_SECTORS = "pledges-tertiary-sub-sectors";
    public static final String PLEDGES_TERTIARY_SUB_SUB_SECTORS = "pledges-tertiary-sub-sub-sectors";
    public static final String PLEDGES_QUATERNARY_SECTORS = "pledges-quaternary-sectors";
    public static final String PLEDGES_QUATERNARY_SUB_SECTORS = "pledges-quaternary-sub-sectors";
    public static final String PLEDGES_QUATERNARY_SUB_SUB_SECTORS = "pledges-quaternary-sub-sub-sectors";
    public static final String PLEDGES_QUINARY_SECTORS = "pledges-quinary-sectors";
    public static final String PLEDGES_QUINARY_SUB_SECTORS = "pledges-quinary-sub-sectors";
    public static final String PLEDGES_QUINARY_SUB_SUB_SECTORS = "pledges-quinary-sub-sub-sectors";
