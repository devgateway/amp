...
public class FiltersConstants {
    ...
    public static final String PLEDGES_ADM_LEVEL_0 = "pledges-adm-level-0";
    public static final String PLEDGES_ADM_LEVEL_1 = "pledges-adm-level-1";
    public static final String PLEDGES_ADM_LEVEL_2 = "pledges-adm-level-2";
    public static final String PLEDGES_ADM_LEVEL_3 = "pledges-adm-level-3";
    public static final String PLEDGES_ADM_LEVEL_4 = "pledges-adm-level-4";
