...
public class ReportErrors {
    ...
    public static final ApiErrorMessage LIST_NAME_REQUIRED = new ApiErrorMessage(2, "List name not specified: ");
    public static final ApiErrorMessage LIST_INVALID = new ApiErrorMessage(3, "Not allowed / invalid listName: ");
