...
public final class MoConstants {
	...
	public static final String H_ACTIVITY_STATUS = "Status Hierarchy";
	public static final String H_MODALITIES = "Modalities Hierarchy";
	public static final String H_TYPE_OF_COOPERATION = "Type of Cooperation Hierarchy";
	public static final String H_TYPE_OF_IMPLEMENTATION = "Type of Implementation Hierarchy";
	public static final String H_PROCUREMENT_SYSTEM = "Procurement System Hierarchy";
	public static final String H_FUNDING_STATUS = "Funding Status Hierarchy";
	public static final String H_MODE_OF_PAYMENT = "Mode of Payment Hierarchy";
	public static final String H_FINANCING_INSTRUMENT = "Financing Instrument Hierarchy";
	public static final String H_TYPE_OF_ASSISTANCE = "Type Of Assistance Hierarchy";
	...
	public static final String ATTR_ACTIVITY_STATUS = "Status Name";
	public static final String ATTR_MODALITIES = "Modalities Name";
	public static final String ATTR_TYPE_OF_COOPERATION = "Type of Cooperation Name";
	public static final String ATTR_TYPE_OF_IMPLEMENTATION = "Type of Implementation Name";
	public static final String ATTR_PROCUREMENT_SYSTEM = "Procurement System Name";
	public static final String ATTR_FUNDING_STATUS = "Funding Status Name";
	public static final String ATTR_MODE_OF_PAYMENT = "Mode of Payment Name";
	public static final String ATTR_FINANCING_INSTRUMENT = "Financing Instrument Name";
	public static final String ATTR_TYPE_OF_ASSISTANCE = "Type Of Assistance Name";
