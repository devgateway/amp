...
public class MondrianMapping {
	...
	*/
	...
	private static final Map<NamedTypedEntity,MDXElement> entityMap = new HashMap<NamedTypedEntity, MDXElement>() {{
			...
			put(new ReportColumn(ColumnConstants.APPROVAL_STATUS, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_APPROVAL_STATUS, MoConstants.ATTR_APPROVAL_STATUS));
			...
			put(new ReportColumn(ColumnConstants.FY, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_FY, MoConstants.ATTR_FY));
			put(new ReportColumn(ColumnConstants.VOTE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_VOTE, MoConstants.ATTR_VOTE));
			put(new ReportColumn(ColumnConstants.SUB_VOTE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_SUB_VOTE, MoConstants.ATTR_SUB_VOTE));
			put(new ReportColumn(ColumnConstants.PROJECT_CODE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_CODE, MoConstants.ATTR_PROJECT_CODE));
			put(new ReportColumn(ColumnConstants.MINISTRY_CODE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_MINISTRY_CODE, MoConstants.ATTR_MINISTRY_CODE));
			put(new ReportColumn(ColumnConstants.CRIS_NUMBER, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_CRIS_NUMBER, MoConstants.ATTR_CRIS_NUMBER));
			put(new ReportColumn(ColumnConstants.PROJECT_IMPLEMENTING_UNIT, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_IMPLEMENTING_UNIT, MoConstants.ATTR_PROJECT_IMPLEMENTING_UNIT));
			put(new ReportColumn(ColumnConstants.PROJECT_HAS_BEEN_APPROVED_BY_IMAC, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_APPROVED_BY_IMAC, MoConstants.ATTR_PROJECT_APPROVED_BY_IMAC));
			put(new ReportColumn(ColumnConstants.GOVERNMENT_IS_MEMBER_OF_PROJECT_STEERING_COMMITTEE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_GOVERNMENT_IN_STEERING_COMMITTEE, MoConstants.ATTR_GOVERNMENT_IN_STEERING_COMMITTEE));
			put(new ReportColumn(ColumnConstants.PROJECT_IS_ON_BUDGET, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_ON_BUDGET, MoConstants.ATTR_PROJECT_ON_BUDGET));
			put(new ReportColumn(ColumnConstants.PROJECT_IS_ON_PARLIAMENT, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_ON_PARLIAMENT, MoConstants.ATTR_PROJECT_ON_PARLIAMENT));
			put(new ReportColumn(ColumnConstants.PROJECT_DISBURSES_DIRECTLY_INTO_THE_GOVERNMENT_SINGLE_TREASURY_ACCOUNT, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_DISBURSES_DIRECTLY_INTO_GOVERNMENT_TREASURY, MoConstants.ATTR_PROJECT_DISBURSES_DIRECTLY_INTO_GOVERNMENT_TREASURY));
			put(new ReportColumn(ColumnConstants.PROJECT_USES_NATIONAL_FINANCIAL_MANAGEMENT_SYSTEMS, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_USES_NATIONAL_FIN_MNG_SYSTEMS, MoConstants.ATTR_PROJECT_USES_NATIONAL_FIN_MNG_SYSTEMS));
			put(new ReportColumn(ColumnConstants.PROJECT_USES_NATIONAL_PROCUREMENT_SYSTEMS, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_USES_NATIONAL_PROCURMENT_SYSTEMS, MoConstants.ATTR_PROJECT_USES_NATIONAL_PROCURMENT_SYSTEMS));
			put(new ReportColumn(ColumnConstants.PROJECT_USES_NATIONAL_AUDIT_SYSTEMS, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROJECT_USES_NATIONAL_AUDIT_SYSTEMS, MoConstants.ATTR_PROJECT_USES_NATIONAL_AUDIT_SYSTEMS));
			put(new ReportColumn(ColumnConstants.PROPOSED_PROJECT_LIFE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_FIXED_TEXTS, MoConstants.H_PROPOSED_PROJECT_LIFE, MoConstants.ATTR_PROPOSED_PROJECT_LIFE));
