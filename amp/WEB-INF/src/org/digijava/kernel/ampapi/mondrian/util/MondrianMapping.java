...
public class MondrianMapping {
	...
	*/
	...
	private static final Map<NamedTypedEntity,MDXElement> entityMap = new HashMap<NamedTypedEntity, MDXElement>() {{
			...
			put(new ReportColumn(ColumnConstants.PROJECT_DESCRIPTION, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_PROJECT_DESCRIPTION, MoConstants.ATTR_PROJECT_DESCRIPTION));
			put(new ReportColumn(ColumnConstants.OBJECTIVE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_OBJECTIVE, MoConstants.ATTR_OBJECTIVE));
			put(new ReportColumn(ColumnConstants.RESULTS, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_RESULTS, MoConstants.ATTR_RESULTS));
			put(new ReportColumn(ColumnConstants.PURPOSE, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_PURPOSE, MoConstants.ATTR_PURPOSE));
			put(new ReportColumn(ColumnConstants.PROJECT_COMMENTS, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_PROJECT_COMMENTS, MoConstants.ATTR_PROJECT_COMMENTS));
			put(new ReportColumn(ColumnConstants.PROJECT_IMPACT, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_PROJECT_IMPACT, MoConstants.ATTR_PROJECT_IMPACT));
			put(new ReportColumn(ColumnConstants.EQUAL_OPPORTUNITY, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_EQUAL_OPPORTUNITY, MoConstants.ATTR_EQUAL_OPPORTUNITY));
			put(new ReportColumn(ColumnConstants.ENVIRONMENT, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_ENVIRONMENT, MoConstants.ATTR_ENVIRONMENT));
			put(new ReportColumn(ColumnConstants.MINORITIES, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_MINORITIES, MoConstants.ATTR_MINORITIES));
			put(new ReportColumn(ColumnConstants.PROGRAM_DESCRIPTION, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.ACTIVITY_TEXTS, MoConstants.H_PROGRAM_DESCRIPTION, MoConstants.ATTR_PROGRAM_DESCRIPTION));
			...
			put(new ReportColumn(ColumnConstants.PRIMARY_SECTOR, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.PRIMARY_SECTOR, MoConstants.H_PRIMARY_SECTOR, MoConstants.ATTR_PRIMARY_SECTOR_NAME));
			put(new ReportColumn(ColumnConstants.SECONDARY_SECTOR, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.SECONDARY_SECTOR, MoConstants.H_SECONDARY_SECTOR, MoConstants.ATTR_SECONDARY_SECTOR_NAME));
			put(new ReportColumn(ColumnConstants.TERTIARY_SECTOR, ReportEntityType.ENTITY_TYPE_ACTIVITY), new MDXLevel(MoConstants.TERTIARY_SECTOR, MoConstants.H_TETRIARY_SECTOR, MoConstants.ATTR_SECONDARY_SECTOR_NAME));
			put(new ReportColumn(ColumnConstants.PLEDGES_SECTORS, ReportEntityType.ENTITY_TYPE_PLEDGE), new MDXLevel(MoConstants.PRIMARY_SECTOR, MoConstants.H_PRIMARY_SECTOR, MoConstants.ATTR_PRIMARY_SECTOR_NAME));
			put(new ReportColumn(ColumnConstants.PLEDGES_SECONDARY_SECTORS, ReportEntityType.ENTITY_TYPE_PLEDGE), new MDXLevel(MoConstants.SECONDARY_SECTOR, MoConstants.H_SECONDARY_SECTOR, MoConstants.ATTR_SECONDARY_SECTOR_NAME));
			put(new ReportColumn(ColumnConstants.PLEDGES_TERTIARY_SECTORS, ReportEntityType.ENTITY_TYPE_PLEDGE), new MDXLevel(MoConstants.TERTIARY_SECTOR, MoConstants.H_TETRIARY_SECTOR, MoConstants.ATTR_SECONDARY_SECTOR_NAME));
