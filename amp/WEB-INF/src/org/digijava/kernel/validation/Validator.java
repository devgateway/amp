...
public class Validator {
     ...
     * @param translationContext context object for accessing translated values
     ...
     */
    public Set<ConstraintViolation> validate(APIField type, Object value,
            TranslationContext translationContext, Class<?>... groups) {
        ...
        validate(type, value, translationContext, ImmutableSet.copyOf(groups), validationContext, path);
    ...
    private void validate(APIField type, Object value, TranslationContext translationContext,
        ...
        for (APIField field : type.getChildren()) {
            ...
            if (fieldValue != null) {
                cascadeValidationForObjects(field, fieldValue, translationContext, groups, validationContext,
                        fieldPath);
            }
        }
    }
     ...
     * @param path current path
     */
    private void cascadeValidationForObjects(APIField type, Object value,
        ...
        if (type.getApiType().isAnObject()) {
            ...
            for (Object el : subFieldValueList) {
                if (el != null) {
                    validate(type, el, translationContext, groups, validationContext, path);
                }
            }
        }
    }
     ...
     * @param translatedValueContext context object for accessing translated values
     * @param groups validation groups
     * @return constraint violations if any
     */
    public Set<ConstraintViolation> validateField(APIField field, Object value,
        ...
        validateField(field, value, translatedValueContext, ImmutableSet.copyOf(groups), validationContext, fieldPath);
     ...
     * @param path current path
     */
    private void validateField(APIField field, Object value, TranslatedValueContext translatedValueContext,
            Set<Class<?>> groups, ValidationContext validationContext, PathImpl path) {
