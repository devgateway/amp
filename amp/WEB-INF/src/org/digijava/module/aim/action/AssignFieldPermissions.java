...
//session.flush();
		...
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Beneficiary Agency Permission","BA",OrgRoleGate.class,fpf.getBaRead(),fpf.getBaEdit(),"This permission has been generated by the Feature Manager permission popup");
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Contracting Agency Permission","CA",OrgRoleGate.class,fpf.getCaRead(),fpf.getCaEdit(),"This permission has been generated by the Feature Manager permission popup");		
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Executing Agency Permission","EA",OrgRoleGate.class,fpf.getEaRead(),fpf.getEaEdit(),"This permission has been generated by the Feature Manager permission popup");
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Implementing Agency Permission","IA",OrgRoleGate.class,fpf.getIaRead(),fpf.getIaEdit(),"This permission has been generated by the Feature Manager permission popup");
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Responsible Agency Permission","RO",OrgRoleGate.class,fpf.getRoRead(),fpf.getRoEdit(),"This permission has been generated by the Feature Manager permission popup");
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Funding Agency Permission","DN",OrgRoleGate.class,fpf.getFaRead(),fpf.getFaEdit(),"This permission has been generated by the Feature Manager permission popup");		
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Regional Group Permission","RG",OrgRoleGate.class,fpf.getRgRead(),fpf.getRgEdit(),"This permission has been generated by the Feature Manager permission popup");	
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Sector Group Permission","SG",OrgRoleGate.class,fpf.getSgRead(),fpf.getSgEdit(),"This permission has been generated by the Feature Manager permission popup");
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Everyone Permission",UserLevelGate.PARAM_EVERYONE,UserLevelGate.class,fpf.getEvRead(),fpf.getEvEdit(),"This permission has been generated by the Feature Manager permission popup");
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Guest Permission",UserLevelGate.PARAM_GUEST,UserLevelGate.class,fpf.getGuRead(),fpf.getGuEdit(),"This permission has been generated by the Feature Manager permission popup");
		PMUtil.initializeAndSaveGatePermission(session,cp,afv.getName()+ " - Owner Permission",UserLevelGate.PARAM_OWNER,UserLevelGate.class,fpf.getOwRead(),fpf.getOwEdit(),"This permission has been generated by the Feature Manager permission popup");
		session.save(cp);
