...
public class ExportActivityToWord extends Action {
	...
	private void processPlanningPart(HttpServletRequest request,
		...
		if(FeaturesUtil.isVisibleModule("/Activity Form/Planning/current completion date", ampContext)){
			columnName=TranslatorWorker.translateText("current completion date"+": ",request);
