...
public class ViewMyMessage extends Action {

	private static Logger logger = Logger.getLogger(ViewMyMessage.class);
			...
			HttpServletRequest request, HttpServletResponse response) throws java.lang.Exception
	{
		...
		if (teamMember.getTeamHead()) { // // checking user is a TL of a working team
			...
			logger.debug("request.getParameter is : " + showMessage);
			
			if (showMessage == null || showMessage.equals(""))
				return mapping.findForward("view");
			else if ("showMessage".equals(showMessage))
