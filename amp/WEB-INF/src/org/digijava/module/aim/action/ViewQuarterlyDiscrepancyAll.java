...
import org.digijava.module.aim.form.QuarterlyDiscrepancyAllForm;
...
public class ViewQuarterlyDiscrepancyAll extends TilesAction	{
	private static Logger logger = Logger.getLogger(ViewQuarterlyDiscrepancyAll.class);
	...
	public ActionForward execute(ComponentContext context,
		...
		QuarterlyDiscrepancyAllForm formBean = (QuarterlyDiscrepancyAllForm) form;		
