...
import org.digijava.module.aim.form.RegionalObservationsForm;
...
public class ViewRegionalObservations extends TilesAction {
	...
	public ActionForward execute(ComponentContext context, ActionMapping mapping, ActionForm form,
		...
		RegionalObservationsForm formBean = (RegionalObservationsForm) form;
		...
		if (teamMember == null) {
			...
			formBean.setIssues(ActivityUtil.getRegionalObservations(ampActivityId));
		}
		return null;
	}
}
