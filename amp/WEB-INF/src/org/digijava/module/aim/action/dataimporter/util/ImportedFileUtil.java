...
public class ImportedFileUtil {
    ...
    public static ImportedFilesRecord saveFile(File file, String filename) throws IOException, NoSuchAlgorithmException {
        ...
        String sql = "INSERT INTO imported_files_record (nextval('IMPORTED_FILES_RECORD_SEQ'), file_hash, import_status, file_name) VALUES (:fileHash, :importStatus, :fileName)";
