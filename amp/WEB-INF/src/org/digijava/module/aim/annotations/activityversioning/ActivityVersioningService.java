 ...
 public class ActivityVersioningService {
    ...
    public static Map<String, List<CompareOutput>> compareActivities(Long activityOneId) throws Exception {
        ...
        ActivityVersionUtil.initializeActivity(ampActivityOne);
         ...
         AmpActivityGroup auxActivityGroup = (AmpActivityGroup) session.load(AmpActivityGroup.class, ampActivityOne.getAmpActivityGroup().getAmpActivityGroupId());
               
         Set <AmpActivityVersion > activites = auxActivityGroup.getActivities();
         
        // Long  cc = auxActivityGroup.getAmpActivityGroupId();
         
         Long av = new AmpActivityVersion().getAmpActivityId();
         
        // ActivityVersioningService avs = 
         
         //ActivityVersionUtil u= cc.get
         
         
         Iterator iterAct = activites.iterator();
         
         while(iterAct.hasNext())
         {
        	 Object actid = iterAct.next();
        	 
        	 if(av==activityOneId)
        	 {
        		 activityTwoId = activityOneId-1;
        		 
        	 }
        	 
         }
         
//         Long activityTwoId =activityOneId;
//         = auxActivityGroup.getActivities();
//            .getAmpActivityLastVersion();
