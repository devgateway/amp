    ...
    public Output getOutput() {
        ...
        while (iter.hasNext()) {
            ...
            if (!error) {
                ...
                if (auxDetail.getRecipientOrg() != null && auxDetail.getRecipientRole() != null) recipientInfo = String.format(" to %s as %s", auxDetail.getRecipientOrg().getName(), auxDetail.getRecipientRole().getName());
