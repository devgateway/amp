...
public class GlobalSettingsConstants {
    ...
    public static final String ALERT_IF_DISBURSMENT_BIGGER_COMMITMENTS =
            "Alert if sum of disbursements is bigger than sum of commitments";

    public static final String ALERT_IF_EXPENDITURE_BIGGER_DISBURSMENT =
            "Alert if sum of expenditures is bigger than sum of disbursments";
    ...
    public static final String AUTOMATICALLY_CLOSE_ACTIVITIES =
            "Change activity status once the Actual End Date has passed";
    ...
    public static final String UNLINKED_FUNDING_IN_PLEDGES_REPORTS =
            "Unlinked commitments and disburesements in pledges reports";
    ...
    public static final String NUMBER_OF_DAYS_BEFORE_AUTOMATIC_VALIDATION =
            "Number of days before automatic validation";
    ...
    public static final String EXEMPT_ORGANIZATION_REPORT = "Exempt organization to see reports";
