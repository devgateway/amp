...
/*    public static ArrayList getAmpModality() {
    ...
    public static Collection searchForOrganisation(String namesFirstLetter, String keyword, Long orgType) {
        ...
        try {
            session = PersistenceManager.getRequestDBSession();
            String queryString = "select distinct org from " + AmpOrganisation.class.getName() + " org inner join org.orgGrpId grp "
...
//beginTransaction();
            ...
            /*if (org.getAmpOrgId() != null) {
				...
				if (admin) {
					...
					if (locations != null) {
						Iterator<AmpOrgLocation> locationIter = locations
								.iterator();
						while (locationIter.hasNext()) {
							AmpOrgLocation location = locationIter.next();
							if (location.getAmpOrgLocId() != null) {
								AmpOrgLocation oldLocation = (AmpOrgLocation) sess
										.get(AmpOrgLocation.class,
												location.getAmpOrgLocId());
...
*/
    ...
    public static Collection getAllDonorOrgs() {
        ...
        try {
            session = PersistenceManager.getRequestDBSession();
            String queryString = "select distinct org from " + AmpFunding.class.getName()+" f inner join f.ampDonorOrgId org "
