...
/**
 * <p>Ensure that percentages sum up to 100 for all activity locations.</p>
 *
 * <p>This validator does not check if a location is included twice (either directly or indirectly).</p>
 *
...
@Constraint(validatedBy = LocationTotalPercentageValidator.class)
public @interface LocationTotalPercentage {
