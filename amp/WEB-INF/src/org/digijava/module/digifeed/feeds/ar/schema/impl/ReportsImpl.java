...
public class ReportsImpl
    extends org.digijava.module.digifeed.feeds.ar.schema.impl.ReportsTypeImpl
    implements org.digijava.module.digifeed.feeds.ar.schema.Reports, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, org.digijava.module.digifeed.feeds.ar.schema.impl.runtime.UnmarshallableObject, org.digijava.module.digifeed.feeds.ar.schema.impl.runtime.XMLSerializable, org.digijava.module.digifeed.feeds.ar.schema.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.digijava.module.digifeed.feeds.ar.schema.Reports.class);
    }

    public java.lang.String ____jaxb_ri____getNamespaceURI() {
        return "http://digijava.org/module/digifeed/feeds/ar/schema.xml";
    }
    ...
    public org.digijava.module.digifeed.feeds.ar.schema.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.digijava.module.digifeed.feeds.ar.schema.impl.runtime.UnmarshallingContext context) {
        return new org.digijava.module.digifeed.feeds.ar.schema.impl.ReportsImpl.Unmarshaller(context);
    }

    public void serializeBody(org.digijava.module.digifeed.feeds.ar.schema.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://digijava.org/module/digifeed/feeds/ar/schema.xml", "reports");
...
+"~\u0000\u001bt\u00007org.digijava.module.digifeed.feeds.ar.schema.ReportTyp"
...
+"ema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0006reportt\u00007http://digijava.org/modul"
+"e/digifeed/feeds/ar/schema.xmlsq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009"
+"q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0007reportsq\u0000~\u0000>sr\u0000\"com.sun.msv.grammar.Expression"
...
+"~\u0000\fq\u0000~\u0000$q\u0000~\u0000?x"));
        ...
        extends org.digijava.module.digifeed.feeds.ar.schema.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.digijava.module.digifeed.feeds.ar.schema.impl.ReportsImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("reports" == ___local)&&("http://digijava.org/module/digifeed/feeds/ar/schema.xml" == ___uri)) {
                    ...
                    case  1 :
                        if (("report" == ___local)&&("http://digijava.org/module/digifeed/feeds/ar/schema.xml" == ___uri)) {
                            spawnHandlerFromEnterElement((((org.digijava.module.digifeed.feeds.ar.schema.impl.ReportsTypeImpl)org.digijava.module.digifeed.feeds.ar.schema.impl.ReportsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
