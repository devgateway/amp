...
public class XlsHelper {
	...
	protected FundingCalculationsHelper getTotalsForActivity(AmpActivityVersion aA, String currencyCode)
	{
		...
		while (fundItr.hasNext()) {
			AmpFunding ampFunding = (AmpFunding) fundItr.next();
			boolean relevantFunding = (ampFunding.getSourceRole() == null) ||
					((ampFunding.getSourceRole() != null) & (ampFunding.getSourceRole().getRoleCode().equals(Constants.ROLE_CODE_DONOR)));
			if (!relevantFunding)
				continue;
