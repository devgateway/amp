...
/**
 * This class represents each row in the GPI 9b report.
 * 
 * @author gabriel
 */
public class GPIReport9bRow extends GPIReportAbstractRow {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof GPIReport9bRow))
            return false;
        GPIReport9bRow other = (GPIReport9bRow) obj;
        if (column1 == null) {
