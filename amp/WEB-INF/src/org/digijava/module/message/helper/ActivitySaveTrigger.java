...
public class ActivitySaveTrigger extends Trigger {
	...
	public static final String[] parameterNames = new String[] { PARAM_NAME,
			PARAM_CREATED_DATE, PARAM_CREATED_BY, PARAM_URL };

	public ActivitySaveTrigger(Object source) {
		if (!(source instanceof AmpActivity))
			throw new RuntimeException(
					"Incompatible object. Source must be an AmpActivity!");
		this.source = source;
		forwardEvent();
	}
	...
	protected Event generateEvent() {
		...
		e.getParameters().put(PARAM_URL,
				"http://....?ampActivityId=" + act.getAmpActivityId());
		return e;
	}
