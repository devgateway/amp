 ...
 * 
 *A cell formatter modifies the behavior of Cell.getFormattedValue(). The class must implement the
 * mondrian.olap.CellFormatter interface, and is specified like this:
 *<Measure name="name" formatter="com.acme.MyCellFormatter">
 *        <CalculatedMemberProperty />
 *</Measure>
 *For a calculated member that belongs to a cube or virtual cube, you can define a formatter by setting the 
...
public class TotalCellFromat implements CellFormatter{
