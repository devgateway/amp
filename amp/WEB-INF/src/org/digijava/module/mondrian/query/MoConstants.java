...
public final class MoConstants {
	...
	public static String PRIMARY_PROGRAM_LEVEL_1 = "Primary Program Level 1";
	public static String PRIMARY_PROGRAM_LEVEL_2 = "Primary Program Level 2";
	public static String PRIMARY_PROGRAM_LEVEL_3 = "Primary Program Level 3";
	public static String PRIMARY_PROGRAM_LEVEL_4 = "Primary Program Level 4";
	public static String PRIMARY_PROGRAM_LEVEL_5 = "Primary Program Level 5";
	public static String PRIMARY_PROGRAM_LEVEL_6 = "Primary Program Level 6";
	public static String PRIMARY_PROGRAM_LEVEL_7 = "Primary Program Level 7";
	public static String PRIMARY_PROGRAM_LEVEL_8 = "Primary Program Level 8";
	
	public static String SECONDARY_PROGRAMS = "Secondary Program";
	public static String SECONDARY_PROGRAMS_LEVEL_1 = "Secondary Program Level 1";
	public static String SECONDARY_PROGRAMS_LEVEL_2 = "Secondary Program Level 2";
	public static String SECONDARY_PROGRAMS_LEVEL_3 = "Secondary Program Level 3";
	public static String SECONDARY_PROGRAMS_LEVEL_4 = "Secondary Program Level 4";
	public static String SECONDARY_PROGRAMS_LEVEL_5 = "Secondary Program Level 5";
	public static String SECONDARY_PROGRAMS_LEVEL_6 = "Secondary Program Level 6";
	public static String SECONDARY_PROGRAMS_LEVEL_7 = "Secondary Program Level 7";
	public static String SECONDARY_PROGRAMS_LEVEL_8 = "Secondary Program Level 8";
	
	public static  String NATIONAL_PROGRAM= "National Planning Objectives";
	public static  String NATIONAL_PROGRAM_LEVEL_1= "National Planning Objectives Level 1";
	public static  String NATIONAL_PROGRAM_LEVEL_2= "National Planning Objectives Level 2";
	public static  String NATIONAL_PROGRAM_LEVEL_3= "National Planning Objectives Level 3";
	public static  String NATIONAL_PROGRAM_LEVEL_4= "National Planning Objectives Level 4";
	public static  String NATIONAL_PROGRAM_LEVEL_5= "National Planning Objectives Level 5";
	public static  String NATIONAL_PROGRAM_LEVEL_6= "National Planning Objectives Level 6";
	public static  String NATIONAL_PROGRAM_LEVEL_7= "National Planning Objectives Level 7";
	public static  String NATIONAL_PROGRAM_LEVEL_8= "National Planning Objectives Level 8";
	...
	public static String SEC_SUB_SECTORS = "Secondary Sector Sub-Sector";
