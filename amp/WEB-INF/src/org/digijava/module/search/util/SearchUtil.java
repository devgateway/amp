...
public class SearchUtil {
	...
	public static Collection<LoggerIdentifiable> getActivities(String keyword, HttpServletRequest request, TeamMember tm) {
		...
		try {
			...
			String newQueryString = String.format("SELECT f.amp_activity_id, f.amp_id, %s AS name FROM amp_activity f WHERE f.amp_activity_id in ("+filter.getGeneratedFilterQuery()+")",
