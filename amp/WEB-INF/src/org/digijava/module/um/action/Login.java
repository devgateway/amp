...
public final class Login
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        if (loginForm.isAutoLogin()) {
            ...
            String userName = loginForm.getUsername() == null ? null :
                loginForm.getUsername().toLowerCase();
            sessionId = HttpLoginManager.loginByCredentials(request, response,
                userName, loginForm.getPassword(), loginForm.isSaveLogin());
        }
        // Redirect back
