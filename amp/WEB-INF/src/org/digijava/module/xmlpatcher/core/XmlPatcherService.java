...
public class XmlPatcherService extends AbstractServiceImpl {
    ...
    public void processInitEvent(ServiceContext serviceContext)
        ...
        try {
            // workaround a design fault whereas a patch which was deleted and then a different one with the same name was read remains marked as "deleted" by AMP and never executed.
