...
<link rel="stylesheet" type="text/css"
      href="<digi:file src= '/jsp/aim/view/scripts/jquery-ui-1.11.0/jquery-ui.min.css'/>">
<link rel="stylesheet" type="text/css"
      href="<digi:file src= '/jsp/aim/view/scripts/jquery-ui-1.11.0/jquery-ui.theme.min.css'/>">
...
<script src="/jsp/aim/view/scripts/jquery-ui-1.11.0/jquery-ui.min.js" type="text/javascript"></script>
<script type="text/javascript"
...
<c:set var="failureMessage">
    <digi:trn
            key="aim:reportwizard:connectionProblems">Apparently there are some connection problems. Please try again in a few moments.</digi:trn>
</c:set>
<c:set var="filterProblemsMessage">
    <digi:trn
            key="aim:reportwizard:filterProblems">Apparently there are some problems displaying filters pop-up. Please try again.</digi:trn>
</c:set>
...
<c:set var="cannotSaveFiltersMessage">
    <digi:trn
            key="aim:reportwizard:cannotSaveFilters">There was a problem saving the filters. Please try again.</digi:trn>
</c:set>
    ...
    <script language="JavaScript">
        ...
        function chekingWorkspaceTypeAndCatValue(action) {
            if (action != "reset") {
                ...
                <digi:trn key="aim:workspaceManager:selectDonorType">if you choose Donor Team Category, you must choose Donor workspace type and vice versa
			...
			msg+="
                ...
                <digi:trn key="aim:workspaceManager:selectGivernmentType">if you choose Government Team Category, you must choose Team or Management workspace type and vice versa
                                                                    ...
                                                                    <tr bgColor=#f4f4f2>
                                                                        <td bgColor=#f4f4f2>
                                                                            <table border="0" cellpadding="0"
                                                                                ...
                                                                                <tr bgColor=#f4f4f2>
                                                                                    <td bgColor=#C7D4DB class=box-title
                                                                                        ...
                                                                                        <logic:equal
                                                                                                ...
                                                                                                value="add">
                                                                                            <digi:trn
                                                                                                    key="aim:addTeam">Add Team</digi:trn>
                                                                                        </logic:equal>
                                                                                        <logic:equal
                                                                                                name="aimUpdateWorkspaceForm"
                                                                                                property="actionEvent"
                                                                                                value="edit">
                                                                                            <digi:trn
                                                                                                    key="aim:editTeam">Edit Team</digi:trn>
                                                                                        </logic:equal>
                                                                                        <logic:equal
                                                                                                name="aimUpdateWorkspaceForm"
                                                                                                property="actionEvent"
                                                                                                value="delete">
                                                                                            <digi:trn
                                                                                                    key="aim:deleteTeam">Delete Team</digi:trn>
                                                                                        </logic:equal>
                                                                                        <logic:equal
                                                                                                name="aimUpdateWorkspaceForm"
                                                                                                property="actionEvent"
                                                                                                value="view">
                                                                                            <digi:trn
                                                                                                    key="aim:viewTeam">View Team</digi:trn>
                                                                                        </logic:equal>
                                                                                        <!-- end table title -->
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <table border="0" cellPadding=3
                                                                                ...
                                                                                <tr>
                                                                                    <td width="150" align="right"
                                                                                        ...
                                                                                        <digi:trn
                                                                                                key="aim:teamName">Team Name</digi:trn>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td width="150" align="right"
                                                                                        ...
                                                                                        <font color="red"><b>*</b></font>
                                                                                        <digi:trn
                                                                                                key="aim:workspaceGroup">Workspace Group</digi:trn>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="right" bgcolor="#FFFFFF"
                                                                                        ...
                                                                                        <font color="red"><b>*</b></font>
                                                                                        <digi:trn
                                                                                                key="aim:workspaceType">Workspace Type</digi:trn>
                                                                                    </td>
                                                                                    <c:if test="${aimUpdateWorkspaceForm.actionEvent == 'add'}">
                                                                                        <td align="left"
                                                                                            ...
                                                                                            <html:select
                                                                                                    ...
                                                                                                    styleClass="inp-text"
                                                                                                    onchange="workspaceChangeType()">
                                                                                                <html:option value="-1"><digi:trn
                                                                                                        key="aim:selectWorkspace">-- Select Workspace --</digi:trn></html:option>
                                                                                                <html:option
                                                                                                        value="Management"><digi:trn
                                                                                                        key="aim:management">Management</digi:trn></html:option>
                                                                                                <html:option
                                                                                                        value="Team"><digi:trn
                                                                                                        key="aim:team">Team</digi:trn></html:option>
                                                                                            </html:select>
                                                                                        </td>
                                                                                    </c:if>
                                                                                    <c:if test="${aimUpdateWorkspaceForm.actionEvent != 'add'}">
                                                                                        ...
                                                                                        <td align="left"
                                                                                            ...
                                                                                            <logic:equal
                                                                                                ...
                                                                                                <html:select
                                                                                                        ...
                                                                                                        styleClass="inp-text">
                                                                                                    <html:option
                                                                                                            value="-1">${translation}</html:option>
                                                                                                    <logic:notEmpty
                                                                                                            name="aimUpdateWorkspaceForm"
                                                                                                            property="fmTemplateList">
                                                                                                        <html:optionsCollection
                                                                                                                name="aimUpdateWorkspaceForm"
                                                                                                                property="fmTemplateList"
                                                                                                                value="id"
                                                                                                                label="name"
                                                                                                                styleClass="COLOR: #cc0000;"/>
                                                                                                    </logic:notEmpty>
                                                                                                </html:select>
                                                                                            </logic:equal>
                                                                                            <logic:equal
                                                                                ...
                                                                                <feature:display name="Workspace Prefix"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="150" align="right"
                                                                                            bgcolor="#FFFFFF">
                                                                                            <digi:trn
                                                                                                    key="aim:workspacePrefix">Workspace Prefix</digi:trn>
                                                                                        </td>
                                                                                        <td align="left"
                                                                                            bgcolor="#FFFFFF">
                                                                                            <c:set var="translation">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="right" bgcolor="#FFFFFF"
                                                                                        style="font-size:12px; font-weight:bold;">
                                                                                        <digi:trn
                                                                                                key="aim:description">Description</digi:trn>
                                                                                    </td>
                                                                                    <td align="left" bgcolor="#FFFFFF"
                                                                                        style="font-size:12px; font-weight:bold;">
                                                                                        <logic:equal
                                                                                    ...
                                                                                    <c:if test="${aimUpdateWorkspaceForm.relatedTeamFlag != 'no'}">
                                                                                        <tr id="relTeamRow">
                                                                                            <td align="right"
                                                                                                ...
                                                                                                style="font-size:12px; font-weight:bold;">
                                                                                                <digi:trn
                                                                                                        key="aim:relatedTeam">Related Team</digi:trn>
                                                                                            </td>
                                                                                            <td align="left"
                                                                                                bgcolor="#FFFFFF"
                                                                                                style="font-size:12px; font-weight:bold;">
                                                                                                <html:select
                                                                                                        property="relatedTeam"
                                                                                                        styleClass="inp-text">
                                                                                                    <c:if test="${aimUpdateWorkspaceForm.relatedTeamFlag == 'nil'}">
                                                                                                        <html:option
                                                                                                                value="-1">No related team available</html:option>
                                                                                                    </c:if>
                                                                                                    <c:if test="${aimUpdateWorkspaceForm.relatedTeamFlag == 'set'}">
                                                                                                        <html:option
                                                                                                                value="-1">-- Select Team --</html:option>
                                                                                                        <logic:notEmpty
                                                                                                                name="aimUpdateWorkspaceForm"
                                                                                                                property="relatedTeamBilatColl">
                                                                                                            <optgroup
                                                                                                                    label="Bilateral"
                                                                                                        ...
                                                                                                        <logic:notEmpty
                                                                                                                name="aimUpdateWorkspaceForm"
                                                                                                                property="relatedTeamMutilatColl">
                                                                                                            <optgroup
                                                                                                                    label="Multilateral"
                                                                                    ...
                                                                                    <td colspan="4">
                                                                                                ...
                                                                                                <table>
                                                                                                    <tr>
                                                                                                        <td align="right"
                                                                                                            ...
                                                                                                            style="font-size:12px; font-weight:bold;">
                                                                                                            <digi:trn
                                                                                                                    key="aim:childWorkspacesOrTeams">Child Workspaces/Teams</digi:trn>
                                                                                                        </td>
                                                                                                        <td align="left"
                                                                                                            bgcolor="#FFFFFF"
                                                                                                            style="font-size:12px; font-weight:bold;">
                                                                                        ...
                                                                                        <c:if test="${!empty aimUpdateWorkspaceForm.childWorkspaces}">
                                                                                            ...
                                                                                            <table width="98%"
                                                                                                ...
                                                                                                <c:forEach
                                                                                                        var="workspaces"
                                                                                                        items="${aimUpdateWorkspaceForm.childWorkspaces}">
                                                                                                    <tr>
                                                                                                        <td align="left">
                                                                                                            &nbsp;
                                                                                                        ...
                                                                                                        <td align="right"
                                                                                                            ...
                                                                                                            <c:if test="${aimUpdateWorkspaceForm.actionEvent != 'delete'}">
                                                                                                                <a href="javascript:removeChildWorkspace(<c:out value="${workspaces.ampTeamId}"/>)">
                                                                                                                    <digi:img
                                                                                                                            src="../ampTemplate/images/deleteIcon.gif"
                                                                                                                            border="0"
                                                                                                                            alt="Remove this child workspace"/></a>&nbsp;
                                                                                                            </c:if>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </c:forEach>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-size:12px; font-weight:bold;">
                                                                                                    <html:checkbox
                                                                                                            ...
                                                                                                            value="true"
                                                                                                            onclick="computationChange()"><digi:trn
                                                                                                            key="chk:computation">Computation</digi:trn></html:checkbox>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    ...
                                                                                    <td colspan="4">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <html:checkbox
                                                                                                            ...
                                                                                                            value="true"><digi:trn
                                                                                                            key="chk:addActivity">Add Activity</digi:trn></html:checkbox>
                                                                                                </td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <html:checkbox
                                                                                                            property="hideDraftActivities"
                                                                                                            value="true"><digi:trn>Hide draft activities</digi:trn></html:checkbox>
                                                                                                </td>
                                                                                            </tr>

                                                                                        </table>
                                                                                        <fieldset
                                                                                                class="main_side_cont">
                                                                                            <legend>
                                                                                                <html:radio
                                                                                                        property="useFilter"
                                                                                                        value="${true}"
                                                                                                        onclick="toggleFilterVsOrgs(this);"/>
                                                                                                <span class="legend_label"><digi:trn
                                                                                                        key="rep:wizard:subtitle:selectedFilters">Selected Filters</digi:trn></span>
                                                                                            </legend>
                                                                                            <input id="hasFilters"
                                                                                                   type="hidden"
                                                                                                   value="<%=ReportContextData.hasFilters()%>"
                                                                                                   name="hasFilters">
                                                                                            <div id="listFiltersDiv"
                                                                                                 style="height:85px; width: 713px; overflow-y:auto; overflow-x:auto; margin-bottom: 5px; white-space: normal;"
                                                                                                 class="inputx">
                                                                                                <%/*<jsp:include page="reportWizard/showSelectedFilters.jsp" />*/%>
                                                                                            </div>
                                                                                            <button type="button"
                                                                                                    value="Filters"
                                                                                                    class="buttonx_sm btn_save"
                                                                                                    id="add_filters_button"
                                                                                                    style="margin-right:2px;"
                                                                                                    onclick="repFilters.showFilters('<%=ReportContextData.getCurrentReportContextId(request, true)%>')"/>
                                                                                            <digi:trn
                                                                                                    key="btn:repFilters">Filters</digi:trn>
                                                                                            </button>
                                                                                        </fieldset>
                                                                                        <fieldset
                                                                                                class="main_side_cont">
                                                                                            <legend>
                                                                                                <html:radio
                                                                                                        ...
                                                                                                        onclick="toggleFilterVsOrgs(this);"/>
                                                                                                <span class="legend_label"><digi:trn
                                                                                                        key="aim:childrenOrganizations">Children (Organizations)</digi:trn></span>
                                                                                            </legend>
                                                                                            <c:if test="${!empty aimUpdateWorkspaceForm.organizations}">
                                                                                                <table width="98%"
                                                                                                       ...
                                                                                                       class="box-border-nopadding">
                                                                                                    <c:forEach var="org"
                                                                                                               items="${aimUpdateWorkspaceForm.organizations}">
                                                                                                        <tr>
                                                                                                            <td align="left">
                                                                                                                &nbsp;
                                                                                                                <input type="hidden"
                                                                                            ...
                                                                                            <c:if test="${aimUpdateWorkspaceForm.actionEvent != 'delete'}">
                                                                                                <c:if test="${aimUpdateWorkspaceForm.relatedTeamFlag != 'noedit'}">
                                                                                                    <aim:addOrganizationButton
                                                                                                            showAs="popin"
                                                                                                            refreshParentDocument="false"
                                                                                                            collection="organizations"
                                                                                                            form="${aimUpdateWorkspaceForm}"
                                                                                                            styleClass="buttonx_sm btn_save">
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <c:if test="${aimUpdateWorkspaceForm.actionEvent == 'edit'}">
                                                                                                            <input type="button"
                                                                                                                   value="${translation}"
                                                                                                                   class="buttonx"
                                                                                                                   onclick="update1('editreset',${aimUpdateWorkspaceForm.teamId})"/>
                                                                                                        </c:if>
                                                                                                        <c:if test="${aimUpdateWorkspaceForm.actionEvent == 'add'}">
                                                                                                            <input type="button"
                                                                                                                   value="${translation}"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var once = true;
        widgetFilter.loaded.done(_.bind(function () {
            if (once) {
