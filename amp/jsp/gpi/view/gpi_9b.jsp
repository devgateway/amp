	...
	style="font-size:11px; font-family: Arial,sans-serif; background-color: white; font-family: Arial, Helvetica, sans-serif;">
	    <tr align="center">
			...
			<td width="27%" height="33" class="inside_header" >
			  <div align="center">
			      <strong><digi:trn>Disbursements Using Country PFM System</digi:trn></strong>
			  </div>
			</td>
			<td width="26%" height="33" class="inside_header" >
			  <div align="center">
			      <strong><digi:trn>All Disbursements</digi:trn></strong>
			  </div>
			</td>
			<td width="27%" height="33" class="inside_header" >
	            <div align="center">
	                <strong><digi:trn>Indicator 9b</digi:trn></strong>
	            </div>
	        </td>
		</tr>
	    ...
	    <logic:notEmpty name="gpiForm" property="mainTableRows">
	       ...
	       <logic:iterate id="element" name="gpiForm" property="mainTableRows" indexId="index" type="org.digijava.module.gpi.helper.row.GPIReport9bRow">
