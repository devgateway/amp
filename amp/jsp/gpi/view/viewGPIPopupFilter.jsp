...
<digi:instance property="gpiForm" />
...
<bean:define id="sy" name="gpiForm" property="startYears"
			...
			<div class="yui-content" style="background-color: #FFFFFF;">
				<div>
					<div id="tabDatesCurrencey">
						<bean:define name="gpiForm" id="element"
							...
							<div class="innerTab">
								<ul class="groupingSelectors">
									<c:forEach var="element"
										items="${gpiForm.financingInstrumentsElements}">
									...
									<ul style="list-style-type: none;margin: 0; padding: 0;">
										<li><input type="checkbox"
											...
											<span style="font-family: Arial,sans-serif; font-size: 12px;"> <digi:trn>${element.rootHierarchyListable.label}</digi:trn>
												...
												page="/jsp/aim/view/filters/hierarchyLister.jsp" />
										</li>
									</ul>
								</div>
							</c:forEach>
						...
						<div style="width: 40%; float: left;">
							<p>
								...
								<html:select property="selectedCalendar"
									...
									<logic:notEmpty name="gpiForm" property="calendars">
							...
							<p>
								...
								<html:select property="selectedCurrency"
									name="gpiForm" styleId="selectedCurrency">
									<logic:notEmpty name="gpiForm"
										property="currencyTypes">
										<html:optionsCollection name="gpiForm"
				...
				<div>
						...
						<div class="groupingSelector">
							...
							<div class="innerTab">
								<ul class="groupingSelectors">
									<c:forEach var="element"
										items="${gpiForm.sectorStatusesElements}">
