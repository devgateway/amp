delete from amp_category_value v using amp_category_value v inner join amp_category_class c where v.amp_category_class_id=c.id 
	and c.keyName="funding_status";
delete from amp_category_class where keyName="funding_status";

insert into amp_category_class (category_name,description,is_multiselect,is_ordered,keyName)
select 'Funding Status',"",False,False,'funding_status' from DUAL where
