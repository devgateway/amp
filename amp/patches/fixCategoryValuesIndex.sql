...
begin
declare r,no_more_rows int default 0;
declare class_id,cur_cat_id,cur_class_id double;
...
if cur_class_id=class_id then
update amp_category_value set index_column=r where id=cur_cat_id;
set r=r+1;
end if;
