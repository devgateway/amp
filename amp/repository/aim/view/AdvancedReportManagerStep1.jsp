...
<table bgColor=#ffffff cellPadding=0 cellSpacing=0 width="770" vAlign="top" align="left">
	<tr>
				...
				<TABLE width="100%" cellSpacing=0 cellPadding=0 vAlign="top" align="left" height="15" >
					...
					<TR>
						<TD noWrap="noWrap"> 
								...
								<digi:link href="/advancedReportManager.do?check=SelectCols" styleClass="reportMenuSelected"  title="<%=translation%>" >
									<span id="leftNavSelected">			
										2 :   Select Columns
									</span>
								</digi:link>
