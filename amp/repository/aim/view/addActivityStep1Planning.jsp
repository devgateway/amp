															...
															<td>
																...
																<a title="<digi:trn key="aim:lineMinistryRank">Line Ministry Rank</digi:trn>">
																	<c:if test="${contentDisabled=='true'}">
					                                                	<category:showoptions   firstLine="${translation}"  name="aimEditActivityForm" property="planning.lineMinRank"  keyName="<%= org.digijava.module.categorymanager.util.CategoryConstants.LINE_MINISTRY_RANK %>" styleClass="inp-text" outerdisabled="disabled" />
					                                                </c:if>
					                                                <c:if test="${contentDisabled=='false'}">
					                                                	<category:showoptions   firstLine="${translation}" name="aimEditActivityForm" property="planning.lineMinRank"  keyName="<%= org.digijava.module.categorymanager.util.CategoryConstants.LINE_MINISTRY_RANK %>" styleClass="inp-text" />
					                                                </c:if>
																</a>
															</td>
														</tr>
													...
													<table cellPadding=0 cellSpacing=0>
														<tr>
															<td>
																<a title="<digi:trn key="aim:planMinistryRank">Ministry of Planning Rank</digi:trn>">
																	<c:if test="${contentDisabled=='true'}">
					                                                	<category:showoptions   firstLine="${translation}" name="aimEditActivityForm" property="planning.planMinRank"  keyName="<%= org.digijava.module.categorymanager.util.CategoryConstants.MINISTRY_PLANNING_RANK %>" styleClass="inp-text" outerdisabled="disabled" />
					                                                </c:if>
					                                                <c:if test="${contentDisabled=='false'}">
					                                                	<category:showoptions   firstLine="${translation}" name="aimEditActivityForm" property="planning.planMinRank"  keyName="<%= org.digijava.module.categorymanager.util.CategoryConstants.MINISTRY_PLANNING_RANK %>" styleClass="inp-text" />
					                                                </c:if>
																</a>
															</td>
														</tr>
