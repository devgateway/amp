									...
									<tr><td>
										<logic:notEmpty name="aimEditActivityForm" property="respOrganisations">
											<table width="100%" cellSpacing=1 cellPadding=5 class="box-border-nopadding">
												<logic:iterate name="aimEditActivityForm" property="respOrganisations" id="repOrganisation" type="org.digijava.module.aim.dbentity.AmpOrganisation">
													<tr><td>
								...
								<logic:empty name="aimEditActivityForm" property="respOrganisations">
									...
									<table width="100%" bgcolor="#cccccc" cellSpacing=1 cellPadding=5>
										<tr>
											<td bgcolor="#ffffff">
												<field:display name="Responsible Organization Add Button" feature="Responsible Organization">
												<aim:addOrganizationButton form="${aimEditActivityForm}" collection="respOrganisations" refreshParentDocument="true">
