									...
									<div id="disb">
										<c:if test="${aimEditActivityForm.funding.fundingRegionId != -1}">
											...
											<% String tNameBase = "disb_" + indexD + "_"; 
												...
												</select>&nbsp;<input type="text" readonly="readonly" name="<%=field4%>" id="<%=field4%>"  
...
function addCommitments() {
	...
	s += "</select>&nbsp;";
	s += "<input type='text' readonly='readonly' name='comm_" + numComm + "_4' id='comm_" + numComm + "_4' size='10' class='inp-text' >&nbsp;";
...
function addDisbursement() {
	...
	s += "</select>&nbsp;";
	s += "<input type='text' readonly='readonly' name='disb_" + numDisb + "_4' id='disb_" + numDisb + "_4' size='10' class='inp-text' >&nbsp;";
...
function addExpenditure() {
	...
	s += "</select>&nbsp;";
	s += "<input type='text' readonly='readonly' name='expn_" + numExpn + "_4' id='expn_" + numExpn + "_4' size='10' class='inp-text' >&nbsp;";
