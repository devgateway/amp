...
<tr>
	...
	<c:if test="${reportData.levelDepth == 2}">
		<td nowrap="nowrap" style="background:#A5A5A5; border-bottom: #E2E2E2 1px solid;border-right: #E2E2E2 1px solid;" height="21px" title='<bean:write name="reportData" property="repName"/>' colspan='<bean:write name="reportData" property="sourceColsCount"/>'>
	...
	<c:if test="${reportData.levelDepth == 3}">
		<td nowrap="nowrap" style="border-bottom:#E2E2E2 1px solid;border-right:#E2E2E2 1px solid" height="21px" colspan='<bean:write name="reportData" property="sourceColsCount"/>'>
	...
	<logic:iterate name="reportData" property="trailCells" id="cell" scope="page">
		...
		<c:if test="${reportData.levelDepth == 2}">
			<td height="21px" style="border-bottom: #868383 1px solid;border-right: #868383 1px solid;font-weight: bold;font-family: Arial;">
		</c:if>  
		<c:if test="${reportData.levelDepth > 2}">
			<td height="21px" style="border-bottom: #E2E2E2 1px solid;border-right: #E2E2E2 1px solid">
		</c:if>  
