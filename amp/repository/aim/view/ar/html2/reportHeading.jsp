    ...
    <logic:iterate name="columnReport" property="items" id="column" scope="page" type="org.dgfoundation.amp.ar.Column">
      ...
      column.setCurrentDepth(curDepth);
        ...
        <logic:equal name="column" property="columnDepth" value="1">
        	...
        	<td style="border-bottom:#E2E2E2 0px solid;padding-left: 2px; padding-right: 2px " height="20px" nowrap="nowrap" align="center" class="reportHeader" rowspan="<%=rowsp%>" colspan='<bean:write name="subColumn" property="width"/>'>          
	        		<c:choose>
	        	...
	        	<logic:notEqual name="widget" scope="request" value="true">
	            	<html:link  style="font-family: Arial;font-size: 11px;text-decoration: none;color: white;cursor:pointer;" page="/viewNewAdvancedReport.do" name="linkMap">
        		...
        		<%
          		...
          		<c:otherwise>
	      			<td class="reportHeader" valign="bottom" height="15px" nowrap="nowrap" align="center" rowspan="<%=rowsp%>" colspan='<bean:write name="subColumn" property="width"/>'>
	      				<html:link style="font-family: Arial;font-size: 11px;text-decoration: none; color: white" page="/viewNewAdvancedReport.do" paramName="subColumn" paramProperty="name" paramId="sortBy">
	        				<digi:trn key="aim:reportBuilder:${reportHeading}">
	            				<c:out value="${reportHeading}"/>
	            			</digi:trn>
						</html:link>
