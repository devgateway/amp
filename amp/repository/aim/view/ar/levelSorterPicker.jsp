...
<digi:form action="/viewNewAdvancedReport.do">
	<table border="0" cellspacing="2" cellpadding="2" align=center>
			<tr>
	  			...
	  			<td>
					...
					<logic:iterate name="reportMeta" property="hierarchies"  id="iter" >
						...
						<html:option value="${iter.levelId}">
							<digi:trn key="${key}">${iter.column.columnName}</digi:trn>
						</html:option>
					</logic:iterate>
				</html:select>
	  			</td>
	  		...
	  		<tr>
	  			<td align=right style="font-family: Arial,sans-serif;font-size: 11px">
	  				<digi:trn key="aim:popsort:hierarchy:sortby">Sort by:</digi:trn>
	  			</td>
	  			<td>
					...
					<logic:iterate name="report" property="trailCells"  id="iter1">
						<c:if test="${not empty iter1.column.absoluteColumnName}">
							<html:option value="${iter1.column.absoluteColumnName}">
								...
								<digi:trn key="${key1}">${iter1.column.absoluteColumnName}</digi:trn>
							</html:option>
						</c:if>
					</logic:iterate>
				</html:select>
	  		...
	  		<tr>
	  			<td align=right style="font-family: Arial,sans-serif;font-size: 11px"> 
	  				<digi:trn key="aim:popsort:hierarchy:sortorder">Sort Order:</digi:trn>
	  			</td>
	  			<td>
