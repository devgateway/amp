								...
								<tr>
									<td align="left" colspan=5>
										<table border="0" align="center" bgcolor="#f2f2f2" width=100%>
											<tr>
												<td noWrap align=center valign="middle"><a
													target="_blank" onclick="exportXSL(); return false;"> <digi:img
															hspace="2" vspace="2"
															src="/TEMPLATE/ampTemplate/imagesSource/common/ico_exc.gif"
															border="0" alt="Export to Excel" /> </a> <digi:link
														styleId="printWin" href="#"
														onclick="window.print(); return false;">
														<digi:img hspace="2" vspace="2"
															src="/TEMPLATE/ampTemplate/imagesSource/common/ico_print.gif"
													...
													<table cellpadding="0" cellspacing="0" width="100">
														<tr>
															<td bgColor=#c9c9c7 class=box-title><digi:trn
																	key="aim:otherLinks">
																	<b style="font-size: 12px; padding-left: 5px;">Other
																		links</b>
																</digi:trn>
															</td>
