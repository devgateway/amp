				...
				<div style="width: 55%; height:30%; padding: 10px; float: left;">
					...
					<table style="font-family: Arial; font-size: 1em;">
						<tr>
							...
							<a id="date1" style="background-color: #F6FAFF;" href='javascript:pickDateById2("date1","fromDate", true)'>
							...
							<a id="date2" style="background-color: #F6FAFF;" href='javascript:pickDateById2("date2","toDate", true)'>
								<img src="../ampTemplate/images/show-calendar.gif" alt="Click to View Calendar" border="0">
							</a>
