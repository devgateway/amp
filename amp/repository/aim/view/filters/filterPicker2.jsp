			...
			<div class="grayBorder">
				...
				<div style="width: 55%; height:30%; padding: 10px; float: left;">
					...
					<table style="font-family: Arial; font-size: 1em;">
						<tr>
							<td align="left">
							<digi:trn key="rep:filer:From"> From </digi:trn> <html:text  property="fromDate" size="10" styleId="fromDate" styleClass="inp-text"/>
							<a id="date1" style="background-color: #F6FAFF;" href='javascript:pickDateById("date1","fromDate")'>
								<img src="../ampTemplate/images/show-calendar.gif" alt="Click to View Calendar" border="0">
							</a>
							</td>
							<td align="left">&nbsp;&nbsp;
							<digi:trn key="rep:filer:To"> To </digi:trn> <html:text  property="toDate" size="10" styleId="toDate" styleClass="inp-text" />
