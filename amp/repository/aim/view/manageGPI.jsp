...
<div style="margin: 0 auto; width: 1000px;">
	...
	<digi:form action="/manageGPI.do?actionType=save" method="post" name="gpiForm">
		...
		<table cellpadding="1" cellspacing="1">
			<tr>
				<td>
					<h3><digi:trn>Indicator 5a: Development Cooperation is more predictable.</digi:trn></h3>
			...
			<tr>
				<td>
					<h3><digi:trn>Indicator 6: Aid is on budgets which are subject to parliamentary scrutiny.</digi:trn></h3>
			...
			<tr>
				<td>
					<h3><digi:trn>Indicator 9b: Use of developing country PFM and procurement systems.</digi:trn></h3>
