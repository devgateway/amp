				...
				<tr>
					...
					<html:select property="tempNumResults" styleClass="inp-text">
						<html:option value="10">
							<digi:trn key="aim:10">10</digi:trn>
						</html:option>
						<html:option value="20">
							<digi:trn key="aim:20">20</digi:trn>
						</html:option>
						<html:option value="50">
							<digi:trn key="aim:50">50</digi:trn>
						</html:option>
						<html:option value="-1">
							<digi:trn key="aim:all">All</digi:trn>
						</html:option>
																...
																<logic:iterate name="aimOrgManagerForm"
																	...
																	<tr>
																		<td class="inside"><jsp:useBean id="urlParams"
																			...
																			property="actionFlag" value="edit" /> <c:set
																			target="${urlParams}" property="ampOrgId">
										...
										<logic:notEmpty name="aimOrgManagerForm" property="pages">
											<tr>
												<td colspan="4"><digi:trn key="aim:organizationPages">
													...
													<c:set target="${urlParamsFirst}" property="orgSelReset"
														value="false" />
													...
													<c:set target="${urlParamsPrevious}" property="orgSelReset"
														value="false" />
													<c:set var="translation">
													...
													<c:if test="${aimOrgManagerForm.currentPage != pages}">
														...
														<digi:link href="/organisationSearch.do" name="urlParams1"
															title="${translation}">
															<%=pages%>
														</digi:link>
													</c:if>
													...
													<c:set target="${urlParamsNext}" property="page"
														value="${aimOrgManagerForm.currentPage+1}" />
													<c:set target="${urlParamsNext}" property="orgSelReset"
														value="false" />
													<c:set var="translation">
													...
													<c:set target="${urlParamsLast}" property="orgSelReset"
														value="false" />
													<c:set var="translation">
													...
													value="${aimOrgManagerForm.pagesSize}"></c:out></td>
											</tr>
										</logic:notEmpty>
														...
														<td><c:if
															...
															<c:if test="${aimOrgManagerForm.currentAlpha!='viewAll'}">
																<c:if test="${aimOrgManagerForm.currentAlpha!=''}">
																	...
																	<a href="javascript:searchAlpha('viewAll')"
																		...
																		key="aim:viewAllLink">viewAll</digi:trn></a>
																</c:if>
															</c:if>
															...
															<c:if test="${alphaPages != null}">
																...
																<c:if
																	...
																	<a href="javascript:searchAlpha('<%=alphaPages%>')"
