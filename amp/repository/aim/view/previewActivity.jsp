...
<jsp:include page="activityHistoryUtil.jsp" flush="true" />
	...
	type="text/javascript"src="<digi:file src="module/aim/scripts/dscript120.js"/>"></script>
...
<digi:form action="/saveActivity.do" method="post">
		...
		<div class="breadcrump_1" align="center">
			<div class="centering">
				<div class="breadcrump_cont">
					...
					<span class="bread_sel"> <digi:trn key="aim:previewActivity"> Preview Activity </digi:trn> </span>
				</c:if>
				</div>
			</div>
		</div>
	...
	<table width="1000" border="0" cellspacing="0" cellpadding="0" align=center>
		...
		<tr valign=top>
			...
			<div style="float: right;"><logic:present name="currentMember" scope="session">
				<table cellSpacing="1" cellPadding="1" vAlign="bottom" border="0">
					<tr>
						<td>
							...
							<input type="button" class="buttonx" onclick="javascript:expandAll()" value="${tran}"/>
						</td>
						<td>
							<c:set var="tran">
								<digi:trn key="aim:previe:collapseAll">Collapse all</digi:trn>
							</c:set> 
							<input type="button" class="buttonx" onclick="javascript:collapseAll()" value="${tran}"/>
						</td>
						<td height=16 vAlign=bottom align="right">
							<input type="button" class="buttonx" onclick="window.open('/showPrinterFriendlyPage.do?edit=true', '_blank', '');"
						...
						<td>
							...
							<input type="button" class="buttonx" onclick="javascript:exportToPdf(${actId})" value="${trn}"/>
						</td>
						<td>
							<c:if test="${aimEditActivityForm.pageId == 1}">
								<input type="button" class="buttonx" onclick="disable()" value='<digi:trn key="btn:saveActivity">Save Activity</digi:trn>' name="submitButton"/>
							</c:if>
						</td>
						<td>
			...
			<input type="button" class="buttonx" onclick="javascript:history.go(-1)" value='<< <digi:trn key="btn:back">Back</digi:trn>' name="backButton"/>
			<div class="wht_blck">
				...
				<!-- IDENTIFICATION SECTION -->
					...
					<tr>
						<td width="45%" align=right class="prv_left">
							<digi:trn key="aim:ampId">AMP ID</digi:trn>
						</td>
						<td width="55%" class="prv_right">
							<b><c:out value="${aimEditActivityForm.identification.ampId}"/></b>
						</td>
					</tr>
					
					<module:display name="/Activity Form/Identification/Project Title" parentModule="/Activity Form/Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:projectTitle">Project title</digi:trn>
							</td>
							<td class="prv_right">
								<c:out value="${aimEditActivityForm.identification.title}"/>&nbsp;
							</td>
						</tr>
					</module:display>
					...
					<module:display name="/Activity Form/Identification/Status Reason" parentModule="/Activity Form/Identification">
						<tr>
						 ...
						 <tr>
							...
							<td class="prv_right">${aimEditActivityForm.identification.statusReason}</td>
						</tr>
					</module:display>
					...
					<module:display name="/Activity Form/Identification/Project Comments" parentModule="/Activity Form/Identification">
						<tr>
							<td class="prv_left" align=right><digi:trn key="aim:description">Project Comments</digi:trn></td>
							<td class="prv_right">
							...
							<tr>
								...
								<td class="prv_right">
									...
									<logic:equal name="comments" property="key" value="Purpose Objectively Verifiable Indicators">
										<logic:iterate name="comments" id="comment" property="value" type="org.digijava.module.aim.dbentity.AmpComments">
											<b> <digi:trn key="aim:purposeObjectivelyVerifiableIndicators">Purpose Objectively Verifiable Indicators</digi:trn>:</b>
											<bean:write name="comment" property="comment" />
											<br/>
										</logic:iterate>
									</logic:equal>
					...
					<module:display name="/Activity Form/Identification/Procurement System" parentModule="/Activity Form/Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:ProcurementSystem">Procurement System</digi:trn>
							</td>
							<td class="prv_right">
					...
					<module:display name="/Activity Form/Identification/Reporting System" parentModule="/Activity Form/Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:ReportingSystem">Reporting System</digi:trn>
							</td>
							<td class="prv_right">
					...
					<module:display name="/Activity Form/Identification/Audit System" parentModule="/Activity Form/Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:AuditSystem" >Audit System</digi:trn>
							</td>
							<td class="prv_right">
					...
					<module:display name="/Activity Form/Identification/Institutions" parentModule="/Activity Form/Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:Institutions" >Institutions</digi:trn>
							</td>
							<td class="prv_right">
					...
					<field:display name="Project Category" feature="Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:ProjectCategory">Project Category</digi:trn>
							</td>
							<td class="prv_right">
					...
					<field:display name="Government Agreement Number" feature="Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:step1:GovernmentAgreementNumTitle">Government Agreement Number</digi:trn>
							</td>
							<td class="prv_right"><c:out
				...
				<!-- END IDENTIFICATION SECTION -->
					...
					<feature:display name="Budget" module="Project ID and Planning">
						<tr>
							<td class="prv_left" align=right>
								<img id="budget_plus" onclick="toggleGroup('budget')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
								<img id="budget_minus" onclick="toggleGroup('budget')" src="/TEMPLATE/ampTemplate/images/arrow_down.gif" style="display: none"/> <digi:trn key="aim:actBudget">Budget</digi:trn></td>
							<td class="prv_right">
								...
								<c:if test="${!empty aimEditActivityForm.identification.selecteddepartment}">
									<c:forEach var="selecteddep" items="${aimEditActivityForm.identification.budgetdepartments}">
										<c:if test="${aimEditActivityForm.identification.selecteddepartment==selecteddep.id}">
											<li style="margin-left: 10px">
												<c:out value="${selecteddep.code}"/> - 
												<c:out value="${selecteddep.name}"/>
											</li>
										</c:if>
									</c:forEach>
								</c:if>
					...
					<module:display name="/Activity Form/Identification/Humanitarian Aid" parentModule="/Activity Form/Identification">
						<tr>
							<td class="prv_left" align=right>
								<digi:trn key="aim:humanitarianaid">Humanitarian Aid</digi:trn>
							</td>
							<td class="prv_right">
					...
					<tr>
						<td class="prv_left" align=right>
							<img id="group_planning_plus" onclick="toggleGroup('group_planning')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
							<img id="group_planning_minus" onclick="toggleGroup('group_planning')" 
								src="/TEMPLATE/ampTemplate/images/arrow_down.gif" style="display: none"/> 
						...
						<table width="100%" cellSpacing=2 cellpadding="1" style="font-size:11px;">
							<module:display name="/Activity Form/Planning/Line Ministry Rank" parentModule="/Activity Form/Planning">
								<tr>
									<td width="32%">
										<digi:trn key="aim:lineMinRank">Line Ministry Rank</digi:trn>
									</td>
									<td width="1">:</td>
									<td align="left">
							...
							<module:display name="/Activity Form/Planning/Ministry of Planning Rank" parentModule="/Activity Form/Planning">
								<tr>
									<td width="32%">
										<digi:trn key="aim:planMinRank">Ministry of Planning Rank</digi:trn>
									</td>
									<td width="1">:</td>
									<td align="left">
							...
							<module:display name="/Activity Form/Planning/Final Date for Contracting" parentModule="/Activity Form/Planning">
								<tr>
									<td width="32%">
										<digi:trn key="aim:ContractingDateofProject1">Final Date for Contracting</digi:trn>
									</td>
									<td width="1">:</td>
									<td align="left">
				...
				<module:display name="References" parentModule="PROJECT MANAGEMENT">
					<tr>
						<td class="prv_left" align=right>
							<digi:trn key="aim:References">References</digi:trn></td>
						<td class="prv_right">
				...
				<tr>
					<td class="prv_left" align=right style="vertical-align: top">
						<img id="sector_plus" onclick="toggleGroup('sector')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
						<img id="sector_minus" onclick="toggleGroup('sector')" src="/TEMPLATE/ampTemplate/images/arrow_down.gif"
							style="display: none"/> 
				...
				<c:if test="${not empty aimEditActivityForm.components.activityComponentes}">
					<tr>
						<td class="prv_left" align=right>
							<img id="component_sector_plus" onclick="toggleGroup('component_sector')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
							<img id="component_sector_minus" onclick="toggleGroup('component_sector')" 
								src="/TEMPLATE/ampTemplate/images/arrow_down.gif" style="display: none"/> 
					...
					<module:display name="/Activity Form/Program/National Plan Objective" parentModule="/Activity Form/Program">
						<tr>
							<td class="prv_left" align=right><img id="npd_npo_plus"
								onclick="toggleGroup('npd_npo')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
						...
						<module:display name="/Activity Form/Program/Primary Programs" parentModule="/Activity Form/Program">
							<tr>
								<td class="prv_left" align=right>
									<img id="npd_primaryprog_plus" onclick="toggleGroup('npd_primaryprog')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> <img id="npd_primaryprog_minus"
								...
								<div id="act_npd_primaryprog" style="display: none;">
									<c:forEach
										var="program" items="${aimEditActivityForm.programs.primaryPrograms}">
										<c:out value="${program.hierarchyNames}" />&nbsp; 
										<c:out value="${program.programPercentage}"/>%<br />
									</c:forEach>	
								</div>
						...
						<tr>
								<td class="prv_left" align=right><img
									...
									<img id="npd_secondprog_minus" onclick="toggleGroup('npd_secondprog')" src="/TEMPLATE/ampTemplate/images/arrow_down.gif"
										style="display: none"/> 
							...
							<c:forEach var="regFunds" items="${aimEditActivityForm.funding.regionalFundings}">
								<tr>
									...
									<table width="100%" cellSpacing="1" cellPadding="1">
										...
										<module:display name="/Activity Form/Regional Funding/Region Item/Commitments" 
				...
				<module:display name="/Activity Form/Components" parentModule="/Activity Form">
					<tr>
						<td class="prv_left" align=right>
							<img id="components_plus" onclick="toggleGroup('components')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
						...
						<c:if test="${!empty aimEditActivityForm.components.selectedComponents}">
							<c:forEach var="comp" items="${aimEditActivityForm.components.selectedComponents}">
								...
								<field:display name="Components Physical Progress" feature="Activity - Component Step">
									<tr>
										<td class="prv_right"><b>
											<digi:trn key="aim:physicalProgressOfTheComponent">Physical progress of the component</digi:trn></b>
										</td>
									</tr>
		...
		<tr>
			<td class="prv_left" align=right>
				<img id="components_resume_plus" onclick="toggleGroup('components_resume')" 
					src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
				<img id="components_resume_minus" onclick="toggleGroup('components_resume')"
					src="/TEMPLATE/ampTemplate/images/arrow_down.gif"/> 
					<digi:trn key="aim:components">Components</digi:trn>
			</td>
			<td class="prv_right">
		...
		<!-- END COMPONENTS -->
				...
				<tr>
					<td class="prv_left" align=right>
						<img id="issues_plus" onclick="toggleGroup('issues')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
				...
				<tr>
					<td class="prv_left" align=right>
						<img id="related_documents_plus" onclick="toggleGroup('related_documents')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
					...
					<c:if test="${ (!empty aimEditActivityForm.documents.documentList) || (!empty aimEditActivityForm.documents.crDocuments)}">
						<table width="100%" cellSpacing="0" cellPadding="0">
							<logic:iterate name="aimEditActivityForm" property="documents.documents" id="docs" 
				...
				<tr>
					<td class="prv_left" align=right><img id="orgz_plus" onclick="toggleGroup('orgz')" src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
					...
					<module:display name="/Activity Form/Related Organizations/Responsible Organization" parentModule="/Activity Form/Related Organizations">
						...
						<img id="implementing_agency_minus" onclick="toggleGroup('responsible_organisation')" src="/TEMPLATE/ampTemplate/images/arrow_down.gif" style="display: none" />
						</logic:notEmpty>
					...
					<div id="act_orgz" style="display: none;">
						<logic:notEmpty name="aimEditActivityForm" property="agencies.executingAgencies">
							...
							<img id="executing_agency_minus" onclick="toggleGroup('executing_agency')" src="/TEMPLATE/ampTemplate/images/arrow_down.gif"
								style="display: none" />
						</logic:notEmpty>
					...
					<module:display name="/Activity Form/Related Organizations/Implementing Agency" parentModule="/Activity Form/Related Organizations">
						<logic:notEmpty name="aimEditActivityForm" property="agencies.impAgencies">
							...
							<img id="implementing_agency_minus" onclick="toggleGroup('implementing_agency')" src="/TEMPLATE/ampTemplate/images/arrow_down.gif" style="display: none"/>
						</logic:notEmpty>
					...
					<module:display name="/Activity Form/Related Organizations/Regional Group" parentModule="/Activity Form/Related Organizations">
						<logic:notEmpty name="aimEditActivityForm" property="agencies.sectGroups">
							...
							<img id="regGroups_agency_minus" onclick="toggleGroup('regGroups_agency')" 
								src="/TEMPLATE/ampTemplate/images/arrow_down.gif" style="display: none"/>
						</logic:notEmpty>
				...
				<module:display name="/Activity Form/Contacts/Project Coordinator Contact Information" parentModule="/Activity Form/Contacts">
					<tr>
						<td class="prv_left" align=right><digi:trn>Project Coordinator Contact Information</digi:trn></td>
						<td class="prv_right">
				...
				<field:display name="Activity Performance" feature="Activity Dashboard" >
					<tr>
						<td class="prv_left" align=right>
							<digi:trn key="aim:meActivityPerformance" > Activity - Performance</digi:trn>
						</td>
						<td class="prv_right">
							<%
				...
				<feature:display name="Contracting" module="Contracting">
					<tr>
						<td class="prv_left" align=right>
							<img id="contract_plus" onclick="toggleGroup('contract')" 
							src="/TEMPLATE/ampTemplate/images/arrow_right.gif"/> 
