...
<tr bgcolor="#FFFFCC">
	<td colspan="4" style="text-transform: uppercase"><a title='<digi:trn>Amount effectively spent by the implementing agency</digi:trn>'>
...
<c:if test="${!empty funding.fundingDetails}">
	...
	<tr>
		<td colspan="2" bgcolor="#eeeeee" style="border-top: 1px solid #000000; text-transform: uppercase">
			<digi:trn>SUBTOTAL PLANNED EXPENDITURES</digi:trn>
		</td>
	...
	<tr bgcolor="#FFFFCC">
		<td colspan="4" style="text-transform: uppercase">
			<a	title='<digi:trn>Amount effectively spent by the implementing agency</digi:trn>'>
	...
	<tr>
		<td colspan="2" bgcolor="#eeeeee"style="border-top: 1px solid #000000; text-transform: uppercase">
			<digi:trn>SUBTOTAL ACTUAL EXPENDITURES</digi:trn>
		</td>
		<td nowrap="nowrap" align="right" bgcolor="#eeeeee"	style="border-top: 1px solid #000000">
