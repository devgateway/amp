          ...
          <tr>
            ...
            <td colspan="6">
              <span class="crumb">
                ...
                <digi:link ampModule="aim" href="/quartzJobManager.do~action=all" styleClass="comment" title="${trn}" >
              ...
              <table width="150" cellspacing="0" cellpadding="0" class="inside">
                ...
                <tr>
                  <td class="inside"><img width="15" height="10"
                                          src="/TEMPLATE/ampTemplate/ampModule/aim/images/arrow-014E86.gif"> <digi:link
                          ampModule="aim" href="/admin.do"> <digi:trn
