...
var dow   = new makeArray0('<digi:trn jsFriendly="true" key='calendar:Sun'>Sun</digi:trn>','<digi:trn jsFriendly="true" key='calendar:Mon'>Mon</digi:trn>','<digi:trn jsFriendly="true" jsFriendly="true" key='calendar:Tue'>Tue</digi:trn>','<digi:trn jsFriendly="true" key='calendar:Wed'>Wed</digi:trn>','<digi:trn jsFriendly="true" key='calendar:Thu'>Thu</digi:trn>','<digi:trn jsFriendly="true" key='calendar:Fri'>Fri</digi:trn>','<digi:trn jsFriendly="true" key='calendar:Sat'>Sat</digi:trn>');
