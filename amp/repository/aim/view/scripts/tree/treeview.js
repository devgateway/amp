...
YAHOO.extend(YAHOO.widget.TextNode, YAHOO.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        */
        ...
        sb[sb.length] = ' href="JavaScript:browseProgram(\''+this.programId+'\',\''+this.index+'\')"';

        sb[sb.length] = ' target="' + this.target + '"';
        //sb[sb.length] = ' onclick="return browseProgram(\''+this.programId+'\',\''+this.index+'\')"';
        ...
        if (this.indicators != null){
	        ...
	        sb[sb.length] = '<div id="indTreeList'+this.programId+'" style="display : none;">';
