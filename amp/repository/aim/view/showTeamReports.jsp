...
<!-- CSS -->
<link
	href="/TEMPLATE/ampTemplate/js_2/yui/tabview/assets/tabview-core.css"
	type="text/css" rel="stylesheet">
<link href='TEMPLATE/ampTemplate/css_2/amp.css' rel='stylesheet'
	type='text/css'>
<link href='TEMPLATE/ampTemplate/css_2/tabs.css' rel='stylesheet'
	type='text/css'>
<link
	href="/TEMPLATE/ampTemplate/js_2/yui/container/assets/container.css"
	type="text/css" rel="stylesheet">
<link
	href="/TEMPLATE/ampTemplate/js_2/yui/tabview/assets/skins/sam/tabview.css"
	type="text/css" rel="stylesheet">
<link type="text/css" rel="stylesheet"
	href="/TEMPLATE/ampTemplate/css_2/yui_tabs.css">
...
$(document).ready(function() {
						...
						<div id="Tab_Name"
														...
														<tr>
															<td>
																<table cellpadding="6" cellspacing="6">
																	<tr>
																		<td id="reportsearchform"><c:choose>
																				<c:when test="${aimTeamReportsForm.showTabs}">
																					<digi:trn>Tab Title</digi:trn>
																				</c:when>
																				<c:otherwise>
																					<digi:trn>Report Title</digi:trn>
																				</c:otherwise>
																			</c:choose>: <html:text property="keyword" /></td>
																		<td id="reportsearchform1"><input type="button"
																			value="<digi:trn>Search</digi:trn>"
																			onclick="submitForm('search')" /></td>
																		<td id="reportsearchform2"><input type="button"
																			value="<digi:trn>clear</digi:trn>"
																			onclick="submitForm('clear')" /></td>
																	</tr>
																</table>
															</td>
														</tr>
														<tr>
															<td><c:set var="reportNumber"
																...
																<c:if test="${reportNumber != 0}">
																	<table>
																		<logic:present name="isUserLogged" scope="session">
																			<c:if test="${!aimTeamReportsForm.showTabs}">
																				<div class="filtered"
																					...
																					<span><img
																						...
																						border="0" style="vertical-align: baseline;" /></span> <span><digi:trn>Not filtered Report</digi:trn>&nbsp;
																						<img
																						src="/TEMPLATE/ampTemplate/images/bullet_green_sq.gif"
																						border="0"
																						style="vertical-align: baseline; margin-left: 8px;" /></span>
																					<span><digi:trn>Filtered Report</digi:trn>&nbsp;
																						<img
																						src="/repository/message/view/images/edit.gif"
																						border="0"
																						style="vertical-align: bottom; margin-left: 8px;" /></span>
																					<span><digi:trn>Edit Report</digi:trn>&nbsp;
																						<img
																						src="/repository/message/view/images/trash_12.gif"
																						border="0"
																						style="vertical-align: bottom; margin-left: 8px;" /></span>
																			...
																			<c:if test="${aimTeamReportsForm.showTabs}">
																				<div class="filtered"
																					...
																					<span><img
																						src="/TEMPLATE/ampTemplate/images/bullet_grey_sq.gif"
																						border="0" style="vertical-align: baseline;" /> <digi:trn>Not filtered Tab</digi:trn>&nbsp;
																						<span><img
																							src="/TEMPLATE/ampTemplate/images/bullet_green_sq.gif"
																							border="0"
																							style="vertical-align: baseline; margin-left: 8px;" /></span>
																						<digi:trn>Filtered Tab</digi:trn>&nbsp; <span><img
																							src="/repository/message/view/images/edit.gif"
																							border="0"
																							style="vertical-align: bottom; margin-left: 8px;" /></span>
																						<digi:trn>Edit Tab</digi:trn>&nbsp; <span><img
																							src="/repository/message/view/images/trash_12.gif"
																							border="0"
																							style="vertical-align: bottom; margin-left: 8px;" /></span>
																		...
																		<tr
																			style="font-size: 11px; font-family: Aria, sans-serif;">
																			<td>
																				<%
					                          								...
					                          								<c:set var="translation">
																					...
																					value="${aimTeamReportsForm.pagesToShow}"></c:set>
																				<c:set var="start"
																					value="${aimTeamReportsForm.offset}" /> <c:if
																					test="${maxpages > 1}">
																					<logic:iterate name="pagelist" id="pageidx"
																						type="java.lang.Integer" offset="${start}"
																						length="${length}">
																						<c:set target="${urlParamsPagination}"
																							property="page" value="${pageidx - 1}" />
															...
															<td valign="top">
																<table>
																	<tr>
																		<td>
																			<table class="inside"
																				style="font-size: 11px; font-family: Arial, sans-serif; background-color: white;"
																				width="950px">
																				<tr>
																					...
																					<td align="center" class="inside_header"><c:if
																							...
																							<img
																								src="/TEMPLATE/ampTemplate/images/arrow_up.gif"
																								alt="up" />
																						</c:if></td>
																					...
																					<c:if test="${!aimTeamReportsForm.tabs}">
																						<td align="center" class="inside_header"><b><digi:trn
																									key="aim:reportType">Type</digi:trn></b></td>
																					</c:if>
																					<td align="center" class="inside_header"><b><digi:trn
																								key="aim:hierarchies">Hierarchies</digi:trn></b></td>
																					<%
																						String s = (String) session.getAttribute("teamLeadFlag");
																							...
																							if (tm != null) {
																					%>
																					<td align="center" class="inside_header"><b><digi:trn>Fields</digi:trn></b>
																					</td>
																					<c:if test="${aimTeamReportsForm.showTabs}">
																						<td align="center" class="inside_header"><b><digi:trn>Position</digi:trn></b>
																						</td>
																					</c:if>
																					<td align="center" class="inside_header"><b><digi:trn
																								key="aim:reportAction">Action</digi:trn></b></td>
																					<%
																						}
																					%>
																				</tr>
							...
							: "\'#ffffff\'")%>, '#a5bcf2', '#FFFF00');">
																						...
																						<td align="center" class="inside"
																							...
																							bgcolor="<%=color%>"><logic:notEmpty
																								name="report" property="filterDataSet">
																								<img
																									src="/TEMPLATE/ampTemplate/images/bullet_green_sq.gif"
																									vspace="2" border="0" align="middle" />
																							</logic:notEmpty> <logic:empty name="report"
																								property="filterDataSet">
																								<img
																									src="/TEMPLATE/ampTemplate/images/bullet_grey_sq.gif"
																									vspace="2" border="0" align="middle" />
																							</logic:empty></td>
																						<td class="inside"
																							...
																							bgcolor="<%=color%>"><c:if
																								test="${!aimTeamReportsForm.showTabs}">
																								<digi:link
																									href="/viewNewAdvancedReport.do?view=reset&widget=false&resetSettings=true"
																									paramName="report" paramId="ampReportId"
																									paramProperty="ampReportId" styleClass="h-box"
																							...
																							</c:if> <c:if test="${aimTeamReportsForm.showTabs}">
																								<b>
																									<p
																										style="max-width: 400px; white-space: normal"
																										title='<c:out value="${report.name}"/>'>
																						...
																						<td align="center" class="inside"
																							...
																							<p style="white-space: nowrap">
																								<logic:present name="report" property="ownerId">
																									<i><bean:write name="report"
																											property="ownerId.user.name" /></i>
																								</logic:present>
																							</p>
																						</td>
																						<td align="center" class="inside"
																							...
																							<p style="white-space: nowrap">
																								<logic:present name="report"
																									...
																									<bean:write name="report"
																										property="formatedUpdatedDate" />
																								</logic:present>
																							</p>
																						</td>
																						<c:if test="${!aimTeamReportsForm.tabs}">
																							<td class="inside"
																								style="padding-right: 8px; padding-left: 8px; font-size: 11px;"
																								bgcolor="<%=color%>">
																								<p style="white-space: nowrap">
																								<li>
																									<%
 ...
 %> <digi:trn
																									...
																									%>
																							</li> <logic:equal name="report"
																									property="drilldownTab" value="true">
																									<li><digi:trn key="aim:typeDrilldownTab">Desktop Tab</digi:trn>
																									</li>
																								</logic:equal> <logic:equal name="report"
																									property="publicReport" value="true">
																									<li><digi:trn key="aim:typePublicReport">Public Report</digi:trn>
																									</li>
																								</logic:equal> <logic:equal name="report"
																									property="hideActivities" value="true">
																									<li><digi:trn key="aim:typeSummaryReport">Summary Report</digi:trn>
																									</li>
																								</logic:equal> <logic:equal name="report" property="options"
																									value="A">
																									<li><digi:trn key="aim:annualreport">Annual</digi:trn>
																									</li>
																								</logic:equal> <logic:equal name="report" property="options"
																									value="Q">
																									<li><digi:trn key="aim:quarterlyreport">Quarterly</digi:trn>
																									</li>
																								</logic:equal> <logic:equal name="report" property="options"
																									value="M">
																									<li><digi:trn key="aim:monthlyreport">Monthly</digi:trn>
																									</li>
																								</logic:equal>
																								</p>
																							</td>
																						...
																						<td class="inside"
																							style="padding-right: 10px; padding-left: 10px; font-size: 11px; width: 20%;"
																							bgcolor="<%=color%>"><logic:iterate
																								name="report" property="hierarchies"
																								id="hierarchy">
																								<%-- <bean:write name="hierarchy" property="column.columnName"/> --%>
																								<li><digi:trn
																										key="aim:report:${hierarchy.column.columnName}">
																										<bean:write name="hierarchy"
																						...
																						<td width="200" class="inside"
																							style="padding-right: 10px; padding-left: 10px; font-size: 11px; width: 150px;"
																							align="center" bgcolor="<%=color%>">
																							<div style='position: relative; display: none;'
																								id='report-<bean:write name="report" property="ampReportId"/>'>
																								<logic:iterate name="report" property="columns"
																									id="column" indexId="index">
																									<%
																										if (index.intValue() % 2 == 0) {
																									%>
																									<li><digi:trn
																											key="aim:report:${column.column.columnName}">
 ...
 %> , <digi:trn
																							...
																							onMouseOver="stm(['<digi:trn>Columns</digi:trn>',document.getElementById('report-<bean:write name="report" property="ampReportId"/>').innerHTML],Style[0])"
																							onMouseOut="htm()">[ <u
																								style="text-transform: capitalize;"><digi:trn>Columns</digi:trn></u>
																								]&nbsp;
																						</span>
																							<div style='position: relative; display: none;'
																								id='measure-<bean:write name="report" property="ampReportId"/>'>
																								<logic:iterate name="report" property="measures"
																									id="measure" indexId="index">
																									<li><digi:trn
																											key="aim:reportBuilder:${measure.measure.aliasName}">${measure.measure.aliasName}</digi:trn>
																									</li>
																								</logic:iterate>
																							</div> <span align="center"
																							style="text-transform: capitalize; white-space: no-wrap;"
																							onMouseOver="stm(['<digi:trn key="aim:teamreports:measures">measures</digi:trn>',document.getElementById('measure-<bean:write name="report" property="ampReportId"/>').innerHTML],Style[1])"
																							onMouseOut="htm()">[ <u><digi:trn
																										key="aim:teamreports:measures">Measures</digi:trn></u>
																								]<br /></span>
																						</td>
																						<c:if test="${aimTeamReportsForm.showTabs}">
																							<td class="inside"
																								style="padding-right: 15px; padding-left: 15px; font-size: 11px;"
																								bgcolor="<%=color%>"><c:forEach
																									var="desktopTab"
																									items="${report.desktopTabSelections}">
																									<c:if
																										test="${desktopTab.owner.ampTeamMemId==aimTeamReportsForm.currentMemberId}">
																										<c:set var="position">
					                                									${desktopTab.index}
					                                									</c:set>
																									</c:if>
																								</c:forEach> <a class="activateTab${report.ampReportId}"
																								onclick="activate(${report.ampReportId})"
																								<c:if test="${not empty position}">style="display:none"</c:if>><digi:trn>activate</digi:trn></a>
																								<div class="savePosition${report.ampReportId}"
																									<c:if test="${empty position}">style="display:none"</c:if>>
																									<select
																										class="savePositionDropDown${report.ampReportId}"
																										...
																										<c:forEach var="i" begin="0" end="4">
																											<option value="${i}"
																												<c:if test="${position==i}">selected</c:if>>
																												<c:out value="${i+1}" />
																											</option>
																										</c:forEach>
																									</select>
																								</div> <c:remove var="position" /></td>
																						</c:if>
																						<td align="center" class="inside"
																							style="padding-right: 15px; padding-left: 15px; font-size: 11px;"
																							bgcolor="<%=color%>">
																							<p style="white-space: nowrap">
																								...
																								<c:set target="${urlParams}" property="event"
																									value="edit" />
																								<logic:equal name="teamLeadFlag" scope="session"
																									value="true">
																									<c:set var="translation">
																										<c:if test="${aimTeamReportsForm.showTabs}">
																									...
																									<digi:link
																										href="/reportWizard.do?editReportId=${report.ampReportId}"
																										title="${translation}">
																										<img
																											src="/repository/message/view/images/edit.gif"
					                                      									...
					                                      									<c:set
																										...
																										<c:if test="${aimTeamReportsForm.showTabs}">
																											...
																											<c:set target="${urlParams}" property="isTab"
																												value="1" />
																										</c:if>
																										<c:if test="${!aimTeamReportsForm.showTabs}">
																									...
																									<digi:link href="/deleteAllReports.do"
																										name="urlParams"
																										onclick="return confirmFunc()"
																										title="${translation}">
																										<img
																											src="/repository/message/view/images/trash_12.gif"
																											vspace="2" border="0" align="absmiddle" />
																								...
																								<logic:equal name="teamLeadFlag" scope="session"
																									value="false">
																									<logic:present name="report" property="ownerId">
																										<logic:equal name="report"
																											property="ownerId.ampTeamMemId"
																											value="${aimTeamReportsForm.currentMemberId}">
																											<c:set var="translation">
																												<c:if test="${aimTeamReportsForm.showTabs}">
																													<digi:trn key="aim:ClickEditTab">Click on this icon to edit tab&nbsp;</digi:trn>
																												</c:if>
																											...
																											<c:set var="translation">
																												<c:if test="${aimTeamReportsForm.showTabs}">
																													<digi:trn key="aim:ClickDeleteTab">Click on this icon to delete tab&nbsp;</digi:trn>
																													<c:set target="${urlParams}"
																														property="isTab" value="1" />
																												</c:if>
																												<c:if test="${!aimTeamReportsForm.showTabs}">
																													<digi:trn key="aim:ClickDeleteReport">Click on this icon to delete report&nbsp;</digi:trn>
																													<c:set target="${urlParams}"
																														property="isTab" value="0" />
																												</c:if>
																											</c:set>
																											<digi:link href="/deleteAllReports.do"
																												name="urlParams"
														...
														<tr>
															<td valign="top"><c:if test="${reportNumber != 0}">
																	<table
																		style="font-size: 11px; font-family: Aria, sans-serif;">
																		<tr>
