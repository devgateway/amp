...
<feature:display module="Funding" name="MTEF Projections">
                                            ...
                                            <feature:display module="Funding" name="Expenditures">
					      			        ...
					      			        <feature:display module="Funding" name="Expenditures">
                                            	    ...
                                            	    <TD align="center" nowrap="nowrap"><bean:write name="breakdown" property="totalCost"/></TD>
                                            		<TD align="center" nowrap="nowrap"><bean:write name="breakdown" property="uncommittedbalance"/></TD>
												</TR>
											</logic:iterate>
											</logic:notEmpty>
				                  ...
				                  <TR valign="top">
		    	                    ...
		    	                    <TD class="note" style="background-color:#FFFFFF;"></TD>
						                ...
						                <TD class="note" style="background-color:#FFFFFF;"></TD>
				                                        ...
				                                        <feature:display module="Funding" name="MTEF Projections">
                                                    	<field:display feature="MTEF Projections" name="MTEFProjections">
                                                            <TD align="right" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalProjections"/></TD>
				                    					</field:display>
                                                        </feature:display>
														<field:display name="Total Committed" feature="Commitments">
                                                            <TD align="center" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalCommitted"/></TD>
														</field:display>
                                                        <field:display name="Total Ordered" feature="Disbursement Orders">
                                                            <TD align="center" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalDisbOrdered"/></TD>
                                                        </field:display>
														<field:display name="Total Disbursed" feature="Disbursement">
                                                            <TD align="center" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalDisbursed"/></TD>
														</field:display>
														<field:display name="Undisbursed Funds" feature="Funding Information">
                                                            <TD align="center" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalUnDisbursed"/></TD>
                                                        </field:display>
														<feature:display module="Funding" name="Expenditures">
                                                		    <field:display name="Total Expended" feature="Expenditures">
                                                                <TD align="center" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalExpended"/></TD>
                                                		    </field:display>
                                                        </feature:display>
                                            		<feature:display module="Funding" name="Expenditures">
													    <field:display name="Unexpended Funds" feature="Funding Information">
    								                    ...
    								                    <TD align="center" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalCost"/></TD>
                                                        <TD align="center" class="note" style="background-color:#FFFFFF;"><bean:write name="aimFinancingBreakdownForm" property="totalUncommitted"/></TD>
