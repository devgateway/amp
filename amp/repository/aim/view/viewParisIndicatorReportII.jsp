													...
													<td>
														<table>
															<tr>
																...
																<i><digi:trn key="rep:pop:SelectedRangeStartYear">Start Year</digi:trn>:</i>&nbsp;${aimParisIndicatorReportForm.startYear}&nbsp;|
																<i><digi:trn key="rep:pop:SelectedRangeEndYear">End Year</digi:trn>:</i>&nbsp;${aimParisIndicatorReportForm.closeYear}&nbsp;|				
																<c:if test = "${aimParisIndicatorReportForm.indicatorCode != '10a'}">
																	...
																	<i><digi:trn key="rep:pop:CalendarType">Calendar Type</digi:trn>:</i>&nbsp;<%=cal%>&nbsp;|
																	...
																	<i><digi:trn key="rep:pop:CurrencyType">Currency Type</digi:trn>:</i>&nbsp;<%=curr%>&nbsp;|
																</c:if>
																<%String donorAux = "All";
																...
																<i><digi:trn key="rep:pop:Donors">Donors</digi:trn>:</i>&nbsp;<%=donorAux%>&nbsp;|			
																<c:if test = "${aimParisIndicatorReportForm.indicatorCode != '10a'}">
																	<%
																	...
																	%>
																	<i><digi:trn key="rep:pop:StatusType">Status Type</digi:trn>:</i>&nbsp;<%=statusName%>&nbsp;|
																</c:if>
																<c:if test = "${aimParisIndicatorReportForm.indicatorCode == '10a'}">
																	<%
																	...
																	%>
																	<i><digi:trn key="rep:pop:Groups">Groups</digi:trn>:</i>&nbsp;<%=groupsAux%>&nbsp;|
																</c:if>
																</td>
															</tr>
														</table>
												...
												<c:if test = "${aimParisIndicatorReportForm.indicatorCode != '10a'}">
													<tr>
														<td style="font-size:11px;" valign="top">
															...
															%>
															<i><digi:trn key="rep:filer:financingInstrument">Financing Instrument</digi:trn>:</i>&nbsp;<%=indName%>&nbsp;|
															...
															<i><digi:trn key="rep:pop:sectors">Sectors</digi:trn>:</i>&nbsp;<%=sectorAux%>&nbsp;|
														</td>
													</tr>
												</c:if>
											</table>
													...
													<LI class='<%=(request.getParameter("indcId").equals(new Integer(newTabIndex).toString()))?"selected":""%>'>
														<span>
															...
															<div style="max-width: 90px">
																<digi:trn key="aim:parisIndicator:${report.indicatorCode}">Paris<br><c:out value="Indicator ${report.indicatorCode}"/></digi:trn>
									                        </div>
															</digi:link>
								                    	</span>
													</LI>
