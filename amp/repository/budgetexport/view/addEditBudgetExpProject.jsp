...
<tr>
<td colspan=4 align=center background="/TEMPLATE/ampTemplate/images/ins_header.gif" class=inside><b class="ins_header"><digi:trn>Add/Edit Budget Export Project</digi:trn></b></td>
</tr>
<tr>
    <td background="/TEMPLATE/ampTemplate/images/ins_bg.gif" class=inside width=40%><b class="ins_header" style="font-size:11px;"><digi:trn>Name</digi:trn></b></td>
    <td background="/TEMPLATE/ampTemplate/images/ins_bg.gif" class=inside width=40%><b class="ins_header" style="font-size:11px;"><digi:trn>Description</digi:trn></b></td>
    <td background="/TEMPLATE/ampTemplate/images/ins_bg.gif" class=inside width=20%><b class="ins_header" style="font-size:11px;"><digi:trn>Report</digi:trn></b></td>
    </tr>
<tr>
    <td class=inside>
