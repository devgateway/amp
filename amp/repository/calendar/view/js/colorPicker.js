...
function PopupWindow_showPopup(anchorname) {
    ...
    if(this.divName != null) {
        ...
        if(this.popupWindow == null || this.popupWindow.closed) {
            ...
            var avoidAboutBlank = window.opera ||
                (document.layers && !navigator.mimeTypes['*']) ||
                navigator.vendor == 'KDE ' || (document.childNodes && !
                                               document.all &&
                                               !navigator.taintEnabled);
            this.popupWindow = window.open(avoidAboutBlank ? "" : "about:blank",
                                           "window_" + anchorname,
                                           this.windowProperties + ",width=" +
                                           this.width + ",height=" +
                                           this.height + ",screenX=" + this.x +
                                           ",left=" + this.x + ",screenY=" +
                                           this.y + ",top=" + this.y + "");
        }
        this.refresh();
...
function PopupWindow_isClicked(e) {
    if(this.divName != null) {
        if(this.use_layers) {
            ...
            if((clickX > t.left) && (clickX < t.left + t.clip.width) &&
               (clickY > t.top) && (clickY < t.top + t.clip.height)) {
                return true;
            } else {
                return false;
            }
