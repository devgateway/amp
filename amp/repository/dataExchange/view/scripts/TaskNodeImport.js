...
//        this.logger.log("check");
        ...
        //id_activities
        document.getElementById("de_btn_import_1").disabled = false;
        document.getElementById("de_btn_import_2").disabled = false;
        document.getElementById("de_btn_import_3").disabled = false;
        var existEl = document.getElementById("li_id_"+this.aid);
        if(existEl == null && this.aid != "activityTreeselect"){
	        var acts = document.getElementById("id_activities");
	        var new_element = document.createElement('li');
	        new_element.innerHTML = this.actName;
	        new_element.id = 'li_id_'+this.aid;
	        acts.insertBefore(new_element, acts.firstChild);
        }
        //if(this.aid == "activityTreeselect") {
		//	checkAll1();
		//}
...
//      this.updateParent();
    ...
    uncheck: function() { 
        ...
        var acts = document.getElementById("li_id_"+this.aid);
        if(acts != null)
        	acts.parentNode.removeChild(acts);
...
//        this.updateParent();
    ...
    unCheckAll: function() { 
    	...
    	this.uncheck();
        document.getElementById("de_btn_import_1").disabled = true;
        document.getElementById("de_btn_import_2").disabled = true;
        document.getElementById("de_btn_import_3").disabled = true;
