...
YAHOOAmp.lang.augmentProto(YAHOOAmp.util.Chain,YAHOOAmp.util.EventProvider);
/****************************************************************************/
/****************************************************************************/
/****************************************************************************/
 ...
 * the THEAD.
 */
YAHOOAmp.widget.ColumnSet = function(aDefinitions) {
    this._sId = "yui-cs" + YAHOOAmp.widget.ColumnSet._nCount;

    // First clone the defs
    aDefinitions = YAHOOAmp.widget.DataTable._cloneObject(aDefinitions);
    this._init(aDefinitions);

    YAHOOAmp.widget.ColumnSet._nCount++;
    YAHOOAmp.log("ColumnSet initialized", "info", this.toString());
};
 ...
 * @static
 */
YAHOOAmp.widget.ColumnSet._nCount = 0;

YAHOOAmp.widget.ColumnSet.prototype = {
    /**
    ...
    _init : function(aDefinitions) {        
        ...
        var parseColumns = function(nodeList, parent) {
            ...
            for(var j=0; j<nodeList.length; j++) {
                ...
                var oColumn = new YAHOOAmp.widget.Column(currentNode);
                
                // Assign unique ID to Column and cross-reference it back to the
                // original object literal definition
                currentNode.yuiColumnId = oColumn._sId = YAHOOAmp.widget.Column._nCount + "";
                
                // Assign a key if not found
                if(!YAHOOAmp.lang.isValue(oColumn.key)) {
                    oColumn.key = "yui-dt-col" + YAHOOAmp.widget.Column._nCount;
                }
                // Increment counter
                YAHOOAmp.widget.Column._nCount++;
                ...
                if(YAHOOAmp.lang.isArray(currentNode.children)) {
                    ...
                    var countTerminalChildNodes = function(ancestor) {
                        ...
                        for(var k=0; k<descendants.length; k++) {
                            // Keep drilling down
                            if(YAHOOAmp.lang.isArray(descendants[k].children)) {
        ...
        if(YAHOOAmp.lang.isArray(aDefinitions)) {
            ...
            YAHOOAmp.log("Could not initialize ColumnSet due to invalid definitions","error");
            return null;
        }
        ...
        var parseTreeForRowspan = function(tree) {
            ...
            var countMaxRowDepth = function(row, tmpRowDepth) {
                ...
                for(var n=0; n<row.length; n++) {
                    ...
                    if(YAHOOAmp.lang.isArray(col.children)) {
                        tmpRowDepth++;
            ...
            for(var m=0; m<tree.length; m++) {
                ...
                for(var p=0; p<currentRow.length; p++) {
                    ...
                    if(!YAHOOAmp.lang.isArray(currentColumn.children)) {
     ...
     * @return {YAHOOAmp.widget.Column} Column instance.
     */

    getColumnById : function(column) {
        if(YAHOOAmp.lang.isString(column)) {
    ...
    getColumn : function(column) {
        if(YAHOOAmp.lang.isNumber(column) && this.keys[column]) {
            return this.keys[column];
        }
        else if(YAHOOAmp.lang.isString(column)) {
            var allColumns = this.flat;
            var aColumns = [];
     ...
     * @parem {YAHOOAmp.widget.Column} Column instance.
 ...
 */
YAHOOAmp.widget.Column = function(oConfigs) {
    ...
    // Backward compatibility
    if(this.width && !YAHOOAmp.lang.isNumber(this.width)) {
        this.width = null;
        YAHOOAmp.log("The Column property width must be a number", "warn", this.toString());
    }
};
...
YAHOOAmp.lang.augmentObject(YAHOOAmp.widget.Column, {
    /**
    ...
    formatCheckbox : function(elCell, oRecord, oColumn, oData) {
        YAHOOAmp.log("The method YAHOOAmp.widget.Column.formatCheckbox() has been" +
        " deprecated in favor of YAHOOAmp.widget.DataTable.formatCheckbox()", "warn",
        "YAHOOAmp.widget.Column.formatCheckbox");
        YAHOOAmp.widget.DataTable.formatCheckbox(elCell, oRecord, oColumn, oData);
    },

    formatCurrency : function(elCell, oRecord, oColumn, oData) {
        YAHOOAmp.log("The method YAHOOAmp.widget.Column.formatCurrency() has been" +
        " deprecated in favor of YAHOOAmp.widget.DataTable.formatCurrency()", "warn",
        "YAHOOAmp.widget.Column.formatCurrency");
        YAHOOAmp.widget.DataTable.formatCurrency(elCell, oRecord, oColumn, oData);
    },

    formatDate : function(elCell, oRecord, oColumn, oData) {
        YAHOOAmp.log("The method YAHOOAmp.widget.Column.formatDate() has been" +
        " deprecated in favor of YAHOOAmp.widget.DataTable.formatDate()", "warn",
        "YAHOOAmp.widget.Column.formatDate");
        YAHOOAmp.widget.DataTable.formatDate(elCell, oRecord, oColumn, oData);
    },

    formatEmail : function(elCell, oRecord, oColumn, oData) {
        YAHOOAmp.log("The method YAHOOAmp.widget.Column.formatEmail() has been" +
        " deprecated in favor of YAHOOAmp.widget.DataTable.formatEmail()", "warn",
        "YAHOOAmp.widget.Column.formatEmail");
        YAHOOAmp.widget.DataTable.formatEmail(elCell, oRecord, oColumn, oData);
    },

    formatLink : function(elCell, oRecord, oColumn, oData) {
        YAHOOAmp.log("The method YAHOOAmp.widget.Column.formatLink() has been" +
        " deprecated in favor of YAHOOAmp.widget.DataTable.formatLink()", "warn",
        "YAHOOAmp.widget.Column.formatLink");
        YAHOOAmp.widget.DataTable.formatLink(elCell, oRecord, oColumn, oData);
    },

    formatNumber : function(elCell, oRecord, oColumn, oData) {
        YAHOOAmp.log("The method YAHOOAmp.widget.Column.formatNumber() has been" +
        " deprecated in favor of YAHOOAmp.widget.DataTable.formatNumber()", "warn",
        "YAHOOAmp.widget.Column.formatNumber");
        YAHOOAmp.widget.DataTable.formatNumber(elCell, oRecord, oColumn, oData);
    },

    formatSelect : function(elCell, oRecord, oColumn, oData) {
        YAHOOAmp.log("The method YAHOOAmp.widget.Column.formatSelect() has been" +
        " deprecated in favor of YAHOOAmp.widget.DataTable.formatDropdown()", "warn",
        "YAHOOAmp.widget.Column.formatSelect");
        YAHOOAmp.widget.DataTable.formatDropdown(elCell, oRecord, oColumn, oData);
    }
});

YAHOOAmp.widget.Column.prototype = {
    /**
     ...
     * @private
     */
    //YAHOOAmp.widget.Column.prototype._elCol = null;
     ...
     */
    /**
     * Default sort direction for Column: YAHOOAmp.widget.DataTable.CLASS_ASC or YAHOOAmp.widget.DataTable.CLASS_DESC.
     *
     ...
     *
     * @method getParent
     * @return {YAHOOAmp.widget.Column} Column's parent instance.
     */
    getParent : function() {
    ...
    // Backward compatibility
    getColSpan : function() {
        YAHOOAmp.log("The method getColSpan() has been" +
     ...
     */
    getColEl : function() {
        YAHOOAmp.log("The method getColEl() has been" +
        " deprecated in favor of getThEl()", "warn",
        this.toString());
        return this.getThEl();
    },
    getIndex : function() {
        YAHOOAmp.log("The method getIndex() has been" +
        " deprecated in favor of getKeyIndex()", "warn",
        this.toString());
        return this.getKeyIndex();
    },
    format : function() {
        YAHOOAmp.log("The method format() has been deprecated in favor of the " +
 ...
 * @namespace YAHOOAmp.util
 * @class ColumnDD
 * @extends YAHOOAmp.util.DDProxy
 * @constructor
 * @param oDataTable {YAHOOAmp.widget.DataTable} DataTable instance.
 * @param oColumn {YAHOOAmp.widget.Column} Column instance.
 * @param elTh {HTMLElement} TH element reference.
 * @param elTarget {HTMLElement} Drag target element.
 */
YAHOOAmp.widget.ColumnDD = function(oDataTable, oColumn, elTh, elTarget) {
    if(oDataTable && oColumn && elTh && elTarget) {
        ...
        YAHOOAmp.log("Column dragdrop could not be created","warn",oDataTable.toString());
    }
};

if(YAHOOAmp.util.DDProxy) {
    YAHOOAmp.extend(YAHOOAmp.widget.ColumnDD, YAHOOAmp.util.DDProxy, {
        initConstraints: function() {
            //Get the top, right, bottom and left positions
            var region = YAHOOAmp.util.Dom.getRegion(this.table),
                //Get the element we are working on
                el = this.getEl(),
                //Get the xy position of it
                xy = YAHOOAmp.util.Dom.getXY(el),
                //Get the width and height
                width = parseInt(YAHOOAmp.util.Dom.getStyle(el, 'width'), 10),
                height = parseInt(YAHOOAmp.util.Dom.getStyle(el, 'height'), 10),
            ...
            YAHOOAmp.util.Event.on(window, 'resize', function() {
        ...
        _resizeProxy: function() {
            ...
            YAHOOAmp.util.Dom.setStyle(this.pointer, 'height', (this.table.parentNode.offsetHeight + 10) + 'px');
            YAHOOAmp.util.Dom.setStyle(this.pointer, 'display', 'block');
            var xy = YAHOOAmp.util.Dom.getXY(el);
            YAHOOAmp.util.Dom.setXY(this.pointer, [xy[0], (xy[1] - 5)]);
            
            YAHOOAmp.util.Dom.setStyle(dragEl, 'height', this.datatable.getContainerEl().offsetHeight + "px");
            YAHOOAmp.util.Dom.setStyle(dragEl, 'width', (parseInt(YAHOOAmp.util.Dom.getStyle(dragEl, 'width'),10) + 4) + 'px');
            YAHOOAmp.util.Dom.setXY(this.dragEl, xy);
        },
        ...
        clickValidator: function(e) {
            if(!this.column.hidden) {
                var target = YAHOOAmp.util.Event.getTarget(e);
        ...
        onDragOver: function(ev, id) {
            ...
            if(target) {
                var mouseX = YAHOOAmp.util.Event.getPageX(ev),
                targetX = YAHOOAmp.util.Dom.getX(id),
                midX = targetX + ((YAHOOAmp.util.Dom.get(id).offsetWidth)/2),
                ...
                if (mouseX < midX) {
                   YAHOOAmp.util.Dom.setX(this.pointer, targetX);
                } else {
                    var thisWidth = parseInt(target.getThEl().offsetWidth, 10);
                    YAHOOAmp.util.Dom.setX(this.pointer, (targetX + thisWidth));
                    newIndex++;
                }
        ...
        onDragDrop: function() {
            if(YAHOOAmp.lang.isNumber(this.newIndex) && (this.newIndex !== this.column.getTreeIndex())) {
        ...
        endDrag: function() {
            this.newIndex = null;
            YAHOOAmp.util.Dom.setStyle(this.pointer, 'display', 'none');
        }
    });
}
 ...
 */
YAHOOAmp.util.ColumnResizer = function(oDataTable, oColumn, elTh, sHandleId, elProxy) {
    if(oDataTable && oColumn && elTh && sHandleId) {
        ...
        YAHOOAmp.log("Column resizer could not be created","warn",oDataTable.toString());
    }
};

if(YAHOOAmp.util.DD) {
    YAHOOAmp.extend(YAHOOAmp.util.ColumnResizer, YAHOOAmp.util.DDProxy, {
        /////////////////////////////////////////////////////////////////////////////
        //
        // Public methods
        //
        ...
        resetResizerEl : function() {
            var resizerStyle = YAHOOAmp.util.Dom.get(this.handleElId).style;
        ...
        onMouseUp : function(e) {
            ...
            var newWidth = el.offsetWidth -
                (parseInt(YAHOOAmp.util.Dom.getStyle(el,"paddingLeft"),10)|0) -
                (parseInt(YAHOOAmp.util.Dom.getStyle(el,"paddingRight"),10)|0);
        ...
        onMouseDown : function(e) {
            ...
            this.startX = YAHOOAmp.util.Event.getXY(e)[0];
            this.nLinerPadding = (parseInt(YAHOOAmp.util.Dom.getStyle(this.headCellLiner,"paddingLeft"),10)|0) +
                    (parseInt(YAHOOAmp.util.Dom.getStyle(this.headCellLiner,"paddingRight"),10)|0);
        },
         ...
         */
        onDrag : function(e) {
            var newX = YAHOOAmp.util.Event.getXY(e)[0];
            if(newX > YAHOOAmp.util.Dom.getX(this.headCellLiner)) {
 ...
 * @constructor
 */
YAHOOAmp.widget.RecordSet = function(data) {
    // Internal variables
    this._sId = "yui-rs" + YAHOOAmp.widget.RecordSet._nCount;
    YAHOOAmp.widget.RecordSet._nCount++;
    this._records = [];
    //this._length = 0;

    if(data) {
        if(YAHOOAmp.lang.isArray(data)) {
     ...
     * @param oArgs.record {YAHOOAmp.widget.Record} The Record instance.
     ...
     * @param oArgs.records {YAHOOAmp.widget.Record[]} An array of Record instances.
     * @param oArgs.data {Object[]} Data added.
     */
    ...
    YAHOOAmp.log("RecordSet initialized", "info", this.toString());
};
 ...
 * @static
 */
YAHOOAmp.widget.RecordSet._nCount = 0;

YAHOOAmp.widget.RecordSet.prototype = {
     ...
     * @return {YAHOOAmp.widget.Record} A Record instance.
     * @private
     */
    _addRecord : function(oData, index) {
        var oRecord = new YAHOOAmp.widget.Record(oData);
        
        if(YAHOOAmp.lang.isNumber(index) && (index > -1)) {
    ...
    _setRecord : function(oData, index) {
        if (!YAHOOAmp.lang.isNumber(index) || index < 0) {
            index = this._records.length;
        }
        return (this._records[index] = new YAHOOAmp.widget.Record(oData));
        /*
        if(YAHOOAmp.lang.isNumber(index) && (index > -1)) {
            this._records[index] = oRecord;
    ...
    _deleteRecord : function(index, range) {
        if(!YAHOOAmp.lang.isNumber(range) || (range < 0)) {
            range = 1;
        }
     ...
     *
     * @method getRecord
     * @param record {YAHOOAmp.widget.Record | Number | String} Record instance,
     * RecordSet position index, or Record ID.
     * @return {YAHOOAmp.widget.Record} Record object.
     */
    getRecord : function(record) {
        var i;
        if(record instanceof YAHOOAmp.widget.Record) {
        ...
        else if(YAHOOAmp.lang.isNumber(record)) {
            if((record > -1) && (record < this.getLength())) {
                return this._records[record];
            }
        }
        else if(YAHOOAmp.lang.isString(record)) {
            for(i=0; i<this._records.length; i++) {
     ...
     * @return {YAHOOAmp.widget.Record[]} Array of Records starting at given index and
     * length equal to given range. If index is not given, all Records are returned.
     */
    getRecords : function(index, range) {
        if(!YAHOOAmp.lang.isNumber(index)) {
            return this._records;
        }
        if(!YAHOOAmp.lang.isNumber(range)) {
     ...
     * @param oRecord {YAHOOAmp.widget.Record} Record instance.
    ...
    addRecord : function(oData, index) {
        if(oData && (oData.constructor == Object)) {
            ...
            YAHOOAmp.log("Added Record at index " + index +
                    " with data " + YAHOOAmp.lang.dump(oData), "info", this.toString());
            return oRecord;
        }
        else {
            YAHOOAmp.log("Could not add Record with data" +
                    YAHOOAmp.lang.dump(oData), "info", this.toString());
            return null;
        }
    },
     ...
     * @param index {Number} (optional) Position index.
     * @return {YAHOOAmp.widget.Record[]} An array of Record instances.
     */
    addRecords : function(aData, index) {
        if(YAHOOAmp.lang.isArray(aData)) {
            var newRecords = [];
            ...
            YAHOOAmp.log("Added " + newRecords.length + " Record(s) at index " + index +
                    " with data " + YAHOOAmp.lang.dump(aData), "info", this.toString());
           return newRecords;
        }
            ...
            YAHOOAmp.log("Added 1 Record at index " + index +
                    " with data " + YAHOOAmp.lang.dump(aData), "info", this.toString());
            return oRecord;
        }
        else {
            YAHOOAmp.log("Could not add Records with data " +
                    YAHOOAmp.lang.dump(aData), "info", this.toString());
            return null;
        }
    },
    ...
    setRecord : function(oData, index) {
        if(oData && (oData.constructor == Object)) {
            ...
            YAHOOAmp.log("Set Record at index " + index +
                    " with data " + YAHOOAmp.lang.dump(oData), "info", this.toString());
            return oRecord;
        }
        else {
            YAHOOAmp.log("Could not set Record with data" +
                    YAHOOAmp.lang.dump(oData), "info", this.toString());
            return null;
        }
    },
    ...
    setRecords : function(aData, index) {
        var Rec   = YAHOOAmp.widget.Record,
            a     = YAHOOAmp.lang.isArray(aData) ? aData : [aData],
            added = [],
            i = 0, l = a.length, j = 0;
        ...
        YAHOOAmp.log("Set "+j+" Record(s) at index "+index, "info",
                  this.toString());

        if (a.length && !added.length) {
            YAHOOAmp.log("Could not set Records with data " +
                    YAHOOAmp.lang.dump(aData), "info", this.toString());
        }
     ...
     *
     * @method updateRecord
     * @param record {YAHOOAmp.widget.Record | Number | String} A Record instance,
     * a RecordSet position index, or a Record ID.
     * @param oData {Object} Object literal of new data.
     * @return {YAHOOAmp.widget.Record} Updated Record, or null.
     */
    updateRecord : function(record, oData) {
        ...
        if(oRecord && oData && (oData.constructor == Object)) {
            ...
            YAHOOAmp.log("Record at index " + this.getRecordIndex(oRecord) +
                    " updated with data " + YAHOOAmp.lang.dump(oData), "info", this.toString());
            return oRecord;
        }
        else {
            YAHOOAmp.log("Could not update Record " + record, "error", this.toString());
            return null;
        }
    },
    ...
    updateRecordValue : function(record, sKey, oData) {
        ...
        if(oRecord) {
            ...
            YAHOOAmp.log("Key \"" + sKey +
                    "\" for Record at index " + this.getRecordIndex(oRecord) +
                    " updated to \"" + YAHOOAmp.lang.dump(oData) + "\"", "info", this.toString());
        }
        else {
            YAHOOAmp.log("Could not update key " + sKey + " for Record " + record, "error", this.toString());
        }
    },
     ...
     * @return {YAHOOAmp.widget.Record || YAHOOAmp.widget.Record[]} A Record instance or
     * an array of Records.
     */
     ...
     * @return {YAHOOAmp.widget.Record[]} Sorted array of Records.
     */
     ...
     * @return {YAHOOAmp.widget.Record[]} Reverse-sorted array of Records.
     */
    ...
    deleteRecord : function(index) {
        if(YAHOOAmp.lang.isNumber(index) && (index > -1) && (index < this.getLength())) {
            // Copy data from the Record for the event that gets fired later
            var oData = YAHOOAmp.widget.DataTable._cloneObject(this.getRecord(index).getData());
            
            this._deleteRecord(index);
            this.fireEvent("recordDeleteEvent",{data:oData,index:index});
            YAHOOAmp.log("Record deleted at index " + index +
                    " and containing data " + YAHOOAmp.lang.dump(oData), "info", this.toString());
            return oData;
        }
        else {
            YAHOOAmp.log("Could not delete Record at index " + index, "error", this.toString());
            return null;
        }
    },
    ...
    deleteRecords : function(index, range) {
        ...
        if(YAHOOAmp.lang.isNumber(index) && (index > -1) && (index < this.getLength())) {
            ...
            for(var i=0; i<recordsToDelete.length; i++) {
                deletedData[deletedData.length] = YAHOOAmp.widget.DataTable._cloneObject(recordsToDelete[i]);
            }
            this._deleteRecord(index, range);

            this.fireEvent("recordsDeleteEvent",{data:deletedData,index:index});
            YAHOOAmp.log(range + "Record(s) deleted at index " + index +
                    " and containing data " + YAHOOAmp.lang.dump(deletedData), "info", this.toString());

            return deletedData;
        }
        else {
            YAHOOAmp.log("Could not delete Records at index " + index, "error", this.toString());
            return null;
        }
    },
    ...
    reset : function() {
        ...
        YAHOOAmp.log("All Records deleted from RecordSet", "info", this.toString());
    }
};

YAHOOAmp.augment(YAHOOAmp.widget.RecordSet, YAHOOAmp.util.EventProvider);
 ...
 */
YAHOOAmp.widget.Record = function(oLiteral) {
    this._sId = "yui-rec" + YAHOOAmp.widget.Record._nCount;
    YAHOOAmp.widget.Record._nCount++;
    this._oData = {};
 ...
 * @private
 */
YAHOOAmp.widget.Record._nCount = 0;

YAHOOAmp.widget.Record.prototype = {
    /**
    ...
    getData : function(sKey) {
        if(YAHOOAmp.lang.isString(sKey)) {
 ...
 * @class Paginator
 * @uses YAHOOAmp.util.EventProvider
 * @uses YAHOOAmp.util.AttributeProvider
 *
 * @constructor
 * @param config {Object} Object literal to set instance and ui component
 * configuration.
 */
YAHOOAmp.widget.Paginator = function (config) {
    var UNLIMITED = YAHOOAmp.widget.Paginator.VALUE_UNLIMITED,
        lang      = YAHOOAmp.lang,
...
// Static members
YAHOOAmp.lang.augmentObject(YAHOOAmp.widget.Paginator, {
    /**
...
YAHOOAmp.widget.Paginator.prototype = {
    ...
    /**
     * Initialize the Paginator's attributes (see YAHOOAmp.util.Element class
     * AttributeProvider).
     * @method initConfig
     * @private
     */
    initConfig : function () {
        ...
        this.setAttributeConfig('template', {
            value : YAHOOAmp.widget.Paginator.TEMPLATE_DEFAULT,
        ...
        this.setAttributeConfig('id', {
            value    : YAHOOAmp.widget.Paginator.id++,
            readOnly : true
        });
    ...
    initUIComponents : function () {
        var ui = YAHOOAmp.widget.Paginator.ui;
        for (var name in ui) {
            var UIComp = ui[name];
            if (YAHOOAmp.lang.isObject(UIComp) &&
                YAHOOAmp.lang.isFunction(UIComp.init)) {
                UIComp.init(this);
            }
        }
    },
    ...
    render : function () {
        ...
        if (totalRecords !== YAHOOAmp.widget.Paginator.VALUE_UNLIMITED &&
        ...
        for (var i = 0, len = this._containers.length; i < len; ++i) {
            var c       = this._containers[i],
                ...
                id_base = YAHOOAmp.widget.Paginator.ID_BASE + this.get('id') +
                          '-' + i;
            ...
            for (var j = 0, jlen = markers.length; j < jlen; ++j) {
                var m      = markers[j],
                    ...
                    UIComp = YAHOOAmp.widget.Paginator.ui[name];

                if (YAHOOAmp.lang.isFunction(UIComp)) {
                    var comp = new UIComp(this);
                    if (YAHOOAmp.lang.isFunction(comp.render)) {
    ...
    updateVisibility : function (e) {
        ...
        if (e.type === 'alwaysVisibleChange' || !alwaysVisible) {
            ...
            if (YAHOOAmp.lang.isArray(rppOptions)) {
            ...
            for (i = 0, len = this._containers.length; i < len; ++i) {
                YAHOOAmp.util.Dom.setStyle(this._containers[i],'display',
                    visible ? '' : 'none');
            }
        }
    },
     ...
     * set to YAHOOAmp.widget.Paginator.VALUE_UNLIMITED, returns
     * YAHOOAmp.widget.Paginator.VALUE_UNLIMITED.
    ...
    getTotalPages : function () {
        ...
        if (records === YAHOOAmp.widget.Paginator.VALUE_UNLIMITED) {
            return YAHOOAmp.widget.Paginator.VALUE_UNLIMITED;
        }
    ...
    hasPage : function (page) {
        if (!YAHOOAmp.lang.isNumber(page) || page < 1) {
            return false;
        }

        var totalPages = this.getTotalPages();

        return (totalPages === YAHOOAmp.widget.Paginator.VALUE_UNLIMITED || totalPages >= page);
    },
    ...
    hasNextPage : function () {
        ...
        return currentPage && (totalPages === YAHOOAmp.widget.Paginator.VALUE_UNLIMITED || currentPage < totalPages);
    },
    ...
    getPageRecords : function (page) {
        if (!YAHOOAmp.lang.isNumber(page)) {
    ...
    setRowsPerPage : function (rpp,silent) {
        if (YAHOOAmp.lang.isNumber(rpp) && rpp > 0 &&
            rpp !== this.get('rowsPerPage')) {
            if (this.get('updateOnChange') || silent) {
    ...
    setTotalRecords : function (total,silent) {
        if (YAHOOAmp.lang.isNumber(total) && total >= 0 &&
    ...
    setStartIndex : function (offset,silent) {
        if (YAHOOAmp.lang.isNumber(offset) && offset >= 0 &&
    ...
    _syncRecordOffset : function (v) {
        if (v !== YAHOOAmp.widget.Paginator.VALUE_UNLIMITED) {
...
YAHOOAmp.lang.augmentProto(YAHOOAmp.widget.Paginator, YAHOOAmp.util.AttributeProvider);
...
YAHOOAmp.widget.Paginator.ui = {};

var Paginator = YAHOOAmp.widget.Paginator,
    ui        = Paginator.ui,
    l         = YAHOOAmp.lang;
 ...
 *
 * @namespace YAHOOAmp.widget.Paginator.ui
 * @class FirstPageLink
 * @for YAHOOAmp.widget.Paginator
 *
 * @constructor
...
ui.FirstPageLink.prototype = {
    ...
    render : function (id_base) {
        ...
        YAHOOAmp.util.Event.on(this.link,'click',this.onClick,this,true);
     ...
     */
    destroy : function () {
        YAHOOAmp.util.Event.purgeElement(this.link);
    },
     ...
     */
    onClick : function (e) {
        YAHOOAmp.util.Event.stopEvent(e);
...
ui.PageLinks.prototype = {
    ...
    render : function (id_base) {
        ...
        YAHOOAmp.util.Event.on(this.container,'click',this.onClick,this,true);
     ...
     */
    destroy : function () {
        YAHOOAmp.util.Event.purgeElement(this.container,true);
    },
     ...
     */
    onClick : function (e) {
        var t = YAHOOAmp.util.Event.getTarget(e);
        if (t && YAHOOAmp.util.Dom.hasClass(t,
...
ui.RowsPerPageDropdown.prototype = {
    ...
    render : function (id_base) {
        ...
        YAHOOAmp.util.Event.on(this.select,'change',this.onChange,this,true);
     ...
     */
    destroy : function () {
        YAHOOAmp.util.Event.purgeElement(this.select);
    },
 ...
 * @param oDataSource {YAHOOAmp.util.DataSource} DataSource instance.
 * @param oConfigs {object} (optional) Object literal of configuration values.
 */
YAHOOAmp.widget.DataTable = function(elContainer,aColumnDefs,oDataSource,oConfigs) {
    var DT = YAHOOAmp.widget.DataTable,
        DS = YAHOOAmp.util.DataSource;

    // Internal vars
    this._nIndex = DT._nCount;
    this._sId = "yui-dt"+this._nIndex;
    this._oChainRender = new YAHOOAmp.util.Chain();
    this._oChainSync = new YAHOOAmp.util.Chain();
    ...
    if(!this._oDataSource) {
        YAHOOAmp.log("Could not instantiate DataTable due to an invalid DataSource", "error", this.toString());
        return;
    }
    ...
    if(!this._oColumnSet) {
        YAHOOAmp.log("Could not instantiate DataTable due to an invalid ColumnSet", "error", this.toString());
        return;
    }
    ...
    this._initRecordSet();
    if(!this._oRecordSet) {
        YAHOOAmp.log("Could not instantiate DataTable due to an invalid RecordSet", "error", this.toString());
        return;
    }
    ...
    if(!this._elContainer) {
        YAHOOAmp.log("Could not instantiate DataTable due to an invalid container element", "error", this.toString());
        return;
    }
    ...
    if(!this._elContainer || !this._elThead || !this._elTbody) {
        YAHOOAmp.log("Could not instantiate DataTable due to an invalid DOM elements", "error", this.toString());
        return;
    }
    ...
    if(this._oConfigs.paginator && !(this._oConfigs.paginator instanceof YAHOOAmp.widget.Paginator)) {
        // Backward compatibility
    ...
    // Once per instance
    YAHOOAmp.util.Event.addListener(document, "click", this._onDocumentClick, this);
        ...
        this._oChainRender.add({
            method: function() {
                if((this instanceof DT) && this._sId && this._bInit) {
                    ...
                    YAHOOAmp.log("DataTable initialized with no rows", "info", this.toString());
                }
            },
            scope: this
        });
...
lang.augmentObject(DT, {
    ...
    formatButton : function(el, oRecord, oColumn, oData) {
        ...
        //TODO: support YAHOOAmp.widget.Button
        //if(YAHOOAmp.widget.Button) {
    ...
    editDate : function(oEditor, oSelf) {
        ...
        if(YAHOOAmp.widget.Calendar) {
            ...
            var calendar =
                    new YAHOOAmp.widget.Calendar(calPrefix + "-date",
                    calContainer.id,
    ...
    editTextbox : function(oEditor, oSelf) {
       ...
       var value = oEditor.value;
        ...
        Ev.addListener(elTextbox, "keypress", function(v){
            ...
            // Save on "enter"
            if((v.keyCode === 13)) {
                YAHOOAmp.util.Event.preventDefault(v);
    ...
    */
    validateNumber : function(oData) {
        ...
        if(lang.isNumber(number)) {
            ...
            YAHOOAmp.log("Could not validate data " + lang.dump(oData) + " to type Number", "warn", this.toString());
            return null;
        }
    },
...
initAttributes : function(oConfigs) {
    ...
    *
    * @default null
    * @type {Object|YAHOOAmp.widget.Paginator}
    */
        ...
        method : function (on) {
            ...
            if (!(oPaginator instanceof Pag)) {
                ...
                if(on) {
                    ...
                    YAHOOAmp.log("Paginator enabled", "info", this.toString());
                }
                // Pagination is disabled
                    ...
                    //TODO: fire paginatorDisabledEvent & add to api doc
                    YAHOOAmp.log("Paginator disabled", "info", this.toString());
                }
            }
        }
    });
 ...
 * @type YAHOOAmp.widget.ColumnSet
 * @private
 */
_oColumnSet : null,
 ...
 * @type YAHOOAmp.widget.RecordSet
 * @private
 */
_oRecordSet : null,
...
_initConfigs : function(oConfigs) {
    if(oConfigs) {
        if(oConfigs.constructor != Object) {
            oConfigs = null;
            YAHOOAmp.log("Invalid configs", "warn", this.toString());
        }
        // Backward compatibility
        else if(lang.isBoolean(oConfigs.paginator)) {
            YAHOOAmp.log("DataTable's paginator model has been revised" +
...
_initColumnSet : function(aColumnDefs) {
    ...
    if(lang.isArray(aColumnDefs)) {
        this._oColumnSet =  new YAHOOAmp.widget.ColumnSet(aColumnDefs);
    }
    // Backward compatibility
    else if(aColumnDefs instanceof YAHOOAmp.widget.ColumnSet) {
        this._oColumnSet =  aColumnDefs;
        YAHOOAmp.log("DataTable's constructor now requires an array" +
    ...
    // Backward compatibility
        ...
        if(tmpContainer.hasChildNodes()) {
            ...
            if(tmpTable) {
                ...
                YAHOOAmp.log("Null DataSource for progressive enhancement from" +
...
_initRecordSet : function() {
    if(this._oRecordSet) {
        ...
        this._oRecordSet = new YAHOOAmp.widget.RecordSet();
    }
},
...
_initTheadEls : function() {
    ...
    for(l=0; l<aTheads.length; l++) {
        ...
        if(l===0) {
            ...
            if(this._oConfigs.draggableColumns) {
                for(i=0; i<this._oColumnSet.tree[0].length; i++) {
                    ...
                    if(foundDD) {
                        ...
                        oColumn._dd = new YAHOOAmp.widget.ColumnDD(this, oColumn, elTheadCell, elDragTarget);
                    }
                    else {
                        needDD = true;
                    }    
            ...
            for(i=0; i<this._oColumnSet.keys.length; i++) {
                ...
                if(oColumn.resizeable) {
                    if(foundDD) {
                        ...
                        oColumn._ddResizer = new YAHOOAmp.util.ColumnResizer(
            ...
            if(needDD) {
                YAHOOAmp.log("Could not find DragDrop dependancy", "warn", this.toString());
            }
            YAHOOAmp.log("TH cells for " + this._oColumnSet.keys.length + " keys created", "info",this.toString());
        }
        else {
            YAHOOAmp.log("Accessibility TH cells for " + this._oColumnSet.keys.length + "keys created","info",this.toString());
        }
    }
 ...
 * @param oColumn {YAHOOAmp.widget.Column} Column object.
 ...
 * @param oRecord {YAHOOAmp.widget.Record} The associated Record instance.
 ...
 * @return {YAHOOAmp.util.DataSource} DataSource instance.
 */
 ...
 *
 * @method getColumnSet
 * @return {YAHOOAmp.widget.ColumnSet} ColumnSet instance.
 */
 ...
 *
 * @method getRecordSet
 * @return {YAHOOAmp.widget.RecordSet} RecordSet instance.
 */
 ...
 *
 * <dt>column</dt>
 * <dd>{YAHOOAmp.widget.Column} Associated Column instance.</dd>
 *
 * <dt>container</dt>
 ...
 *
 * <dt>record</dt>
 * <dd>{YAHOOAmp.widget.Record} Associated Record instance.</dd>
 *
 * <dt>validator</dt>
 ...
 *
 * @method getTrEl
 * @param row {HTMLElement | String | Number | YAHOOAmp.widget.Record} Which row to
...
getTrEl : function(row) {
    ...
    // By Record
    if(row instanceof YAHOOAmp.widget.Record) {
 ...
 *
 * @method getNextTrEl
 * @param row {HTMLElement | String | Number | YAHOOAmp.widget.Record} Element
...
getNextTrEl : function(row) {
    ...
    YAHOOAmp.log("Could not get next TR element for row " + row, "info", this.toString());
    return null;
},
...
getPreviousTrEl : function(row) {
    ...
    YAHOOAmp.log("Could not get previous TR element for row " + row, "info", this.toString());
    return null;
},
...
getFirstTdEl : function(row) {
    ...
    YAHOOAmp.log("Could not get first TD element for row " + elRow, "info", this.toString());
    return null;
},
...
getLastTdEl : function(row) {
    ...
    YAHOOAmp.log("Could not get last TD element for row " + elRow, "info", this.toString());
    return null;
},
...
getNextTdEl : function(cell) {
    ...
    YAHOOAmp.log("Could not get next TD element for cell " + cell, "info", this.toString());
    return null;
},
...
getAboveTdEl : function(cell) {
    ...
    YAHOOAmp.log("Could not get above TD element for cell " + cell, "info", this.toString());
    return null;
},
...
getBelowTdEl : function(cell) {
    ...
    YAHOOAmp.log("Could not get below TD element for cell " + cell, "info", this.toString());
    return null;
},
 ...
 *
 * @method getThLinerEl
 * @param theadCell {YAHOOAmp.widget.Column | HTMLElement | String} Column instance,
...
getThEl : function(theadCell) {
    ...
    if(theadCell instanceof YAHOOAmp.widget.Column) {
 ...
 *
 * @method getTrIndex
 * @param row {HTMLElement | String | YAHOOAmp.widget.Record | Number} DOM or ID
...
getTrIndex : function(row) {
    ...
    YAHOOAmp.log("Could not get page row index for row " + row, "info", this.toString());
    return null;
},
...
render : function() {
    ...
    this.showTableMessage(DT.MSG_LOADING, DT.CLASS_LOADING);
    YAHOOAmp.log("DataTable rendering...", "info", this.toString());
        ...
        this._oChainRender.add({
            method: function(oArg) {
                ...
                if(this._bInit) {
                    ...
                    this._oChainRender.add({
                        method: function() {
                            if((this instanceof DT) && this._sId && this._bInit) {
                                this._bInit = false;
                                this.fireEvent("initEvent");
                                YAHOOAmp.log("DataTable initialized with " + allRecords.length + " of " + this._oRecordSet.getLength() + " rows", "info", this.toString());
                            }
                        },
                        scope: this
                    });
                    ...
                    YAHOOAmp.log("DataTable rendered " + allRecords.length + " of " + this._oRecordSet.getLength() + " rows", "info", this.toString());
                }
...
destroy : function() {
    ...
    YAHOOAmp.log("DataTable instance destroyed: " + instanceName);
},
...
showTableMessage : function(sHTML, sClassName) {
    ...
    YAHOOAmp.log("DataTable showing message: " + sHTML, "info", this.toString());
},
...
hideTableMessage : function() {
    if(this._elMsgTbody.style.display != "none") {
        ...
        YAHOOAmp.log("DataTable message hidden", "info", this.toString());
    }
},
 ...
 *
 * @method getRecordIndex
 * @param row {YAHOOAmp.widget.Record | HTMLElement | Number} Record instance, TR
...
getRecordIndex : function(row) {
    ...
    YAHOOAmp.log("Could not get Record index for row " + row, "info", this.toString());
    return null;
},
 ...
 * @return {YAHOOAmp.widget.Record} Record instance.
 */
getRecord : function(row) {
    ...
    if(oRecord instanceof YAHOOAmp.widget.Record) {
        return this._oRecordSet.getRecord(oRecord);
    }
    else {
        YAHOOAmp.log("Could not get Record for row at " + row, "info", this.toString());
        return null;
    }
},
...
getColumn : function(column) {
    ...
    if(!oColumn) {
        YAHOOAmp.log("Could not get Column for column at " + column, "info", this.toString());
    }
    return oColumn;
},
...
sortColumn : function(oColumn, sDir) {
    if(oColumn && (oColumn instanceof YAHOOAmp.widget.Column)) {
        if(!oColumn.sortable) {
        ...
        if(!bSorted || sDir) {
            ...
            var sortFnc = (oColumn.sortOptions && lang.isFunction(oColumn.sortOptions.sortFunction)) ?
                    ...
                    function(a, b, desc) {
                        var sorted = YAHOOAmp.util.Sort.compare(a.getData(oColumn.key),b.getData(oColumn.key), desc);
                        if(sorted === 0) {
                            return YAHOOAmp.util.Sort.compare(a.getId(),b.getId(), desc);
                        }
                        else {
                            return sorted;
                        }
        ...
        YAHOOAmp.log("Column \"" + oColumn.key + "\" sorted \"" + sortDir + "\"", "info", this.toString());
    }
    else {
        YAHOOAmp.log("Could not sort Column \"" + oColumn.key + "\"", "warn", this.toString());
    }
},
...
_setColumnWidth : function(oColumn, sWidth, sOverflow) {
    ...
    if(oColumn) {
        ...
        YAHOOAmp.log("Could not set width of Column " + oColumn + " to " + sWidth, "warn", this.toString());
    }
},
...
setColumnWidth : function(oColumn, nWidth) {
    ...
    if(oColumn) {
        ...
        if(lang.isNumber(nWidth)) {
            ...
            YAHOOAmp.log("Set width of Column " + oColumn + " to " + nWidth + "px", "info", this.toString());
            return;
        }
    }
    YAHOOAmp.log("Could not set width of Column " + oColumn + " to " + nWidth + "px", "warn", this.toString());
},
    ...
    if(oColumn && !oColumn.hidden) {
        ...
        if(oColumn.getTreeIndex() !== null) {
            ...
            for(var i=0; i<allDescendants.length; i++) {
                ...
                YAHOOAmp.log("Column \"" + oColumn.key + "\" hidden", "info", this.toString());
            }
        }
        else {
            YAHOOAmp.log("Could not hide Column \"" + oColumn.key + "\". Only non-nested Columns can be hidden", "warn", this.toString());
        }
    }
},
    ...
    if(oColumn && oColumn.hidden) {
        ...
        if(oColumn.getTreeIndex() !== null) {
            ...
            for(var i=0; i<allDescendants.length; i++) {
                ...
                YAHOOAmp.log("Column \"" + oColumn.key + "\" shown", "info", this.toString());
            }
        }
        else {
            YAHOOAmp.log("Could not show Column \"" + oColumn.key + "\". Only non-nested Columns can be shown", "warn", this.toString());
        }
    }
},
 ...
 * @method removeColumn
 * @param oColumn {YAHOOAmp.widget.Column} Column instance.
 * @return oColumn {YAHOOAmp.widget.Column} Removed Column instance.
 */
removeColumn : function(oColumn) {
    ...
    if(nColTreeIndex !== null) {
        ...
        YAHOOAmp.log("Column \"" + oColumn.key + "\" removed", "info", this.toString());
        return oColumn;
    }
    YAHOOAmp.log("Could not remove Column \"" + oColumn.key + "\". Only non-nested Columns can be removed", "warn", this.toString());
},
 ...
 *
 * @method insertColumn
 * @param oColumn {Object | YAHOOAmp.widget.Column} Object literal Column
 * definition or a Column instance.
 * @param index {Number} (optional) Column key index.
 */
insertColumn : function(oColumn, index) {
    // Validate Column
    if(oColumn instanceof YAHOOAmp.widget.Column) {
        oColumn = oColumn.getDefinition();
    }
    else if(oColumn.constructor !== Object) {
        YAHOOAmp.log("Could not insert Column \"" + oColumn + "\" due to invalid argument", "warn", this.toString());
        return;
    }
    ...
    YAHOOAmp.log("Column \"" + oColumn.key + "\" inserted into index " + index, "info", this.toString());
},
...
selectColumn : function(oColumn) {
    ...
    if(oColumn && !oColumn.selected) {
        ...
        if(oColumn.getKeyIndex() !== null) {
            ...
            YAHOOAmp.log("Column \"" + oColumn.key + "\" selected", "info", this.toString());
        }
        else {
            YAHOOAmp.log("Could not select Column \"" + oColumn.key + "\". Only non-nested Columns can be selected", "warn", this.toString());
        }
    }
},
...
unselectColumn : function(oColumn) {
    ...
    if(oColumn && oColumn.selected) {
        ...
        if(oColumn.getKeyIndex() !== null) {
            ...
            YAHOOAmp.log("Column \"" + oColumn.key + "\" unselected", "info", this.toString());
        }
        else {
            YAHOOAmp.log("Could not unselect Column \"" + oColumn.key + "\". Only non-nested Columns can be unselected", "warn", this.toString());
        }
    }
},
 ...
 * @return {YAHOOAmp.widget.Column[]} Array of Column instances.
 */
...
highlightColumn : function(column) {
    ...
    if(oColumn && (oColumn.getKeyIndex() !== null)) {
        ...
        YAHOOAmp.log("Column \"" + oColumn.key + "\" highlighed", "info", this.toString());
    }
    else {
        YAHOOAmp.log("Could not highlight Column \"" + oColumn.key + "\". Only non-nested Columns can be highlighted", "warn", this.toString());
    }
},
...
unhighlightColumn : function(column) {
    ...
    if(oColumn && (oColumn.getKeyIndex() !== null)) {
        ...
        YAHOOAmp.log("Column \"" + oColumn.key + "\" unhighlighted", "info", this.toString());
    }
    else {
        YAHOOAmp.log("Could not unhighlight Column \"" + oColumn.key + "\". Only non-nested Columns can be unhighlighted", "warn", this.toString());
    }
},
...
addRow : function(oData, index) {
    if(oData && (oData.constructor == Object)) {
        ...
        if(oRecord) {
            ...
            if (oPaginator instanceof Pag || this.get('paginated')) {
                ...
                YAHOOAmp.log("Added a row for Record " + YAHOOAmp.lang.dump(oRecord) + " at RecordSet index " + recIndex, "info", this.toString()); 
                return;
            }
            // Not paginated
            else {
    ...
    YAHOOAmp.log("Could not add row with " + lang.dump(oData), "error", this.toString());
},
...
addRows : function(aData, index) {
    if(lang.isArray(aData)) {
        ...
        if(aRecords) {
            ...
            if (oPaginator instanceof Pag ||
                ...
                YAHOOAmp.log("Added " + aRecords.length + 
    ...
    YAHOOAmp.log("Could not add rows with " + lang.dump(aData));    
},
 ...
 *
 * @method updateRow
 * @param row {YAHOOAmp.widget.Record | Number | HTMLElement | String}
...
updateRow : function(row, oData) {
    ...
    if((row instanceof YAHOOAmp.widget.Record) || (lang.isNumber(row))) {
            // Get the Record directly
    ...
    if(oldRecord) {
        ...
        oldData = YAHOOAmp.widget.DataTable._cloneObject(oRecordData);

        updatedRecord = this._oRecordSet.updateRecord(oldRecord, oData);
    }
    else {
        YAHOOAmp.log("Could not update row " + row + " with the data : " +
        ...
        this._oChainRender.add({
            method: function() {
                if((this instanceof DT) && this._sId) {
                    ...
                    YAHOOAmp.log("DataTable row updated: Record ID = " + updatedRecord.getId() +
...
deleteRow : function(row) {
        ...
        if(oData) {     
            ...
            this._oChainRender.add({
                method: function() {
                    ...
                    YAHOOAmp.log("Deleted row with data " + YAHOOAmp.lang.dump(oData) +
    ...
    YAHOOAmp.log("Could not delete row: " + row, "warn", this.toString());
    return null;
},
...
deleteRows : function(row, count) {
        ...
        if(aData) {
            ...
            this._oChainRender.add({
                method: function() {                   
                    ...
                    YAHOOAmp.log("DataTable row deleted: Record ID = " + sRecordId +
    ...
    YAHOOAmp.log("Could not delete " + count + " rows at row " + row, "warn", this.toString());
    return null;
},
 ...
 * @param oRecord {YAHOOAmp.widget.Record} (Optional) Record instance.
 * @param oColumn {YAHOOAmp.widget.Column} (Optional) Column instance.
 */
formatCell : function(elCell, oRecord, oColumn) {
    ...
    if(oRecord && oColumn) {
        ...
        YAHOOAmp.log("Could not format cell " + elCell, "error", this.toString());
    }
},
 ...
 *
 * @method selectRow
 * @param row {HTMLElement | String | YAHOOAmp.widget.Record | Number} HTML element
...
selectRow : function(row) {
    ...
    if(oRecord) {
        ...
        YAHOOAmp.log("Selected " + elRow, "info", this.toString());
    }
    else {
        YAHOOAmp.log("Could not select row " + row, "warn", this.toString());
    }
},
...
unselectRow : function(row) {
    ...
    if(oRecord) {
        ...
        if(bFound) {
            ...
            YAHOOAmp.log("Unselected " + elRow, "info", this.toString());
    ...
    YAHOOAmp.log("Could not unselect row " + row, "warn", this.toString());
},
...
unselectAllRows : function() {
    ...
    YAHOOAmp.log("Unselected all rows", "info", this.toString());
},
...
*/
    ...
    if(elCell) {
        ...
        if(oRecord && sColumnId) {
            ...
            YAHOOAmp.log("Selected " + elCell, "info", this.toString());
            return;
        }
    }
    YAHOOAmp.log("Could not select cell " + cell, "warn", this.toString());
},
        ...
        if(oRecord && sColumnId) {
            ...
            for(var j=tracker.length-1; j>-1; j--) {
                if((tracker[j].recordId === id) && (tracker[j].columnId === sColumnId)){
                    ...
                    YAHOOAmp.log("Unselected " + elCell, "info", this.toString());
                    return;
                }
            }
        }
    }
    YAHOOAmp.log("Could not unselect cell " + cell, "warn", this.toString());
},
...
unselectAllCells: function() {
    ...
    YAHOOAmp.log("Unselected all cells", "info", this.toString());
},
 ...
 *
 * @method isSelected
 * @param o {String | HTMLElement | YAHOOAmp.widget.Record | Number
 * {record:YAHOOAmp.widget.Record, column:YAHOOAmp.widget.Column} } TR or TD element by
...
isSelected : function(o) {
    if(o && (o.ownerDocument == document)) {
        ...
        if(tracker && tracker.length > 0) {
            ...
            if(o instanceof YAHOOAmp.widget.Record) {
                oRecord = o;
            }
...
/*        if(this._sLastHighlightedTrElId) {
        ...
        YAHOOAmp.log("Highlighted " + elRow, "info", this.toString());
        return;
    }
    YAHOOAmp.log("Could not highlight row " + row, "warn", this.toString());
},
...
unhighlightRow : function(row) {
    ...
    if(elRow) {
        ...
        YAHOOAmp.log("Unhighlighted " + elRow, "info", this.toString());
        return;
    }
    YAHOOAmp.log("Could not unhighlight row " + row, "warn", this.toString());
},
...
highlightCell : function(cell) {
    ...
    if(elCell) {
        ...
        YAHOOAmp.log("Highlighted " + elCell, "info", this.toString());
        return;
    }
    YAHOOAmp.log("Could not highlight cell " + cell, "warn", this.toString());
},
...
unhighlightCell : function(cell) {
    ...
    if(elCell) {
        ...
        YAHOOAmp.log("Unhighlighted " + elCell, "info", this.toString());
        return;
    }
    YAHOOAmp.log("Could not unhighlight cell " + cell, "warn", this.toString());
},
...
showCellEditor : function(elCell, oRecord, oColumn) {
    ...
    if(elCell && (elCell.ownerDocument === document)) {
        if(!oRecord || !(oRecord instanceof YAHOOAmp.widget.Record)) {
            oRecord = this.getRecord(elCell);
        }
        if(!oColumn || !(oColumn instanceof YAHOOAmp.widget.Column)) {
        ...
        if(oRecord && oColumn) {
            ...
            if(fnEditor) {
                ...
                YAHOOAmp.log("Cell Editor shown for " + elCell, "info", this.toString());
                return;
            }
        }
    }
    YAHOOAmp.log("Could not show Cell Editor for " + elCell, "warn", this.toString());
},
...
saveCellEditor : function() {
    if(this._oCellEditor.isActive) {
        ...
        var oldData = YAHOOAmp.widget.DataTable._cloneObject(this._oCellEditor.record.getData(this._oCellEditor.column.key));
        ...
        if(this._oCellEditor.validator) {
            ...
            if(newData === null ) {
                ...
                YAHOOAmp.log("Could not save Cell Editor input due to invalid data " +
        ...
        this.fireEvent("editorSaveEvent",
                {editor:this._oCellEditor, oldData:oldData, newData:newData});
        YAHOOAmp.log("Cell Editor input saved", "info", this.toString());
    }
    else {
        YAHOOAmp.log("Cell Editor not active to save input", "warn", this.toString());
    }
},
...
cancelCellEditor : function() {
    if(this._oCellEditor.isActive) {
        ...
        YAHOOAmp.log("Cell Editor input canceled", "info", this.toString());
    }
    else {
        YAHOOAmp.log("Cell Editor not active to cancel input", "warn", this.toString());
    }
},
...
//TODO: support form elements in sortable columns
    ...
    if(el && el.yuiColumnKey) {
        ...
        YAHOOAmp.log("Could not find Column for " + target, "warn", this.toString());
    }
},
...
onEventFormatCell : function(oArgs) {
    ...
    if(elCell && elCell.yuiColumnKey) {
        ...
        YAHOOAmp.log("Could not format cell " + target, "warn", this.toString());
    }
},
...
onEventShowCellEditor : function(oArgs) {
    ...
    if(elCell) {
        ...
        YAHOOAmp.log("Could not edit cell " + target, "warn", this.toString());
    }
},
...
_handleDataReturnPayload : function (oRequest, oResponse, meta) {
     ...
     * @param oArgs.column {YAHOOAmp.widget.Column} The Column instance.
     * @param oArgs.dir {String} Sort direction: YAHOOAmp.widget.DataTable.CLASS_ASC
     * or YAHOOAmp.widget.DataTable.CLASS_DESC.
     */
     ...
     * @param oArgs.column {YAHOOAmp.widget.Column} The highlighted Column.
     */
     ...
     * @param oArgs.column {YAHOOAmp.widget.Column} The unhighlighted Column.
     */
     ...
     *
     * @event rowAddEvent
     * @param oArgs.record {YAHOOAmp.widget.Record} The added Record.
     */
     ...
     *
     * @event rowsAddEvent
     * @param oArgs.record {YAHOOAmp.widget.Record[]} The added Records.
     */
     ...
     * @param oArgs.record {YAHOOAmp.widget.Record} The updated Record.
     ...
     * @param oArgs.record {YAHOOAmp.widget.Record} The selected Record.
     */
     ...
     * @param oArgs.record {YAHOOAmp.widget.Record} The unselected Record.
     */
     ...
     * @param oArgs.record {YAHOOAmp.widget.Record} The highlighted Record.
     */
     ...
     * @param oArgs.record {YAHOOAmp.widget.Record} The associated Record instance.
     * @param oArgs.column {YAHOOAmp.widget.Column} The associated Column instance.
     ...
     * @param oArgs.record {YAHOOAmp.widget.Record} The associated Record.
     * @param oArgs.column {YAHOOAmp.widget.Column} The associated Column instance.
...
getBody : function() {
    // Backward compatibility
    YAHOOAmp.log("The method getBody() has been deprecated" +
...
getCell : function(index) {
    // Backward compatibility
    YAHOOAmp.log("The method getCell() has been deprecated" +
...
getRow : function(index) {
    // Backward compatibility
    YAHOOAmp.log("The method getRow() has been deprecated" +
...
refreshView : function() {
    // Backward compatibility
    YAHOOAmp.log("The method refreshView() has been deprecated" +
...
select : function(els) {
    // Backward compatibility
    YAHOOAmp.log("The method select() has been deprecated" +
...
formatPaginators : function() {
    ...
    YAHOOAmp.log("Paginators formatted", "info", this.toString());
},
...
formatPaginatorDropdown : function(elDropdown, dropdownOptions) {
    ...
    YAHOOAmp.log("Could not update Paginator dropdown " + elDropdown, "error", this.toString());
},
...
formatPaginatorLinks : function(elContainer, nCurrentPage, nPageLinksStart, nPageLinksLength, nTotalPages) {
    ...
    YAHOOAmp.log("Could not format Paginator links", "error", this.toString());
},
...
_onPaginatorDropdownChange : function(e, oSelf) {
    ...
    if(newRowsPerPage !== null) {
        ...
        YAHOOAmp.log("Could not paginate with " + newValue + " rows per page", "error", oSelf.toString());
    }
},
...
onEventEditCell : function(oArgs) {
    // Backward compatibility
    YAHOOAmp.log("The method onEventEditCell() has been deprecated" +
...
onDataReturnReplaceRows : function(sRequest, oResponse) {
    // Backward compatibility
    YAHOOAmp.log("The method onDataReturnReplaceRows() has been deprecated" +
...
YAHOOAmp.register("datatable", YAHOOAmp.widget.DataTable, {version: "2.5.2", build: "1076"});
