	...
	<div class="subtabs">
          ...
          <c:if test="${stepNum!=deExportForm.tabCount}">
            <button id="step${stepNum}_next_button" type="button" class="toolbar" onclick="navigateTab(1)">
                <img height="16" src="/TEMPLATE/ampTemplate/imagesSource/reports/next.png" class="toolbar" /> 
                <digi:trn key="btn:next">Next</digi:trn>
            </button>
          </c:if>
    	...
    	<button id="step${stepNum}_export" name="expodtButton" type="button" class="toolbar" onclick="exportActivity()" >
			<img src="/TEMPLATE/ampTemplate/imagesSource/reports/file-export-16x16.png" class="toolbar"/>
