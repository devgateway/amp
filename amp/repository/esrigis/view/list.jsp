        ...
        <tr>
          <td height=33 colspan="2">
          	<span class=crumb>
	            ...
	            &nbsp;&gt;&nbsp;
	            <digi:trn>GIS Structure Type Manager</digi:trn>
            </span>
          </td>
        </tr>
        <!--<tr>
              ...
              <tr>
                <td align="center">
                  <table width="100%" id="dataTable" cellpadding="4" class="inside"> 
                    <tr>
                      <td bgcolor="#c7d4db" align="center" width="20%" class="inside"><strong style="font-size:12px;"><digi:trn>Name</digi:trn></strong></td>
                    ...
                    <c:if test="${fn:length(requestScope.structureTypesList) eq 0}">
                      <tr bgColor=#f4f4f2>
                      ...
                      <c:forEach  var="structureType" items="${requestScope.structureTypesList}">
                        <tr bgColor=#f4f4f2>
                          ...
                          <td align="center" class="inside">
                          	...
                          	<digi:link href="/structureTypeManager.do?action=delete&id=${structureType.typeId}" onclick="return confirm('${confirmationTrn}');">
              ...
              <tr>
                <td bgColor=#ffffff class=box-border><table cellPadding=5 cellspacing="1" width="100%" class="inside">
                    ...
                    <tr>
                      ...
                      <td class="inside" width=100%>
                      	<digi:link href="/structureTypeManager.do?action=add&reset=true">
                          <digi:trn>Add new structure</digi:trn>
                        </digi:link>
                      </td>
                    </tr>
                  </table></td>
