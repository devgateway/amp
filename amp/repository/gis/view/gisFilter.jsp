					...
					<div style="width: 40%; float: left;">
						...
						<div style="width: 60%; float: left;">
							<p>
								...
								<select id="mapModeFin" value="commitment">
							...
							<p>
								...
								<select id="fundingType" value="commitment" styleId="fundType">
						...
						<div class="tabSubmit">
							<input type="button" class="buttonx" 
								value="<digi:trn>Apply Filters to the Report</digi:trn>" onclick="applySectorFilter();"/>
							<input type="button"
								class="buttonx" value="<digi:trn>Reset and Start Over</digi:trn>" onclick="resetPIFilters();"/>
						</div>
					</div>
