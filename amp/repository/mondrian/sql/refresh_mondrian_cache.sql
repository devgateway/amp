...
CREATE TABLE cached_amp_activity AS  SELECT amp_activity_version.* FROM amp_activity_version, amp_activity_group WHERE (amp_activity_version.amp_activity_id = amp_activity_group.amp_activity_last_version_id);
