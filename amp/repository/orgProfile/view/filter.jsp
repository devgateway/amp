        ...
        <tr>
            <td>
                <div id="orgProfToolbarId" style="width: 99%; background-color: #ccdbff; padding: 2px 2px 2px 2px; min-height: 22px; Font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">
                    ...
                    <span style="cursor: pointer; font-family: Arial; min-height: 20px; font-size: 11px; font-style: italic; float: right;" id="displaySettingsButton"><digi:trn>Show Current Settings</digi:trn>  &gt;&gt;</span>
                    &nbsp;
                        ...
                        <tbody id="filterSettingsTable">
                            <tr>
                                <td style="font-size:11px;" valign="top">
									...
									${orgProfOrgProfileFilterForm.yearsInRange}
                        		</td>
							</tr>
                        </tbody>
                    </table>
