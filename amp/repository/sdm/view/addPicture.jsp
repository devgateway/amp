...
<p align="center"><b><font size="4" color="#00008B">
	<digi:errors/>
	<digi:form action="/savePicture.do" method="post" enctype="multipart/form-data">
	<div align="center">
		<table width="60%">
			<tr>
...
<p>
	<digi:trn key="sdm:addPicturetoDoc">Add a picture to this Document!</digi:trn></p></font></b></p>
	...
	<table width="70%">
		<tr>
			<td noWrap><font size="2">
				<digi:trn key="sdm:pictureTitle">Title of the Picture:</digi:trn></font><BR>
				<html:text name="sdmForm" property="contentTitle" size="50"/>
			</td>
		</tr>
		<tr>
			<td noWrap><font size="2">
				<digi:trn key="sdm:choosePicFile">Choose a picture file:</digi:trn></font><BR>
