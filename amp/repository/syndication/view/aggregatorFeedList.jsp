...
<script language="JavaScript">
	...
	function next() {
	  <digi:context name="next" property="context/module/moduleinstance/aggregatorFeedList.do" />
	...
	function prev() {
	  <digi:context name="prev" property="context/module/moduleinstance/aggregatorFeedList.do" />
      document.collectorFeedForm.action = "<%= prev %>?nav=<bean:write name="collectorFeedForm" property="prev"/>";
      document.collectorFeedForm.submit();	
	}
	function changeItemPerPage() {
	  <digi:context name="changeItemPerPage" property="context/module/moduleinstance/aggregatorFeedList.do" />
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td width="99%" class="mainHeader" align="center" valign="middle">
					<digi:trn key="syndication:aggregatorFeeds">Aggregator feeds page</digi:trn>
				</td>
...
<digi:form action="/aggregatorFeedList.do">
