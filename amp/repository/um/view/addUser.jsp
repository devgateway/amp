									...
									<tr>
										...
										<table border="0" cellPadding=5 cellspacing="0" width="100%">
											...
											<tr>
												...
												<td class="left-align">
													<html:text  styleId="userEmail" property="email" size="20"
																styleClass="inp-text pwd_username email-input" />
												</td>
											</tr>
											<tr>
												<td width="3%">&nbsp;</td>
												...
												<td class="left-align">
													<html:text styleId="userEmailConfirmation" property="emailConfirmation"	size="20" styleClass="inp-text email-input" />
												</td>
											</tr>
											<tr>
												<td width="3%">&nbsp;</td>
											...
											<tr id="notificationEmailRow">
                                                ...
                                                <td class="left-align">
                                                    <html:text property="notificationEmail" size="20" styleClass="inp-text email-input" styleId="notificationEmail"/></td>
                                            </tr>
											<tr>
												<td width="3%">&nbsp;</td>
												<td class="f-names right-align" noWrap>
