						...
						<td align="left" colspan=8>
							<table border="0" align="center" bgcolor="#f2f2f2" width=100%>
								<tr>
									...
									<td noWrap align=center valign="middle"><a target="_blank"
										onclick="exportXSL(); return false;"> <digi:img hspace="2"
												vspace="2"
																			...
																			<table width="734" RULES=ALL FRAME=VOID
																				...
																				<c:if
																					...
																					<thead
																						...
																						<tr>
																							<td height="30" width="220"><digi:link
																									href="/viewAllUsers.do?sortBy=name&reset=false">
																									<b> <digi:trn
																											key="um:viewAllUsers:UsersNames">Name</digi:trn>
																									</b>
																								</digi:link></td>
																							<td height="30" width="220"><digi:link
																									href="/viewAllUsers.do?sortBy=email&reset=false">
																									<b> <digi:trn
																											key="um:viewAllUsers:UsersEmails">Email</digi:trn>
																									</b>
																								</digi:link></td>
													...
													<table cellpadding="0" cellspacing="0" width="100">
														<tr>
															<td bgColor=#c9c9c7 class=box-title><digi:trn
																	key="aim:otherLinks">
																	<b style="font-weight: bold; font-size: 12px;">Other
																		links</b>
																</digi:trn></td>
