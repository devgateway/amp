...
public final class ArConstants {
    public final static MetaInfo []prefixes=new MetaInfo[] {
        ...
        new MetaInfo(GenericViews.HTML2,"/WEB-INF/repository/aim/view/ar/html2/"),
        new MetaInfo(GenericViews.HTML,"/WEB-INF/repository/aim/view/ar/html/"),
        ...
        new MetaInfo(GenericViews.PRINT,"/WEB-INF/repository/aim/view/ar/print/"),
        new MetaInfo(GenericViews.TREE,"/WEB-INF/repository/aim/view/ar/tree/"),
        new MetaInfo(GenericViews.FOLDABLE,"/WEB-INF/repository/aim/view/ar/foldable/"),
        };
