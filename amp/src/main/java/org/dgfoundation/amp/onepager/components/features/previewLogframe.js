...
//
	...
	function showPLogframe() {
        ...
        content.innerHTML = '<div style="height:400px"><p align="left"><img align="top" src="/WEB-INF/jsp/aim/view/scripts/ajaxtabs/loading.gif" /><font size="3"><b>'+loading+'</b></font></p></div>';
		//if (panelFirstShow == 1){
