...
public abstract class AbstractAutoCompleteTextField<CHOICE> extends TextField {
     ...
     *            the renderer to set
     */
    public AbstractAutoCompleteTextField(final String id, final IModel model, final IAutoCompleteRenderer<CHOICE> renderer) {
...
//      settings.setShowListOnFocusGain(true);
     ...
     */
    public final Iterator<CHOICE> getChoices(final String searchTextInput) {
