 ...
 */
@Path("reports")
@Api(value = "Endpoints for creating, retrieving, and updating reports in the AMP Report Designer")
public class ReportsDesignerEndpoint {
    ...
    public final ReportDesigner getReportDesigner(
    ...
    @Path("/{reportId}")
    @Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
    public final JsonApiResponse<Report> updateReport(
