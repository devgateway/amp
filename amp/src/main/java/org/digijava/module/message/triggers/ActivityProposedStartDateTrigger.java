...
public class ActivityProposedStartDateTrigger extends Trigger {
    ...
    public ActivityProposedStartDateTrigger(Object source) {
    ...
    protected Event generateEvent() {
        Event e=new Event(ActivityProposedStartDateTrigger.class);
