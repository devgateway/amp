 ...
 * @author gabriel
 */
public class PIReport10bRow extends PIReportAbstractRow {

    private AmpOrgGroup donorGroup;
    private int year;
    // Number of Country Analytic documents that are joint
    private int column1;
    // Total number of Country Analytic documents
    private int column2;
    // Proportion of Country analytic documents that are joint
