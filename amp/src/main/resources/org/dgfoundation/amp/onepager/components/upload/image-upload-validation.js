function setupImageUploadValidation(options) {
    ...
    if (noImage) {
        ...
        noImage.style.display = 'inline'; // Ensure noImage is visible initially
    }
    if (previewImg) {
        previewImg.style.display = 'none'; // Ensure preview is hidden initially
    }
        ...
        if (previewImg) {
            ...
            previewImg.onclick = function() {
                if (previewImg.style.display !== 'none') {
                    document.getElementById('modalPreviewImage').src = previewImg.src;
