		...
		<tr>
			<td width=768  valign="top">
				...
				<td width="222" valign="top">
					...
					<div class="right_menu_box"><div class="right_menu_cont" style="font-size:11px;">
					<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/img_2/ico_unread.gif" style="margin-right:5px;"> - <digi:trn>Unread message</digi:trn><br/>
					<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/img_2/ico_reply.gif" style="margin-right:5px;"> - <digi:trn>Reply to message</digi:trn><br/>
					<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/img_2/ico_forward.gif" style="margin-right:5px;"> - <digi:trn>Forward message</digi:trn><br/>
					<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/img_2/ico_trash.gif" style="margin-right:5px;"> - <digi:trn>Delete message</digi:trn><br/>
