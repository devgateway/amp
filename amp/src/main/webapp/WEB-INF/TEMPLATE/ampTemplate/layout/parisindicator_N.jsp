...
<link rel="stylesheet" href="<digi:file src="/src/main/webapp/WEB-INF/repository/parisindicator/view/css/pi_styles.css"/>">
		            ...
		            <tr>
		                <td width="90%" class="td_top1" style="padding-left:2px;" >
		                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		                        ...
		                        <tr>
		                            <td style="padding:5">
		                                <strong><p><img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/images/info.png" width="15" height="15">&nbsp;<bean:write name="parisIndicatorForm" property="piReport.name"/></p></strong>
		                            </td>
		                        </tr>
		                    </table>
		                </td>
		            ...
		            <tr>
		                <td class="td_right_left1">
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="3">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_3.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="4">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_4.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="5a">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_5a.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="5b">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_5b.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="6">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_6.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="7">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_7.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="9">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_9.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="10a">
                                <jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_10a.jsp"></jsp:include>
                            </logic:equal>
                            <logic:equal name="parisIndicatorForm" property="piReport.indicatorCode" value="10b">
	                        	<jsp:include page="/src/main/webapp/WEB-INF/repository/parisindicator/view/parisindicator_10b.jsp"></jsp:include>
							</logic:equal>
	                    </td>
	                </tr>
	                <tr>
