		   ...
		   <logic:present name="eventsListToday" property="title">
		    <logic:present name="eventsListToday" property="description">
				<digi:link href="/showCalendarItemDetails.do" paramName="eventsListToday" paramId="activeCalendarItem" paramProperty="id" >
		          <bean:write name="eventsListToday" property="title" filter="false" />
				</digi:link>   
		    </logic:present>
		    <logic:notPresent name="eventsListToday" property="description">
		      <a href='<bean:write name="eventsListToday" property="sourceUrl"/>' class="text">
		          <bean:write name="eventsListToday" property="title" filter="false" />
		      </a>
		    </logic:notPresent>
		    </logic:present>
		    <br>
		    <span class="dta"><i><bean:write name="eventsListToday" property="startDate" />-<bean:write name="eventsListToday" property="endDate" /></i></span>
		  </p>
		</logic:iterate> 
		</tr></td>
		  <tr> 
