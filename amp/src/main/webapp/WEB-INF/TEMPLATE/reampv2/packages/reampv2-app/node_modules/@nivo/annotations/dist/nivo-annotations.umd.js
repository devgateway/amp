(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('lodash/omit'), require('lodash/isNumber'), require('lodash/filter'), require('@nivo/core'), require('@react-spring/web'), require('react/jsx-runtime')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'lodash/omit', 'lodash/isNumber', 'lodash/filter', '@nivo/core', '@react-spring/web', 'react/jsx-runtime'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global['lodash/omit'], global['lodash/isNumber'], global['lodash/filter'], global.nivo, global['@react-spring/web'], global['react/jsx-runtime']));
}(this, (function (exports, react, _omit, _isNumber, _filter, core, web, jsxRuntime) { 'use strict';

  _omit = _omit && Object.prototype.hasOwnProperty.call(_omit, 'default') ? _omit['default'] : _omit;
  _isNumber = _isNumber && Object.prototype.hasOwnProperty.call(_isNumber, 'default') ? _isNumber['default'] : _isNumber;
  _filter = _filter && Object.prototype.hasOwnProperty.call(_filter, 'default') ? _filter['default'] : _filter;
