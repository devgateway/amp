(function (global, factory) {
  ...
  typeof define === 'function' && define.amd ? define(['exports', '@nivo/axes', '@nivo/annotations', 'react/jsx-runtime', '@nivo/legends', '@nivo/core', 'react', '@react-spring/web', '@nivo/tooltip', '@nivo/colors', '@nivo/scales', 'd3-shape', 'lodash/uniqBy'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.nivo, global.nivo, global['react/jsx-runtime'], global.nivo, global.nivo, global.React, global['@react-spring/web'], global.nivo, global.nivo, global.nivo, global.d3, global['lodash/uniqBy']));
}(this, (function (exports, axes, annotations, jsxRuntime, legends, core, react, web, tooltip, colors, scales, d3Shape, _uniqBy) { 'use strict';
