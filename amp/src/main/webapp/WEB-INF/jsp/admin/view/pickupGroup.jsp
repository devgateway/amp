...
<a href="javascript:fnOnExpand('<%= item.getKey()%>')">+</a></td>
 <td>
<c:if test="${!empty item.id}"><digi:img src="${pageContext.request.contextPath}/resources/images/module/admin/images/group.gif" border="0"/></c:if>
<c:if test="${empty item.id}"><digi:img src="${pageContext.request.contextPath}/resources/images/module/admin/images/site.gif" border="0"/></c:if>
</td>
 <td>
