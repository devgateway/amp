													...
													<table width="100%" cellspacing="1" cellpadding="1"
														...
														<td>
															<html:text name ="aimSectorSchemeForm" property="secSchemeId" size="5"/> 
																	...
																	<tr>
																		<td>&nbsp;</td>
																		<td><input class="buttonx" type="button"
																			name="addBtn" value="<digi:trn>Save</digi:trn>"
														...
														<field:display name="Level 2 Sectors List"
															feature="Sectors">
															<tr>
																<td class="report">
																					...
																					<tr>
																						...
																						<td bgcolor="#ffffff" width="75" align="center"
																							class="ignore"><c:set var="translation">
																								...
																								name="urlParams2" title="${translation}">${edittext}</digi:link>
																							]</td>
