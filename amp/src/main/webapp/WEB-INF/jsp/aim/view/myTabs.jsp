...
<link rel="stylesheet" type="text/css" href="/static/aim/view/css/filters/filters2.css">
<%
	{
...
<script type="text/javascript" src="/static/aim/view/multilingual/multilingual_scripts.js"></script>
