...
SaveReportEngine.prototype.saveReport		= function () {
	...
	if (reportTitles == null) {
		...
		this.panel.setFooter( SaveReportEngine.savingMessage + "...<br />  <img src='WEB-INF/jsp/aim/view/images/images_dhtmlsuite/ajax-loader-darkblue.gif' border='0' height='17px'/>" );
