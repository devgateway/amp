			...
			<c:if test="${reportNumber != 0}">
				<logic:present name="isUserLogged" scope="session">
								...
								<tr>
									...
									<td>
										<span><digi:trn>Filtered Report</digi:trn>&nbsp;
											<img src= "/resources/images/jsp/message/view/images/edit.gif" border="0" style="vertical-align: bottom; margin-left: 8px;" />
										</span>
									</td>
									<td>
										<span><digi:trn>Edit Report</digi:trn>&nbsp;
											<img src= "/resources/images/jsp/message/view/images/trash_12.gif" border="0" style="vertical-align: bottom; margin-left: 8px;" />
										</span>
									</td>
									<td>
					...
					<c:if test="${aimTeamReportsForm.showTabs}">
						...
						<span><img src= "/resources/images/jsp/message/view/images/edit.gif" border="0" style="vertical-align: bottom; margin-left: 8px;" /></span>
						...
						<logic:equal name="teamLeadFlag" scope="session" value="true">
							...
							<c:choose>
								<c:when test="${report.budgetExporter}">
									<a href="/TEMPLATE/reampv2/packages/container/build/index.html#/reampv2-app/report_generator/${report.ampReportId}" title="${translation}">
										<img src= "${pageContext.request.contextPath}/resources/images/jsp/message/view/images/edit.gif" border="0" class="img-padding" />
									</a>
								</c:when>
								<c:otherwise>
									<a href="/TEMPLATE/reampv2/packages/container/build/index.html#/reampv2-app/report_generator/${report.ampReportId}" title="${translation}">
							...
							<c:set var="translation">
								...
								<digi:link href="/deleteAllReports.do" name="urlParams" onclick="return confirmFunc()" title="${translation}">
									<img src= "${pageContext.request.contextPath}/resources/images/jsp/message/view/images/trash_12.gif" border="0" class="img-padding" />
								</digi:link>
						</logic:equal>
