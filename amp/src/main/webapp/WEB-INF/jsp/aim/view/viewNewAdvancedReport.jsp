...
<script type="text/javascript" src="WEB-INF/jsp/aim/view/scripts/arFunctions.js"></script>
...
<div id="mySorter" class="dialog" style="padding:10px 5px;overflow: auto; display: none;">
    <jsp:include page="WEB-INF/jsp/aim/view/ar/levelSorterPicker.jsp"/>
</div>
<%
...
<%// see AMP-30664 for details <jsp:include page="WEB-INF/jsp/aim/view/saveReports/dynamicSaveReportsAndFilters.jsp"/>%>
<%
    counter++;
    ReportContextData.getFromRequest().setProgressValue(counter);
%>
...
<table width="100%">
        ...
        <td>
            ...
            <logic:notEqual name="viewFormat" scope="request" value="print">
                <bean:define id="viewable" name="generatedReport" type="org.dgfoundation.amp.ar.Viewable"
                             toScope="request"/>
                <jsp:include page="WEB-INF/jsp/aim/view/ar/toolBar.jsp"/>
    ...
    <tr>
        <td>
            <%@include file="WEB-INF/jsp/aim/view/ar/opts/report_opts.jspf" %>
        </td>
    </tr>
    </logic:notEqual>
    </logic:notEqual>
    ...
    <logic:equal name="widget" scope="request" value="true">
        ...
        <tr>
            <td style="padding-left:-2px;">
                <%@include file="WEB-INF/jsp/aim/view/ar/opts/tab_opts.jspf" %>
            </td>
        </tr>
        <tr>
            <td>
                <%@include file="WEB-INF/jsp/aim/view/ar/opts/tab_opts_common.jspf" %>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <td>
                            ...
                            <logic:equal name="viewFormat" value="print">
                                <table id='reportTable' cellSpacing="0" width="900px" style="overflow:hidden">
                                    ...
                                    <jsp:include page="WEB-INF/jsp/aim/view/ar/viewableItem.jsp"/>
                                </table>
                            </logic:equal>
