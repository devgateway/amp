...
<%@ taglib uri="http://digijava.org/ResourceSettings" prefix="rs" %>
...
.all_markup .yui-dt-sortedbyasc .yui-dt-headcontainer td{color: black;background: url('/jsp/contentrepository/view/images/up.gif') no-repeat right;}/*arrow up*/
.all_markup .yui-dt-sortedbydesc .yui-dt-headcontainer td{color: black;background: url('/jsp/contentrepository/view/images/down.gif') no-repeat right;}/*arrow down*/
...
.versions_markup .yui-dt-sortedbyasc .yui-dt-headcontainer {background: url('/jsp/contentrepository/view/images/up.gif') no-repeat right;}/*arrow up*/
.versions_markup .yui-dt-sortedbydesc .yui-dt-headcontainer {background: url('/jsp/contentrepository/view/images/down.gif') no-repeat right;}/*arrow down*/
...
function deleteRow(uuid,o) {
	...
	if ( confirmDelete() ) {
		...
		//YAHOO.amp.panels[2].setBody("<div align='center'>" + translation2 + "<br /> <img src='/jsp/contentrepository/view/images/ajax-loader-darkblue.gif' border='0'/> </div>" );
...
function WindowControllerObject(bodyContainerEl) {
	...
	this.populateCallback		= function (sType, aArgs, obj) {
				...
				//alert(parameters);
				this.bodyContainerElement.innerHTML="<div align='center'>${trans_wait}<br /><img src='/jsp/contentrepository/view/images/ajax-loader-darkblue.gif' border='0' /> </div>";
...
function rejectDoc (uuid,actType,tabType){
	...
	//panel.setBody("<div style='text-align: center;'><img src='/jsp/contentrepository/view/images/ajax-loader-darkblue.gif' /></div>");
...
function showOrgsPanel(uuid) {
	...
	organisationPanel.setBody("<div style='text-align: center;'><img src='/jsp/contentrepository/view/images/ajax-loader-darkblue.gif' /></div>");
...
function addFromTemplate(ownType) {
	...
	templatesPanel.setBody("<div style='text-align: center;'><img src='/jsp/contentrepository/view/images/ajax-loader-darkblue.gif' /></div>");
	templatesPanel.show();
