							...
							<tr>
								...
								<c:choose>
									<c:when test="${documentData.webLink == null}">
										...
										title="${translation }"><img src="/static/contentrepository/view/images/check_out.gif" border="0"></a>
									</c:when>
									<c:otherwise>
										<c:set var="translation">
										...
										onmouseover="Tip('${translation} ${documentData.webLink}')"><img src="/static/contentrepository/view/images/link_go.gif" border="0"></a>
									</c:otherwise>
								</c:choose>
