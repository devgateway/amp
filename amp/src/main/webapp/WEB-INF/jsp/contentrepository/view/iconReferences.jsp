...
<table width="500" border="0" cellpadding="3" cellspacing="0" style="padding-left:30px;">
   ...
   <tr>
     <td nowrap="nowrap"><img src= "/jsp/contentrepository/view/images/check_out.gif" vspace="2" border="0" align="absmiddle" />
         <digi:trn key="contentrepository:documentManagerDownloadHint"> Click here to download document&nbsp;</digi:trn>
         <br />
     </td>
     <td nowrap="nowrap">&nbsp;</td>
     <td nowrap="nowrap"><img src= "/jsp/contentrepository/view/images/update.gif" vspace="2" border="0" align="absmiddle" />
         <digi:trn key="contentrepository:documentManagerAddVersionHint"> Click here to add a new version of this document</digi:trn>
     </td>
   </tr>
   <tr>
     <td nowrap="nowrap"><img src= "/jsp/contentrepository/view/images/link_go.gif" vspace="2" border="0" align="absmiddle"/>
         <digi:trn key="contentrepository:documentManagerFollowLinkHint"> Follow link to</digi:trn>
         <br />
     </td>
     <td nowrap="nowrap">&nbsp;</td>
     <td nowrap="nowrap"><img src= "/jsp/contentrepository/view/images/make_public.gif" vspace="2" border="0" align="absmiddle" />
         <digi:trn key="contentrepository:documentManagerMakePublicHint"> Click here to make this document public</digi:trn>
         <br />
     </td>
   </tr>
   <tr>
     <td nowrap="nowrap"><img src= "/jsp/contentrepository/view/images/make_private.gif" border="0" align="absmiddle" />
         <digi:trn key="contentrepository:documentManagerUnpublishHint"> Click here to unpublish this document</digi:trn>
     </td>
     <td nowrap="nowrap">&nbsp;</td>

     <td nowrap="nowrap"><img src= "/jsp/contentrepository/view/images/trash_12.gif" vspace="2" border="0" align="absmiddle" />
