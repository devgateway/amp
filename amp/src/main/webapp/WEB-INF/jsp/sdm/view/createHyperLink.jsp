...
<p align="center"><b><font size="4" color="#00008B">
	<digi:errors/>
	<digi:form action="/saveHyperLink.do" method="post">
	<div align="center">
		<table width="60%">
			<tr>
...
<p>
	<digi:trn key="sdm:createHyperLinktoDoc">Create a Hyper Link for this Document!</digi:trn></p></font></b></p>
	...
	<table width="70%">
		<tr>
			<td><font size="2">
				<digi:trn key="sdm:linkTitle">Title of the Link:</digi:trn></font><BR>
				<html:text name="sdmForm" property="contentTitle" size="50"/>
			</td>
		</tr>
		<tr>
			<td><font size="2">
				<digi:trn key="sdm:linkAddress">Link Address:</digi:trn></font><BR>
				<html:text name="sdmForm" property="content" size="70"/>
			</td>
		</tr>
		<tr>
			<td>
