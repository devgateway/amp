...
{
	window.document.form1.action="GlobalAddKey.do";
...
<form name="form1" method="POST" action="<%=request.getContextPath()%>/translate/global/global.do">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="headerNav">
		...
		<!-- can use HTML :select -->	      
			      <select name="locale" style="FONT-SIZE: 7pt; FONT-FAMILY: Verdana, Tahoma, 'MS Sans Serif', Arial" onChange="document.form1.mykey.value='';document.form1.new_text.value='';document.form1.choice.value='';document.form1.src_locale.value=this.options[this.selectedIndex].value;document.form1.multi.value='0';document.form1.buttontype.value='0';document.form1.submit()">
