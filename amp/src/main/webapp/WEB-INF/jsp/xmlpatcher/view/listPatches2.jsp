...
<!-- XML/Java Beautifier -->
<script type="text/javascript" src="/static/xmlpatcher/js/sh_main.min.js"></script>
<script type="text/javascript" src="/static/xmlpatcher/js/sh_xml.min.js"></script>
<script type="text/javascript" src="/static/xmlpatcher/js/sh_java.min.js"></script>
<link rel="stylesheet" type="text/css" href="/static/xmlpatcher/css/sh_style.css" />
