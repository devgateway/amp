                    ...
                    <div class="admin_landing_page_box_cont">
                      ...
                      <table border="0" cellspacing="2" cellpadding="2">
                        <module:display name="Global Settings" parentModule="ADMINISTRATIVE SECTION">
                          <tr>
                            <td><img width="16" align="left" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/arrow-th-BABAB9.gif"></td>
                        ...
                        <tr>
                          <td>
                            <img width="16" align="left" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/arrow-th-BABAB9.gif">
                          </td>
                          <td class="admin_box_label">
                        ...
                        <module:display name="Data Freeze Manager" parentModule="ADMINISTRATIVE SECTION">
                          <tr>
                            ...
                            <td class="admin_box_label">
                              ...
                              <a href="/src/main/webapp/WEB-INF/TEMPLATE/reamp/modules/admin/data-freeze-manager/index.html"
                        ...
                        <module:display name="Project Performance Alerts Manager" parentModule="ADMINISTRATIVE SECTION">
                          <tr>
                            ...
                            <td class="admin_box_label">
                                ...
                                <a href="/src/main/webapp/WEB-INF/TEMPLATE/reamp/modules/admin/performance-alert-manager/index.html"
                      ...
                      <table border="0" cellspacing="2" cellpadding="2">
                        ...
                        <module:display name="Indicator Layer Manager" parentModule="ADMINISTRATIVE SECTION">
                          <tr>
                           <td><img width="16" align="left" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/arrow-th-BABAB9.gif"></td>
                           <td>
                             <a href="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/node_modules/gis-layers-manager/dist/index.html" >
                        ...
                        <module:display name="Program Mapping Manager" parentModule="ADMINISTRATIVE SECTION">
                          <tr>
                            ...
                            <td class="admin_box_label">
                              ...
                              <a href="/src/main/webapp/WEB-INF/TEMPLATE/reampv2/build/index.html#/ndd"
                                 title="${translation}">
                        ...
                        <module:display name="Currency deflator" parentModule="ADMINISTRATIVE SECTION">
                          <tr>
                            ...
                            <td class="admin_box_label">
                              ...
                              <a href="/src/main/webapp/WEB-INF/TEMPLATE/reamp/modules/admin/currency/deflator/index.html"
                                 title="${translation}">
                        ...
                        <module:display name="Resource Manager" parentModule="ADMINISTRATIVE SECTION">
							<tr>
								<td><img width="16" align="left"
									src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/arrow-th-BABAB9.gif"></td>
								<td class="admin_box_label">
									<c:set var="translation">
										<digi:trn invisibleLinks="true">Click here to view Document manager admin</digi:trn>
									</c:set> 
									<a href="/src/main/webapp/WEB-INF/TEMPLATE/reamp/modules/admin/resource-manager-admin/index.html"
                            ...
                            <td class="admin_box_label">
                              <c:set var="translation">
                                <digi:trn invisibleLinks="true">Click here to view Dashboard Manager</digi:trn>
                                 ...
                                 <a href="/src/main/webapp/WEB-INF/TEMPLATE/reamp/modules/admin/dashboard/index.html"
                                 title="${translation}">
