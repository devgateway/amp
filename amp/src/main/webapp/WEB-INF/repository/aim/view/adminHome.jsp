                    ...
                    <div class="admin_landing_page_box_cont">
                      ...
                      <table border="0" cellspacing="2" cellpadding="2">
                        <module:display name="Global Settings" parentModule="ADMINISTRATIVE SECTION">
                          <tr>
                            <td><img width="16" align="left" src="/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/arrow-th-BABAB9.gif"></td>
                        ...
                        <tr>
                          <td>
                            <img width="16" align="left" src="/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/arrow-th-BABAB9.gif">
                          </td>
                          <td class="admin_box_label">
                        ...
                        <module:display name="Resource Manager" parentModule="ADMINISTRATIVE SECTION">
							<tr>
								<td><img width="16" align="left"
									src="/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/arrow-th-BABAB9.gif"></td>
								<td class="admin_box_label">
									<c:set var="translation">
