...
<ul>
	<logic:iterate scope="request" name="unorgLocCollection" id="loc" type="org.digijava.module.aim.dbentity.AmpCategoryValueLocations">
		...
		<li id="lid-${loc.id}" class="dhtmlgoodies_sheet.gif" >
			...
			<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/images/application_edit.png" style="height: 13px; cursor: pointer;"
					onclick="editLocation(${loc.id})" />
			<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/images/deleteIcon.gif" style="height: 10px; cursor: pointer;" />
