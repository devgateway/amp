...
<jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/addEditOrganizationsPopin.jsp"  />
<jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/addOrganizationPopin.jsp"  />
<jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/components/contactScripts.jsp"  />
                                    ...
                                    <td colspan="2">
                                        <table cellpadding="2" cellspacing="2" border="0" width="80%" align=center style="margin-top:15px; margin-bottom:15px;">
                                            <tr>
                                                ...
                                                <td align="left">
                                                	<jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/multilingual/multilingualFieldEntry.jsp">
				...
				<table width="95%" cellspacing="0" cellpadding="0" border="0">
					<tr>									
						<td bgcolor=#f4f4f2 align=center>
							...
							<jsp:include page="/src/main/webapp/WEB-INF/repository/contentrepository/view/showSelectedDocumentsDM.jsp"/>
						</td>
					</tr>
				</table>				
			</td>
