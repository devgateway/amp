...
<logic:notEmpty scope="request" name="reqSelectorHeaderSize">
	...
	<div class="grouping_selector_wrapper">
		<div style="background-image:url(/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/img_2/ins_header.gif);margin:0px; width: 100%; padding-top:5px; height: ${selectorHeaderSize}%; border: 1px solid #CCCCCC;border-bottom: 0px;">
			<div class="inside">
	...
	<div class="member_selector_wrapper">
		<div style="background-image:url(/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/img_2/ins_header.gif);margin:0px; padding-top:5px; height: ${selectorHeaderSize}%; border: 1px solid #CCCCCC; border-bottom: 0px;">
