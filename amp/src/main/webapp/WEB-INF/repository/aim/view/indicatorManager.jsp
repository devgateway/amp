																								...
																								<tr><td>
																										<table cellspacing="0" cellpadding="0">
																												<tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                          <img id="img1" alt="" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/tab-rightselected1.gif" width="20" height="19" />
                                                                                                                        </td>
																														<td noWrap height=17>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                          <img id="img2" alt="" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/tab-rightselected1.gif" width="20" height="19" />
                                                                                                                        </td>
																														<td noWrap height=17>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                          <img id="img3" alt="" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate//WEB-INF/repository/aim/images/tab-right1.gif" width="20" height="19" />
                                                                                                                        </td>
																												</tr>
																										</table>
																								</tr>
