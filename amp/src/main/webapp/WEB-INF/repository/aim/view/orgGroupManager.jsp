																...
																<table width="100%" border="0" class="inside">
																	<tr>
																		<td height="30" width="377" class="inside" bgcolor=#F2F2f2>
																			...
																			<c:if test="${empty aimOrgGroupManagerForm.sortBy || aimOrgGroupManagerForm.sortBy=='nameAscending'}"><img  src="/WEB-INF/repository/aim/images/up.gif"/></c:if>
																			<c:if test="${not empty aimOrgGroupManagerForm.sortBy && aimOrgGroupManagerForm.sortBy=='nameDescending'}"><img src="/WEB-INF/repository/aim/images/down.gif"/></c:if>
																		</td>	
																		<td height="30" width="171" class="inside" bgcolor=#F2F2f2>
																			...
																			<c:if test="${not empty aimOrgGroupManagerForm.sortBy && aimOrgGroupManagerForm.sortBy=='codeAscending'}"><img  src="/WEB-INF/repository/aim/images/up.gif"/></c:if>
																			<c:if test="${not empty aimOrgGroupManagerForm.sortBy && aimOrgGroupManagerForm.sortBy=='codeDescending'}"><img src="/WEB-INF/repository/aim/images/down.gif"/></c:if>
																		</td>
																		<td height="30" width="147" class="inside" bgcolor=#F2F2f2>
																			...
																			<c:if test="${not empty aimOrgGroupManagerForm.sortBy && aimOrgGroupManagerForm.sortBy=='typeAscending'}"><img  src="/WEB-INF/repository/aim/images/up.gif"/></c:if>
																			<c:if test="${not empty aimOrgGroupManagerForm.sortBy && aimOrgGroupManagerForm.sortBy=='typeDescending'}"><img src="/WEB-INF/repository/aim/images/down.gif"/></c:if>
