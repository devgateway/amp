...
<%@ taglib uri="http://digijava.org/aim" prefix="aim" %>
    ...
    <link href="/src/main/webapp/WEB-INF/repository/bootstrap/bootstrap-select.min.css" rel="stylesheet" type="text/css">
    <link href="/src/main/webapp/WEB-INF/repository/bootstrap/jquery.pnotify.default.css" media="all" rel="stylesheet" type="text/css" />
    <link href="/src/main/webapp/WEB-INF/repository/bootstrap/jquery.pnotify.default.icons.css" media="all" rel="stylesheet" type="text/css" />
<!-- <link href="/src/main/webapp/WEB-INF/repository/bootstrap/lightbox/ekko-lightbox.min.css" media="all" rel="stylesheet" type="text/css" />  -->
    <link href="/src/main/webapp/WEB-INF/repository/bootstrap/bootstrap-dialog.min.css" rel="stylesheet" type="text/css" />
    <link href="/src/main/webapp/WEB-INF/repository/bootstrap/datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css" />
    <link href="/src/main/webapp/WEB-INF/repository/bootstrap/upload/jquery.fileupload.css" rel="stylesheet" type="text/css" />
    <link href="/src/main/webapp/WEB-INF/repository/bootstrap/amp-bootstrap.css" rel="stylesheet" type="text/css" /> <!-- this should always be included last -->
    
    <!-- THESE 4 FILES SHOULD ALWAYS BE THE FIRST INCLUDED JS, IN THIS ORDER -->
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
	<script src="/src/main/webapp/WEB-INF/repository/bootstrap/amp-bootstrap.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/aim/view/pledgeform/pfscripts.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/aim/view/bootstrap/amp_validation.js" type="text/javascript"></script>
	<script src="/src/main/webapp/WEB-INF/repository/aim/view/bootstrap/forms.js" type="text/javascript"></script>
...
<logic:notPresent name="PNOTIFY_ERROR_MESSAGE" scope="request">
    ...
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/bootstrap-select.min.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/jquery.pnotify.min.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/bootstrap-dialog.min.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/jquery.ui.widget.js" type="text/javascript"></script>
	<script src="/src/main/webapp/WEB-INF/repository/bootstrap/upload/jquery.iframe-transport.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/upload/jquery.fileupload.js" type="text/javascript"></script>
    
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/datetimepicker/moment-with-langs.min.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/datetimepicker/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
    <script src="/src/main/webapp/WEB-INF/repository/bootstrap/bootstrap-utils.js" type="text/javascript"></script>
 <!--   <script src="/src/main/webapp/WEB-INF/repository/bootstrap/lightbox/ekko-lightbox.min.js" type="text/javascript"></script>  -->
