...
<script type="text/javascript">
	...
	function showPLogframe() {
        ...
        content.innerHTML = '<div style="height:400px"><p align="center"><img align="top" src="/src/main/webapp/WEB-INF/repository/aim/view/scripts/ajaxtabs/loading.gif" /><font size="3"><b>'+loading+'</b></font></p></div>';
		//if (panelFirstShow == 1){
