															 	...
															 	<tr bgcolor="#ffffff">
																	<td vAlign="center">
																		...
																		<%-- <a style="cursor: pointer; text-decoration: underline; color: blue;" id="<c:out value="${crDoc.uuid}"/>"
																			...
																			<img src="/src/main/webapp/WEB-INF/repository/contentrepository/view/images/check_out.gif" border="0">
																		</a> --%>
																		<a id="<c:out value="${crDoc.uuid}"/>" target="_blank" href="${crDoc.generalLink}" title="${translation}">
																			<img src="/src/main/webapp/WEB-INF/repository/contentrepository/view/images/check_out.gif" border="0"></a>
