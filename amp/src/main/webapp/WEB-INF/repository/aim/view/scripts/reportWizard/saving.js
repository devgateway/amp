...
SaveReportEngine.prototype.runReportInSaiku = function(reportToken) {
	var reportUrl = '/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/saikuui_reports/index_reports.html#report/run/' + reportToken;
...
SaveReportEngine.prototype.openReport = function(reportId, isSaiku) {
    ...
    if (isSaiku) {
         reportUrl = '/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/saikuui_reports/index_reports.html#report/open/' + reportId;
    } else {
...
SaveReportEngine.prototype.saveAndOrOpenReport = function (openReport) {
	...
	this.divEl.innerHTML			= this.savingMessage + 
			"... <img src='/src/main/webapp/WEB-INF/repository/aim/view/images/images_dhtmlsuite/ajax-loader-darkblue.gif' border='0' height='17px'/>";
