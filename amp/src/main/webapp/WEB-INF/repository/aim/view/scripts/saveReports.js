...
SaveReportEngine.prototype.saveReport		= function () {
	...
	if (reportTitles == null) {
		...
		this.panel.setFooter( SaveReportEngine.savingMessage + "...<br />  <img src='/src/main/webapp/WEB-INF/repository/aim/view/images/images_dhtmlsuite/ajax-loader-darkblue.gif' border='0' height='17px'/>" );
