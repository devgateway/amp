								...
								<tr>
									...
									<td>
										<span><digi:trn>Filtered Report</digi:trn>&nbsp;
											<img src= "/src/main/webapp/WEB-INF/repository/message/view/images/edit.gif" border="0" style="vertical-align: bottom; margin-left: 8px;" />
										</span>
									</td>
									<td>
										<span><digi:trn>Edit Report</digi:trn>&nbsp;
											<img src= "/src/main/webapp/WEB-INF/repository/message/view/images/trash_12.gif" border="0" style="vertical-align: bottom; margin-left: 8px;" />
										</span>
									</td>
									<td>
						...
						<logic:equal name="teamLeadFlag" scope="session" value="true"> 
							...
							<c:set var="translation">
								...
								<digi:link href="/deleteAllReports.do" name="urlParams" onclick="return confirmFunc()" title="${translation}">
									<img src= "/src/main/webapp/WEB-INF/repository/message/view/images/trash_12.gif" border="0" class="img-padding" />
								</digi:link>
						</logic:equal>
