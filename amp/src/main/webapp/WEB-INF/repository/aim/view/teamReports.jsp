...
<td>
									...
									<br>
									<div id="private">
										<img src= "/WEB-INF/repository/contentrepository/view/images/make_public.gif">
										<c:if test="${aimTeamReportsForm.showReportList == true}">
									...
									<div id="private">
										<img src= "/WEB-INF/repository/contentrepository/view/images/make_private.gif">
										<c:if test="${aimTeamReportsForm.showReportList == true}">
														...
														<td class="inside">
															...
															<logic:equal name="reports" property="teamView" value="false">
																...
																<c:set target="${urlParams}" property="currentPage" value="${aimTeamReportsForm.currentPage}" />
																	...
																	<digi:link href="/changeTeamReportStatus.do" name="urlParams" title="${translation}" >
																		<img hspace="2" title="<digi:trn key="aim:teamReportListMakePublic">Make this team-visible</digi:trn>" src= "/WEB-INF/repository/contentrepository/view/images/make_private.gif" border="0">
																	</digi:link>
															</logic:equal>
															...
															<logic:equal name="reports" property="teamView" value="true">
																...
																<c:set target="${urlParams}" property="currentPage" value="${aimTeamReportsForm.currentPage}" />
																	...
																	<digi:link href="/changeTeamReportStatus.do" name="urlParams" title="${translation}" >
																		<img hspace="2" title="<digi:trn key="aim:teamReportListMakePrivate">Make this team-invisible</digi:trn>" src= "/WEB-INF/repository/contentrepository/view/images/make_public.gif" border="0">
																	</digi:link>
															</logic:equal>
