...
function putLoading(){
	...
	if(mainDiv[0]){
		loadstatustext='&nbsp;&nbsp;&nbsp;<img src="/src/main/webapp/WEB-INF/repository/aim/view/scripts/ajaxtabs/loading.gif" /> <%=((String) pageContext.getAttribute("loadstatustext")).replaceAll("\r\n"," ")%> <span id="statusValue">...</span>';
