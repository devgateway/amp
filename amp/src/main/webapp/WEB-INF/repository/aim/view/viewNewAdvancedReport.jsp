...
<script type="text/javascript" src="/src/main/webapp/WEB-INF/repository/aim/view/scripts/arFunctions.js"></script>
...
<script type="text/javascript">
    ...
    if (location.toString().indexOf('queryEngine.do') === -1) {
        ...
        loadingreport.setBody("<div align='center'>" + msgwait1 + "<br>" + '<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/img_2/loading-icon.gif" />' + "</div>");
...
<table width="100%">
        ...
        <td>
            ...
            <logic:notEqual name="viewFormat" scope="request" value="print">
                <bean:define id="viewable" name="generatedReport" type="org.dgfoundation.amp.ar.Viewable"
                             toScope="request"/>
                <jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/ar/toolBar.jsp"/>
    ...
    <tr>
        <td>
            <%@include file="/src/main/webapp/WEB-INF/repository/aim/view/ar/opts/report_opts.jspf" %>
        </td>
    </tr>
    </logic:notEqual>
    </logic:notEqual>
    ...
    <logic:equal name="widget" scope="request" value="true">
        ...
        <tr>
            <td style="padding-left:-2px;">
                <%@include file="/src/main/webapp/WEB-INF/repository/aim/view/ar/opts/tab_opts.jspf" %>
            </td>
        </tr>
        <tr>
            <td>
                <%@include file="/src/main/webapp/WEB-INF/repository/aim/view/ar/opts/tab_opts_common.jspf" %>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <td>
                            ...
                            <logic:equal name="viewFormat" value="print">
                                <table id='reportTable' cellSpacing="0" width="900px" style="overflow:hidden">
                                    ...
                                    <jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/ar/viewableItem.jsp"/>
                                </table>
                            </logic:equal>
