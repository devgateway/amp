...
<digi:ref href="/src/main/webapp/WEB-INF/repository/budgetexport/view/css/budgetexport.css" type="text/css" rel="stylesheet" />
...
<script language="JavaScript" src="/src/main/webapp/WEB-INF/repository/budgetexport/view/js/budgetexport.js"></script>