          ...
          <table class="contentbox_border" width="100%" border="0" bgcolor="#f4f4f2" cellspacing=0 cellpadding=0>
                    ...
                    <tr>
                      <td align="center">
                          <table cellpadding="5" cellspacing="5">
                            <tr>
                              <td align="center">
                              <img src="/WEB-INF/repository/content/view/layout_1.png"/><br />
                              <html:radio name="contentForm" property="contentLayout" value="1" disabled="false" />
                              <br />
                              </td>
                              <td align="center">
                              <img src="/WEB-INF/repository/content/view/layout_2.png" /><br />
                              <html:radio property="contentLayout" value="2" disabled="false" />
                              <br />
                              </td>
                              <td align="center">
                              <img src="/WEB-INF/repository/content/view/layout_3.png" /><br />
                              <html:radio property="contentLayout" value="3" disabled="false" />
                              <br />
                              </td>
                              <td align="center">
                              <img src="/WEB-INF/repository/content/view/layout_4.png" /><br />
              ...
              <tr>
                <td valign="top" bgcolor="#f4f4f2" align="left" style="border:1px dotted black;">
                    ...
                    <c:import url="/WEB-INF/repository/content/view/layout_${layoutNumber}.jsp">
