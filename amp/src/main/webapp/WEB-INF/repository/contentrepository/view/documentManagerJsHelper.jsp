...
.all_markup .yui-dt-sortedbyasc .yui-dt-headcontainer td{color: black;background: url('/src/main/webapp/WEB-INF/repository/contentrepository/view/images/up.gif') no-repeat right;}/*arrow up*/
.all_markup .yui-dt-sortedbydesc .yui-dt-headcontainer td{color: black;background: url('/src/main/webapp/WEB-INF/repository/contentrepository/view/images/down.gif') no-repeat right;}/*arrow down*/
...
.versions_markup .yui-dt-sortedbyasc .yui-dt-headcontainer {background: url('/src/main/webapp/WEB-INF/repository/contentrepository/view/images/up.gif') no-repeat right;}/*arrow up*/
.versions_markup .yui-dt-sortedbydesc .yui-dt-headcontainer {background: url('/src/main/webapp/WEB-INF/repository/contentrepository/view/images/down.gif') no-repeat right;}/*arrow down*/
...
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/event-mouseenter/event-mouseenter-min.js"></script>
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/selector/selector-min.js"></script>
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/event-delegate/event-delegate-min.js"></script>
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/element/element-min.js"></script>
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/calendar/calendar-min.js"></script>
...
function deleteRow(uuid,o) {
	...
	if ( confirmDelete() ) {
		...
		//YAHOO.amp.panels[2].setBody("<div align='center'>" + translation2 + "<br /> <img src='/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif' border='0'/> </div>" );
...
function WindowControllerObject(bodyContainerEl) {
	...
	this.populateCallback		= function (sType, aArgs, obj) {
				...
				//alert(parameters);
				this.bodyContainerElement.innerHTML="<div align='center'>${trans_wait}<br /><img src='/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif' border='0' /> </div>";
...
function toggleView(elementId, iconId, isMinus) {
	...
	if (isMinus) {
			icon.src				= '/src/main/webapp/WEB-INF/repository/contentrepository/view/images/dhtmlgoodies_plus.gif';
			element.style.display	= 'none';
			isMinus		= false;
	}
	else{
			icon.src	= '/src/main/webapp/WEB-INF/repository/contentrepository/view/images/dhtmlgoodies_minus.gif';
...
$.getScript("/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/script/common/FileTypeValidator.js");
...
function rejectVersion(versionId, baseNodeUUID){
	...
	//myDiv.innerHTML='<img src=\"/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif\" height=\"20px\" />';
...
function rejectDoc (uuid,actType,tabType){
	...
	//panel.setBody("<div style='text-align: center;'><img src='/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif' /></div>");
...
function showOrgsPanel(uuid) {
	...
	organisationPanel.setBody("<div style='text-align: center;'><img src='/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif' /></div>");
...
function addFromTemplate(ownType) {
	...
	templatesPanel.setBody("<div style='text-align: center;'><img src='/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif' /></div>");
	templatesPanel.show();
