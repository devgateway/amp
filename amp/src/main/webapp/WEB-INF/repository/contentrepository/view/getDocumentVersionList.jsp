...
<bean:define id="myForm" name="crDocumentManagerForm" toScope="page" type="org.digijava.module.contentrepository.form.DocumentManagerForm" />
	<div id="loadingDiv" style="text-align: center;display: none;">
		...
		<img src='/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif' border='0' height='15px' align="middle"/>
	</div>
							...
							<tr>
								...
								<c:choose>
									<c:when test="${documentData.webLink == null}">
										...
										title="${translation }"><img src= "/src/main/webapp/WEB-INF/repository/contentrepository/view/images/check_out.gif" border="0"></a>
									</c:when>
									<c:otherwise>
										<c:set var="translation">
										...
										onmouseover="Tip('${translation} ${documentData.webLink}')"><img src= "/src/main/webapp/WEB-INF/repository/contentrepository/view/images/link_go.gif" border="0"></a>
									</c:otherwise>
								</c:choose>
