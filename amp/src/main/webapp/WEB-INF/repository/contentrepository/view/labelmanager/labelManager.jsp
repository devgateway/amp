...
<link rel="stylesheet" type="text/css" href="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/slider/assets/skins/sam/slider.css">
<link rel="stylesheet" type="text/css" href="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/colorpicker/assets/skins/sam/colorpicker.css">
<!-- Individual YUI JS files --> 
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/slider/slider-min.js"></script>
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/element/element-min.js"></script>
<script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/js_2/yui/colorpicker/colorpicker-min.js"></script>
	...
	function showColorPickerPanel(inputEl) {
		...
		if (panel == null) {
			...
			YAHOO.amp.picker = new YAHOO.widget.ColorPicker("colorPickerDiv", {
				images: {
					PICKER_THUMB: "/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/images/yui/colorpicker/picker_thumb.png",
					HUE_THUMB: "/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/images/yui/colorpicker/hue_thumb.png"
				},
									...
									<li noDrag="true" id="li-root">
										...
										<ul>
											<li noDrag="true">
												...
												<img src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/images/green_plus.png" style="height: 13px; cursor: pointer;"
