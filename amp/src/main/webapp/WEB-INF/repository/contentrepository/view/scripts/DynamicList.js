...
AbstractDynamicList.prototype.sendRequest		= function (shouldRetrieveFilters) {
	...
	this.containerEl.innerHTML="<div align='center'>"+ trnWait +"<br /><img src='/src/main/webapp/WEB-INF/repository/contentrepository/view/images/ajax-loader-darkblue.gif' border='0' /> </div>";
