...
<digi:form action="/gpi" type="org.digijava.module.gpi.form.GPIForm" name="gpiForm">
	...
	style="font-size:11px; font-family: Arial,sans-serif; background-color: white; font-family: Arial, Helvetica, sans-serif;">
	    <tr align="center">
			...
			<td width="27%" height="33" class="inside_header" >
			  <div align="center">
			      <strong><digi:trn>Disbursed On Budget Aid Financing</digi:trn></strong>
			  </div>
			</td>
			<td width="26%" height="33" class="inside_header" >
			  <div align="center">
			      <strong><digi:trn>Total Aid Financing</digi:trn></strong>
			  </div>
			</td>
			<td width="27%" height="33" class="inside_header" >
	            <div align="center">
	                <strong><digi:trn>Indicator 6</digi:trn></strong>
	            </div>
	        </td>
		</tr>
	    ...
	    <logic:notEmpty name="gpiForm" property="mainTableRows">
	       ...
	       <logic:iterate id="element" name="gpiForm" property="mainTableRows" indexId="index" type="org.digijava.module.gpi.helper.row.GPIReport6Row">
	...
	<font color="orange">&nbsp;*&nbsp;</font>
  	<jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/utils/amountUnitsUnformatted.jsp">
