...
<%@ taglib uri="http://displaytag.sf.net/display" prefix="display" %>
...
<script type="text/javascript">
  ...
  YAHOOAmp.widget.GlossNode = function(oData, oParent, expanded, checked, isMandatory, ident) {
    ...
    <script type="text/javascript" src="/src/main/webapp/WEB-INF/TEMPLATE/ampTemplate/script/yui/treeview-debug.js"></script>
