...
<jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/strongPassword.jsp"  />
										...
										<table border="0" cellPadding=5 cellspacing="0" width="100%">
											<tr>
												...
												<logic:notEmpty name="umAddUserForm" property="errors">
													...
													<jsp:include page="/src/main/webapp/WEB-INF/repository/aim/view/strongPasswordRulesLegend.jsp"  />
												</td>
											</tr>
                                            <tr>
