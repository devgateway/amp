							...
							<table border="0" cellpadding="0" cellspacing="0" width=772>
								...
								<tr>
									<td align="center" valign="top" width=520><br>
										...
										<td align="center">
										<a href="javascript:deleteWS(<c:out value="${assignedWS.ampTeamMemId}"/>)" title="<digi:trn key="aim:ClickDeleteUserFromWS">Click on this icon to remove user from the workspace</digi:trn>"><img  src="/src/main/webapp/WEB-INF/repository/message/view/images/trash_12.gif" border="0" hspace="2"/></a>
										</td>
										</tr>
										</logic:iterate>
										</c:if>
