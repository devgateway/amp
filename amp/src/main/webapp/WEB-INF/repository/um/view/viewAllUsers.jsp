...
<!--  AMP Admin Logo -->
<!-- jsp:include page="/src/main/webapp/WEB-INF/repositoryteamPagesHeader.jsp"  /-->
<!-- End of Logo -->
                ...
                List of users 
					...
					<tr>
						<td align="left" colspan=8>
								<jsp:include
									page="/src/main/webapp/WEB-INF/repository/aim/view/adminXSLExportToolbar.jsp" />
						</td>
					</tr>
																					...
																					<thead
																						...
																						<tr>
																							<td height="30" width="220"><c:if
																									...
																									test="${not empty umViewAllUsersForm.sortBy && umViewAllUsersForm.sortBy=='nameAscending'}">
																									<img src="/src/main/webapp/WEB-INF/repository/aim/images/up.gif" />
																								</c:if> <c:if
																									test="${not empty umViewAllUsersForm.sortBy && umViewAllUsersForm.sortBy=='nameDescending'}">
																									<img src="/src/main/webapp/WEB-INF/repository/aim/images/down.gif" />
																								</c:if></td>
																							<td height="30" width="220"><c:if
