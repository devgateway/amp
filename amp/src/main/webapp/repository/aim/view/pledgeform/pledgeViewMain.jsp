...
<%@ taglib uri="/src/main/webapp/WEB-INF/featureVisibility.tld" prefix="feature" %>
    ...
    <link href="/src/main/webapp/repository/bootstrap/bootstrap-select.min.css" rel="stylesheet" type="text/css">
    <link href="/src/main/webapp/repository/bootstrap/jquery.pnotify.default.css" media="all" rel="stylesheet" type="text/css" />
    <link href="/src/main/webapp/repository/bootstrap/jquery.pnotify.default.icons.css" media="all" rel="stylesheet" type="text/css" />
<!-- <link href="/src/main/webapp/repository/bootstrap/lightbox/ekko-lightbox.min.css" media="all" rel="stylesheet" type="text/css" />  -->
    <link href="/src/main/webapp/repository/bootstrap/bootstrap-dialog.min.css" rel="stylesheet" type="text/css" />
    <link href="/src/main/webapp/repository/bootstrap/amp-bootstrap.css" rel="stylesheet" type="text/css" /> <!-- this should always be included last -->
    
    <!-- THESE 4 FILES SHOULD ALWAYS BE THE FIRST INCLUDED JS, IN THIS ORDER -->
	<script src="/src/main/webapp/repository/bootstrap/amp-bootstrap.js" type="text/javascript"></script>
  <body class="main_side">
 	...
 	<div id="pledge_form_big_div"> 
		...
		<jsp:include page="/src/main/webapp/repository/aim/view/pledgeform/pledgeContactsView.jsp"></jsp:include>
		<jsp:include page="/src/main/webapp/repository/aim/view/pledgeform/pledgeEpilogueView.jsp"></jsp:include>
    ...
    <script src="/src/main/webapp/repository/bootstrap/bootstrap.min.js"></script>
    <script src="/src/main/webapp/repository/bootstrap/bootstrap-select.min.js" type="text/javascript"></script>
    <script src="/src/main/webapp/repository/bootstrap/jquery.pnotify.min.js" type="text/javascript"></script>
    <script src="/src/main/webapp/repository/bootstrap/bootstrap-dialog.min.js" type="text/javascript"></script>
