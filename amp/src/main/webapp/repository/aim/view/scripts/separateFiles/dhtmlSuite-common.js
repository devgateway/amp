...
//		this.cssPath = '../css_dhtmlsuite/';	// Path to images	
		...
		this.imagePath = '/src/main/webapp/repository/aim/view/images/images_dhtmlsuite/';	// Path to images
		this.cssPath = '/src/main/webapp/repository/aim/view/css/css_dhtmlsuite/';	// Path to images
