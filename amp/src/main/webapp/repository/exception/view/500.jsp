...
<tr>
	<td width="100%">
	<fieldset>
	<legend><digi:trn key="exception:stackTrace" >Stack trace</digi:trn></legend>
	<table width="100%">
	<tr>
		<td>
		    <html:textarea style="width:100%;height:350px" readonly="true" name="exceptionReportForm" property="stackTrace" />
		</td>	
	</tr>
	</table>
	</fieldset>
