...
public class MultilingualThroughTrnTests extends ReportsTestCase
{
				...
				GroupReportModel.withGroupReports("AMP-16666-by-impl-level",
						GroupReportModel.withColumnReports("AMP-16666-by-impl-level",
							ColumnReportDataModel.withColumns("Implementation Level: National",
								...
								SimpleColumnModel.withContents("Mode of Payment", "date-filters-activity", "Mode of Payment Unallocated"), 
							...
							ColumnReportDataModel.withColumns("Implementation Level: Provincial",
								SimpleColumnModel.withContents("Project Title", "crazy funding 1", "crazy funding 1", "Test MTEF directed", "Test MTEF directed", "Eth Water", "Eth Water", "TAC_activity_1", "TAC_activity_1", "ptc activity 2", "ptc activity 2", "TAC_activity_2", "TAC_activity_2", "ptc activity 1", "ptc activity 1", "SSC Project 2", "SSC Project 2", "SSC Project 1", "SSC Project 1"), 
								SimpleColumnModel.withContents("Modalities", "Eth Water", "Diplomats and courses", "SSC Project 2", "Virtual Platforms and blogs to consult, learn, and exchange ideas", "SSC Project 1", "Diplomats and courses"), 
								SimpleColumnModel.withContents("Status", "crazy funding 1", "default status", "Test MTEF directed", "default status", "Eth Water", "second status", "TAC_activity_1", "default status", "ptc activity 2", "default status", "TAC_activity_2", "default status", "ptc activity 1", "default status", "SSC Project 2", "default status", "SSC Project 1", "default status"), 
								...
								SimpleColumnModel.withContents("Mode of Payment", "crazy funding 1", "[Cash, Direct payment]", "Test MTEF directed", "[Cash, Mode of Payment Unallocated]", "Eth Water", "[Direct payment, Mode of Payment Unallocated]", "ptc activity 2", "No Information", "TAC_activity_1", "Mode of Payment Unallocated", "ptc activity 1", "Reimbursable", "TAC_activity_2", "Mode of Payment Unallocated", "SSC Project 2", "Direct payment", "SSC Project 1", "Direct payment"), 
								SimpleColumnModel.withContents("Type Of Assistance", "crazy funding 1", "[default type of assistance, second type of assistance]", "Test MTEF directed", "default type of assistance", "Eth Water", "[default type of assistance, second type of assistance]", "ptc activity 2", "default type of assistance", "TAC_activity_1", "default type of assistance", "TAC_activity_2", "default type of assistance", "ptc activity 1", "default type of assistance", "SSC Project 2", "default type of assistance", "SSC Project 1", "default type of assistance"), 
								GroupColumnModel.withSubColumns("Funding",
									GroupColumnModel.withSubColumns("2009",
										GroupColumnModel.withSubColumns("Actual Commitments",
											SimpleColumnModel.withContents("Mode of Payment Unallocated", MUST_BE_EMPTY))), 
									...
									GroupColumnModel.withSubColumns("2013",
										GroupColumnModel.withSubColumns("Actual Commitments",
											...
											SimpleColumnModel.withContents("Direct payment", "crazy funding 1", "222 222", "SSC Project 2", "567 421", "SSC Project 1", "111 333"), 
										...
										GroupColumnModel.withSubColumns("Actual Disbursements",
											SimpleColumnModel.withContents("Direct payment", "SSC Project 2", "131 845", "SSC Project 1", "555 111"), 
											SimpleColumnModel.withContents("Mode of Payment Unallocated", "Eth Water", "545 000")))), 
								GroupColumnModel.withSubColumns("Total Costs",
									SimpleColumnModel.withContents("Actual Commitments", "crazy funding 1", "333 333", "ptc activity 2", "333 222", "TAC_activity_1", "213 231", "TAC_activity_2", "999 888", "ptc activity 1", "666 777", "SSC Project 2", "567 421", "SSC Project 1", "111 333"), 
									SimpleColumnModel.withContents("Actual Disbursements", "Test MTEF directed", "143 777", "Eth Water", "545 000", "TAC_activity_1", "123 321", "TAC_activity_2", "453 213", "SSC Project 2", "131 845", "SSC Project 1", "555 111")))
					...
					.withPositionDigest(true,
						...
						"(line 2:RHLC Actual Commitments: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 6, colSpan: 1), RHLC Actual Disbursements: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 7, colSpan: 2), RHLC Actual Commitments: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 9, colSpan: 1), RHLC Actual Commitments: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 10, colSpan: 1), RHLC Actual Disbursements: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 11, colSpan: 1), RHLC Actual Commitments: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 12, colSpan: 4), RHLC Actual Disbursements: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 16, colSpan: 2), RHLC Actual Commitments: (startRow: 2, rowSpan: 2, totalRowSpan: 2, colStart: 18, colSpan: 1), RHLC Actual Disbursements: (startRow: 2, rowSpan: 2, totalRowSpan: 2, colStart: 19, colSpan: 1))",
		...
		fddr_correct = GroupReportModel.withGroupReports("AMP-16666-by-impl-level",
				GroupReportModel.withColumnReports("AMP-16666-by-impl-level",
						ColumnReportDataModel.withColumns("Implementation Level: Национальный",
							SimpleColumnModel.withContents("Project Title", "проект-фильтры-по-датам", "проект-фильтры-по-датам"), 
							SimpleColumnModel.withContents("Modalities", MUST_BE_EMPTY), 
							SimpleColumnModel.withContents("Status", "проект-фильтры-по-датам", "первый статус"), 
							SimpleColumnModel.withContents("Financing Instrument", "проект-фильтры-по-датам", "первичный инструмент финансирования"), 
							SimpleColumnModel.withContents("Mode of Payment", "проект-фильтры-по-датам", "Способ оплаты не указан"), 
							SimpleColumnModel.withContents("Type Of Assistance", "проект-фильтры-по-датам", "первичный тип помощи"), 
							GroupColumnModel.withSubColumns("Funding",
								GroupColumnModel.withSubColumns("2009",
									GroupColumnModel.withSubColumns("Actual Commitments",
								...
								GroupColumnModel.withSubColumns("2010",
									GroupColumnModel.withSubColumns("Actual Disbursements",
										SimpleColumnModel.withContents("Mode of Payment Unallocated", "проект-фильтры-по-датам", "60 000"), 
										SimpleColumnModel.withContents("Наличные", MUST_BE_EMPTY))), 
								GroupColumnModel.withSubColumns("2011",
									GroupColumnModel.withSubColumns("Actual Commitments",
										SimpleColumnModel.withContents("Mode of Payment Unallocated", MUST_BE_EMPTY))), 
								GroupColumnModel.withSubColumns("2012",
								...
								GroupColumnModel.withSubColumns("2013",
									GroupColumnModel.withSubColumns("Actual Commitments",
										SimpleColumnModel.withContents("Компенсируемые", MUST_BE_EMPTY), 
										SimpleColumnModel.withContents("Наличные", MUST_BE_EMPTY), 
										SimpleColumnModel.withContents("Нет данных", MUST_BE_EMPTY), 
										SimpleColumnModel.withContents("Прямая оплата", MUST_BE_EMPTY)), 
									GroupColumnModel.withSubColumns("Actual Disbursements",
										SimpleColumnModel.withContents("Mode of Payment Unallocated", MUST_BE_EMPTY), 
										SimpleColumnModel.withContents("Прямая оплата", MUST_BE_EMPTY)))), 
							GroupColumnModel.withSubColumns("Total Costs",
								SimpleColumnModel.withContents("Actual Commitments", "проект-фильтры-по-датам", "125 000"), 
								SimpleColumnModel.withContents("Actual Disbursements", "проект-фильтры-по-датам", "72 000")))
						...
						ColumnReportDataModel.withColumns("Implementation Level: Провинциальный",
							SimpleColumnModel.withContents("Project Title", "crazy funding 1", "crazy funding 1", "Тест направленных МТЕФ", "Тест направленных МТЕФ", "Вода Eth", "Вода Eth", "Проект_TAC_1", "Проект_TAC_1", "Проект PTC 2", "Проект PTC 2", "Проект_TAC_2", "Проект_TAC_2", "Проект PTC 1", "Проект PTC 1", "Проект КЮЮ 2", "Проект КЮЮ 2", "Проект КЮЮ 1", "Проект КЮЮ 1"), 
							SimpleColumnModel.withContents("Modalities", "Вода Eth", "Дипломаты и курсы", "Проект КЮЮ 2", "Виртуальные Платформы и блоги проконсультироваться, узнать, и обмениваться идеями", "Проект КЮЮ 1", "Дипломаты и курсы"), 
							SimpleColumnModel.withContents("Status", "crazy funding 1", "первый статус", "Тест направленных МТЕФ", "первый статус", "Вода Eth", "второй статус", "Проект_TAC_1", "первый статус", "Проект PTC 2", "первый статус", "Проект_TAC_2", "первый статус", "Проект PTC 1", "первый статус", "Проект КЮЮ 2", "первый статус", "Проект КЮЮ 1", "первый статус"), 
							...
							SimpleColumnModel.withContents("Mode of Payment", "crazy funding 1", "[Наличные, Прямая оплата]", "Тест направленных МТЕФ", "[Наличные, Способ оплаты не указан]", "Вода Eth", "[Прямая оплата, Способ оплаты не указан]", "Проект PTC 2", "Нет данных", "Проект_TAC_1", "Способ оплаты не указан", "Проект PTC 1", "Компенсируемые", "Проект_TAC_2", "Способ оплаты не указан", "Проект КЮЮ 2", "Прямая оплата", "Проект КЮЮ 1", "Прямая оплата"), 
							SimpleColumnModel.withContents("Type Of Assistance", "crazy funding 1", "[вторичный тип помощи, первичный тип помощи]", "Тест направленных МТЕФ", "первичный тип помощи", "Вода Eth", "[вторичный тип помощи, первичный тип помощи]", "Проект PTC 2", "первичный тип помощи", "Проект_TAC_1", "первичный тип помощи", "Проект_TAC_2", "первичный тип помощи", "Проект PTC 1", "первичный тип помощи", "Проект КЮЮ 2", "первичный тип помощи", "Проект КЮЮ 1", "первичный тип помощи"), 
							GroupColumnModel.withSubColumns("Funding",
								GroupColumnModel.withSubColumns("2009",
									GroupColumnModel.withSubColumns("Actual Commitments",
										SimpleColumnModel.withContents("Mode of Payment Unallocated", MUST_BE_EMPTY))), 
								GroupColumnModel.withSubColumns("2010",
									GroupColumnModel.withSubColumns("Actual Disbursements",
										SimpleColumnModel.withContents("Mode of Payment Unallocated", "Проект_TAC_1", "123 321", "Проект_TAC_2", "453 213"), 
								...
								GroupColumnModel.withSubColumns("2013",
									GroupColumnModel.withSubColumns("Actual Commitments",
										...
										SimpleColumnModel.withContents("Прямая оплата", "crazy funding 1", "222 222", "Проект КЮЮ 2", "567 421", "Проект КЮЮ 1", "111 333")), 
									GroupColumnModel.withSubColumns("Actual Disbursements",
										SimpleColumnModel.withContents("Mode of Payment Unallocated", "Вода Eth", "545 000"), 
										SimpleColumnModel.withContents("Прямая оплата", "Проект КЮЮ 2", "131 845", "Проект КЮЮ 1", "555 111")))), 
							GroupColumnModel.withSubColumns("Total Costs",
								SimpleColumnModel.withContents("Actual Commitments", "crazy funding 1", "333 333", "Проект PTC 2", "333 222", "Проект_TAC_1", "213 231", "Проект_TAC_2", "999 888", "Проект PTC 1", "666 777", "Проект КЮЮ 2", "567 421", "Проект КЮЮ 1", "111 333"), 
								SimpleColumnModel.withContents("Actual Disbursements", "Тест направленных МТЕФ", "143 777", "Вода Eth", "545 000", "Проект_TAC_1", "123 321", "Проект_TAC_2", "453 213", "Проект КЮЮ 2", "131 845", "Проект КЮЮ 1", "555 111")))
	...
	public void testFlat()
	{
		GroupReportModel fddr_correct = 
			GroupReportModel.withColumnReports("AMP-16666-flat",
				ColumnReportDataModel.withColumns("AMP-16666-flat",
					SimpleColumnModel.withContents("Project Title", "crazy funding 1", "crazy funding 1", "TAC_activity_1", "TAC_activity_1", "TAC_activity_2", "TAC_activity_2", "Proposed Project Cost 1 - USD", "Proposed Project Cost 1 - USD", "Proposed Project Cost 2 - EUR", "Proposed Project Cost 2 - EUR", "Pure MTEF Project", "Pure MTEF Project", "Test MTEF directed", "Test MTEF directed", "activity with components", "activity with components", "Project with documents", "Project with documents", "mtef activity 1", "mtef activity 1", "Eth Water", "Eth Water", "mtef activity 2", "mtef activity 2", "date-filters-activity", "date-filters-activity", "ptc activity 2", "ptc activity 2", "ptc activity 1", "ptc activity 1", "SSC Project 2", "SSC Project 2", "SSC Project 1", "SSC Project 1"), 
					SimpleColumnModel.withContents("Modalities", "Eth Water", "Diplomats and courses", "SSC Project 2", "Virtual Platforms and blogs to consult, learn, and exchange ideas", "SSC Project 1", "Diplomats and courses"), 
					SimpleColumnModel.withContents("Status", "crazy funding 1", "default status", "TAC_activity_1", "default status", "TAC_activity_2", "default status", "Proposed Project Cost 1 - USD", "default status", "Proposed Project Cost 2 - EUR", "default status", "Pure MTEF Project", "default status", "Test MTEF directed", "default status", "activity with components", "default status", "Project with documents", "default status", "mtef activity 1", "default status", "Eth Water", "second status", "mtef activity 2", "default status", "date-filters-activity", "default status", "ptc activity 2", "default status", "ptc activity 1", "default status", "SSC Project 2", "default status", "SSC Project 1", "default status"), 
					...
					SimpleColumnModel.withContents("Mode of Payment", "crazy funding 1", "[Cash, Direct payment]", "Pure MTEF Project", "Mode of Payment Unallocated", "Test MTEF directed", "[Cash, Mode of Payment Unallocated]", "mtef activity 1", "Mode of Payment Unallocated", "Eth Water", "[Direct payment, Mode of Payment Unallocated]", "mtef activity 2", "Direct payment", "date-filters-activity", "Mode of Payment Unallocated", "TAC_activity_1", "Mode of Payment Unallocated", "ptc activity 2", "No Information", "TAC_activity_2", "Mode of Payment Unallocated", "ptc activity 1", "Reimbursable", "SSC Project 2", "Direct payment", "SSC Project 1", "Direct payment"), 
					SimpleColumnModel.withContents("Type Of Assistance", "Pure MTEF Project", "default type of assistance", "crazy funding 1", "[default type of assistance, second type of assistance]", "Test MTEF directed", "default type of assistance", "mtef activity 1", "default type of assistance", "Eth Water", "[default type of assistance, second type of assistance]", "mtef activity 2", "default type of assistance", "date-filters-activity", "default type of assistance", "ptc activity 2", "default type of assistance", "TAC_activity_1", "default type of assistance", "TAC_activity_2", "default type of assistance", "ptc activity 1", "default type of assistance", "SSC Project 2", "default type of assistance", "SSC Project 1", "default type of assistance"), 
					SimpleColumnModel.withContents("Implementation Level", "crazy funding 1", "Provincial", "TAC_activity_1", "Provincial", "TAC_activity_2", "Provincial", "Proposed Project Cost 1 - USD", "Provincial", "Proposed Project Cost 2 - EUR", "Provincial", "Pure MTEF Project", "Provincial", "Test MTEF directed", "Provincial", "activity with components", "Provincial", "Project with documents", "Provincial", "mtef activity 1", "National", "Eth Water", "Provincial", "mtef activity 2", "Provincial", "date-filters-activity", "National", "ptc activity 2", "Provincial", "ptc activity 1", "Provincial", "SSC Project 2", "Provincial", "SSC Project 1", "Provincial"), 
					GroupColumnModel.withSubColumns("Funding",
						GroupColumnModel.withSubColumns("2009",
							GroupColumnModel.withSubColumns("Actual Commitments",
								SimpleColumnModel.withContents("Mode of Payment Unallocated", "date-filters-activity", "100 000"))), 
						...
						GroupColumnModel.withSubColumns("2013",
							...
							GroupColumnModel.withSubColumns("Actual Disbursements",
								...
								SimpleColumnModel.withContents("Mode of Payment Unallocated", "Eth Water", "545 000")))), 
					GroupColumnModel.withSubColumns("Total Costs",
						SimpleColumnModel.withContents("Actual Commitments", "crazy funding 1", "333 333", "date-filters-activity", "125 000", "ptc activity 2", "333 222", "TAC_activity_1", "213 231", "TAC_activity_2", "999 888", "ptc activity 1", "666 777", "SSC Project 2", "567 421", "SSC Project 1", "111 333"), 
						SimpleColumnModel.withContents("Actual Disbursements", "Test MTEF directed", "143 777", "Eth Water", "545 000", "date-filters-activity", "72 000", "TAC_activity_1", "123 321", "TAC_activity_2", "453 213", "SSC Project 2", "131 845", "SSC Project 1", "555 111")))
		...
		fddr_correct = GroupReportModel.withColumnReports("AMP-16666-flat",
				ColumnReportDataModel.withColumns("AMP-16666-flat",
						SimpleColumnModel.withContents("Project Title", "crazy funding 1", "crazy funding 1", "Проект_TAC_1", "Проект_TAC_1", "Проект_TAC_2", "Проект_TAC_2", "Предполагаемая стоймость проекта 1 - USD", "Предполагаемая стоймость проекта 1 - USD", "Предполагаемая стоймость проекта 2 - EUR", "Предполагаемая стоймость проекта 2 - EUR", "Чисто-МТЕФ-Проект", "Чисто-МТЕФ-Проект", "Тест направленных МТЕФ", "Тест направленных МТЕФ", "проект с подпроектами", "проект с подпроектами", "Проект с документами", "Проект с документами", "Проект МТЕФ 1", "Проект МТЕФ 1", "Вода Eth", "Вода Eth", "Проект МТЕФ 2", "Проект МТЕФ 2", "проект-фильтры-по-датам", "проект-фильтры-по-датам", "Проект PTC 2", "Проект PTC 2", "Проект PTC 1", "Проект PTC 1", "Проект КЮЮ 2", "Проект КЮЮ 2", "Проект КЮЮ 1", "Проект КЮЮ 1"), 
						SimpleColumnModel.withContents("Modalities", "Вода Eth", "Дипломаты и курсы", "Проект КЮЮ 2", "Виртуальные Платформы и блоги проконсультироваться, узнать, и обмениваться идеями", "Проект КЮЮ 1", "Дипломаты и курсы"), 
						SimpleColumnModel.withContents("Status", "crazy funding 1", "первый статус", "Проект_TAC_1", "первый статус", "Проект_TAC_2", "первый статус", "Предполагаемая стоймость проекта 1 - USD", "первый статус", "Предполагаемая стоймость проекта 2 - EUR", "первый статус", "Чисто-МТЕФ-Проект", "первый статус", "Тест направленных МТЕФ", "первый статус", "проект с подпроектами", "первый статус", "Проект с документами", "первый статус", "Проект МТЕФ 1", "первый статус", "Вода Eth", "второй статус", "Проект МТЕФ 2", "первый статус", "проект-фильтры-по-датам", "первый статус", "Проект PTC 2", "первый статус", "Проект PTC 1", "первый статус", "Проект КЮЮ 2", "первый статус", "Проект КЮЮ 1", "первый статус"), 
						...
						SimpleColumnModel.withContents("Mode of Payment", "crazy funding 1", "[Наличные, Прямая оплата]", "Чисто-МТЕФ-Проект", "Способ оплаты не указан", "Тест направленных МТЕФ", "[Наличные, Способ оплаты не указан]", "Проект МТЕФ 1", "Способ оплаты не указан", "Вода Eth", "[Прямая оплата, Способ оплаты не указан]", "Проект МТЕФ 2", "Прямая оплата", "проект-фильтры-по-датам", "Способ оплаты не указан", "Проект_TAC_1", "Способ оплаты не указан", "Проект PTC 2", "Нет данных", "Проект_TAC_2", "Способ оплаты не указан", "Проект PTC 1", "Компенсируемые", "Проект КЮЮ 2", "Прямая оплата", "Проект КЮЮ 1", "Прямая оплата"), 
						SimpleColumnModel.withContents("Type Of Assistance", "Чисто-МТЕФ-Проект", "первичный тип помощи", "crazy funding 1", "[вторичный тип помощи, первичный тип помощи]", "Тест направленных МТЕФ", "первичный тип помощи", "Проект МТЕФ 1", "первичный тип помощи", "Вода Eth", "[вторичный тип помощи, первичный тип помощи]", "Проект МТЕФ 2", "первичный тип помощи", "проект-фильтры-по-датам", "первичный тип помощи", "Проект PTC 2", "первичный тип помощи", "Проект_TAC_1", "первичный тип помощи", "Проект_TAC_2", "первичный тип помощи", "Проект PTC 1", "первичный тип помощи", "Проект КЮЮ 2", "первичный тип помощи", "Проект КЮЮ 1", "первичный тип помощи"), 
						SimpleColumnModel.withContents("Implementation Level", "crazy funding 1", "Провинциальный", "Проект_TAC_1", "Провинциальный", "Проект_TAC_2", "Провинциальный", "Предполагаемая стоймость проекта 1 - USD", "Провинциальный", "Предполагаемая стоймость проекта 2 - EUR", "Провинциальный", "Чисто-МТЕФ-Проект", "Провинциальный", "Тест направленных МТЕФ", "Провинциальный", "проект с подпроектами", "Провинциальный", "Проект с документами", "Провинциальный", "Проект МТЕФ 1", "Национальный", "Вода Eth", "Провинциальный", "Проект МТЕФ 2", "Провинциальный", "проект-фильтры-по-датам", "Национальный", "Проект PTC 2", "Провинциальный", "Проект PTC 1", "Провинциальный", "Проект КЮЮ 2", "Провинциальный", "Проект КЮЮ 1", "Провинциальный"), 
						GroupColumnModel.withSubColumns("Funding",
							GroupColumnModel.withSubColumns("2009",
								GroupColumnModel.withSubColumns("Actual Commitments",
									SimpleColumnModel.withContents("Mode of Payment Unallocated", "проект-фильтры-по-датам", "100 000"))), 
							...
							GroupColumnModel.withSubColumns("2013",
								...
								GroupColumnModel.withSubColumns("Actual Disbursements",
									...
									SimpleColumnModel.withContents("Прямая оплата", "Проект КЮЮ 2", "131 845", "Проект КЮЮ 1", "555 111")))), 
						GroupColumnModel.withSubColumns("Total Costs",
							SimpleColumnModel.withContents("Actual Commitments", "crazy funding 1", "333 333", "проект-фильтры-по-датам", "125 000", "Проект PTC 2", "333 222", "Проект_TAC_1", "213 231", "Проект_TAC_2", "999 888", "Проект PTC 1", "666 777", "Проект КЮЮ 2", "567 421", "Проект КЮЮ 1", "111 333"), 
							SimpleColumnModel.withContents("Actual Disbursements", "Тест направленных МТЕФ", "143 777", "Вода Eth", "545 000", "проект-фильтры-по-датам", "72 000", "Проект_TAC_1", "123 321", "Проект_TAC_2", "453 213", "Проект КЮЮ 2", "131 845", "Проект КЮЮ 1", "555 111")))
