...
public class CurrencyConvertorTests extends MondrianReportsTestCase {
	...
	public void testLocalDateToJulian() {
		assertEquals(new Integer(2456320), DateTimeUtil.toJulianDayNumber(new LocalDate(2013, 1, 27)));
		assertEquals(new Integer(2456268), DateTimeUtil.toJulianDayNumber(new LocalDate(2012, 12, 06)));
		assertEquals(new Integer(2454236), DateTimeUtil.toJulianDayNumber(new LocalDate(2007, 05, 15)));
	}
...
//		assertEquals(0.04629122272957889, exchangeRateMDLtoEUR );
		assertEquals(0.038209030948756974, exchangeRateMDLtoEUR );
//		0.038209030948756974
		
//		assertEquals(21.602367382726875, exchangeRateEURtoMDL );
		assertEquals(26.171823131058293, exchangeRateEURtoMDL );
