...
public class MondrianSummaryReportTests extends ReportingTestCase {
	...
	public void testSummaryReportGauge() {
	    ...
	    .withChildren(
	      new ReportAreaForTests()
	          .withContents("Project Title", "TAC_activity_2", "Region", "Falesti County", "Primary Sector", "130 - POPULATION POLICIES/PROGRAMMES AND REPRODUCTIVE HEALTH", "2009-Actual Commitments", "", "2009-Actual Disbursements", "", "2010-Actual Commitments", "", "2010-Actual Disbursements", "453 213", "2011-Actual Commitments", "999 888", "2011-Actual Disbursements", "", "2012-Actual Commitments", "", "2012-Actual Disbursements", "", "2013-Actual Commitments", "", "2013-Actual Disbursements", "", "Total Measures-Actual Commitments", "999 888", "Total Measures-Actual Disbursements", "453 213"),
	      new ReportAreaForTests()
	...
	public void testRegionHierarchy() {
	    ...
	    .withChildren(
	      new ReportAreaForTests()
	          .withContents("Region", "Balti County Totals", "Project Title", "", "2009-Actual Commitments", "0", "2011-Actual Commitments", "0", "2012-Actual Commitments", "0", "2013-Actual Commitments", "333 333", "Total Measures-Actual Commitments", "333 333")
	      .withChildren(
	        new ReportAreaForTests()
	              .withContents("Region", "Balti County", "Project Title", "crazy funding 1", "2009-Actual Commitments", "", "2011-Actual Commitments", "", "2012-Actual Commitments", "", "2013-Actual Commitments", "333 333", "Total Measures-Actual Commitments", "333 333")    ),
	      new ReportAreaForTests()
	          .withContents("Region", "Falesti County Totals", "Project Title", "", "2009-Actual Commitments", "0", "2011-Actual Commitments", "999 888", "2012-Actual Commitments", "0", "2013-Actual Commitments", "0", "Total Measures-Actual Commitments", "999 888")
	      .withChildren(
	        new ReportAreaForTests()
	              .withContents("Region", "Falesti County", "Project Title", "TAC_activity_2", "2009-Actual Commitments", "", "2011-Actual Commitments", "999 888", "2012-Actual Commitments", "", "2013-Actual Commitments", "", "Total Measures-Actual Commitments", "999 888")    ),
	      new ReportAreaForTests()
	          .withContents("Region", "Region: Undefined Totals", "Project Title", "", "2009-Actual Commitments", "100 000", "2011-Actual Commitments", "0", "2012-Actual Commitments", "25 000", "2013-Actual Commitments", "0", "Total Measures-Actual Commitments", "125 000")
	      .withChildren(
	        new ReportAreaForTests()
	              .withContents("Region", "Region: Undefined", "Project Title", "date-filters-activity", "2009-Actual Commitments", "100 000", "2011-Actual Commitments", "", "2012-Actual Commitments", "25 000", "2013-Actual Commitments", "", "Total Measures-Actual Commitments", "125 000")    )  );
