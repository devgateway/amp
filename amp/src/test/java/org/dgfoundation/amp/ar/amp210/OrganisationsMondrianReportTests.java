...
public class OrganisationsMondrianReportTests extends MondrianReportsTestCase {
	...
	public void testProjectsWithoutDonorFunding() {
	    ...
	    .withContents("Project Title", "Report Totals", "Donor Agency", "", "Donor Group", "", "Donor Type", "", "2010-Actual Disbursements", "143 777", "2010-Actual Commitments", "0", "2013-Actual Disbursements", "545 000", "2013-Actual Commitments", "0", "Total Measures-Actual Disbursements", "688 777", "Total Measures-Actual Commitments", "0")
	    .withChildren(
	      new ReportAreaForTests().withContents("Project Title", "Proposed Project Cost 1 - USD", "Donor Agency", "", "Donor Group", "", "Donor Type", "", "2010-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2013-Actual Disbursements", "0", "2013-Actual Commitments", "0", "Total Measures-Actual Disbursements", "0", "Total Measures-Actual Commitments", "0"),
	      new ReportAreaForTests().withContents("Project Title", "Test MTEF directed", "Donor Agency", "Ministry of Economy", "Donor Group", "National", "Donor Type", "Default", "2010-Actual Disbursements", "143 777", "2010-Actual Commitments", "0", "2013-Actual Disbursements", "0", "2013-Actual Commitments", "0", "Total Measures-Actual Disbursements", "143 777", "Total Measures-Actual Commitments", "0"),
	      new ReportAreaForTests().withContents("Project Title", "Pure MTEF Project", "Donor Agency", "Ministry of Finance", "Donor Group", "National", "Donor Type", "Default", "2010-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2013-Actual Disbursements", "0", "2013-Actual Commitments", "0", "Total Measures-Actual Disbursements", "0", "Total Measures-Actual Commitments", "0"),
	      new ReportAreaForTests().withContents("Project Title", "activity with components", "Donor Agency", "", "Donor Group", "", "Donor Type", "", "2010-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2013-Actual Disbursements", "0", "2013-Actual Commitments", "0", "Total Measures-Actual Disbursements", "0", "Total Measures-Actual Commitments", "0"),
	      new ReportAreaForTests().withContents("Project Title", "Project with documents", "Donor Agency", "", "Donor Group", "", "Donor Type", "", "2010-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2013-Actual Disbursements", "0", "2013-Actual Commitments", "0", "Total Measures-Actual Disbursements", "0", "Total Measures-Actual Commitments", "0"),
	      new ReportAreaForTests().withContents("Project Title", "Eth Water", "Donor Agency", "Finland, Norway, USAID", "Donor Group", "American, Default Group, European", "Donor Type", "Default", "2010-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2013-Actual Disbursements", "545 000", "2013-Actual Commitments", "0", "Total Measures-Actual Disbursements", "545 000", "Total Measures-Actual Commitments", "0"));
	...
	public void testDirectedMtefProjectsDonorInfo() {
	    ...
	    .withContents("Project Title", "Test MTEF directed", "Donor Agency", "Ministry of Economy", "Donor Group", "National", "Donor Type", "Default", "2010-Actual Commitments", "0", "2010-Actual Disbursements", "143 777", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "143 777")  );
	...
	public void testRelatedAgenciesFlat() {
	    ...
	    .withChildren(
	      new ReportAreaForTests().withContents("Project Title", "Proposed Project Cost 2 - EUR", "Responsible Organization", "", "Responsible Organization Groups", "", "Executing Agency", "", "Executing Agency Groups", "", "Implementing Agency", "", "Implementing Agency Groups", "", "Beneficiary Agency", "", "Beneficiary Agency Groups", "", "2009-Actual Commitments", "0", "2009-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2010-Actual Disbursements", "0", "2012-Actual Commitments", "0", "2012-Actual Disbursements", "0", "2013-Actual Commitments", "0", "2013-Actual Disbursements", "0", "2014-Actual Commitments", "0", "2014-Actual Disbursements", "0", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "0"),
	      ...
	      new ReportAreaForTests().withContents("Project Title", "mtef activity 1", "Responsible Organization", "", "Responsible Organization Groups", "", "Executing Agency", "", "Executing Agency Groups", "", "Implementing Agency", "", "Implementing Agency Groups", "", "Beneficiary Agency", "", "Beneficiary Agency Groups", "", "2009-Actual Commitments", "0", "2009-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2010-Actual Disbursements", "0", "2012-Actual Commitments", "0", "2012-Actual Disbursements", "0", "2013-Actual Commitments", "0", "2013-Actual Disbursements", "0", "2014-Actual Commitments", "0", "2014-Actual Disbursements", "0", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "0"),
	      ...
	      new ReportAreaForTests().withContents("Project Title", "pledged 2", "Responsible Organization", "", "Responsible Organization Groups", "", "Executing Agency", "", "Executing Agency Groups", "", "Implementing Agency", "", "Implementing Agency Groups", "", "Beneficiary Agency", "", "Beneficiary Agency Groups", "", "2009-Actual Commitments", "0", "2009-Actual Disbursements", "0", "2010-Actual Commitments", "0", "2010-Actual Disbursements", "0", "2012-Actual Commitments", "0", "2012-Actual Disbursements", "0", "2013-Actual Commitments", "2 670 000", "2013-Actual Disbursements", "0", "2014-Actual Commitments", "4 400 000", "2014-Actual Disbursements", "450 000", "Total Measures-Actual Commitments", "7 070 000", "Total Measures-Actual Disbursements", "450 000")  );
	...
	public void testResponsibleOrganisationFilter() {
	    ...
	    .withChildren(
	      new ReportAreaForTests()
		  .withContents("Project Title", "Test MTEF directed", "Responsible Organization", "72 Local Public Administrations from RM", "Responsible Organization Groups", "Default Group", "Executing Agency", "Water Foundation", "Executing Agency Groups", "American", "Implementing Agency", "USAID", "Implementing Agency Groups", "American", "Beneficiary Agency", "", "Beneficiary Agency Groups", "", "2010-Actual Commitments", "0", "2010-Actual Disbursements", "71 888,5", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "71 888,5")  );
