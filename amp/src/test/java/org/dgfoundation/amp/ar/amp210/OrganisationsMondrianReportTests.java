...
public class OrganisationsMondrianReportTests extends ReportingTestCase {
	...
	public void testProjectsWithoutDonorFunding() {
	    ...
	    .withChildren(
	      ...
	      new ReportAreaForTests()
	          .withContents("Project Title", "Eth Water", "Donor Agency", "Finland, Norway, USAID", "Donor Group", "American, Default Group, European", "Donor Type", "Default", "2010-Actual Commitments", "", "2010-Actual Disbursements", "", "2013-Actual Commitments", "", "2013-Actual Disbursements", "545 000", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "545 000")  );
	...
	public void testRelatedAgenciesFlat() {
	    ...
	    .withChildren(
	      ...
	      new ReportAreaForTests()
	          .withContents("Project Title", "Test MTEF directed", "Responsible Organization", "72 Local Public Administrations from RM, UNDP", "Responsible Organization Groups", "Default Group, International", "Executing Agency", "Water Foundation", "Executing Agency Groups", "American", "Implementing Agency", "USAID", "Implementing Agency Groups", "American", "Beneficiary Agency", "", "Beneficiary Agency Groups", "", "2009-Actual Commitments", "", "2009-Actual Disbursements", "", "2010-Actual Commitments", "", "2010-Actual Disbursements", "143 777", "2012-Actual Commitments", "", "2012-Actual Disbursements", "", "2013-Actual Commitments", "", "2013-Actual Disbursements", "", "2014-Actual Commitments", "", "2014-Actual Disbursements", "", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "143 777"),
	      new ReportAreaForTests()
	      ...
	      new ReportAreaForTests()
	          .withContents("Project Title", "Eth Water", "Responsible Organization", "", "Responsible Organization Groups", "", "Executing Agency", "UNDP, World Bank", "Executing Agency Groups", "International", "Implementing Agency", "Ministry of Economy, Ministry of Finance", "Implementing Agency Groups", "National", "Beneficiary Agency", "Water Foundation, Water Org", "Beneficiary Agency Groups", "American", "2009-Actual Commitments", "", "2009-Actual Disbursements", "", "2010-Actual Commitments", "", "2010-Actual Disbursements", "", "2012-Actual Commitments", "", "2012-Actual Disbursements", "", "2013-Actual Commitments", "", "2013-Actual Disbursements", "545 000", "2014-Actual Commitments", "", "2014-Actual Disbursements", "", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "545 000"),
	      new ReportAreaForTests()
	...
	public void testExecutingAgencyFilter() {
	    ...
	    .withChildren(
	      new ReportAreaForTests()
	          .withContents("Project Title", "Eth Water", "Responsible Organization", "", "Responsible Organization Groups", "", "Executing Agency", "UNDP, World Bank", "Executing Agency Groups", "International", "Implementing Agency", "Ministry of Economy, Ministry of Finance", "Implementing Agency Groups", "National", "Beneficiary Agency", "Water Foundation, Water Org", "Beneficiary Agency Groups", "American", "2009-Actual Commitments", "", "2009-Actual Disbursements", "", "2010-Actual Commitments", "", "2010-Actual Disbursements", "", "2012-Actual Commitments", "", "2012-Actual Disbursements", "", "2013-Actual Commitments", "", "2013-Actual Disbursements", "545 000", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "545 000"),
	      new ReportAreaForTests()
	...
	public void testOrgTypeFiltering() {
	    ...
	    .withChildren(
	      new ReportAreaForTests()
	          .withContents("Project Title", "Test MTEF directed", "Responsible Organization", "72 Local Public Administrations from RM, UNDP", "Responsible Organization Groups", "Default Group, International", "Executing Agency", "Water Foundation", "Executing Agency Groups", "American", "Implementing Agency", "USAID", "Implementing Agency Groups", "American", "Beneficiary Agency", "", "Beneficiary Agency Groups", "", "2009-Actual Commitments", "", "2009-Actual Disbursements", "", "2010-Actual Commitments", "", "2010-Actual Disbursements", "143 777", "2012-Actual Commitments", "", "2012-Actual Disbursements", "", "2013-Actual Commitments", "", "2013-Actual Disbursements", "", "Total Measures-Actual Commitments", "0", "Total Measures-Actual Disbursements", "143 777"),
	      new ReportAreaForTests()
