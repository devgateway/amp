...
public class PledgeFiltersMondrianReportTests extends MondrianReportsTestCase {
	...
	public void testPledgeLocationFilter() {
		ReportAreaForTests correctReport = new ReportAreaForTests()
	    .withContents("Pledges Titles", "Report Totals", "Pledges Aid Modality", "", "Pledges Districts", "", "Pledges Donor Group", "", "Pledges National Plan Objectives", "", "Pledge Status", "", "Pledges sectors", "", "Pledges Programs", "", "Pledges Regions", "", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "", "Pledges Tertiary Programs", "", "2012-Actual Pledge", "0,06", "2014-Actual Pledge", "51 662,25", "Total Measures-Actual Pledge", "51 662,31")
	    .withChildren(
	      new ReportAreaForTests().withContents("Pledges Titles", "Test pledge 1", "Pledges Aid Modality", "Development of shared analytical studies, Interchanging models, proposals, and printed materials, Sending and exchanging experts, researchers, and professors", "Pledges Districts", "", "Pledges Donor Group", "European", "Pledges National Plan Objectives", "", "Pledge Status", "second status", "Pledges sectors", "112 - BASIC EDUCATION, 113 - SECONDARY EDUCATION", "Pledges Programs", "Subprogram p1.b", "Pledges Regions", "Transnistrian Region", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "3 NATIONAL COMPETITIVENESS, 5 REGIONAL DEVELOPMENT", "Pledges Tertiary Programs", "OP1 name", "2012-Actual Pledge", "0,06", "2014-Actual Pledge", "51 662,25", "Total Measures-Actual Pledge", "51 662,31"));
	...
	public void testPledgePrimaryProgramFilter() {
		ReportAreaForTests correctReport = new ReportAreaForTests()
	    .withContents("Pledges Titles", "Report Totals", "Pledges Aid Modality", "", "Pledges Districts", "", "Pledges Donor Group", "", "Pledges National Plan Objectives", "", "Pledge Status", "", "Pledges sectors", "", "Pledges Programs", "", "Pledges Regions", "", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "", "Pledges Tertiary Programs", "", "2012-Actual Pledge", "1,25", "2014-Actual Pledge", "1 033 244,98", "Total Measures-Actual Pledge", "1 971 315,98")
	    .withChildren(
	      new ReportAreaForTests().withContents("Pledges Titles", "Test pledge 1", "Pledges Aid Modality", "Development of shared analytical studies, Interchanging models, proposals, and printed materials, Sending and exchanging experts, researchers, and professors", "Pledges Districts", "", "Pledges Donor Group", "European", "Pledges National Plan Objectives", "", "Pledge Status", "second status", "Pledges sectors", "112 - BASIC EDUCATION, 113 - SECONDARY EDUCATION", "Pledges Programs", "Subprogram p1.b", "Pledges Regions", "Balti County, Cahul County, Transnistrian Region", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "3 NATIONAL COMPETITIVENESS, 5 REGIONAL DEVELOPMENT", "Pledges Tertiary Programs", "OP1 name", "2012-Actual Pledge", "1,25", "2014-Actual Pledge", "1 033 244,98", "Total Measures-Actual Pledge", "1 033 246,23"),
	      new ReportAreaForTests().withContents("Pledges Titles", "ACVL Pledge Name 2", "Pledges Aid Modality", "Conferences, seminars, capacity specializations, Undefined", "Pledges Districts", "", "Pledges Donor Group", "Default Group", "Pledges National Plan Objectives", "", "Pledge Status", "", "Pledges sectors", "", "Pledges Programs", "Subprogram p1.b", "Pledges Regions", "", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "1-DEMOCRATIC COUNTRY", "Pledges Tertiary Programs", "OP1 name", "2012-Actual Pledge", "0", "2014-Actual Pledge", "0", "Total Measures-Actual Pledge", "938 069,75"));
	...
	public void testPledgePrimarySectorFilter() {
		ReportAreaForTests correctReport = new ReportAreaForTests()
	    .withContents("Pledges Titles", "Report Totals", "Pledges Aid Modality", "", "Pledges Districts", "", "Pledges Donor Group", "", "Pledges National Plan Objectives", "", "Pledge Status", "", "Pledges sectors", "", "Pledges Programs", "", "Pledges Regions", "", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "", "Pledges Tertiary Programs", "", "2012-Actual Pledge", "0,81", "2014-Actual Pledge", "671 609,24", "Total Measures-Actual Pledge", "671 610,05")
	    .withChildren(
	      new ReportAreaForTests().withContents("Pledges Titles", "Test pledge 1", "Pledges Aid Modality", "Development of shared analytical studies, Interchanging models, proposals, and printed materials, Sending and exchanging experts, researchers, and professors", "Pledges Districts", "", "Pledges Donor Group", "European", "Pledges National Plan Objectives", "", "Pledge Status", "second status", "Pledges sectors", "113 - SECONDARY EDUCATION", "Pledges Programs", "Subprogram p1.b", "Pledges Regions", "Balti County, Cahul County, Transnistrian Region", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "3 NATIONAL COMPETITIVENESS, 5 REGIONAL DEVELOPMENT", "Pledges Tertiary Programs", "OP1 name", "2012-Actual Pledge", "0,81", "2014-Actual Pledge", "671 609,24", "Total Measures-Actual Pledge", "671 610,05"));
	...
	public void testPledgeSecondarySectorFilter() {
	    ...
	    .withChildren(
	      new ReportAreaForTests().withContents("Pledges Titles", "ACVL Pledge Name 2", "Pledges Aid Modality", "Conferences, seminars, capacity specializations, Undefined", "Pledges Districts", "", "Pledges Donor Group", "Default Group", "Pledges National Plan Objectives", "", "Pledge Status", "", "Pledges sectors", "", "Pledges Programs", "Subprogram p1.b", "Pledges Regions", "", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "1-DEMOCRATIC COUNTRY", "Pledges Tertiary Programs", "OP1 name", "2012-Actual Pledge", "0", "Total Measures-Actual Pledge", "938 069,75"),
	...
	public void testPledgeTypeOfAssistanceFilter() {
		ReportAreaForTests correctReport = new ReportAreaForTests()
	    .withContents("Pledges Titles", "Report Totals", "Pledges Aid Modality", "", "Pledges Districts", "", "Pledges Donor Group", "", "Pledges National Plan Objectives", "", "Pledge Status", "", "Pledges Tertiary Sectors", "", "Pledges sectors", "", "Pledges Type Of Assistance", "", "Pledges Programs", "", "Pledges Regions", "", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "", "Pledges Tertiary Programs", "", "2014-Actual Pledge", "265 568,98", "Total Measures-Actual Pledge", "265 568,98")
	    .withChildren(
	      new ReportAreaForTests().withContents("Pledges Titles", "Test pledge 1", "Pledges Aid Modality", "Interchanging models, proposals, and printed materials", "Pledges Districts", "", "Pledges Donor Group", "European", "Pledges National Plan Objectives", "", "Pledge Status", "second status", "Pledges Tertiary Sectors", "", "Pledges sectors", "112 - BASIC EDUCATION, 113 - SECONDARY EDUCATION", "Pledges Type Of Assistance", "second type of assistance", "Pledges Programs", "Subprogram p1.b", "Pledges Regions", "Balti County, Cahul County, Transnistrian Region", "Pledges Secondary Programs", "", "Pledges Secondary Sectors", "3 NATIONAL COMPETITIVENESS, 5 REGIONAL DEVELOPMENT", "Pledges Tertiary Programs", "OP1 name", "2014-Actual Pledge", "265 568,98", "Total Measures-Actual Pledge", "265 568,98"));
