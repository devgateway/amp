...
public class AmpSchemaSanityTests extends BasicSanityChecks {
	...
	/*this tests expenditure class-related measures*/
	@Test
	public void testExpenditureClass() {
		...
		runNiTestCase(
				buildSpecification("testcase expenditure class with everything", 
						...
						Arrays.asList(MeasureConstants.ACTUAL_CLASSIFIED_EXPENDITURES, MeasureConstants.PLANNED_CLASSIFIED_EXPENDITURES, 
								MeasureConstants.ACTUAL_COMMITMENTS, MeasureConstants.REAL_COMMITMENTS, MeasureConstants.REAL_DISBURSEMENTS, 
								MeasureConstants.PLANNED_EXPENDITURES, MeasureConstants.ACTUAL_EXPENDITURES), 
						Arrays.asList(ColumnConstants.DONOR_AGENCY, ColumnConstants.PRIMARY_SECTOR), 
						GroupingCriteria.GROUPING_TOTALS_ONLY),
				"en", 
				Arrays.asList("expenditure class", "Eth Water", "Test MTEF directed"),
				cor);
		cor = new NiReportModel("testcase expenditure class with donor org and real measures")
				.withHeaders(Arrays.asList(
		...
		runNiTestCase(
				buildSpecification("testcase expenditure class with donor org and real measures", 
						...
						Arrays.asList(MeasureConstants.ACTUAL_CLASSIFIED_EXPENDITURES, MeasureConstants.PLANNED_CLASSIFIED_EXPENDITURES, 
								MeasureConstants.REAL_DISBURSEMENTS, 
								MeasureConstants.REAL_COMMITMENTS), 
						Arrays.asList(ColumnConstants.DONOR_AGENCY), 
						GroupingCriteria.GROUPING_TOTALS_ONLY),
				"en", 
				Arrays.asList("expenditure class", "Eth Water", "Test MTEF directed"),
				cor);
		cor = new NiReportModel("testcase expenditure class with primary sector")
				.withHeaders(Arrays.asList(
		...
		runNiTestCase(
				buildSpecification("testcase expenditure class with primary sector", 
						...
						Arrays.asList(MeasureConstants.ACTUAL_CLASSIFIED_EXPENDITURES, MeasureConstants.PLANNED_CLASSIFIED_EXPENDITURES, 
								MeasureConstants.PLANNED_EXPENDITURES), 
						Arrays.asList(ColumnConstants.PRIMARY_SECTOR), 
						GroupingCriteria.GROUPING_TOTALS_ONLY),
				"en", 
				Arrays.asList("expenditure class", "Eth Water", "Test MTEF directed"),
				cor);
		cor = new NiReportModel("testcase expenditure class with assistance type")
				.withHeaders(Arrays.asList(
						"(RAW: (startRow: 0, rowSpan: 1, totalRowSpan: 4, colStart: 0, colSpan: 11))",
