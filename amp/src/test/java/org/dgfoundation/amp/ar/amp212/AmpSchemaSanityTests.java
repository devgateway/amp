...
public class AmpSchemaSanityTests extends MondrianReportsTestCase {
	...
	public void testByTypeOfAssistance_still_has_dummy_zero_subreport() {
		...
		assertEquals(
			"{(root) -> default type of assistance=11927387.555086, (root) -> second type of assistance=7481303.631302, (root) -> =0, (root)=19408691.186388}",
			buildNiReportDigest(spec, acts, new TrailCellsDigest("RAW / Totals / Actual Commitments")).toString());
		
		assertEquals(
			"{(root) -> default type of assistance=2676802, (root) -> second type of assistance=530000, (root) -> =0, (root)=3206802}",
