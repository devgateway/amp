...
public class AmpSchemaSanityTests extends BasicSanityChecks {
    ...
    public void test_AMP_18509() {
        NiReportModel cor = new NiReportModel("AMP-18509")
                .withHeaders(Arrays.asList(
                        ...
                        "(Project Title: (startRow: 1, rowSpan: 4, totalRowSpan: 4, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 4, totalRowSpan: 4, colStart: 1, colSpan: 1));(AMP ID: (startRow: 1, rowSpan: 4, totalRowSpan: 4, colStart: 2, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 4, colStart: 3, colSpan: 33));(Totals: (startRow: 1, rowSpan: 3, totalRowSpan: 4, colStart: 36, colSpan: 3))",
    ...
    public void test_AMP_18577_only_count_donor_transactions() {
        ...
        .withHeaders(Arrays.asList(
                ...
                "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 1));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 3, colSpan: 1))",
    ...
    public void test_AMP_18330_empty_rows() {
        ...
        .withHeaders(Arrays.asList(
            ...
            .withWarnings(Arrays.asList())
            .withBody(      new ReportAreaForTests(null)
              .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2010-Actual Disbursements", "143,777", "Totals-Actual Disbursements", "143,777")
              .withChildren(
                new ReportAreaForTests(null, "Project Title", "Test MTEF directed", "Administrative Level 1", "Anenii Noi County", "Funding-2010-Actual Disbursements", "143,777", "Totals-Actual Disbursements", "143,777"),
    ...
    public void test_AMP_18748_no_data() {
        ...
        .withHeaders(Arrays.asList(
                "(RAW: (startRow: 0, rowSpan: 1, totalRowSpan: 4, colStart: 0, colSpan: 3))",
                "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 2, colSpan: 1))",
                "",
    ...
    public void testActivityCountNonSummary() {
        NiReportModel cor = new NiReportModel("ActivityCountReport")
            .withHeaders(Arrays.asList(
                    ...
                    "(Administrative Level 1: (startRow: 1, rowSpan: 2, totalRowSpan: 2, colStart: 0, colSpan: 1));(Project Title: (startRow: 1, rowSpan: 2, totalRowSpan: 2, colStart: 1, colSpan: 1));(Activity Count: (startRow: 1, rowSpan: 2, totalRowSpan: 2, colStart: 2, colSpan: 1));(Administrative Level 2: (startRow: 1, rowSpan: 2, totalRowSpan: 2, colStart: 3, colSpan: 1));(Totals: (startRow: 1, rowSpan: 1, totalRowSpan: 2, colStart: 4, colSpan: 2))",
                ...
                .withWarnings(Arrays.asList())
                .withBody(      new ReportAreaForTests(null)
                  .withContents("Administrative Level 1", "", "Project Title", "", "Activity Count", "12", "Administrative Level 2", "", "Totals-Actual Commitments", "6 678 792,63", "Totals-Actual Disbursements", "1 433 888")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Anenii Noi County", 9085))
                    .withContents("Project Title", "", "Activity Count", "8", "Administrative Level 2", "", "Totals-Actual Commitments", "1 611 832", "Totals-Actual Disbursements", "1 243 888", "Administrative Level 1", "Anenii Noi County")
                    .withChildren(
                      new ReportAreaForTests(new AreaOwner(18), "Project Title", "Test MTEF directed", "Administrative Level 2", "", "Totals-Actual Disbursements", "143 777"),
                      new ReportAreaForTests(new AreaOwner(24), "Project Title", "Eth Water", "Administrative Level 2", "", "Totals-Actual Disbursements", "545 000"),
                      new ReportAreaForTests(new AreaOwner(28), "Project Title", "ptc activity 1", "Administrative Level 2", "", "Totals-Actual Commitments", "666 777"),
                      new ReportAreaForTests(new AreaOwner(29), "Project Title", "ptc activity 2", "Administrative Level 2", "", "Totals-Actual Commitments", "333 222"),
                      new ReportAreaForTests(new AreaOwner(30), "Project Title", "SSC Project 1", "Administrative Level 2", "", "Totals-Actual Commitments", "111 333", "Totals-Actual Disbursements", "555 111"),
                      new ReportAreaForTests(new AreaOwner(33), "Project Title", "Activity with Zones", "Administrative Level 2", "Bulboaca", "Totals-Actual Commitments", "285 000"),
                      new ReportAreaForTests(new AreaOwner(36), "Project Title", "Activity With Zones and Percentages", "Administrative Level 2", "Dolboaca", "Totals-Actual Commitments", "178 000"),
                      new ReportAreaForTests(new AreaOwner(40), "Project Title", "SubNational no percentages", "Administrative Level 2", "", "Totals-Actual Commitments", "37 500")        ),
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Chisinau County", 9089))
                    .withContents("Project Title", "", "Activity Count", "4", "Administrative Level 2", "", "Totals-Actual Commitments", "5 066 960,63", "Totals-Actual Disbursements", "190 000", "Administrative Level 1", "Chisinau County")
                    .withChildren(
                      new ReportAreaForTests(new AreaOwner(46), "Project Title", "pledged education activity 1", "Administrative Level 2", "", "Totals-Actual Commitments", "5 000 000"),
    ...
    public void testActivityCountDoubleSummary() {
        NiReportModel cor = new NiReportModel("activity-count-summary-dual")
            .withHeaders(Arrays.asList(
                    ...
                    "(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Primary Sector: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Activity Count: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 2, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 3, colSpan: 16));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 19, colSpan: 2))",
                ...
                .withWarnings(Arrays.asList())
                .withBody(      new ReportAreaForTests(null)
                  .withContents("Administrative Level 1", "", "Primary Sector", "", "Activity Count", "37", "Funding-2006-Actual Commitments", "96 840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100 000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "780 311", "Funding-2011-Actual Commitments", "1 213 119", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25 000", "Funding-2012-Actual Disbursements", "12 000", "Funding-2013-Actual Commitments", "7 842 086", "Funding-2013-Actual Disbursements", "1 266 956", "Funding-2014-Actual Commitments", "8 159 813,77", "Funding-2014-Actual Disbursements", "710 200", "Funding-2015-Actual Commitments", "1 971 831,84", "Funding-2015-Actual Disbursements", "437 335", "Totals-Actual Commitments", "19 408 691,19", "Totals-Actual Disbursements", "3 206 802")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Anenii Noi County", 9085))
                    ...
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Cahul County", 9087)).withContents("Primary Sector", "", "Activity Count", "1", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "2 670 000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "4 400 000", "Funding-2014-Actual Disbursements", "450 000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "7 070 000", "Totals-Actual Disbursements", "450 000", "Administrative Level 1", "Cahul County")
                    .withChildren(
                    ...
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Edinet County", 9092)).withContents("Primary Sector", "", "Activity Count", "1", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "567 421", "Funding-2013-Actual Disbursements", "131 845", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "567 421", "Totals-Actual Disbursements", "131 845", "Administrative Level 1", "Edinet County")
                    .withChildren(
                      new ReportAreaForTests(new AreaOwner("Primary Sector", "112 - BASIC EDUCATION", 6242), "Activity Count", "1", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "567 421", "Funding-2013-Actual Disbursements", "131 845", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "567 421", "Totals-Actual Disbursements", "131 845", "Primary Sector", "112 - BASIC EDUCATION")        ),
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Falesti County", 9093)).withContents("Primary Sector", "", "Activity Count", "1", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "453 213", "Funding-2011-Actual Commitments", "999 888", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "999 888", "Totals-Actual Disbursements", "453 213", "Administrative Level 1", "Falesti County")
                    .withChildren(
                      new ReportAreaForTests(new AreaOwner("Primary Sector", "130 - POPULATION POLICIES/PROGRAMMES AND REPRODUCTIVE HEALTH", 6267), "Activity Count", "1", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "453 213", "Funding-2011-Actual Commitments", "999 888", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "999 888", "Totals-Actual Disbursements", "453 213", "Primary Sector", "130 - POPULATION POLICIES/PROGRAMMES AND REPRODUCTIVE HEALTH")        ),
    ...
    public void testProjectTitleAsSingleHierarchy() {
        ...
        .withHeaders(Arrays.asList(
                "(RAW: (startRow: 0, rowSpan: 1, totalRowSpan: 4, colStart: 0, colSpan: 21))",
                "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Primary Sector: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 2, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 3, colSpan: 16));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 19, colSpan: 2))",
                "(2006: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 3, colSpan: 2));(2009: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 5, colSpan: 2));(2010: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 7, colSpan: 2));(2011: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 9, colSpan: 2));(2012: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 11, colSpan: 2));(2013: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 13, colSpan: 2));(2014: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 15, colSpan: 2));(2015: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 17, colSpan: 2))",
                "(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 3, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 4, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 5, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 6, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 7, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 8, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 9, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 10, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 11, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 12, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 13, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 14, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 15, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 16, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 17, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 18, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 19, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 20, colSpan: 1))"))
            .withWarnings(Arrays.asList())
            .withBody(      new ReportAreaForTests(null)
              .withContents("Project Title", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "780,311", "Funding-2011-Actual Commitments", "1,213,119", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "7,842,086", "Funding-2013-Actual Disbursements", "1,266,956", "Funding-2014-Actual Commitments", "8,159,813,77", "Funding-2014-Actual Disbursements", "710,200", "Funding-2015-Actual Commitments", "1,971,831,84", "Funding-2015-Actual Disbursements", "437,335", "Totals-Actual Commitments", "19,408,691,19", "Totals-Actual Disbursements", "3,206,802")
              .withChildren(
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity 2 with multiple agreements", 66)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "1,200", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "1,200", "Totals-Actual Disbursements", "0", "Project Title", "Activity 2 with multiple agreements")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(66), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "1,200", "Totals-Actual Commitments", "1,200")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity Linked With Pledge", 41)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "50,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity Linked With Pledge")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(41), "Administrative Level 1", "Chisinau City", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity With Zones and Percentages", 36)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "890,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "890,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity With Zones and Percentages")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(36), "Administrative Level 1", "Anenii Noi County, Balti County", "Primary Sector", "110 - EDUCATION, 120 - HEALTH", "Funding-2013-Actual Commitments", "890,000", "Totals-Actual Commitments", "890,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity with Zones", 33)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "570,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "570,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity with Zones")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(33), "Administrative Level 1", "Anenii Noi County, Balti County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "570,000", "Totals-Actual Commitments", "570,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity with both MTEFs and Act.Comms", 70)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "888,000", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "888,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity with both MTEFs and Act.Comms")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(70), "Administrative Level 1", "Balti County, Drochia County", "Primary Sector", "110 - EDUCATION, 112 - BASIC EDUCATION", "Funding-2015-Actual Commitments", "888,000", "Totals-Actual Commitments", "888,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity with planned disbursements", 69)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "200", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "570", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "770", "Project Title", "Activity with planned disbursements")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(69), "Administrative Level 1", "", "Primary Sector", "112 - BASIC EDUCATION", "Funding-2014-Actual Disbursements", "200", "Funding-2015-Actual Disbursements", "570", "Totals-Actual Disbursements", "770")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity with primary_tertiary_program", 43)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "50,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity with primary_tertiary_program")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(43), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Eth Water", 24)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "545,000", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "545,000", "Project Title", "Eth Water")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(24), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Disbursements", "545,000", "Totals-Actual Disbursements", "545,000")        ),
                ...
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(30), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "111,333", "Funding-2013-Actual Disbursements", "555,111", "Totals-Actual Commitments", "111,333", "Totals-Actual Disbursements", "555,111")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "SSC Project 2", 31)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "567,421", "Funding-2013-Actual Disbursements", "131,845", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "567,421", "Totals-Actual Disbursements", "131,845", "Project Title", "SSC Project 2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(31), "Administrative Level 1", "Edinet County", "Primary Sector", "112 - BASIC EDUCATION", "Funding-2013-Actual Commitments", "567,421", "Funding-2013-Actual Disbursements", "131,845", "Totals-Actual Commitments", "567,421", "Totals-Actual Disbursements", "131,845")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "SubNational no percentages", 40)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "75,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "75,000", "Totals-Actual Disbursements", "0", "Project Title", "SubNational no percentages")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(40), "Administrative Level 1", "Anenii Noi County, Balti County", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "75,000", "Totals-Actual Commitments", "75,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "TAC_activity_1", 12)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "123,321", "Funding-2011-Actual Commitments", "213,231", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "213,231", "Totals-Actual Disbursements", "123,321", "Project Title", "TAC_activity_1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(12), "Administrative Level 1", "Dubasari County", "Primary Sector", "112 - BASIC EDUCATION", "Funding-2010-Actual Disbursements", "123,321", "Funding-2011-Actual Commitments", "213,231", "Totals-Actual Commitments", "213,231", "Totals-Actual Disbursements", "123,321")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "TAC_activity_2", 13)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "453,213", "Funding-2011-Actual Commitments", "999,888", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "999,888", "Totals-Actual Disbursements", "453,213", "Project Title", "TAC_activity_2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(13), "Administrative Level 1", "Falesti County", "Primary Sector", "130 - POPULATION POLICIES/PROGRAMMES AND REPRODUCTIVE HEALTH", "Funding-2010-Actual Disbursements", "453,213", "Funding-2011-Actual Commitments", "999,888", "Totals-Actual Commitments", "999,888", "Totals-Actual Disbursements", "453,213")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Test MTEF directed", 18)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "143,777", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "143,777", "Project Title", "Test MTEF directed")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(18), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2010-Actual Disbursements", "143,777", "Totals-Actual Disbursements", "143,777")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Unvalidated activity", 64)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "45,000", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "45,000", "Totals-Actual Disbursements", "0", "Project Title", "Unvalidated activity")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(64), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "45,000", "Totals-Actual Commitments", "45,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity 1 with agreement", 65)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "456,789", "Funding-2015-Actual Disbursements", "321,765", "Totals-Actual Commitments", "456,789", "Totals-Actual Disbursements", "321,765", "Project Title", "activity 1 with agreement")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(65), "Administrative Level 1", "Balti County", "Primary Sector", "110 - EDUCATION, 112 - BASIC EDUCATION", "Funding-2015-Actual Commitments", "456,789", "Funding-2015-Actual Disbursements", "321,765", "Totals-Actual Commitments", "456,789", "Totals-Actual Disbursements", "321,765")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with capital spending", 50)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "65,760,63", "Funding-2014-Actual Disbursements", "80,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "65,760,63", "Totals-Actual Disbursements", "80,000", "Project Title", "activity with capital spending")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(50), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "65,760,63", "Funding-2014-Actual Disbursements", "80,000", "Totals-Actual Commitments", "65,760,63", "Totals-Actual Disbursements", "80,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with contracting agency", 52)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "50,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "96,840,58", "Totals-Actual Disbursements", "50,000", "Project Title", "activity with contracting agency")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(52), "Administrative Level 1", "Balti County, Transnistrian Region", "Primary Sector", "110 - EDUCATION, 112 - BASIC EDUCATION, 120 - HEALTH", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2014-Actual Disbursements", "50,000", "Totals-Actual Commitments", "96,840,58", "Totals-Actual Disbursements", "50,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with directed MTEFs", 73)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "123,456", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,456", "Totals-Actual Disbursements", "0", "Project Title", "activity with directed MTEFs")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(73), "Administrative Level 1", "Chisinau City", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456")        ),
                ...
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(63), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "100", "Totals-Actual Commitments", "100")        ),
                ...
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(68), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "123,000", "Totals-Actual Commitments", "123,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with many MTEFs", 78)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "80,000", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "80,000", "Project Title", "activity with many MTEFs")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(78), "Administrative Level 1", "Drochia County", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Disbursements", "80,000", "Totals-Actual Disbursements", "80,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with pipeline MTEFs and act. disb", 76)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "75,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "110,000", "Project Title", "activity with pipeline MTEFs and act. disb")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(76), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Disbursements", "75,000", "Totals-Actual Disbursements", "110,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with primary_program", 44)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "32,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "32,000", "Totals-Actual Disbursements", "0", "Project Title", "activity with primary_program")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(44), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "32,000", "Totals-Actual Commitments", "32,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with tertiary_program", 45)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "15,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "15,000", "Totals-Actual Disbursements", "0", "Project Title", "activity with tertiary_program")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(45), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "15,000", "Totals-Actual Commitments", "15,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity-with-unfunded-components", 61)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "123,321", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,321", "Totals-Actual Disbursements", "0", "Project Title", "activity-with-unfunded-components")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(61), "Administrative Level 1", "Transnistrian Region", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "123,321", "Totals-Actual Commitments", "123,321")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity_with_disaster_response", 71)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "33,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "117,000", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "150,000", "Totals-Actual Disbursements", "0", "Project Title", "activity_with_disaster_response")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(71), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION, 113 - SECONDARY EDUCATION", "Funding-2014-Actual Commitments", "33,000", "Funding-2015-Actual Commitments", "117,000", "Totals-Actual Commitments", "150,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "crazy funding 1", 32)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "333,333", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "333,333", "Totals-Actual Disbursements", "0", "Project Title", "crazy funding 1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(32), "Administrative Level 1", "Balti County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "333,333", "Totals-Actual Commitments", "333,333")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "date-filters-activity", 26)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "60,000", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "125,000", "Totals-Actual Disbursements", "72,000", "Project Title", "date-filters-activity")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(26), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2009-Actual Commitments", "100,000", "Funding-2010-Actual Disbursements", "60,000", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Totals-Actual Commitments", "125,000", "Totals-Actual Disbursements", "72,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "execution rate activity", 77)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "90,000", "Project Title", "execution rate activity")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(77), "Administrative Level 1", "Chisinau City, Dubasari County", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Disbursements", "90,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "new activity with contracting", 53)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "12,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "12,000", "Totals-Actual Disbursements", "0", "Project Title", "new activity with contracting")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(53), "Administrative Level 1", "", "Primary Sector", "", "Funding-2014-Actual Commitments", "12,000", "Totals-Actual Commitments", "12,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "pledged 2", 48)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000", "Project Title", "pledged 2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(48), "Administrative Level 1", "Cahul County", "Primary Sector", "113 - SECONDARY EDUCATION", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "pledged education activity 1", 46)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "1,700,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "3,300,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "5,000,000", "Totals-Actual Disbursements", "0", "Project Title", "pledged education activity 1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(46), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "1,700,000", "Funding-2014-Actual Commitments", "3,300,000", "Totals-Actual Commitments", "5,000,000")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "ptc activity 1", 28)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "666,777", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "666,777", "Totals-Actual Disbursements", "0", "Project Title", "ptc activity 1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(28), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "666,777", "Totals-Actual Commitments", "666,777")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "ptc activity 2", 29)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "333,222", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "333,222", "Totals-Actual Disbursements", "0", "Project Title", "ptc activity 2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(29), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "333,222", "Totals-Actual Commitments", "333,222")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "third activity with agreements", 67)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "123,456", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,456", "Totals-Actual Disbursements", "0", "Project Title", "third activity with agreements")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner(67), "Administrative Level 1", "Chisinau City", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456")        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "with weird currencies", 79)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "3,632,14", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "93,930,84", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "97,562,98", "Totals-Actual Disbursements", "0", "Project Title", "with weird currencies")
                .withChildren(
    ...
    public void testProjectTitleAsFirstHierarchy() {
        ...
        .withHeaders(Arrays.asList(
                ...
                "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Donor Agency: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 2, colSpan: 1));(Primary Sector: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 3, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 4, colSpan: 16));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 20, colSpan: 2))",
            ...
            .withWarnings(Arrays.asList())
            .withBody(      new ReportAreaForTests(null)
              .withContents("Project Title", "", "Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "780,311", "Funding-2011-Actual Commitments", "1,213,119", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "7,842,086", "Funding-2013-Actual Disbursements", "1,266,956", "Funding-2014-Actual Commitments", "8,159,813,77", "Funding-2014-Actual Disbursements", "710,200", "Funding-2015-Actual Commitments", "1,971,831,84", "Funding-2015-Actual Disbursements", "437,335", "Totals-Actual Commitments", "19,408,691,19", "Totals-Actual Disbursements", "3,206,802")
              .withChildren(
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity 2 with multiple agreements", 66))
                .withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "1,200", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "1,200", "Totals-Actual Disbursements", "0", "Project Title", "Activity 2 with multiple agreements")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "UNDP", 21695)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "700", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "700", "Totals-Actual Disbursements", "0", "Donor Agency", "UNDP")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(66), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "700", "Totals-Actual Commitments", "700")          ),
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "USAID", 21696)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "500", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "500", "Totals-Actual Disbursements", "0", "Donor Agency", "USAID")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(66), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "500", "Totals-Actual Commitments", "500")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity Linked With Pledge", 41)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "50,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity Linked With Pledge")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "50,000", "Totals-Actual Disbursements", "0", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(41), "Administrative Level 1", "Chisinau City", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity With Zones and Percentages", 36)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "890,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "890,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity With Zones and Percentages")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Norway", 21694)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "890,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "890,000", "Totals-Actual Disbursements", "0", "Donor Agency", "Norway")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(36), "Administrative Level 1", "Anenii Noi County, Balti County", "Primary Sector", "110 - EDUCATION, 120 - HEALTH", "Funding-2013-Actual Commitments", "890,000", "Totals-Actual Commitments", "890,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity with Zones", 33)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "570,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "570,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity with Zones")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "570,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "570,000", "Totals-Actual Disbursements", "0", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(33), "Administrative Level 1", "Anenii Noi County, Balti County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "570,000", "Totals-Actual Commitments", "570,000")          )        ),
                ...
                .withChildren(
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(69), "Administrative Level 1", "", "Primary Sector", "112 - BASIC EDUCATION", "Funding-2014-Actual Disbursements", "200", "Funding-2015-Actual Disbursements", "500", "Totals-Actual Disbursements", "700")          ),
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(69), "Administrative Level 1", "", "Primary Sector", "112 - BASIC EDUCATION", "Funding-2015-Actual Disbursements", "70", "Totals-Actual Disbursements", "70")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Activity with primary_tertiary_program", 43)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "50,000", "Totals-Actual Disbursements", "0", "Project Title", "Activity with primary_tertiary_program")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "UNDP", 21695)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "50,000", "Totals-Actual Disbursements", "0", "Donor Agency", "UNDP")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(43), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000")          )        ),
                ...
                .withChildren(
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(24), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Disbursements", "20,000", "Totals-Actual Disbursements", "20,000")          ),
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(24), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Disbursements", "110,000", "Totals-Actual Disbursements", "110,000")          ),
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(24), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Disbursements", "415,000", "Totals-Actual Disbursements", "415,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "SSC Project 1", 30)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "111,333", "Funding-2013-Actual Disbursements", "555,111", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "111,333", "Totals-Actual Disbursements", "555,111", "Project Title", "SSC Project 1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "111,333", "Funding-2013-Actual Disbursements", "555,111", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "111,333", "Totals-Actual Disbursements", "555,111", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(30), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "111,333", "Funding-2013-Actual Disbursements", "555,111", "Totals-Actual Commitments", "111,333", "Totals-Actual Disbursements", "555,111")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "SSC Project 2", 31)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "567,421", "Funding-2013-Actual Disbursements", "131,845", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "567,421", "Totals-Actual Disbursements", "131,845", "Project Title", "SSC Project 2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Water Org", 21701)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "567,421", "Funding-2013-Actual Disbursements", "131,845", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "567,421", "Totals-Actual Disbursements", "131,845", "Donor Agency", "Water Org")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(31), "Administrative Level 1", "Edinet County", "Primary Sector", "112 - BASIC EDUCATION", "Funding-2013-Actual Commitments", "567,421", "Funding-2013-Actual Disbursements", "131,845", "Totals-Actual Commitments", "567,421", "Totals-Actual Disbursements", "131,845")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "SubNational no percentages", 40)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "75,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "75,000", "Totals-Actual Disbursements", "0", "Project Title", "SubNational no percentages")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Ministry of Economy", 21700)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "75,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "75,000", "Totals-Actual Disbursements", "0", "Donor Agency", "Ministry of Economy")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(40), "Administrative Level 1", "Anenii Noi County, Balti County", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "75,000", "Totals-Actual Commitments", "75,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "TAC_activity_1", 12)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "123,321", "Funding-2011-Actual Commitments", "213,231", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "213,231", "Totals-Actual Disbursements", "123,321", "Project Title", "TAC_activity_1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "World Bank", 21697)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "123,321", "Funding-2011-Actual Commitments", "213,231", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "213,231", "Totals-Actual Disbursements", "123,321", "Donor Agency", "World Bank")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(12), "Administrative Level 1", "Dubasari County", "Primary Sector", "112 - BASIC EDUCATION", "Funding-2010-Actual Disbursements", "123,321", "Funding-2011-Actual Commitments", "213,231", "Totals-Actual Commitments", "213,231", "Totals-Actual Disbursements", "123,321")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "TAC_activity_2", 13)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "453,213", "Funding-2011-Actual Commitments", "999,888", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "999,888", "Totals-Actual Disbursements", "453,213", "Project Title", "TAC_activity_2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Water Foundation", 21702)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "453,213", "Funding-2011-Actual Commitments", "999,888", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "999,888", "Totals-Actual Disbursements", "453,213", "Donor Agency", "Water Foundation")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(13), "Administrative Level 1", "Falesti County", "Primary Sector", "130 - POPULATION POLICIES/PROGRAMMES AND REPRODUCTIVE HEALTH", "Funding-2010-Actual Disbursements", "453,213", "Funding-2011-Actual Commitments", "999,888", "Totals-Actual Commitments", "999,888", "Totals-Actual Disbursements", "453,213")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Test MTEF directed", 18)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "143,777", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "143,777", "Project Title", "Test MTEF directed")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Ministry of Economy", 21700)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "143,777", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "143,777", "Donor Agency", "Ministry of Economy")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(18), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2010-Actual Disbursements", "143,777", "Totals-Actual Disbursements", "143,777")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "Unvalidated activity", 64)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "45,000", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "45,000", "Totals-Actual Disbursements", "0", "Project Title", "Unvalidated activity")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "UNDP", 21695)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "45,000", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "45,000", "Totals-Actual Disbursements", "0", "Donor Agency", "UNDP")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(64), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "45,000", "Totals-Actual Commitments", "45,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity 1 with agreement", 65)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "456,789", "Funding-2015-Actual Disbursements", "321,765", "Totals-Actual Commitments", "456,789", "Totals-Actual Disbursements", "321,765", "Project Title", "activity 1 with agreement")
                .withChildren(
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(65), "Administrative Level 1", "Balti County", "Primary Sector", "110 - EDUCATION, 112 - BASIC EDUCATION", "Funding-2015-Actual Commitments", "456,789", "Funding-2015-Actual Disbursements", "321,765", "Totals-Actual Commitments", "456,789", "Totals-Actual Disbursements", "321,765")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with capital spending", 50)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "65,760,63", "Funding-2014-Actual Disbursements", "80,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "65,760,63", "Totals-Actual Disbursements", "80,000", "Project Title", "activity with capital spending")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "65,760,63", "Funding-2014-Actual Disbursements", "80,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "65,760,63", "Totals-Actual Disbursements", "80,000", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(50), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "65,760,63", "Funding-2014-Actual Disbursements", "80,000", "Totals-Actual Commitments", "65,760,63", "Totals-Actual Disbursements", "80,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with contracting agency", 52)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "50,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "96,840,58", "Totals-Actual Disbursements", "50,000", "Project Title", "activity with contracting agency")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "50,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "96,840,58", "Totals-Actual Disbursements", "50,000", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(52), "Administrative Level 1", "Balti County, Transnistrian Region", "Primary Sector", "110 - EDUCATION, 112 - BASIC EDUCATION, 120 - HEALTH", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2014-Actual Disbursements", "50,000", "Totals-Actual Commitments", "96,840,58", "Totals-Actual Disbursements", "50,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with directed MTEFs", 73)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "123,456", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,456", "Totals-Actual Disbursements", "0", "Project Title", "activity with directed MTEFs")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Ministry of Economy", 21700)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "123,456", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,456", "Totals-Actual Disbursements", "0", "Donor Agency", "Ministry of Economy")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(73), "Administrative Level 1", "Chisinau City", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456")          )        ),
                ...
                .withChildren(
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(68), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "123,000", "Totals-Actual Commitments", "123,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with many MTEFs", 78)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "80,000", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "80,000", "Project Title", "activity with many MTEFs")
                .withChildren(
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(78), "Administrative Level 1", "Drochia County", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Disbursements", "80,000", "Totals-Actual Disbursements", "80,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with pipeline MTEFs and act. disb", 76)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "75,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "110,000", "Project Title", "activity with pipeline MTEFs and act. disb")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "UNDP", 21695)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "75,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "110,000", "Donor Agency", "UNDP")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(76), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Disbursements", "75,000", "Totals-Actual Disbursements", "110,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with primary_program", 44)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "32,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "32,000", "Totals-Actual Disbursements", "0", "Project Title", "activity with primary_program")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "World Bank", 21697)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "32,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "32,000", "Totals-Actual Disbursements", "0", "Donor Agency", "World Bank")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(44), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "32,000", "Totals-Actual Commitments", "32,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity with tertiary_program", 45)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "15,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "15,000", "Totals-Actual Disbursements", "0", "Project Title", "activity with tertiary_program")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Ministry of Economy", 21700)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "15,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "15,000", "Totals-Actual Disbursements", "0", "Donor Agency", "Ministry of Economy")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(45), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "15,000", "Totals-Actual Commitments", "15,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity-with-unfunded-components", 61)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "123,321", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,321", "Totals-Actual Disbursements", "0", "Project Title", "activity-with-unfunded-components")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "123,321", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,321", "Totals-Actual Disbursements", "0", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(61), "Administrative Level 1", "Transnistrian Region", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Commitments", "123,321", "Totals-Actual Commitments", "123,321")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "activity_with_disaster_response", 71)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "33,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "117,000", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "150,000", "Totals-Actual Disbursements", "0", "Project Title", "activity_with_disaster_response")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "33,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "117,000", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "150,000", "Totals-Actual Disbursements", "0", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(71), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION, 113 - SECONDARY EDUCATION", "Funding-2014-Actual Commitments", "33,000", "Funding-2015-Actual Commitments", "117,000", "Totals-Actual Commitments", "150,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "crazy funding 1", 32)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "333,333", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "333,333", "Totals-Actual Disbursements", "0", "Project Title", "crazy funding 1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "333,333", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "333,333", "Totals-Actual Disbursements", "0", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(32), "Administrative Level 1", "Balti County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "333,333", "Totals-Actual Commitments", "333,333")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "date-filters-activity", 26)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "60,000", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "125,000", "Totals-Actual Disbursements", "72,000", "Project Title", "date-filters-activity")
                .withChildren(
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(26), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION", "Funding-2009-Actual Commitments", "100,000", "Funding-2010-Actual Disbursements", "60,000", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Totals-Actual Commitments", "125,000", "Totals-Actual Disbursements", "72,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "execution rate activity", 77)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Commitments", "0", "Totals-Actual Disbursements", "90,000", "Project Title", "execution rate activity")
                .withChildren(
                  ...
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(77), "Administrative Level 1", "Chisinau City, Dubasari County", "Primary Sector", "110 - EDUCATION", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Disbursements", "90,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "new activity with contracting", 53)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "12,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "12,000", "Totals-Actual Disbursements", "0", "Project Title", "new activity with contracting")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "12,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "12,000", "Totals-Actual Disbursements", "0", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(53), "Administrative Level 1", "", "Primary Sector", "", "Funding-2014-Actual Commitments", "12,000", "Totals-Actual Commitments", "12,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "pledged 2", 48)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000", "Project Title", "pledged 2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "USAID", 21696)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000", "Donor Agency", "USAID")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(48), "Administrative Level 1", "Cahul County", "Primary Sector", "113 - SECONDARY EDUCATION", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "pledged education activity 1", 46)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "1,700,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "3,300,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "5,000,000", "Totals-Actual Disbursements", "0", "Project Title", "pledged education activity 1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "USAID", 21696)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "1,700,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "3,300,000", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "5,000,000", "Totals-Actual Disbursements", "0", "Donor Agency", "USAID")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(46), "Administrative Level 1", "Chisinau County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "1,700,000", "Funding-2014-Actual Commitments", "3,300,000", "Totals-Actual Commitments", "5,000,000")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "ptc activity 1", 28)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "666,777", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "666,777", "Totals-Actual Disbursements", "0", "Project Title", "ptc activity 1")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Finland", 21698)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "666,777", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "666,777", "Totals-Actual Disbursements", "0", "Donor Agency", "Finland")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(28), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "666,777", "Totals-Actual Commitments", "666,777")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "ptc activity 2", 29)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "333,222", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "333,222", "Totals-Actual Disbursements", "0", "Project Title", "ptc activity 2")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "USAID", 21696)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "333,222", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "333,222", "Totals-Actual Disbursements", "0", "Donor Agency", "USAID")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(29), "Administrative Level 1", "Anenii Noi County", "Primary Sector", "110 - EDUCATION", "Funding-2013-Actual Commitments", "333,222", "Totals-Actual Commitments", "333,222")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "third activity with agreements", 67)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "123,456", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,456", "Totals-Actual Disbursements", "0", "Project Title", "third activity with agreements")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Ministry of Finance", 21699)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "123,456", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "123,456", "Totals-Actual Disbursements", "0", "Donor Agency", "Ministry of Finance")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(67), "Administrative Level 1", "Chisinau City", "Primary Sector", "110 - EDUCATION", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456")          )        ),
                new ReportAreaForTests(new AreaOwner("Project Title", "with weird currencies", 79)).withContents("Donor Agency", "", "Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "3,632,14", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "93,930,84", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "97,562,98", "Totals-Actual Disbursements", "0", "Project Title", "with weird currencies")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Donor Agency", "Ministry of Finance", 21699)).withContents("Administrative Level 1", "", "Primary Sector", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "3,632,14", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "93,930,84", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "97,562,98", "Totals-Actual Disbursements", "0", "Donor Agency", "Ministry of Finance")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(79), "Administrative Level 1", "", "Primary Sector", "110 - EDUCATION, 112 - BASIC EDUCATION", "Funding-2014-Actual Commitments", "3,632,14", "Funding-2015-Actual Commitments", "93,930,84", "Totals-Actual Commitments", "97,562,98")          )        )      ));
    ...
    public void testPercentageOfCommsDisbsNoPrecursors() {
        ...
        .withHeaders(Arrays.asList(
                ...
                "(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Type Of Assistance: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 2, colSpan: 1));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 3, colSpan: 2))",
                "",
            ...
            .withWarnings(Arrays.asList())
            .withBody(      new ReportAreaForTests(null)
              .withContents("Administrative Level 1", "", "Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "100", "Totals-Percentage Of Total Disbursements", "100")
              .withChildren(
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Anenii Noi County", 9085)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "8,3", "Totals-Percentage Of Total Disbursements", "38,79", "Administrative Level 1", "Anenii Noi County")
                .withChildren(
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Balti County", 9086))
                .withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "11,05", "Totals-Percentage Of Total Disbursements", "10,89", "Administrative Level 1", "Balti County")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Type Of Assistance", "default type of assistance", 2119))
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Cahul County", 9087)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "36,43", "Totals-Percentage Of Total Disbursements", "14,03", "Administrative Level 1", "Cahul County")
                .withChildren(
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Chisinau City", 9088)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "1,53", "Totals-Percentage Of Total Disbursements", "1,4", "Administrative Level 1", "Chisinau City")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Type Of Assistance", "default type of assistance", 2119))
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Chisinau County", 9089))
                .withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "26,11", "Totals-Percentage Of Total Disbursements", "5,92", "Administrative Level 1", "Chisinau County")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Type Of Assistance", "default type of assistance", 2119))
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Drochia County", 9090)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "3,2", "Totals-Percentage Of Total Disbursements", "2,49", "Administrative Level 1", "Drochia County")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Type Of Assistance", "default type of assistance", 2119))
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Dubasari County", 9091)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "1,1", "Totals-Percentage Of Total Disbursements", "5,25", "Administrative Level 1", "Dubasari County")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Type Of Assistance", "default type of assistance", 2119))
                  ...
                  .withChildren(
                    ...
                    new ReportAreaForTests(new AreaOwner(77), "Project Title", "execution rate activity", "Totals-Percentage Of Total Disbursements", "1,4")          )        ),
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Edinet County", 9092)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "2,92", "Totals-Percentage Of Total Disbursements", "4,11", "Administrative Level 1", "Edinet County")
                .withChildren(
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Falesti County", 9093)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "5,15", "Totals-Percentage Of Total Disbursements", "14,13", "Administrative Level 1", "Falesti County")
                .withChildren(
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Transnistrian Region", 9105))
                .withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "0,86", "Totals-Percentage Of Total Disbursements", "0,7", "Administrative Level 1", "Transnistrian Region")
                .withChildren(
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Administrative Level 1: Undefined", -8977)).withContents("Type Of Assistance", "", "Project Title", "", "Totals-Percentage of Total Commitments", "3,35", "Totals-Percentage Of Total Disbursements", "2,27", "Administrative Level 1", "Administrative Level 1: Undefined")
                .withChildren(
                  new ReportAreaForTests(new AreaOwner("Type Of Assistance", "default type of assistance", 2119))
