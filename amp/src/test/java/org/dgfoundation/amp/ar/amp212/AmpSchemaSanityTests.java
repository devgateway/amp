...
public class AmpSchemaSanityTests extends BasicSanityChecks {
	...
	public void testSscMeasuresFlat() {
		...
		.withHeaders(Arrays.asList(
			...
			.withWarnings(Arrays.asList())
			.withBody(      new ReportAreaForTests(null)
		      .withContents("Project Title", "", "Donor Agency", "", "Funding-2012-Official Development Aid Commitments", "0", "Funding-2012-Bilateral SSC Commitments", "12 000", "Funding-2012-Triangular SSC Commitments", "0", "Funding-2012-Cumulated SSC Commitments", "12 000", "Funding-2013-Official Development Aid Commitments", "0", "Funding-2013-Bilateral SSC Commitments", "35 000", "Funding-2013-Triangular SSC Commitments", "64 000", "Funding-2013-Cumulated SSC Commitments", "99 000", "Funding-2014-Official Development Aid Commitments", "175 000", "Funding-2014-Bilateral SSC Commitments", "0", "Funding-2014-Triangular SSC Commitments", "0", "Funding-2014-Cumulated SSC Commitments", "0", "Totals-Official Development Aid Commitments", "175 000", "Totals-Bilateral SSC Commitments", "47 000", "Totals-Triangular SSC Commitments", "64 000", "Totals-Cumulated SSC Commitments", "111 000")
		      .withChildren(
	...
	public void testIndicatorsOnlyFlat() {
		NiReportModel cor = new NiReportModel("testIndicatorsOnlyFlat")
				...
				.withBody(      new ReportAreaForTests(null)
						...
						.withChildren(
								new ReportAreaForTests(new AreaOwner(95), "Indicator Name", "indicator 1, indicator 2", "Indicator Base Value", "0, 10", "Indicator Target Value", "100, 50"),
								new ReportAreaForTests(new AreaOwner(96), "Indicator Name", "indicator 1, indicator 3", "Indicator Base Value", "1, 5", "Indicator Target Value", "3, 33")      ));
				...
				.withBody(      new ReportAreaForTests(null)
						...
						.withChildren(
								...
								new ReportAreaForTests(new AreaOwner("Indicator Name", "indicator 2", 2)).withContents("Indicator code", "", "Indicator Sector", "", "Indicator Description", "", "Indicator Type", "", "Indicator Creation Date", "", "Logframe Category", "", "Risk", "", "Indicator Base Value", "", "Indicator Base Date", "", "Indicator Base Comment", "", "Indicator Target Value", "", "Indicator Target Date", "", "Indicator Target Comment", "", "Indicator Revised Target Value", "", "Indicator Revised Target Date", "", "Indicator Revised Target Comment", "", "Indicator Current Value", "", "Indicator Current Date", "", "Indicator Current Comment", "", "Indicator Name", "indicator 2")
										.withChildren(
												new ReportAreaForTests(new AreaOwner(95), "Indicator code", "IND-2", "Indicator Sector", "120 - HEALTH", "Indicator Description", "ind2desc", "Indicator Creation Date", "13/02/2017", "Logframe Category", "Output", "Risk", "Very Low", "Indicator Base Value", "0", "Indicator Base Date", "01/02/2017", "Indicator Base Comment", "bc1-2", "Indicator Target Value", "100", "Indicator Target Date", "28/02/2017", "Indicator Target Comment", "tc1-2", "Indicator Revised Target Value", "120", "Indicator Revised Target Comment", "rc1-2", "Indicator Current Value", "0", "Indicator Current Date", "10/02/2017", "Indicator Current Comment", "cc1-2")        ),
								new ReportAreaForTests(new AreaOwner("Indicator Name", "indicator 3", 3)).withContents("Indicator code", "", "Indicator Sector", "", "Indicator Description", "", "Indicator Type", "", "Indicator Creation Date", "", "Logframe Category", "", "Risk", "", "Indicator Base Value", "", "Indicator Base Date", "", "Indicator Base Comment", "", "Indicator Target Value", "", "Indicator Target Date", "", "Indicator Target Comment", "", "Indicator Revised Target Value", "", "Indicator Revised Target Date", "", "Indicator Revised Target Comment", "", "Indicator Current Value", "", "Indicator Current Date", "", "Indicator Current Comment", "", "Indicator Name", "indicator 3")
										.withChildren(
												new ReportAreaForTests(new AreaOwner(96), "Indicator code", "IND-3", "Indicator Sector", "140 - WATER AND SANITATION, 160 - OTHER SOCIAL INFRASTRUCTURE AND SERVICES", "Indicator Description", "ind3desc", "Indicator Creation Date", "10/02/2017", "Logframe Category", "None", "Risk", "Very High", "Indicator Base Value", "1", "Indicator Base Date", "04/02/2017", "Indicator Base Comment", "bc2-3", "Indicator Target Value", "3", "Indicator Target Date", "06/02/2017", "Indicator Target Comment", "tc2-3", "Indicator Current Value", "2", "Indicator Current Date", "05/02/2017", "Indicator Current Comment", "cc2-3")        )      ));
