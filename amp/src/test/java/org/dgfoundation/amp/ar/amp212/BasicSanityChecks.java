 ...
 *
 */
public abstract class BasicSanityChecks extends AmpTestCase {
		
	static int nrRunReports = 0;
	...
	protected abstract<K> K buildNiReportDigest(ReportSpecification spec, List<String> activityNames, NiReportOutputBuilder<K> outputBuilder);
...
//	}
	...
	@Test
	public void testReportModelGenerator() {
		ReportSpecification spec = buildSpecification("ByTypeOfAssistance_", 
		...
		assertEquals("",
			buildDigest(spec, acts, new ReportModelGenerator()).toString());
	}
}
