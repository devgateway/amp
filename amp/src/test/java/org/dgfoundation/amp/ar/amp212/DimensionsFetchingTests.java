...
public class DimensionsFetchingTests extends AmpReportingTestCase {
    ...
    public void testLocationsFetching() {
        ...
        assertEquals(-1026567074, snapshot.data.get(1).toString().hashCode());
    ...
    public void testAgreementDimensionFetching() {
        ...
        assertEquals("depth = 1, data = [level 0, info: [(id: -999999999, parent: 0, children: []), (id: 1, parent: 0, children: []), (id: 2, parent: 0, children: []), (id: 3, parent: 0, children: [])]]", snapshot.toString());
