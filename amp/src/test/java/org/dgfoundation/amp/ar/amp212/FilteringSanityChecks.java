    ...
    public void testFilteringByModeOfPaymentCash() {
        NiReportModel cor = new NiReportModel("flat mop [cash]")
                .withHeaders(Arrays.asList(
                        ...
                        "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 6));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 8, colSpan: 2))",
                    ...
                    .withBody(      new ReportAreaForTests(null)
                      .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "143,777", "Funding-2013-Actual Commitments", "111,111", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "0", "Totals-Actual Commitments", "161,111", "Totals-Actual Disbursements", "143,777")
                      .withChildren(
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("flat mop [cash]", 
                Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.MODE_OF_PAYMENT, Arrays.asList(2093l), true);
    ...
    public void testFilteringByModeOfPaymentCash_DirectPayment() {
        NiReportModel cor = new NiReportModel("flat mop [cash, Direct Payment]")
                .withHeaders(Arrays.asList(
                    ...
                    .withWarnings(Arrays.asList())
                    .withBody(      new ReportAreaForTests(null)
                      .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "143,777", "Funding-2013-Actual Commitments", "1,012,087", "Funding-2013-Actual Disbursements", "721,956", "Funding-2014-Actual Commitments", "161,632,14", "Funding-2014-Actual Disbursements", "75,000", "Funding-2015-Actual Commitments", "1,222,386,84", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "2,396,105,98", "Totals-Actual Disbursements", "940,733")
                      .withChildren(
                        new ReportAreaForTests(new AreaOwner(18), "Project Title", "Test MTEF directed", "Administrative Level 1", "Anenii Noi County", "Funding-2010-Actual Disbursements", "143,777", "Totals-Actual Disbursements", "143,777"),
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("flat mop [cash, Direct Payment]", 
                Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.MODE_OF_PAYMENT, Arrays.asList(2093l, 2094l), true);
        runNiTestCase(spec, "en", acts, cor);
    }
...
//              Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.MODE_OF_PAYMENT, Arrays.asList(2093l), false);
//      runNiTestCase(spec, "en", acts, cor);
//  }
    ...
    public void testFilteringTypeOfAssistanceSecond() {
        NiReportModel cor = new NiReportModel("flat toa [second]")
                .withHeaders(Arrays.asList(
                    ...
                    .withWarnings(Arrays.asList())
                    .withBody(      new ReportAreaForTests(null)
                      .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2013-Actual Commitments", "2,892,222", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "4,589,081,63", "Funding-2014-Actual Disbursements", "530,000", "Totals-Actual Commitments", "7,481,303,63", "Totals-Actual Disbursements", "530,000")
                      .withChildren(
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("flat toa [second]", 
                Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.TYPE_OF_ASSISTANCE, Arrays.asList(2124l), true);
    ...
    public void testFilteringTypeOfAssistanceNotSecond() {
        NiReportModel cor = new NiReportModel("flat toa [not second]")
                .withHeaders(Arrays.asList(
                        ...
                        "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 16));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 18, colSpan: 2))",
...
;
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("flat toa [not second]", 
                Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.TYPE_OF_ASSISTANCE, Arrays.asList(2124l), false);
    ...
    public void testFilterByImplementationLevel() {
        NiReportModel cor = new NiReportModel("flat impl. level [national]")
                .withHeaders(Arrays.asList(
                        ...
                        "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 10));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 12, colSpan: 2))",
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("flat impl. level [national]", 
                Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.IMPLEMENTATION_LEVEL, Arrays.asList(70l), true);
    ...
    public void testFilterByImplementationLevelNot() {
        NiReportModel cor = new NiReportModel("flat impl. level [not national]")
                .withHeaders(Arrays.asList(
                        ...
                        "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 12));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 14, colSpan: 2))",
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("flat impl. level [not national]", 
                Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.IMPLEMENTATION_LEVEL, Arrays.asList(70l), false);
    ...
    public void testFilterByActivityId() {
        NiReportModel cor = new NiReportModel("flat filter by amp_activity_id")
            ...
            .withWarnings(Arrays.asList())
            .withBody(      new ReportAreaForTests(null)
              .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Commitments", "45,000", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Commitments", "45,000", "Totals-Actual Disbursements", "90,000")
              .withChildren(
                new ReportAreaForTests(new AreaOwner(64), "Project Title", "Unvalidated activity", "Administrative Level 1", "", "Funding-2015-Actual Commitments", "45,000", "Totals-Actual Commitments", "45,000"),
                new ReportAreaForTests(new AreaOwner(77), "Project Title", "execution rate activity", "Administrative Level 1", "Chisinau City, Dubasari County", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Disbursements", "90,000")));
        
        ReportSpecificationImpl spec = buildSpecForFiltering("flat filter by amp_activity_id", 
            Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.ACTIVITY_ID, Arrays.asList(77l, 64l), true);
    ...
    public void testFilterByNotActivityId() {
        NiReportModel cor2 = new NiReportModel("flat filter by [not amp_activity_id]")
                .withHeaders(Arrays.asList(
                    ...
                    .withWarnings(Arrays.asList())
                    .withBody(      new ReportAreaForTests(null)
                      .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2013-Actual Disbursements", "545,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "995,000")
                      .withChildren(
                        new ReportAreaForTests(new AreaOwner(24), "Project Title", "Eth Water", "Administrative Level 1", "Anenii Noi County", "Funding-2013-Actual Disbursements", "545,000", "Totals-Actual Disbursements", "545,000"),
                        new ReportAreaForTests(new AreaOwner(48), "Project Title", "pledged 2", "Administrative Level 1", "Cahul County", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000")));
        
        ReportSpecificationImpl spec = buildSpecForFiltering("flat filter by [not amp_activity_id]", 
                Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.ACTIVITY_ID, Arrays.asList(77l, 64l), false);
    ...
    public void testFilterByDonorAgency() {
        NiReportModel cor2 = new NiReportModel("flat filter by donor agency")
            ...
            .withWarnings(Arrays.asList())
            .withBody(      new ReportAreaForTests(null)
              .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2013-Actual Disbursements", "415,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "865,000")
              .withChildren(
                new ReportAreaForTests(new AreaOwner(24), "Project Title", "Eth Water", "Administrative Level 1", "Anenii Noi County", "Funding-2013-Actual Disbursements", "415,000", "Totals-Actual Disbursements", "415,000"),
                new ReportAreaForTests(new AreaOwner(48), "Project Title", "pledged 2", "Administrative Level 1", "Cahul County", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000")));

        ReportSpecificationImpl spec = buildSpecForFiltering("flat filter by donor agency", 
            Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_1), null, ColumnConstants.DONOR_AGENCY, Arrays.asList(21696l, 21702l, 21701l), true);
...
;
    ...
    public void testFilterFlatByZone() {
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("flat filter by zone", 
            Arrays.asList(ColumnConstants.PROJECT_TITLE), null, ColumnConstants.LOCATION_ADM_LEVEL_2, Arrays.asList(9108l, 9111l), true); // Bulboaca, Glodeni
    ...
    public void testFilterFlatByZoneNegative() {
        NiReportModel cor = new NiReportModel("flat filter by not zone")
            .withHeaders(Arrays.asList(
                    "(RAW: (startRow: 0, rowSpan: 1, totalRowSpan: 4, colStart: 0, colSpan: 20))",
                    "(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 2: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 16));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 18, colSpan: 2))",
                    "(2006: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 2, colSpan: 2));(2009: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 4, colSpan: 2));(2010: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 6, colSpan: 2));(2011: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 8, colSpan: 2));(2012: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 10, colSpan: 2));(2013: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 12, colSpan: 2));(2014: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 14, colSpan: 2));(2015: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 16, colSpan: 2))",
                    "(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 2, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 3, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 4, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 5, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 6, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 7, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 8, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 9, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 10, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 11, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 12, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 13, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 14, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 15, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 16, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 17, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 18, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 19, colSpan: 1))"))
                .withWarnings(Arrays.asList())
                .withBody(      new ReportAreaForTests(null)
                  .withContents("Project Title", "", "Administrative Level 2", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "780,311", "Funding-2011-Actual Commitments", "1,213,119", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "6,845,086", "Funding-2013-Actual Disbursements", "1,266,956", "Funding-2014-Actual Commitments", "8,122,313,77", "Funding-2014-Actual Disbursements", "710,200", "Funding-2015-Actual Commitments", "1,515,042,84", "Funding-2015-Actual Disbursements", "115,570", "Totals-Actual Commitments", "17,917,402,19", "Totals-Actual Disbursements", "2,885,037")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner(12), "Project Title", "TAC_activity_1", "Administrative Level 2", "", "Funding-2010-Actual Disbursements", "123,321", "Funding-2011-Actual Commitments", "213,231", "Totals-Actual Commitments", "213,231", "Totals-Actual Disbursements", "123,321"),
                    new ReportAreaForTests(new AreaOwner(13), "Project Title", "TAC_activity_2", "Administrative Level 2", "", "Funding-2010-Actual Disbursements", "453,213", "Funding-2011-Actual Commitments", "999,888", "Totals-Actual Commitments", "999,888", "Totals-Actual Disbursements", "453,213"),
                    new ReportAreaForTests(new AreaOwner(18), "Project Title", "Test MTEF directed", "Administrative Level 2", "", "Funding-2010-Actual Disbursements", "143,777", "Totals-Actual Disbursements", "143,777"),
                    new ReportAreaForTests(new AreaOwner(24), "Project Title", "Eth Water", "Administrative Level 2", "", "Funding-2013-Actual Disbursements", "545,000", "Totals-Actual Disbursements", "545,000"),
                    new ReportAreaForTests(new AreaOwner(26), "Project Title", "date-filters-activity", "Administrative Level 2", "", "Funding-2009-Actual Commitments", "100,000", "Funding-2010-Actual Disbursements", "60,000", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Totals-Actual Commitments", "125,000", "Totals-Actual Disbursements", "72,000"),
                    new ReportAreaForTests(new AreaOwner(28), "Project Title", "ptc activity 1", "Administrative Level 2", "", "Funding-2013-Actual Commitments", "666,777", "Totals-Actual Commitments", "666,777"),
                    new ReportAreaForTests(new AreaOwner(29), "Project Title", "ptc activity 2", "Administrative Level 2", "", "Funding-2013-Actual Commitments", "333,222", "Totals-Actual Commitments", "333,222"),
                    new ReportAreaForTests(new AreaOwner(30), "Project Title", "SSC Project 1", "Administrative Level 2", "", "Funding-2013-Actual Commitments", "111,333", "Funding-2013-Actual Disbursements", "555,111", "Totals-Actual Commitments", "111,333", "Totals-Actual Disbursements", "555,111"),
                    new ReportAreaForTests(new AreaOwner(31), "Project Title", "SSC Project 2", "Administrative Level 2", "", "Funding-2013-Actual Commitments", "567,421", "Funding-2013-Actual Disbursements", "131,845", "Totals-Actual Commitments", "567,421", "Totals-Actual Disbursements", "131,845"),
                    new ReportAreaForTests(new AreaOwner(32), "Project Title", "crazy funding 1", "Administrative Level 2", "", "Funding-2013-Actual Commitments", "333,333", "Totals-Actual Commitments", "333,333"),
                    new ReportAreaForTests(new AreaOwner(33), "Project Title", "Activity with Zones", "Administrative Level 2", "Bulboaca", "Funding-2013-Actual Commitments", "285,000", "Totals-Actual Commitments", "285,000"),
                    new ReportAreaForTests(new AreaOwner(36), "Project Title", "Activity With Zones and Percentages", "Administrative Level 2", "Dolboaca", "Funding-2013-Actual Commitments", "178,000", "Totals-Actual Commitments", "178,000"),
                    new ReportAreaForTests(new AreaOwner(40), "Project Title", "SubNational no percentages", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "37,500", "Totals-Actual Commitments", "37,500"),
                    new ReportAreaForTests(new AreaOwner(41), "Project Title", "Activity Linked With Pledge", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000"),
                    new ReportAreaForTests(new AreaOwner(43), "Project Title", "Activity with primary_tertiary_program", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000"),
                    new ReportAreaForTests(new AreaOwner(44), "Project Title", "activity with primary_program", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "32,000", "Totals-Actual Commitments", "32,000"),
                    new ReportAreaForTests(new AreaOwner(45), "Project Title", "activity with tertiary_program", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "15,000", "Totals-Actual Commitments", "15,000"),
                    new ReportAreaForTests(new AreaOwner(46), "Project Title", "pledged education activity 1", "Administrative Level 2", "", "Funding-2013-Actual Commitments", "1,700,000", "Funding-2014-Actual Commitments", "3,300,000", "Totals-Actual Commitments", "5,000,000"),
                    new ReportAreaForTests(new AreaOwner(48), "Project Title", "pledged 2", "Administrative Level 2", "", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000"),
                    new ReportAreaForTests(new AreaOwner(50), "Project Title", "activity with capital spending", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "65,760,63", "Funding-2014-Actual Disbursements", "80,000", "Totals-Actual Commitments", "65,760,63", "Totals-Actual Disbursements", "80,000"),
                    new ReportAreaForTests(new AreaOwner(52), "Project Title", "activity with contracting agency", "Administrative Level 2", "Apareni, Slobozia", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2014-Actual Disbursements", "50,000", "Totals-Actual Commitments", "96,840,58", "Totals-Actual Disbursements", "50,000"),
                    new ReportAreaForTests(new AreaOwner(53), "Project Title", "new activity with contracting", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "12,000", "Totals-Actual Commitments", "12,000"),
                    new ReportAreaForTests(new AreaOwner(61), "Project Title", "activity-with-unfunded-components", "Administrative Level 2", "Tiraspol", "Funding-2014-Actual Commitments", "123,321", "Totals-Actual Commitments", "123,321"),
                    new ReportAreaForTests(new AreaOwner(63), "Project Title", "activity with funded components", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "100", "Totals-Actual Commitments", "100"),
                    new ReportAreaForTests(new AreaOwner(64), "Project Title", "Unvalidated activity", "Administrative Level 2", "", "Funding-2015-Actual Commitments", "45,000", "Totals-Actual Commitments", "45,000"),
                    new ReportAreaForTests(new AreaOwner(66), "Project Title", "Activity 2 with multiple agreements", "Administrative Level 2", "", "Funding-2015-Actual Commitments", "1,200", "Totals-Actual Commitments", "1,200"),
                    new ReportAreaForTests(new AreaOwner(67), "Project Title", "third activity with agreements", "Administrative Level 2", "", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456"),
                    new ReportAreaForTests(new AreaOwner(68), "Project Title", "activity with incomplete agreement", "Administrative Level 2", "", "Funding-2015-Actual Commitments", "123,000", "Totals-Actual Commitments", "123,000"),
                    new ReportAreaForTests(new AreaOwner(69), "Project Title", "Activity with planned disbursements", "Administrative Level 2", "", "Funding-2014-Actual Disbursements", "200", "Funding-2015-Actual Disbursements", "570", "Totals-Actual Disbursements", "770"),
                    new ReportAreaForTests(new AreaOwner(70), "Project Title", "Activity with both MTEFs and Act.Comms", "Administrative Level 2", "", "Funding-2015-Actual Commitments", "888,000", "Totals-Actual Commitments", "888,000"),
                    new ReportAreaForTests(new AreaOwner(71), "Project Title", "activity_with_disaster_response", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "33,000", "Funding-2015-Actual Commitments", "117,000", "Totals-Actual Commitments", "150,000"),
                    new ReportAreaForTests(new AreaOwner(73), "Project Title", "activity with directed MTEFs", "Administrative Level 2", "", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456"),
                    new ReportAreaForTests(new AreaOwner(76), "Project Title", "activity with pipeline MTEFs and act. disb", "Administrative Level 2", "", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Disbursements", "75,000", "Totals-Actual Disbursements", "110,000"),
                    new ReportAreaForTests(new AreaOwner(77), "Project Title", "execution rate activity", "Administrative Level 2", "", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Disbursements", "90,000"),
                    new ReportAreaForTests(new AreaOwner(78), "Project Title", "activity with many MTEFs", "Administrative Level 2", "", "Funding-2015-Actual Disbursements", "80,000", "Totals-Actual Disbursements", "80,000"),
                    new ReportAreaForTests(new AreaOwner(79), "Project Title", "with weird currencies", "Administrative Level 2", "", "Funding-2014-Actual Commitments", "3,632,14", "Funding-2015-Actual Commitments", "93,930,84", "Totals-Actual Commitments", "97,562,98")));

        
        ReportSpecificationImpl spec = buildSpecForFiltering("flat filter by not zone", 
            Arrays.asList(ColumnConstants.PROJECT_TITLE, ColumnConstants.LOCATION_ADM_LEVEL_2), null, ColumnConstants.LOCATION_ADM_LEVEL_2, Arrays.asList(9111l), false); // NOT Glodeni
    ...
    public void testFilterHierByZoneByZone() {
        ...
        .withHeaders(Arrays.asList(
                "(RAW: (startRow: 0, rowSpan: 1, totalRowSpan: 4, colStart: 0, colSpan: 10))",
                "(Administrative Level 2: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 6));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 8, colSpan: 2))",
            ...
            .withBody(      new ReportAreaForTests(null)
              ...
              .withChildren(
                ...
                new ReportAreaForTests(new AreaOwner("Administrative Level 2", "Glodeni"))
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("by zone filter by zone", 
            ...
            ColumnConstants.LOCATION_ADM_LEVEL_2, Arrays.asList(9108l, 9111l), true); // Bulboaca, Glodeni
    ...
    public void testFilterHierByRegionByZone() {
        NiReportModel cor = new NiReportModel("by region filter by zone")
            .withHeaders(Arrays.asList(
                    "(RAW: (startRow: 0, rowSpan: 1, totalRowSpan: 4, colStart: 0, colSpan: 10))",
                    "(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 2, colSpan: 6));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 8, colSpan: 2))",
                    "(2013: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 2, colSpan: 2));(2014: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 4, colSpan: 2));(2015: (startRow: 2, rowSpan: 1, totalRowSpan: 2, colStart: 6, colSpan: 2))",
                    "(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 2, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 3, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 4, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 5, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 6, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 7, colSpan: 1));(Actual Commitments: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 8, colSpan: 1));(Actual Disbursements: (startRow: 3, rowSpan: 1, totalRowSpan: 1, colStart: 9, colSpan: 1))"))
                .withWarnings(Arrays.asList())
                .withBody(      new ReportAreaForTests(null)
                  .withContents("Administrative Level 1", "", "Project Title", "", "Funding-2013-Actual Commitments", "1,282,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "37,500", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "456,789", "Funding-2015-Actual Disbursements", "321,765", "Totals-Actual Commitments", "1,776,289", "Totals-Actual Disbursements", "321,765")
                  .withChildren(
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Anenii Noi County")).withContents("Project Title", "", "Funding-2013-Actual Commitments", "285,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "0", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "0", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "285,000", "Totals-Actual Disbursements", "0", "Administrative Level 1", "Anenii Noi County")
                    .withChildren(
                      new ReportAreaForTests(new AreaOwner(33), "Project Title", "Activity with Zones", "Funding-2013-Actual Commitments", "285,000", "Totals-Actual Commitments", "285,000")        ),
                    new ReportAreaForTests(new AreaOwner("Administrative Level 1", "Balti County"))
                    .withContents("Project Title", "", "Funding-2013-Actual Commitments", "997,000", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "37,500", "Funding-2014-Actual Disbursements", "0", "Funding-2015-Actual Commitments", "456,789", "Funding-2015-Actual Disbursements", "321,765", "Totals-Actual Commitments", "1,491,289", "Totals-Actual Disbursements", "321,765", "Administrative Level 1", "Balti County")
                    .withChildren(
                      new ReportAreaForTests(new AreaOwner(33), "Project Title", "Activity with Zones", "Funding-2013-Actual Commitments", "285,000", "Totals-Actual Commitments", "285,000"),
                      new ReportAreaForTests(new AreaOwner(36), "Project Title", "Activity With Zones and Percentages", "Funding-2013-Actual Commitments", "712,000", "Totals-Actual Commitments", "712,000"),
                      new ReportAreaForTests(new AreaOwner(40), "Project Title", "SubNational no percentages", "Funding-2014-Actual Commitments", "37,500", "Totals-Actual Commitments", "37,500"),
    ...
    public void testFilterHierBySectorByRegionBySectorByRegion() {
        NiReportModel cor = new NiReportModel("by primary sector by region filter by zone by primary sector")
            .withHeaders(Arrays.asList(
                    ...
                    "(Primary Sector: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 0, colSpan: 1));(Administrative Level 1: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 1, colSpan: 1));(Project Title: (startRow: 1, rowSpan: 3, totalRowSpan: 3, colStart: 2, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 3, colStart: 3, colSpan: 8));(Totals: (startRow: 1, rowSpan: 2, totalRowSpan: 3, colStart: 11, colSpan: 2))",
        ...
        ReportSpecificationImpl spec = buildSpecForFiltering("by primary sector by region filter by zone by primary sector", 
            ...
            ColumnConstants.LOCATION_ADM_LEVEL_1, Arrays.asList(9086l), true); // Balti
