...
public class OffDbNiReportEngineTests extends AmpTestCase {
	...
	private List<String> acts = new ArrayList<String>(new HardcodedActivities().getActNamesMap().values());
...
//		outputForSpecs(spec, "RAW / Funding / 2014 / Actual Commitments");
...
//		outputForSpecs(spec, "RAW / Totals / Actual Commitments");
//		outputForSpecs(spec, "RAW / Funding / 2014 / Actual Commitments");
//		outputForSpecs(spec, "RAW / Funding / 2013 / Actual Disbursements");
...
//		outputForSpecs(spec, "RAW / Totals / Actual Commitments");
//		outputForSpecs(spec, "RAW / Funding / 2014 / Actual Disbursements");
...
//		outputForSpecs(spec, "RAW / Totals / Actual Commitments");
//		outputForSpecs(spec, "RAW / Funding / 2014 / Actual Disbursements");
//		outputForSpecs(spec, "RAW / Funding / 2013 / Actual Commitments");
		assertEquals(
...
//		outputForSpecs(spec, "RAW / Totals / Actual Commitments");
//		outputForSpecs(spec, "RAW / Totals / Actual Disbursements");
		assertEquals(
