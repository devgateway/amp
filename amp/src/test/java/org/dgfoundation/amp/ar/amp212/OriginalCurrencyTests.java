    ...
    public void testOriginalCurrencyWithHiers() {
        NiReportModel cor = new NiReportModel("Original currency with hiers")
                .withHeaders(Arrays.asList(
                        ...
                        "(Primary Program: (startRow: 1, rowSpan: 4, totalRowSpan: 4, colStart: 0, colSpan: 1));(Project Title: (startRow: 1, rowSpan: 4, totalRowSpan: 4, colStart: 1, colSpan: 1));(Funding: (startRow: 1, rowSpan: 1, totalRowSpan: 4, colStart: 2, colSpan: 31))",
