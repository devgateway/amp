...
public class PaginationTests extends ReportingTestCase {
    ...
    final ReportSpecification theSingleHierSpec = ReportSpecificationImpl.buildFor("initReport",
            ...
            Arrays.asList(ColumnConstants.LOCATION_ADM_LEVEL_1), GroupingCriteria.GROUPING_YEARLY);
    final ReportSpecification theDoubleHierSpec = ReportSpecificationImpl.buildFor("initReport",
            ...
            Arrays.asList(MeasureConstants.ACTUAL_COMMITMENTS, MeasureConstants.ACTUAL_DISBURSEMENTS),
            Arrays.asList(ColumnConstants.LOCATION_ADM_LEVEL_1, ColumnConstants.PRIMARY_SECTOR), GroupingCriteria.GROUPING_YEARLY);
    ...
    public void testFullFlat() {
        PaginatedReportAreaForTests cor =  new PaginatedReportAreaForTests(null).withCounts(44, 44)
                ...
                .withChildren(
                  new PaginatedReportAreaForTests(new AreaOwner(12), "Project Title", "TAC_activity_1", "Administrative Level 1", "Dubasari County", "Funding-2010-Actual Disbursements", "123,321", "Funding-2011-Actual Commitments", "213,231", "Totals-Actual Commitments", "213,231", "Totals-Actual Disbursements", "123,321").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(13), "Project Title", "TAC_activity_2", "Administrative Level 1", "Falesti County", "Funding-2010-Actual Disbursements", "453,213", "Funding-2011-Actual Commitments", "999,888", "Totals-Actual Commitments", "999,888", "Totals-Actual Disbursements", "453,213").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(15), "Project Title", "Proposed Project Cost 1 - USD", "Administrative Level 1", "Drochia County").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(17), "Project Title", "Proposed Project Cost 2 - EUR", "Administrative Level 1", "Anenii Noi County").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(18), "Project Title", "Test MTEF directed", "Administrative Level 1", "Anenii Noi County", "Funding-2010-Actual Disbursements", "143,777", "Totals-Actual Disbursements", "143,777").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(19), "Project Title", "Pure MTEF Project", "Administrative Level 1", "Cahul County").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(21), "Project Title", "activity with components", "Administrative Level 1", "Anenii Noi County").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(23), "Project Title", "Project with documents", "Administrative Level 1", "Balti County").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(24), "Project Title", "Eth Water", "Administrative Level 1", "Anenii Noi County", "Funding-2013-Actual Disbursements", "545,000", "Totals-Actual Disbursements", "545,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(25), "Project Title", "mtef activity 1", "Administrative Level 1", "").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(26), "Project Title", "date-filters-activity", "Administrative Level 1", "", "Funding-2009-Actual Commitments", "100,000", "Funding-2010-Actual Disbursements", "60,000", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Totals-Actual Commitments", "125,000", "Totals-Actual Disbursements", "72,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(27), "Project Title", "mtef activity 2", "Administrative Level 1", "Anenii Noi County").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(28), "Project Title", "ptc activity 1", "Administrative Level 1", "Anenii Noi County", "Funding-2013-Actual Commitments", "666,777", "Totals-Actual Commitments", "666,777").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(29), "Project Title", "ptc activity 2", "Administrative Level 1", "Anenii Noi County", "Funding-2013-Actual Commitments", "333,222", "Totals-Actual Commitments", "333,222").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(30), "Project Title", "SSC Project 1", "Administrative Level 1", "Anenii Noi County", "Funding-2013-Actual Commitments", "111,333", "Funding-2013-Actual Disbursements", "555,111", "Totals-Actual Commitments", "111,333", "Totals-Actual Disbursements", "555,111").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(31), "Project Title", "SSC Project 2", "Administrative Level 1", "Edinet County", "Funding-2013-Actual Commitments", "567,421", "Funding-2013-Actual Disbursements", "131,845", "Totals-Actual Commitments", "567,421", "Totals-Actual Disbursements", "131,845").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(32), "Project Title", "crazy funding 1", "Administrative Level 1", "Balti County", "Funding-2013-Actual Commitments", "333,333", "Totals-Actual Commitments", "333,333").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(33), "Project Title", "Activity with Zones", "Administrative Level 1", "Anenii Noi County, Balti County", "Funding-2013-Actual Commitments", "570,000", "Totals-Actual Commitments", "570,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(36), "Project Title", "Activity With Zones and Percentages", "Administrative Level 1", "Anenii Noi County, Balti County", "Funding-2013-Actual Commitments", "890,000", "Totals-Actual Commitments", "890,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(40), "Project Title", "SubNational no percentages", "Administrative Level 1", "Anenii Noi County, Balti County", "Funding-2014-Actual Commitments", "75,000", "Totals-Actual Commitments", "75,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(41), "Project Title", "Activity Linked With Pledge", "Administrative Level 1", "Chisinau City", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(43), "Project Title", "Activity with primary_tertiary_program", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "50,000", "Totals-Actual Commitments", "50,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(44), "Project Title", "activity with primary_program", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "32,000", "Totals-Actual Commitments", "32,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(45), "Project Title", "activity with tertiary_program", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "15,000", "Totals-Actual Commitments", "15,000").withCounts(1, -1),
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner(52), "Project Title", "activity with contracting agency", "Administrative Level 1", "Balti County, Transnistrian Region", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2014-Actual Disbursements", "50,000", "Totals-Actual Commitments", "96,840,58", "Totals-Actual Disbursements", "50,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(53), "Project Title", "new activity with contracting", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "12,000", "Totals-Actual Commitments", "12,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(61), "Project Title", "activity-with-unfunded-components", "Administrative Level 1", "Transnistrian Region", "Funding-2014-Actual Commitments", "123,321", "Totals-Actual Commitments", "123,321").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(63), "Project Title", "activity with funded components", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "100", "Totals-Actual Commitments", "100").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(64), "Project Title", "Unvalidated activity", "Administrative Level 1", "", "Funding-2015-Actual Commitments", "45,000", "Totals-Actual Commitments", "45,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(65), "Project Title", "activity 1 with agreement", "Administrative Level 1", "Balti County", "Funding-2015-Actual Commitments", "456,789", "Funding-2015-Actual Disbursements", "321,765", "Totals-Actual Commitments", "456,789", "Totals-Actual Disbursements", "321,765").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(66), "Project Title", "Activity 2 with multiple agreements", "Administrative Level 1", "Chisinau County", "Funding-2015-Actual Commitments", "1,200", "Totals-Actual Commitments", "1,200").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(67), "Project Title", "third activity with agreements", "Administrative Level 1", "Chisinau City", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(68), "Project Title", "activity with incomplete agreement", "Administrative Level 1", "", "Funding-2015-Actual Commitments", "123,000", "Totals-Actual Commitments", "123,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(69), "Project Title", "Activity with planned disbursements", "Administrative Level 1", "", "Funding-2014-Actual Disbursements", "200", "Funding-2015-Actual Disbursements", "570", "Totals-Actual Disbursements", "770").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(70), "Project Title", "Activity with both MTEFs and Act.Comms", "Administrative Level 1", "Balti County, Drochia County", "Funding-2015-Actual Commitments", "888,000", "Totals-Actual Commitments", "888,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(71), "Project Title", "activity_with_disaster_response", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "33,000", "Funding-2015-Actual Commitments", "117,000", "Totals-Actual Commitments", "150,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(73), "Project Title", "activity with directed MTEFs", "Administrative Level 1", "Chisinau City", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(76), "Project Title", "activity with pipeline MTEFs and act. disb", "Administrative Level 1", "Chisinau County", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Disbursements", "75,000", "Totals-Actual Disbursements", "110,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(77), "Project Title", "execution rate activity", "Administrative Level 1", "Chisinau City, Dubasari County", "Funding-2014-Actual Disbursements", "55,000", "Funding-2015-Actual Disbursements", "35,000", "Totals-Actual Disbursements", "90,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(78), "Project Title", "activity with many MTEFs", "Administrative Level 1", "Drochia County", "Funding-2015-Actual Disbursements", "80,000", "Totals-Actual Disbursements", "80,000").withCounts(1, -1),
                  new PaginatedReportAreaForTests(new AreaOwner(79), "Project Title", "with weird currencies", "Administrative Level 1", "", "Funding-2014-Actual Commitments", "3,632,14", "Funding-2015-Actual Commitments", "93,930,84", "Totals-Actual Commitments", "97,562,98").withCounts(1, -1));
    ...
    public void testBeginFlat() {
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(10, 44)
                .withContents("Project Title", "", "Administrative Level 1", "", "Funding-2006-Actual Commitments", "96,840,58",
                        ...
                        "3,206,802")
                .withChildren(
                        new PaginatedReportAreaForTests(new AreaOwner(12), "Project Title", "TAC_activity_1", "Administrative Level 1",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(13), "Project Title", "TAC_activity_2", "Administrative Level 1",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(15), "Project Title",
                                "Proposed Project Cost 1 - USD", "Administrative Level 1", "Drochia County").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(17), "Project Title",
                                "Proposed Project Cost 2 - EUR", "Administrative Level 1", "Anenii Noi County").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(18), "Project Title", "Test MTEF directed",
                                "Administrative Level 1", "Anenii Noi County", "Funding-2010-Actual Disbursements", "143,777",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(19), "Project Title", "Pure MTEF Project",
                                "Administrative Level 1", "Cahul County").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(21), "Project Title", "activity with components",
                                "Administrative Level 1", "Anenii Noi County").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(23), "Project Title", "Project with documents",
                                "Administrative Level 1", "Balti County").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(24), "Project Title", "Eth Water", "Administrative Level 1",
                                "Anenii Noi County", "Funding-2013-Actual Disbursements", "545,000",
                                "Totals-Actual Disbursements", "545,000").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(25), "Project Title", "mtef activity 1", "Administrative Level 1",
                                "").withCounts(1, -1));
        ...
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(10, 44)
                ...
                .withChildren(
                        new PaginatedReportAreaForTests(new AreaOwner(67), "Project Title",
                                "third activity with agreements", "Administrative Level 1", "Chisinau City",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(68), "Project Title",
                                "activity with incomplete agreement", "Administrative Level 1", "", "Funding-2015-Actual Commitments",
                                "123,000", "Totals-Actual Commitments", "123,000").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(69), "Project Title",
                                "Activity with planned disbursements", "Administrative Level 1", "",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(70), "Project Title",
                                "Activity with both MTEFs and Act.Comms", "Administrative Level 1", "Balti County, Drochia County",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(71), "Project Title",
                                "activity_with_disaster_response", "Administrative Level 1", "", "Funding-2014-Actual Commitments",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(73), "Project Title",
                                "activity with directed MTEFs", "Administrative Level 1", "Chisinau City",
                                "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456")
                                        .withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(76), "Project Title",
                                "activity with pipeline MTEFs and act. disb", "Administrative Level 1", "Chisinau County",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(77), "Project Title", "execution rate activity",
                                "Administrative Level 1", "Chisinau City, Dubasari County", "Funding-2014-Actual Disbursements",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(78), "Project Title", "activity with many MTEFs",
                                "Administrative Level 1", "Drochia County", "Funding-2015-Actual Disbursements", "80,000",
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner(79), "Project Title", "with weird currencies",
                                "Administrative Level 1", "", "Funding-2014-Actual Commitments", "3,632,14",
    ...
    public void testFullHier() {
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(37, 37)
                .withContents("Administrative Level 1", "", "Project Title", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "780,311", "Funding-2011-Actual Commitments", "1,213,119", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "7,842,086", "Funding-2013-Actual Disbursements", "1,266,956", "Funding-2014-Actual Commitments", "8,159,813,77", "Funding-2014-Actual Disbursements", "710,200", "Funding-2015-Actual Commitments", "1,971,831,84", "Funding-2015-Actual Disbursements", "437,335", "Totals-Actual Commitments", "19,408,691,19", "Totals-Actual Disbursements", "3,206,802")
                .withChildren(
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Anenii Noi County")).withCounts(8, 8)
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Balti County")).withCounts(7, 7)
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Chisinau City")).withCounts(4, 4)
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Chisinau County")).withCounts(4, 4)
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Drochia County")).withCounts(2, 2)
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Dubasari County")).withCounts(2, 2)
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Transnistrian Region")).withCounts(2, 2)
                  ...
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Administrative Level 1: Undefined")).withCounts(11, 11)
    ...
    public void testBeginHier() {
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(9, 37)
                .withContents("Administrative Level 1", "", "Project Title", "", "Funding-2006-Actual Commitments", "96,840,58",
                        "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000",
                        "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0",
                        "Funding-2010-Actual Disbursements", "780,311", "Funding-2011-Actual Commitments", "1,213,119",
                        "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000",
                        ...
                        "437,335", "Totals-Actual Commitments", "19,408,691,19", "Totals-Actual Disbursements",
                        "3,206,802")
                .withChildren(new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Anenii Noi County"))
                        .withCounts(8, 8)
                        ...
                        new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Balti County")).withCounts(2, 7)
                                .withContents("Project Title", "", "Funding-2006-Actual Commitments", "53,262,32",
                                        ...
                                        "2,144,284,32", "Totals-Actual Disbursements", "349,265", "Administrative Level 1",
                                        "Balti County")
                                .withChildren(
    ...
    public void testEndHier() {
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(9, 37)
                .withContents("Administrative Level 1", "", "Project Title", "", "Funding-2006-Actual Commitments", "96,840,58",
                        ...
                        "437,335", "Totals-Actual Commitments", "19,408,691,19", "Totals-Actual Disbursements",
                        "3,206,802")
                .withChildren(new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Administrative Level 1: Undefined"))
                        .withCounts(9, 11)
                        .withContents("Project Title", "", "Funding-2006-Actual Commitments", "0",
                                "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000",
                                "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0",
                                ...
                                "72,770", "Administrative Level 1", "Administrative Level 1: Undefined")
                        .withChildren(
    ...
    public void testCutEndHier() {
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(3, 37).withContents("Administrative Level 1", "", "Project Title", "", "Funding-2006-Actual Commitments", "96,840,58", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "780,311", "Funding-2011-Actual Commitments", "1,213,119", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "7,842,086", "Funding-2013-Actual Disbursements", "1,266,956", "Funding-2014-Actual Commitments", "8,159,813,77", "Funding-2014-Actual Disbursements", "710,200", "Funding-2015-Actual Commitments", "1,971,831,84", "Funding-2015-Actual Disbursements", "437,335", "Totals-Actual Commitments", "19,408,691,19", "Totals-Actual Disbursements", "3,206,802")
            .withChildren(
                      new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Administrative Level 1: Undefined")).withCounts(3, 11)
                      .withContents("Project Title", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "100,000", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "60,000", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "25,000", "Funding-2012-Actual Disbursements", "12,000", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "145,732,14", "Funding-2014-Actual Disbursements", "200", "Funding-2015-Actual Commitments", "378,930,84", "Funding-2015-Actual Disbursements", "570", "Totals-Actual Commitments", "649,662,98", "Totals-Actual Disbursements", "72,770", "Administrative Level 1", "Administrative Level 1: Undefined")
                      .withChildren(
                        new PaginatedReportAreaForTests(new AreaOwner(69), "Project Title", "Activity with planned disbursements", "Funding-2014-Actual Disbursements", "200", "Funding-2015-Actual Disbursements", "570", "Totals-Actual Disbursements", "770").withCounts(1, -1),
                        new PaginatedReportAreaForTests(new AreaOwner(71), "Project Title", "activity_with_disaster_response", "Funding-2014-Actual Commitments", "33,000", "Funding-2015-Actual Commitments", "117,000", "Totals-Actual Commitments", "150,000").withCounts(1, -1),
        ...
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(37, 37)
                ...
                .withChildren(
                  ...
                  .withChildren(
                    ...
                    .withChildren(
                      new PaginatedReportAreaForTests(new AreaOwner(48), "Project Title", "pledged 2", "Funding-2013-Actual Commitments", "2,670,000", "Funding-2014-Actual Commitments", "4,400,000", "Funding-2014-Actual Disbursements", "450,000", "Totals-Actual Commitments", "7,070,000", "Totals-Actual Disbursements", "450,000").withCounts(1, -1)        )      ),
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Chisinau City")).withCounts(4, 4).withContents("Primary Sector", "", "Project Title", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "0", "Funding-2013-Actual Disbursements", "0", "Funding-2014-Actual Commitments", "50,000", "Funding-2014-Actual Disbursements", "27,500", "Funding-2015-Actual Commitments", "246,912", "Funding-2015-Actual Disbursements", "17,500", "Totals-Actual Commitments", "296,912", "Totals-Actual Disbursements", "45,000", "Administrative Level 1", "Chisinau City")
                  .withChildren(
                    ...
                    .withChildren(
                      ...
                      new PaginatedReportAreaForTests(new AreaOwner(73), "Project Title", "activity with directed MTEFs", "Funding-2015-Actual Commitments", "123,456", "Totals-Actual Commitments", "123,456").withCounts(1, -1),
                      new PaginatedReportAreaForTests(new AreaOwner(77), "Project Title", "execution rate activity", "Funding-2014-Actual Disbursements", "27,500", "Funding-2015-Actual Disbursements", "17,500", "Totals-Actual Disbursements", "45,000").withCounts(1, -1)        )      ),
                  new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Chisinau County")).withCounts(4, 4).withContents("Primary Sector", "", "Project Title", "", "Funding-2006-Actual Commitments", "0", "Funding-2006-Actual Disbursements", "0", "Funding-2009-Actual Commitments", "0", "Funding-2009-Actual Disbursements", "0", "Funding-2010-Actual Commitments", "0", "Funding-2010-Actual Disbursements", "0", "Funding-2011-Actual Commitments", "0", "Funding-2011-Actual Disbursements", "0", "Funding-2012-Actual Commitments", "0", "Funding-2012-Actual Disbursements", "0", "Funding-2013-Actual Commitments", "1,700,000", "Funding-2013-Actual Disbursements", "35,000", "Funding-2014-Actual Commitments", "3,365,760,63", "Funding-2014-Actual Disbursements", "155,000", "Funding-2015-Actual Commitments", "1,200", "Funding-2015-Actual Disbursements", "0", "Totals-Actual Commitments", "5,066,960,63", "Totals-Actual Disbursements", "190,000", "Administrative Level 1", "Chisinau County")
                  .withChildren(
                    new PaginatedReportAreaForTests(new AreaOwner("Primary Sector", "110 - EDUCATION")).withCounts(4, 4)
    ...
    public void testMidDoubleHier() {
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(7, 37)
                .withContents("Administrative Level 1", "", "Primary Sector", "", "Project Title", "",
        ...
        PaginatedReportAreaForTests cor = new PaginatedReportAreaForTests(null).withCounts(2, 37)
                ...
                .withChildren(new PaginatedReportAreaForTests(new AreaOwner("Administrative Level 1", "Administrative Level 1: Undefined"))
                        ...
                        .withContents("Primary Sector", "", "Project Title", "",
                                ...
                                "649,662,98", "Totals-Actual Disbursements", "72,770", "Administrative Level 1", "Administrative Level 1: Undefined")
                        .withChildren(
                                new PaginatedReportAreaForTests(
