	...
	public void testPledgeMergingFilterByPrimarySector() {
		GroupReportModel fddr_correct = GroupReportModel.withColumnReports("AMP-17746-test-merging-basic-education",
				ColumnReportDataModel.withColumns("AMP-17746-test-merging-basic-education",
						SimpleColumnModel.withContents("Project Title", "Heavily used pledge", "Heavily used pledge", "Test pledge 1", "Test pledge 1", "pledged education activity 1", "pledged education activity 1").setIsPledge(false), 
						SimpleColumnModel.withContents("Region", "Heavily used pledge", "[Anenii Noi County, Lapusna County]", "Test pledge 1", "[Balti County, Cahul County, Transnistrian Region]", "pledged education activity 1", "Chisinau County").setIsPledge(false), 
						SimpleColumnModel.withContents("Primary Sector", "Heavily used pledge", "112 - BASIC EDUCATION", "Test pledge 1", "112 - BASIC EDUCATION", "pledged education activity 1", "110 - EDUCATION").setIsPledge(false), 
						...
						SimpleColumnModel.withContents("Tertiary Program", "Heavily used pledge", "[OP111 name, OP2 name]", "Test pledge 1", "OP111 name").setIsPledge(false), 
						GroupColumnModel.withSubColumns("Funding",
							...
							GroupColumnModel.withSubColumns("2014",
								SimpleColumnModel.withContents("Actual Commitments", "Heavily used pledge", "4 900 000", "Test pledge 1", "361 635,74", "pledged education activity 1", "3 300 000").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false))), 
						GroupColumnModel.withSubColumns("Total Costs",
							SimpleColumnModel.withContents("Actual Commitments", "Heavily used pledge", "4 030 000", "Test pledge 1", "361 636,18", "pledged education activity 1", "5 000 000").setIsPledge(false), 
							SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)))
	...
	public void testPledgeMergingFlat() {
		GroupReportModel fddr_correct = GroupReportModel.withColumnReports("AMP-17746-test-merging",
				ColumnReportDataModel.withColumns("AMP-17746-test-merging",
						SimpleColumnModel.withContents("Project Title", "ACVL Pledge Name 2", "ACVL Pledge Name 2", "free text name 2", "free text name 2", "Heavily used pledge", "Heavily used pledge", "pledged 2", "pledged 2", "Test pledge 1", "Test pledge 1", "pledged education activity 1", "pledged education activity 1").setIsPledge(false), 
						SimpleColumnModel.withContents("Region", "Heavily used pledge", "[Anenii Noi County, Lapusna County]", "pledged 2", "Cahul County", "Test pledge 1", "[Balti County, Cahul County, Transnistrian Region]", "pledged education activity 1", "Chisinau County").setIsPledge(false), 
						SimpleColumnModel.withContents("Primary Sector", "Heavily used pledge", "112 - BASIC EDUCATION", "pledged 2", "113 - SECONDARY EDUCATION", "Test pledge 1", "[112 - BASIC EDUCATION, 113 - SECONDARY EDUCATION]", "pledged education activity 1", "110 - EDUCATION").setIsPledge(false), 
						SimpleColumnModel.withContents("Secondary Sector", "ACVL Pledge Name 2", "1-DEMOCRATIC COUNTRY", "free text name 2", "1-DEMOCRATIC COUNTRY", "pledged 2", "4 HUMAN RESOURCES", "Test pledge 1", "[3 NATIONAL COMPETITIVENESS, 5 REGIONAL DEVELOPMENT]", "pledged education activity 1", "4 HUMAN RESOURCES").setIsPledge(false), 
						SimpleColumnModel.withContents("National Planning Objectives", MUST_BE_EMPTY).setIsPledge(false), 
						SimpleColumnModel.withContents("Primary Program", "Test pledge 1", "Subprogram p1.b").setIsPledge(false), 
						SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
						SimpleColumnModel.withContents("Tertiary Program", "ACVL Pledge Name 2", "[OP111 name, OP112 name]", "Heavily used pledge", "[OP111 name, OP2 name]", "Test pledge 1", "OP111 name").setIsPledge(false), 
						GroupColumnModel.withSubColumns("Funding",
							GroupColumnModel.withSubColumns("2012",
								SimpleColumnModel.withContents("Actual Commitments", "free text name 2", "1 044 176,71", "Test pledge 1", "1,25").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)), 
							GroupColumnModel.withSubColumns("2013",
								SimpleColumnModel.withContents("Actual Commitments", "Heavily used pledge", "-870 000", "pledged 2", "2 670 000", "pledged education activity 1", "1 700 000").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)), 
							GroupColumnModel.withSubColumns("2014",
								SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "-50 000", "Heavily used pledge", "4 900 000", "pledged 2", "4 400 000", "Test pledge 1", "1 033 244,98", "pledged education activity 1", "3 300 000").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", "pledged 2", "450 000").setIsPledge(false))), 
						GroupColumnModel.withSubColumns("Total Costs",
							SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "888 069,75", "free text name 2", "1 044 176,71", "Heavily used pledge", "4 030 000", "pledged 2", "7 070 000", "Test pledge 1", "1 033 246,23", "pledged education activity 1", "5 000 000").setIsPledge(false), 
							SimpleColumnModel.withContents("Actual Disbursements", "pledged 2", "450 000").setIsPledge(false)))
		...
		GroupReportModel fddr_correct = GroupReportModel.withGroupReports("AMP-17746-test-merging-by-region",
				GroupReportModel.withColumnReports("AMP-17746-test-merging-by-region",
						ColumnReportDataModel.withColumns("Region: Anenii Noi County",
							...
							SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Tertiary Program", "Heavily used pledge", "[OP111 name, OP2 name]").setIsPledge(false), 
							GroupColumnModel.withSubColumns("Funding",
								GroupColumnModel.withSubColumns("2012",
						...
						ColumnReportDataModel.withColumns("Region: Balti County",
							...
							SimpleColumnModel.withContents("Primary Program", "Test pledge 1", "Subprogram p1.b").setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Tertiary Program", "Test pledge 1", "OP111 name").setIsPledge(false), 
							GroupColumnModel.withSubColumns("Funding",
								GroupColumnModel.withSubColumns("2012",
						...
						ColumnReportDataModel.withColumns("Region: Region Unallocated",
							...
							SimpleColumnModel.withContents("Primary Program", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Tertiary Program", "ACVL Pledge Name 2", "[OP111 name, OP112 name]").setIsPledge(false), 
							GroupColumnModel.withSubColumns("Funding",
								GroupColumnModel.withSubColumns("2012",
		...
		GroupReportModel fddr_correct = GroupReportModel.withGroupReports("AMP-17746-test-merging-by-primary-program",
				GroupReportModel.withColumnReports("AMP-17746-test-merging-by-primary-program",
						ColumnReportDataModel.withColumns("Primary Program: Primary Program Unallocated",
							SimpleColumnModel.withContents("Project Title", "ACVL Pledge Name 2", "ACVL Pledge Name 2", "free text name 2", "free text name 2", "Heavily used pledge", "Heavily used pledge", "pledged 2", "pledged 2", "pledged education activity 1", "pledged education activity 1").setIsPledge(false), 
							SimpleColumnModel.withContents("Region", "Heavily used pledge", "[Anenii Noi County, Lapusna County]", "pledged 2", "Cahul County", "pledged education activity 1", "Chisinau County").setIsPledge(false), 
							SimpleColumnModel.withContents("Primary Sector", "Heavily used pledge", "112 - BASIC EDUCATION", "pledged 2", "113 - SECONDARY EDUCATION", "pledged education activity 1", "110 - EDUCATION").setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Sector", "ACVL Pledge Name 2", "1-DEMOCRATIC COUNTRY", "free text name 2", "1-DEMOCRATIC COUNTRY", "pledged 2", "4 HUMAN RESOURCES", "pledged education activity 1", "4 HUMAN RESOURCES").setIsPledge(false), 
							SimpleColumnModel.withContents("National Planning Objectives", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Tertiary Program", "ACVL Pledge Name 2", "[OP111 name, OP112 name]", "Heavily used pledge", "[OP111 name, OP2 name]").setIsPledge(false), 
							GroupColumnModel.withSubColumns("Funding",
								GroupColumnModel.withSubColumns("2012",
									SimpleColumnModel.withContents("Actual Commitments", "free text name 2", "1 044 176,71").setIsPledge(false), 
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)), 
								GroupColumnModel.withSubColumns("2013",
									...
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)), 
								GroupColumnModel.withSubColumns("2014",
									SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "-50 000", "Heavily used pledge", "4 900 000", "pledged 2", "4 400 000", "pledged education activity 1", "3 300 000").setIsPledge(false), 
									SimpleColumnModel.withContents("Actual Disbursements", "pledged 2", "450 000").setIsPledge(false))), 
							GroupColumnModel.withSubColumns("Total Costs",
								SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "888 069,75", "free text name 2", "1 044 176,71", "Heavily used pledge", "4 030 000", "pledged 2", "7 070 000", "pledged education activity 1", "5 000 000").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", "pledged 2", "450 000").setIsPledge(false)))
	...
	public void testPledgeMergingByTertiaryProgram() {
		GroupReportModel fddr_correct = GroupReportModel.withGroupReports("AMP-17746-test-merging-by-tertiary-program",
				GroupReportModel.withColumnReports("AMP-17746-test-merging-by-tertiary-program",
						ColumnReportDataModel.withColumns("Tertiary Program: OP111 name",
							SimpleColumnModel.withContents("Project Title", "ACVL Pledge Name 2", "ACVL Pledge Name 2", "Heavily used pledge", "Heavily used pledge", "Test pledge 1", "Test pledge 1").setIsPledge(false), 
							SimpleColumnModel.withContents("Region", "Heavily used pledge", "[Anenii Noi County, Lapusna County]", "Test pledge 1", "[Balti County, Cahul County, Transnistrian Region]").setIsPledge(false), 
							SimpleColumnModel.withContents("Primary Sector", "Heavily used pledge", "112 - BASIC EDUCATION", "Test pledge 1", "[112 - BASIC EDUCATION, 113 - SECONDARY EDUCATION]").setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Sector", "ACVL Pledge Name 2", "1-DEMOCRATIC COUNTRY", "Test pledge 1", "[3 NATIONAL COMPETITIVENESS, 5 REGIONAL DEVELOPMENT]").setIsPledge(false), 
							SimpleColumnModel.withContents("National Planning Objectives", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Primary Program", "Test pledge 1", "Subprogram p1.b").setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
							GroupColumnModel.withSubColumns("Funding",
								...
								GroupColumnModel.withSubColumns("2013",
									...
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)), 
								GroupColumnModel.withSubColumns("2014",
									SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "-25 000", "Heavily used pledge", "1 960 000", "Test pledge 1", "1 033 244,98").setIsPledge(false), 
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false))), 
							GroupColumnModel.withSubColumns("Total Costs",
								SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "444 034,88", "Heavily used pledge", "1 612 000", "Test pledge 1", "1 033 246,23").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)))
						.withTrailCells(null, null, null, null, null, null, null, "1,25", "0", "-348 000", "0", "2 968 244,98", "0", "3 089 281,11", "0"),
						ColumnReportDataModel.withColumns("Tertiary Program: OP112 name",
							SimpleColumnModel.withContents("Project Title", "ACVL Pledge Name 2", "ACVL Pledge Name 2").setIsPledge(false), 
							SimpleColumnModel.withContents("Region", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Primary Sector", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Sector", "ACVL Pledge Name 2", "1-DEMOCRATIC COUNTRY").setIsPledge(false), 
							SimpleColumnModel.withContents("National Planning Objectives", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Primary Program", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
							GroupColumnModel.withSubColumns("Funding",
								...
								GroupColumnModel.withSubColumns("2013",
									...
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)), 
								GroupColumnModel.withSubColumns("2014",
									SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "-25 000").setIsPledge(false), 
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false))), 
							GroupColumnModel.withSubColumns("Total Costs",
								SimpleColumnModel.withContents("Actual Commitments", "ACVL Pledge Name 2", "444 034,88").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)))
						.withTrailCells(null, null, null, null, null, null, null, "0", "0", "0", "0", "-25 000", "0", "444 034,88", "0"),
						...
						ColumnReportDataModel.withColumns("Tertiary Program: Tertiary Program Unallocated",
							SimpleColumnModel.withContents("Project Title", "free text name 2", "free text name 2", "pledged 2", "pledged 2", "pledged education activity 1", "pledged education activity 1").setIsPledge(false), 
							...
							SimpleColumnModel.withContents("Secondary Sector", "free text name 2", "1-DEMOCRATIC COUNTRY", "pledged 2", "4 HUMAN RESOURCES", "pledged education activity 1", "4 HUMAN RESOURCES").setIsPledge(false), 
							SimpleColumnModel.withContents("National Planning Objectives", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Primary Program", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Program", MUST_BE_EMPTY).setIsPledge(false), 
							GroupColumnModel.withSubColumns("Funding",
								...
								GroupColumnModel.withSubColumns("2014",
									...
									SimpleColumnModel.withContents("Actual Disbursements", "pledged 2", "450 000").setIsPledge(false))), 
							GroupColumnModel.withSubColumns("Total Costs",
								SimpleColumnModel.withContents("Actual Commitments", "free text name 2", "1 044 176,71", "pledged 2", "7 070 000", "pledged education activity 1", "5 000 000").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", "pledged 2", "450 000").setIsPledge(false)))
		...
		GroupReportModel fddr_correct = GroupReportModel.withGroupReports("AMP-17746-test-merging-by-primary-sector",
				GroupReportModel.withColumnReports("AMP-17746-test-merging-by-primary-sector",
						...
						ColumnReportDataModel.withColumns("Primary Sector: 112 - BASIC EDUCATION",
							SimpleColumnModel.withContents("Project Title", "Heavily used pledge", "Heavily used pledge", "Test pledge 1", "Test pledge 1").setIsPledge(false), 
							SimpleColumnModel.withContents("Region", "Heavily used pledge", "[Anenii Noi County, Lapusna County]", "Test pledge 1", "[Balti County, Cahul County, Transnistrian Region]").setIsPledge(false), 
							SimpleColumnModel.withContents("Secondary Sector", "Test pledge 1", "[3 NATIONAL COMPETITIVENESS, 5 REGIONAL DEVELOPMENT]").setIsPledge(false), 
							SimpleColumnModel.withContents("National Planning Objectives", MUST_BE_EMPTY).setIsPledge(false), 
							SimpleColumnModel.withContents("Primary Program", "Test pledge 1", "Subprogram p1.b").setIsPledge(false), 
							...
							GroupColumnModel.withSubColumns("Funding",
								...
								GroupColumnModel.withSubColumns("2013",
									...
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)), 
								GroupColumnModel.withSubColumns("2014",
									SimpleColumnModel.withContents("Actual Commitments", "Heavily used pledge", "4 900 000", "Test pledge 1", "361 635,74").setIsPledge(false), 
									SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false))), 
							GroupColumnModel.withSubColumns("Total Costs",
								SimpleColumnModel.withContents("Actual Commitments", "Heavily used pledge", "4 030 000", "Test pledge 1", "361 636,18").setIsPledge(false), 
								SimpleColumnModel.withContents("Actual Disbursements", MUST_BE_EMPTY).setIsPledge(false)))
