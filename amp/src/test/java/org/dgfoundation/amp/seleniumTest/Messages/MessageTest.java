...
//                    //selenium.logAssertion"assertTrue", "Error in Messages Settings", "condition=false");
    ...
    private static void deleteLoop(Selenium selenium) {
        while (selenium.isElementPresent("//img[@hspace=\"2\" and @src=\"/static/message/view/images/trash_12.gif\"]")) {
            selenium.click("//img[@hspace=\"2\" and @src=\"/static/message/view/images/trash_12.gif\"]");
            selenium.getConfirmation();
            try {
                Thread.sleep(3000);
