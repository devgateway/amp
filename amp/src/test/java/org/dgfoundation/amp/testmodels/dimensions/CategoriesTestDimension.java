...
public class CategoriesTestDimension extends HardcodedNiDimension {
	...
	public final static CategoriesTestDimension instance = new CategoriesTestDimension("Categories test dimension", TestModelConstants.CATEGORIES_DIMENSION_DEPTH);
