...
public class DistrictCells extends HardcodedCells<PercentageTextCell>{
	...
	protected List<PercentageTextCell> populateCells() {
		return 	Arrays.asList(
			...
			cell("Activity With Zones and Percentages", "", 0.200000),
			cell("Activity With Zones and Percentages", "", 0.800000),
			cell("Activity with Zones", "", 0.500000),
			cell("Activity with Zones", "", 0.500000),
			...
			cell("activity with contracting agency", "", 0.550000),
			cell("activity with contracting agency", "", 0.450000),
			...
			cell("activity-with-unfunded-components", "", 1.000000),
