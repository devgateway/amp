...
public class DistrictCells extends HardcodedCells<PercentageTextCell>{
	...
	public DistrictCells(Map<String, Long> activityNames, Map<String, Long> entityNames) {
	...
	protected List<PercentageTextCell> populateCells() {
		return 	Arrays.asList(
			...
			createCell("Activity With Zones and Percentages", "", 0.200000),
			createCell("Activity With Zones and Percentages", "", 0.800000),
			createCell("Activity with Zones", "", 0.500000),
			createCell("Activity with Zones", "", 0.500000),
			...
			createCell("activity with contracting agency", "", 0.550000),
			createCell("activity with contracting agency", "", 0.450000),
			...
			createCell("activity-with-unfunded-components", "", 1.000000),
