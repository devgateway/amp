...
if("On".equals(publicView)) { %>
				<tr>
					...
					<td>&nbsp;</td>
					<td align="left">
						<input type="button" value="View Public Portfolio" onclick="javascript:window.open('/aim/reportsPublicView.do', 'Public','channelmode=no,directories=no,menubar=no,resizable=yes,status=no,toolbar=no,scrollbars=yes,location=yes');"/>
					</td>
				</tr>
<% } %>
				<tr>
		          ...
		          <td>&nbsp;</td>
					 <td colSpan=2>
						...
						<digi:link href="/showEmailForm.do" module="aim" title="<%=translation%>">
						...
						<digi:link href="/showChangePassword.do" module="aim" title="<%=translation%>">
						...
						<digi:link href="/showRegisterUser.do" module="aim" title="<%=translation%>">
