 ...
 * 	 Created: Aug 3, 2003
 * 	 CVS-ID: $Id: RefLinkManager.java,v 1.1 2005-07-06 10:34:15 rahul Exp $
 *
...
public class RefLinkManager {
    ...
    private static ObjectCache refLinkCache;
    ...
    public RefLinkManager() {
        try {
            ...
            refLinkCache = factory.createCache(this.getClass().getName());
            if (refLinkCache == null) {
                logger.fatal("Can't create cache");
                throw new RuntimeException("Can't create cache");
            }
            ...
            logger.error("Could not initialize RefLinkManager", e);
        }
    }
