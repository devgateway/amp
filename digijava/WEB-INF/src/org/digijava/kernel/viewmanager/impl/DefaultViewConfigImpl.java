...
*   Created: Apr 08, 2004
*   CVS-ID: $Id: DefaultViewConfigImpl.java,v 1.1 2005-07-06 10:34:08 rahul Exp $
*
...
public class DefaultViewConfigImpl extends DefaultViewConfigUtil  {
    protected static Logger logger =
        Logger.getLogger(DefaultViewConfigImpl.class);

    private Site site;

    public DefaultViewConfigImpl(Site site, ServletContext servletContext) throws ViewConfigException {
    ...
    public String getFilePath(String fileName) throws ViewConfigException {
        ...
        try {
            ...
            logger.warn("file " + fileName + " for site " + site.getSiteId() + " not found");
            return null;
        }
        return tmpFileName;
    }
    ...
    if ( path.charAt(0) == File.separator.charAt(0) ) return path;
        ...
        // Assemble path
        String fileName = expandFilePath(path, folderName, isTemplate, groupType,
                                         groupName);
