...
*   Created: Apr 08, 2004
*   CVS-ID: $Id: ViewConfigImpl.java,v 1.1 2005-07-06 10:34:13 rahul Exp $
*
...
public class ViewConfigImpl extends ViewConfigUtil  {
    ...
    public String getFilePath(String fileName) throws ViewConfigException {
        ...
        try {
            ...
            logger.warn("file " + fileName + " for site " + site.getSiteId() + " not found(" + ex.getMessage() + ")");
            logger.debug("ROOT CAUSE", ex);
            return null;
        }
        return tmpFileName;
    }
