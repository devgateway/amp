		...
		if (session.getAttribute("ampAdmin") == null) {
			...
			if (str.equals("no")) {
				return mapping.findForward("index");
					 ...
					 if (request.getParameter("parSecId") != null && addSectorForm.getParentSectorId() == null) {

								/*
								 * check whether parSecId is Long else give error.
								 */
								Long parSecId = new Long(Long.parseLong(request.getParameter("parSecId")));

								/*
								 * check whether there exist a sector with the value parSecId else give error.
								 */
								...
								if (parSecId.intValue() == 0) {
										  ...
										  AmpOrganisation ampOrg = DbUtil.getOrganisation(ampSector.getAmpOrgId().getAmpOrgId());
								...
								if (addSectorForm.getParentSectorId().intValue() == 0) {
										  ...
										  ampSector.setParentSectorId(DbUtil.getAmpSector(addSectorForm.getParentSectorId()));
								}
								ampSector.setAmpOrgId(DbUtil.getOrganisation(addSectorForm.getAmpOrganisationId()));
