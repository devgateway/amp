...
public class CopyOfUpdateWorkspace extends Action {

	private static Logger logger = Logger.getLogger(CopyOfUpdateWorkspace.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            if(session.getAttribute("ampWorkspaces") != null)
            	session.removeAttribute("ampWorkspace");
         ...
         /*       	if(uwForm.getChildWorkspaces()==null && uwForm.getWorkspaceType().compareTo("Management")==0)
                    {
                 	  System.out.println("nu am copii si sunt management!!!!");
                		errors
                        .add(
                            ActionErrors.GLOBAL_ERROR,
                            new ActionError(
           ...
           */     	
                ...
                if(newTeam != null) {
                	...
                	if(uwForm.getChildWorkspaces()==null && uwForm.getWorkspaceType().compareTo("Management")==0)
                    {
                 	   System.out.println("sunt in edit, nu am copii si sunt management**************"+uwForm.getChildWorkspaces().size());
                		errors
                        .add(
                            ActionErrors.GLOBAL_ERROR,
                            new ActionError(
