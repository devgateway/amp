...
public class ViewMulitlateralbyDonor extends Action
{
...
//		formBean.setAdjustmentFlag("false");
		...
		filters=DbUtil.getTeamPageFilters(ampTeamId,Constants.MULTILATERALDONOR);
...
//				ampAdjustmentId=Constants.ACTUAL;
		...
		dbReturnSet=ReportUtil.getAmpReportMultilateral(ampTeamId,fromYr,toYr,perspective,ampCurrencyCode,ampModalityId,ampStatusId,ampOrgId,ampSectorId,fiscalCalId,startDate,closeDate,region);
