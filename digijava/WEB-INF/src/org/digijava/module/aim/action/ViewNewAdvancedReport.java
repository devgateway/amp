...
public class ViewNewAdvancedReport extends Action {
	 ...
	 * @param ampReports the reports are retrieved separately
	 * @param mapping
	 * @param form
	 * @param request
	 * @param response
...
//		for storing the values of start date and close date selected from filter
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, 
			HttpServletRequest request, HttpServletResponse response) throws java.lang.Exception
			{
				...
				AmpReports r=(AmpReports) session.get(AmpReports.class,new Long(ampReportId));
								
				AmpNewFilter af=createFilter(r,mapping,form,request,response);
				if(af==null) mapping.findForward("index");
