...
public class ViewQuarterlyMultilateralbyDonor extends Action
{
	private static Logger logger = Logger.getLogger(ViewMulitlateralbyDonor.class) ;
	...
	int year=0;
		...
		filters=DbUtil.getTeamPageFilters(ampTeamId,Constants.QUARTERLYMULTIDONOR);
...
//				ampAdjustmentId=Constants.ACTUAL;
		...
		dbReturnSet=ReportUtil.getAmpQuarterlyReportMultilateral(ampTeamId,fromYr,toYr,perspective,ampCurrencyCode,ampModalityId,ampStatusId,ampOrgId,ampSectorId,fiscalCalId,startDate,closeDate,region);
