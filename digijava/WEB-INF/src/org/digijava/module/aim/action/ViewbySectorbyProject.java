...
public class ViewbySectorbyProject extends Action{
...
//		formBean.setAdjustmentFlag("false");
		...
		filters=DbUtil.getTeamPageFilters(ampTeamId,Constants.SECTORBYPROJECT);
...
//				ampAdjustmentId=Constants.ACTUAL;
		...
		dbReturnSet=ReportUtil.getAmpReportBySectorByProject(ampTeamId,fromYr,toYr,perspective,ampCurrencyCode,ampModalityId,ampStatusId,ampOrgId,ampSectorId,fiscalCalId,startDate,closeDate,region);
