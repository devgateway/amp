...
public class QuartMultiXlsJrxml
{
...
int textkey=11,linekey=21,c=0,c1=0;
...
p2.println("name='quarterlyMultilaterByDonorXls'");
...
//DYNAMIC CCCCCCCCC
String dc;
p2.println("<field name='c1' class='java.lang.String'/>");
p2.println("<field name='c2' class='java.lang.String'/>");
for(int k=3;k<=(16*n+8);k++)
{
...
p2.println("</background>");
p2.println("<title>");
p2.println("<band height='78'  isSplitAllowed='true' >");
p2.println("<staticText>");
p2.println("<reportElement");
p2.println("mode='Opaque'");
p2.println("x='267'");
p2.println("y='4'");
p2.println("width='400'");
p2.println("height='17'");
...
p2.println("<text><![CDATA[Quarterly Report By Type of Asssistance]]></text>");
p2.println("</staticText>");
...
int drValue = 91 + (180*n) + 165;
p2.println("<textField isStretchWithOverflow='true' pattern='' isBlankWhenNull='false' evaluationTime='Now' hyperlinkType='None' >					<reportElement");
p2.println("mode='Opaque'");
p2.println("x='0'");
p2.println("y='31'");
p2.println("width='"+drValue+"'");
p2.println("height='18'");
p2.println("forecolor='#000000'");
...
p2.println("</columnHeader>");
p2.println("<detail>");
p2.println("<band height='89'  isSplitAllowed='true' >");
p2.println("<textField isStretchWithOverflow='true' pattern='' isBlankWhenNull='false' evaluationTime='Now' hyperlinkType='None' >					<reportElement");
p2.println("mode='Transparent'");
p2.println("x='0'");
p2.println("y='0'");
p2.println("width='70'");
p2.println("height='85'");
p2.println("forecolor='#000000'");
p2.println("backcolor='#FFFFFF'");
...
x=90;y=0;x1=90;y1=0;c=(5+n+1);
for(int i=0;i<n;i++)//bigone
{
	for(int j=0;j<4;j++)//ver
	{
//			x = 90;
			for(int k=0;k<3;k++)//hor
			{
				ctextkey="c"+c;
				p2.println("<textField isStretchWithOverflow='false' pattern='' isBlankWhenNull='false' evaluationTime='Now' hyperlinkType='None' >					<reportElement");
				p2.println("mode='Opaque'");
...
x=(631-(180*(3-n)));y=0;x1=90;y1=0;c=(n*13+6);
for(int j=0;j<3;j++)
{
...
p2.println("<band height='7'  isSplitAllowed='true' >");
p2.println("</band>");
p2.println("</columnFooter>");
