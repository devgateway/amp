/*
 *   CalendarItemForm.java
 *   @Author Maka Kharalashvili maka@digijava.org
 * 	 Created: Nov 17, 2003
 * 	 CVS-ID: $Id: CalendarItemForm.java,v 1.1 2005-07-06 10:34:24 rahul Exp $
 *
...
//        preview = false;
    ...
    public ActionErrors validate(ActionMapping actionMapping,
        ...
        if ( (description == null) || (description.trim().length() == 0)) {
            if ( (sourceName == null) || (sourceName.trim().length() == 0)) {
                if ( (sourceUrl == null) || (sourceUrl.trim().length() == 0) ||
                    ...
                    errors.add(null,
                               new ActionError(
                        "error.calendar.itemDescrAndSourceEmpty"));

                }
                else {
                    errors.add(null,
                               new ActionError(
                        "error.calendar.itemSourceNameEmpty"));
                }
            }
            else {
                if ( (sourceUrl == null) || (sourceUrl.trim().length() == 0) ||
                    ...
                    errors.add(null,
                               new ActionError(
                        "error.calendar.itemSourceUrlEmpty"));
                }
            }
        ...
        if (populator.getStart().getTime().compareTo(populator.getEnd().getTime()) >= 0) {
            errors.add(null,
