/*
*   ShowUserDetails.java
*   @Author George Kvizhinadze gio@digijava.org
*   Created: Mar 15, 2004
*   CVS-ID: $Id: ShowUserDetails.java,v 1.1 2005-07-06 10:34:04 rahul Exp $
*
...
public class ShowUserDetails extends ForumAction {
    ...
    public ActionForward process(ActionMapping mapping,
        ...
        fUser = DbUtil.getForumUserItem(forumPageForm.getUserId());
