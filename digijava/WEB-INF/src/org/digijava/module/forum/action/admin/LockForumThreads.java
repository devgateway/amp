/*
 *   LockForumThreads.java
 *   @Author George Kvizhinadze gio@digijava.org
 *   Created: Mar 15, 2004
 *   CVS-ID: $Id: LockForumThreads.java,v 1.1 2005-07-06 10:34:07 rahul Exp $
 *
...
public class LockForumThreads extends Action  {
    public ActionForward execute(ActionMapping mapping,
        ...
        try {
            DbUtil.lockThreadList(lockThreadIds, true);
        }
