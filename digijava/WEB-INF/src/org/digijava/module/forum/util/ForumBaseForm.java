...
*   Created:
*   CVS-ID: $Id: ForumBaseForm.java,v 1.1 2005-07-06 10:34:19 rahul Exp $
*
...
public class ForumBaseForm
    ...
    public void setForumParams(Forum forum) {
        ...
        this.allowUnregisteredUserPost = forum.getAllowUnregisteredUserPost();
    }
    ...
    public void fillForum(Forum forum) {
        ...
        forum.setAllowUnregisteredUserPost(this.allowUnregisteredUserPost);
    }
    ...
    public void setPostParams (ForumPost post) {
        ...
        this.unregisteredEmail = post.getUnregisteredEmail();
        this.unregisteredFullName = post.getUnregisteredFullName();
    }
    ...
    public void fillPost (ForumPost post) {
        ...
        post.setUnregisteredEmail(this.unregisteredEmail);
        post.setUnregisteredFullName(this.unregisteredFullName);
    }

    public void setPMParams (ForumPrivateMessage pm) {
  ...
  public boolean isAllowUnregisteredUserPost() {
