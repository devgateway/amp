/*
 *   UnSubscribeTemporarly.java
 * 	 @Author Maka Kharalashvili maka@digijava.org
 * 	 Created: Sep 1, 2003
 * 	 CVS-ID: $Id: UnSubscribeTemporarly.java,v 1.1 2005-07-06 10:34:07 rahul Exp $
 *
...
public class UnSubscribeTemporarly
   ...
   public ActionForward execute(ActionMapping mapping,
       ...
       if (user!=null) {
           ...
           leaveUntil.set(java.util.Calendar.MONTH,Integer.parseInt(unsubscribeForm.getSelectedMonth()));
           leaveUntil.set(java.util.Calendar.DAY_OF_MONTH,Integer.parseInt(unsubscribeForm.getDay()));
           leaveUntil.set(java.util.Calendar.YEAR,Integer.parseInt(unsubscribeForm.getYear()));
