...
{
	<digi:context name="addUrl" property="context/module/moduleinstance/viewAmpActivityPreview.do" />
    document.aimAmpActivityForm.action = "<%=addUrl%>";
    document.aimAmpActivityForm.submit();
}
function open_dwin()
{
window.open("http://amp.ncb.ernet.in:8080/digijava/aim/addKnowledgeDocument.do","my_new_window","toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=yes, width=400, height=400")
}

function open_nwin()
{
window.open("http://amp.ncb.ernet.in:8080/digijava/aim/addKnowledgeNotes.do","my_new_window","toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=yes, width=400, height=400")
}

</script>
<digi:form action="/addAmpActivity.do" method="post">
...
<digi:errors/>
	...
	<tr><td width="25%" height="501">
		...
		<tr><td><b><digi:trn key="aim:addNewDocument">Add New Document :</digi:trn></b></td>
		<td><b><html:button property="button" value="Add_Document" onclick="open_dwin()" /></td></tr>
		<tr><td colspan=2>&nbsp;</td></tr>
		<tr><td colspan=2>&nbsp;</td></tr>
		
		<tr><td><b><digi:trn key="aim:addNewNotes">Add New Notes :</digi:trn></b></td>
		<td><b><html:button property="button" value="Add_Notes" onclick="open_nwin()" /></td></tr>

<tr><td><html:submit value="Preview" onclick="javascript:fnShowPreview()" /></td><td><html:submit value="Save"/></td></tr>
</table></td></tr>
