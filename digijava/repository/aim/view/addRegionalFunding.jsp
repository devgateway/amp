								...
								<td colspan="2" class="box-border-alt1">
										...
										<c:if test="${aimEditActivityForm.fundingRegionId != -1}">
											...
											<% String tNameBase = "comm_" + indexC + "_"; 
												...
												value="<c:out value="${comm.transactionDate}"/>" size="10"  class="inp-text">&nbsp;<a href=javascript:newWindow('<%=field4%>')><img src='../ampTemplate/images/show-calendar.gif' border='0'></a>&nbsp;<select name="<%=field5%>" value="<c:out value="${comm.perspectiveCode}"/>" class="inp-text">
								...
								<td colspan="2" class="box-border">
									...
									<div id="disb">
										<c:if test="${aimEditActivityForm.fundingRegionId != -1}">
											...
											<% String tNameBase = "disb_" + indexC + "_"; 
												String divName = "disb_" + indexC;
												indexC++;
												%>
												<% String field1 = tNameBase + "1"; 
												 String field2 = tNameBase + "2"; 
												...
												value="<c:out value="${comm.transactionDate}"/>" size="10"  class="inp-text">&nbsp;<a href=javascript:newWindow("<%=field4%>")><img src='../ampTemplate/images/show-calendar.gif' border='0'></a>&nbsp;<select name="<%=field5%>" 
												class="inp-text">
													<c:forEach var="pers" items="${aimEditActivityForm.perspectives}">
														<c:if test="${comm.perspectiveCode == pers.code}">
															<option selected="true" value="<c:out value="${pers.code}"/>">
								...
								<td colspan="2" class="box-border-alt1">
									...
									<div id="expn">
										<c:if test="${aimEditActivityForm.fundingRegionId != -1}">
											...
											<% String tNameBase = "expn_" + indexC + "_"; 
												String divName = "expn_" + indexC;
												indexC++;
												%>
												<% String field1 = tNameBase + "1"; 
												 String field2 = tNameBase + "2"; 
...
function addCommitments() {
	...
	s += "<a href=javascript:newWindow('comm_" + numComm + "_4')><img src='../ampTemplate/images/show-calendar.gif' border='0'></a>&nbsp;";
...
function addDisbursement() {
	...
	s += "<a href=javascript:newWindow('disb_" + numDisb + "_4')><img src='../ampTemplate/images/show-calendar.gif' border='0'></a>&nbsp;";
...
function addExpenditure() {
	...
	s += "<a href=javascript:newWindow('expn_" + numExpn + "_4')><img src='../ampTemplate/images/show-calendar.gif' border='0'></a>&nbsp;";
