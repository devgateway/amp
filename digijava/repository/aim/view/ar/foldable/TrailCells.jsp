...
<tr id='<bean:write name="reportData" property="absoluteReportName"/>' title='<bean:write name="reportData" property="levelDepth"/>' style="<%=display%>">
	<td style="border-style:solid; border-width:thin;  border-color:#BBBBBB; padding-left:<%=10*(reportData.getLevelDepth()-1)%>; background-color:<%= reportData.getLevelBkgColor() %>" colspan='<bean:write name="reportData" property="sourceColsCount"/>' nowrap>
...
<bean:write name="reportData" property="totalUniqueRows"/>
	...
	<logic:iterate name="reportData" property="trailCells" id="cell" scope="page">
		<td style="border-style:solid; border-width:thin;  border-color:#BBBBBB; background-color:<%= reportData.getLevelBkgColor() %>">
