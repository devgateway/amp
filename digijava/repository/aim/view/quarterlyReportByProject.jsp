...
//		document.aimMulitlateralbyDonorForm.target = popupPointer.name;
	...
	{
		<digi:context name="clearVal" property="context/module/moduleinstance/quarterlyReportByProject.do" />
		document.aimMulitlateralbyDonorForm.action = "<%= clearVal %>";
	...
	/* CSV function start  */
		...
		function popup_csv() {
		openResisableWindow(800, 600);
		<digi:context name="csv" property="context/module/moduleinstance/quarterlyReportByProjectCSV.do" />
	...
	function popup_xls() {
		openResisableWindow(800, 600);
		<digi:context name="xls" property="context/module/moduleinstance/quarterlyReportByProjectXls.do" />
	...
	<table width="100%"  border="0" cellpadding="5" cellspacing="0">
	     <tr>
			...
			<logic:notEmpty name="aimMulitlateralbyDonorForm" property="multiReport">
				...
				<digi:link href="/htmlQuarterlyReportByProject.do" target="_blank">
					Print
				</digi:link>
					</td>
				</tr>
...
<!-- CSV link -->
		...
		<digi:form action="/quarterlyReportByProject.do" >
			<tr>
			<td width="9"></td>
	...
	<logic:iterate name="multiReport"  property="donors" id="donors" type="org.digijava.module.aim.helper.AmpTeamDonors">
		...
		<tr bgcolor="#C9C9C7"><td>&nbsp;</td>
			...
			<td align="right" height="21"> <br>
				...
				<bean:write name="donors" property="donorPlannedDisbAmount"/></td>
				</logic:notEqual>
			<td align="right" height="21"><br>
