...
function restart() {
	var field = document.aimEditActivityForm.selectedDate.value;
	if (field == 1) {
		document.aimEditActivityForm.originalAppDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;
	} else if (field == 2) {
		document.aimEditActivityForm.revisedAppDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;
	} else if (field == 3) {
		document.aimEditActivityForm.originalStartDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;
	} else if (field == 4) {
		document.aimEditActivityForm.revisedStartDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;
	} else if (field == 5) {
		document.aimEditActivityForm.currentCompDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;
	} else if (field == 6) {
		document.aimEditActivityForm.revisedCompDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;		
	} else if (field == 7) {
		document.aimEditActivityForm.phyProgRepDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;
	} else if (field == 8) {
		document.aimEditActivityForm.componentRepDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;
	} else if (field == 9) {
		document.aimEditActivityForm.proposedCompDate.value = '' + padout(curr_day) + '/' + padout(curr_month - 0 + 1) + '/' + curr_year;	
	}
	calWindow.close();
}
