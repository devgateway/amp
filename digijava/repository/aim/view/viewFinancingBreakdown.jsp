			...
			<TABLE width="760" cellSpacing=3 cellPadding=3 vAlign="top" align="center" bgcolor="#f4f4f4">
            	...
            	<TD align=left>
						...
						<SPAN class=crumb>					
							...
							&nbsp;&gt;&nbsp;
							<logic:equal name="aimFinancingBreakdownForm" property="perspective" value="MA">
							<digi:trn key="aim:MOFEDPerspective">MOFED Perspective</digi:trn>
							</logic:equal>
							<logic:equal name="aimFinancingBreakdownForm" property="perspective" value="DN">
							<digi:trn key="aim:donorPerspective">Donor Perspective</digi:trn>
							</logic:equal>
						</SPAN>
								</TD>
								<TD align="right">
                     	...
                     	<logic:equal name="aimFinancingBreakdownForm" property="perspectivePresent" value="true">
                         	...
                         	<html:select property="currency" styleClass="dr-menu">
                       		<html:optionsCollection name="aimFinancingBreakdownForm" property="currencies" value="currencyCode" 
								...
								<html:select property="fiscalCalId" styleClass="dr-menu">
									<html:optionsCollection name="aimFinancingBreakdownForm" property="fiscalYears" value="ampFiscalCalId" label="name"/> 
								</html:select>
			               ...
			               <logic:equal name="aimFinancingBreakdownForm" property="yearRangePresent" value="true">
                    			...
                    			<STRONG>From</STRONG>&nbsp;
							      ...
							      <html:optionsCollection name="aimFinancingBreakdownForm" property="years" value="year" label="year"/>
									</html:select>&nbsp;&nbsp;
							      <STRONG>To</STRONG>&nbsp;
							...
							<TR>
                           	...
                           	<TR bgcolor="#F4F4F2"> 
                              	<TD bgcolor="#C9C9C7" class="box-title">&nbsp;&nbsp;
											<digi:trn key="aim:financingOverviewOfActivity">Financing Overview of Activity</digi:trn></TD>
							...
							<TR>
								<TD width="750" bgcolor="#F4F4F2" align="center" class="box-border-nopadding">
	                           	...
	                           	<TD><digi:trn key="aim:orgFundingId">Org Funding ID</digi:trn> </TD>
											<%--
	                          		<TD><digi:trn key="aim:goeId">GOE ID</digi:trn></TD>
											--%>
	                             	...
	                             	<TD><digi:trn key="aim:totalExpended">Total Expended</digi:trn></TD>
											...
											<%--
											<TD><digi:trn key="aim:signatureDate">Signature Date</digi:trn></TD>
                              	<TD><digi:trn key="aim:actualStartDate">Actual Start Date</digi:trn></TD>
                              	<TD><digi:trn key="aim:closingDate">Closing Date</digi:trn></TD>
											--%>
										</TR>
						...
						<bean:define id="translation">
							<digi:trn key="aim:clickToViewFinancialOverview">Click here to view Financial Overview</digi:trn>
						                  ...
						                  <digi:link href="/viewFinancialOverview.do" name="urlFinancialOverview" title="<%=translation%>" >
											...
											<%--
					                  <TD><bean:write name="breakdown" property="goeId" /></TD>
											--%>
					                  ...
					                  <TD align="right"><bean:write name="breakdown" property="unExpended"/></TD>
											<%--
					                  <TD align="left"><bean:write name="breakdown" property="signatureDate"/></TD>
					                  <TD><bean:write name="breakdown" property="actualStartDate"/></TD>
					                  <TD><bean:write name="breakdown" property="actualCompletionDate"/></TD>
											--%>
										</TR>
										</logic:iterate>
										</logic:notEmpty>
