...
<c:if test="${calendarViewForm.view != 'custom'}">
    <table border="0" width="100%" style="BORDER-LEFT: #484846 2px solid; BORDER-RIGHT: #484846 2px solid;">
        <tr>
            <td>
    ...
    <table border="0" width="100%" style="border:2px solid; border-color: #484846; border-bottom:none">
