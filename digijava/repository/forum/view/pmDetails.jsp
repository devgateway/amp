...
<script language="JavaScript">
	...
	function showPreview() {
		<bean:define id="userId" name="forumPageForm" property="userId"/>
      <digi:context name="showPreview" property="context/module/moduleinstance/showPmDetails.do" />
      document.forumPageForm.action = "<%= showPreview + "?userId=" + String.valueOf(userId) %>";
      document.forumPageForm.submit();
	}

	function sendPm() {
      <digi:context name="sendPm" property="context/module/moduleinstance/sendPm.do" />
      document.forumPageForm.action = "<%= sendPm %>";
      document.forumPageForm.submit();
	}
	...
	function showFindUser() {
	  ...
	  openNewWindow(320, 200);
	     <digi:context name="findUser" property="context/module/moduleinstance/showFindUser.do" />
...
<digi:form action="/showPmDetails.do">
<html:hidden name="forumPageForm" property="userId"/>
<html:hidden name="forumPageForm" property="pmId"/>
	...
	<table class="forumListContainer" width="100%" cellpadding="3" cellspacing="0" border="1">
		<tr>
			<th colspan="2" align="center" class="groupHeader" width="70%" nowrap>
				<digi:trn key="forum:privateMsgTo">Private message to</digi:trn>&nbsp; <bean:write name="forumPageForm" property="nickName"/>
			</th>
		</tr>
		<logic:equal name="forumPageForm" property="pmId" value="0">
		<tr>
			<td class="light" width="20%">
			<digi:trn key="forum:findUser">Find user</digi:trn>
			</td>
			<td class="dark" width="80%">
				<html:text name="forumPageForm" property="nickName" styleClass="forumControls" size="70"/>
				<input type="button" class="forumButtons" value="find" onclick="showFindUser()">
			</td>
		</tr>
		</logic:equal>
				<tr>
