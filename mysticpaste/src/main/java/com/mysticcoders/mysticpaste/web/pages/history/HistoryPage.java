...
public class HistoryPage extends BasePage {
    ...
    public HistoryPage() {
        ...
        add(historyDataView = new DataView<PasteItem>("history", historyDataProvider, 10) {
            protected void populateItem(Item<PasteItem> item) {
                ...
                item.add(new HighlighterPanel("content", new PropertyModel<String>(pasteItem, "previewContent"), pasteItem.getType()));
