...
UPDATE amp_eu_activity_contributions eu_con, amp_modality md, amp_category_value acv SET eu_con.financing_type_categ_val_id = acv.id 
	WHERE md.name = acv.category_value AND eu_con.financing_type_id = md.amp_modality_id;
