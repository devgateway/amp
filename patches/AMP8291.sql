...
INSERT INTO amp_columns (columnId,columnName,aliasName,cellType,extractorView) VALUES 
 (139,'Proposed Start Date','proposedStartDate','org.dgfoundation.amp.ar.cell.DateCell','v_proposed_start_date');
...
INSERT INTO amp_columns (columnId,columnName,aliasName,cellType,extractorView) VALUES 
 (140,'Final Date for Disbursements','disbursementsDate','org.dgfoundation.amp.ar.cell.DateCell','v_disbursements_date');
...
INSERT INTO amp_columns (columnId,columnName,aliasName,cellType,extractorView) VALUES 
 (141,'Final Date for Contracting','contractingDate','org.dgfoundation.amp.ar.cell.DateCell','v_contracting_date');
...
INSERT INTO amp_columns (columnId,columnName,aliasName,cellType,extractorView) VALUES 
 (142,'Final Date for Disbursements Comments','disbursementsDateComments','org.dgfoundation.amp.ar.cell.TextCell','v_disbursements_date_comments');

INSERT INTO amp_columns (columnId,columnName,aliasName,cellType,extractorView) VALUES 
 (143,'Current Completion Date Comments','currentCompletionDateComments','org.dgfoundation.amp.ar.cell.TextCell','v_actual_completion_date_comments');
