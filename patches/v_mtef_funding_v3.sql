...
getExchange(c.currency_code,m.projection_date) AS exchange_rate, org.name as donor_name,org.amp_org_id as org_id, 
	grp.org_grp_name as org_grp_name, grp.amp_org_grp_id as org_grp_id, 
	otype.org_type as donor_type_name, otype.amp_org_type_id as org_type_id, 
  tos.category_value  as terms_assist_name, tos.id as terms_assist_id,
