...
<tr>
	<c:if test="${reportData.levelDepth == 1}">
		<td nowrap="nowrap" style="border-bottom:#E2E2E2 1px solid;border-right:#E2E2E2 1px solid;" height="20px" colspan='<bean:write name="reportData" property="sourceColsCount"/>'>
		<span style="font-family: Arial;color:black; font-weight: bold;font-size: 14px;margin-left: 2px">
				<digi:trn key="rep:popup:reporttotals ">Report Totals:</digi:trn>
			</span>
	</c:if>
	
	<c:if test="${reportData.levelDepth == 2}">
		<td nowrap="nowrap" style="background:#99CCFF; border-bottom: #E2E2E2 1px solid;" height="19px" title='<bean:write name="reportData" property="repName"/>' colspan='<bean:write name="reportData" property="sourceColsCount"/>'>
	...
	<c:if test="${reportData.levelDepth == 3}">
		<td nowrap="nowrap" style="border-bottom:#E2E2E2 1px solid;border-right:#E2E2E2 1px solid" height="19px" colspan='<bean:write name="reportData" property="sourceColsCount"/>'>
	...
	<logic:iterate name="reportData" property="trailCells" id="cell" scope="page">
		<c:if test="${reportData.levelDepth == 1}">
			<td align="center" height="21px" style="border-bottom: #E0E0E0 1px solid;border-right: #E0E0E0 1px solid;font-family: Arial;font-weight: bold">
		</c:if>
		<c:if test="${reportData.levelDepth == 2}">
			<td height="19px" style="background:#99CCFF;font-weight: bold;font-family: Arial;">
		</c:if>  
		<c:if test="${reportData.levelDepth > 2}">
			<td height="19px" style="border-bottom: #E2E2E2 1px solid;border-right: #E2E2E2 1px solid">
		</c:if>  
