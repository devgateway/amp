...
<digi:form action="/editCurrency.do" method="post">

<html:hidden property="currencyId" />
<html:hidden property="currencyRateId" />
			...
			<table cellPadding=5 cellSpacing=0 width="100%">
				<tr>
					...
					<td height=33><span class=crumb>
						...
						<digi:trn key="aim:editCurrency">Edit Currency</digi:trn>	
					</td>
					<!-- End navigation -->
				</tr>
				<tr>
												...
												<table border=0 cellPadding=1 cellSpacing=1 class=box-border width="100%">
													...
													<tr bgColor=#dddddb>
														...
														<td height=20 bgColor=#dddddb align="center" colspan="5"><B>
															<digi:trn key="aim:editCurrency">Edit Currency</digi:trn></B>
														</td>
														<!-- end header -->
													</tr>
													<!-- Page Logic -->
																		...
																		<table width="100%" cellspacing="5">
																			<tr>
																				...
																				<td width="50%" align="left">
																					<html:reset value="Cancel" styleClass="dr-menu"  onclick="javascript:history.go(-1)"/></td></tr>
																		</table>
																	</td>
																</tr>
															</table>
