...
<digi:form action="/editIPAContract.do" method="post">
	...
	<table width="500px" border="0" cellspacing="2" cellpadding="2"
		...
		<tr>
			<td colspan="2" bgcolor="#006699" class="textalb" align="center">
		...
		<field:display name="Contract Name" feature="Contracting">
			<tr>
				<td align="left" nowrap><FONT color=red>*</FONT> <digi:trn
					key="aim:IPA:newPopup:name">Contract Name</digi:trn></td>
				<td><html:text property="contractName" size="47" /></td>
			</tr>
		</field:display>
		<field:display name="Contract Description" feature="Contracting">
			<tr>
				<td align="left" valign="top" nowrap><digi:trn
					key="aim:IPA:newPopup:description">Contract Description</digi:trn>
				</td>
				<td><html:textarea property="description" rows="5" cols="30"
		...
		<field:display name="Contracting Activity Category"
			...
			<tr>
				...
				<td colspan="2"><field:display
					name="Contracting IPA Activity Category" feature="Contracting">
					<digi:trn key="aim:IPA:newPopup:actCat">Activity Category</digi:trn>&nbsp;&nbsp;
				<category:showoptions name="aimIPAContractForm"
						property="activityCategoryId"
						keyName="<%= org.digijava.module.categorymanager.util.CategoryConstants.IPA_ACTIVITY_CATEGORY_KEY %>"
						styleClass="inp-text" />
				
				&nbsp;&nbsp;&nbsp;
			</field:display> <field:display name="Contracting IPA Contract Type"
					feature="Contracting">
					<digi:trn key="aim:IPA:newPopup:contractType">Contract Type</digi:trn>
				&nbsp;&nbsp;
	
				<category:showoptions name="aimIPAContractForm"
						property="contractTypeId"
						keyName="<%= org.digijava.module.categorymanager.util.CategoryConstants.IPA_TYPE_KEY %>"
						styleClass="inp-text" />
	
				&nbsp;&nbsp;&nbsp;
			</field:display> <field:display name="Contracting IPA Activity Type"
					feature="Contracting">
		...
		<tr>
			<td id="calendarPosition" colspan="2" bgcolor="#006699"
				class="textalb" align="center"><b><digi:trn
				key="aim:IPA:newPopup:details">Details</digi:trn></b></td>
		</tr>
			...
			<table cellpadding="2" cellspacing="2" width="100%" border="0">
				<tr>
					<field:display name="Contracting Start of Tendering"
						feature="Contracting">
						<td align="left"><digi:trn key="aim:IPA:newPopup">Start of Tendering</digi:trn>
						</td>
						<td align="left"><html:text readonly="true" size="9"
							property="startOfTendering" styleClass="inp-text"
							styleId="startOfTendering" /> <a id="startOfTenderingDate"
							href='javascript:pickDateByIdDxDyWOScroll("newmyContract","startOfTendering",-250,-250)'>
						<img src="../ampTemplate/images/show-calendar.gif"
							alt="Click to View Calendar" border=0> </a></td>
					</field:display>

					<field:display name="Contract Validity Date" feature="Contracting">
						<td align="left"><digi:trn
							key="aim:IPA:newPopup:contractValidityDate">Contract Validity Date</digi:trn>
						</td>
						<td align="left"><html:text readonly="true" size="9"
							property="contractValidity" styleClass="inp-text"
							styleId="contractValidity" /> <a id="contractValidityDate"
							href='javascript:pickDateByIdDxDyWOScroll("newmyContract","contractValidity",-450,-250)'>
						<img src="../ampTemplate/images/show-calendar.gif"
							alt="Click to View Calendar" border=0> </a></td>
					</field:display>
				</tr>
				<tr>
					<field:display name="Contracting Tab Status" feature="Contracting">
						<td align="left"><digi:trn key="aim:IPA:newPopup:status">Status</digi:trn>
						</td>
						<td align="left"><category:showoptions
							name="aimIPAContractForm" property="statusId"
				...
				<tr>
					<field:display name="Signature of Contract" feature="Contracting">
						<td align="left"><digi:trn
							key="aim:IPA:newPopup:signatureOfContract">Signature of Contract</digi:trn>
						</td>
						<td align="left"><html:text readonly="true" size="9"
							property="signatureOfContract" styleClass="inp-text"
							styleId="signatureOfContract" /> <a id="signatureOfContractDate"
							href='javascript:pickDateByIdDxDyWOScroll("newmyContract","signatureOfContract",-250,-270)'>
						<img src="../ampTemplate/images/show-calendar.gif"
							alt="Click to View Calendar" border=0> </a></td>
					</field:display>
					<field:display name="Contract Completion" feature="Contracting">
						<td align="left"><digi:trn
							key="aim:IPA:newPopup:contractCompletion">Contract Completion</digi:trn>
						</td>
						<td align="left"><html:text readonly="true" size="9"
							property="contractCompletion" styleClass="inp-text"
							styleId="contractCompletion" /> <a id="contractCompletionDate"
							href='javascript:pickDateByIdDxDyWOScroll("newmyContract","contractCompletion",-450,-270)'>
						<img src="../ampTemplate/images/show-calendar.gif"
							alt="Click to View Calendar" border=0> </a></td>
					</field:display>
				</tr>
				...
				<field:display name="Contracting Contractor Name"
					...
					<tr>
						<td align="left"><digi:trn
							key="aim:IPA:newPopup:contractingContractorName">Contractor Name</digi:trn>
						</td>
						<td colspan="5" align="left"><html:text
							property="contractingOrganizationText" size="50"
							styleClass="inp-text" /></td>
					</tr>
				</field:display>
			</table>
		...
		<tr>
			<td colspan="2" align="left"><field:display
				name="Contract Organization" feature="Contracting">
				<aim:addOrganizationButton form="${aimIPAContractForm}"
					collection="organisations" refreshParentDocument="false"
					callBackFunction="orgsAdded()" useClient="false"
					styleClass="dr-menu">
				...
				<c:if test="${!empty aimIPAContractForm.organisations}">
					<html:button styleClass="dr-menu" property="deleteOrgs"
						onclick="delOrgs();">
		...
		<tr>
			...
			<table>
				<c:forEach items="${aimIPAContractForm.organisations}"
					var="selectedOrganizations" varStatus="selIdx">
					<c:if test="${!empty selectedOrganizations.ampOrgId}">
						<tr>
							<td align="left" width=3><html:multibox property="selOrgs">
								<c:out value="${selIdx.count}" />
							</html:multibox></td>
							<td align="left" width="367"><c:out
								value="${selectedOrganizations.name}" /></td>
						</tr>
					</c:if>
				</c:forEach>
			</table>
		...
		<tr>
			...
			<table cellpadding="2" cellspacing="2" width="100%">
				<field:display name="Contracting Amendments" feature="Contracting">
					<tr>
						<td align="left"><digi:trn>Montant</digi:trn></td>
						<td align="left"><html:text
							property="donorContractFundinAmount" style="text-align:right"
							onkeyup="calculer1()" /></td>
						<td align="left" colspan="4"><digi:trn>Devise</digi:trn>
						&nbsp;&nbsp; <html:select property="donorContractFundingCurrency"
							styleClass="inp-text" onchange="miseajourdevise();">
							<html:optionsCollection name="aimIPAContractForm"
								property="currencies" value="currencyCode" label="currencyName" />
						</html:select> <!--					<html:select property="donorContractFundingCurrency" styleClass="inp-text" onchange="miseajourdevise();">-->
		...
		<tr>
			...
			<table cellpadding="2" cellspacing="2" width="100%">
				...
				<field:display name="Contract Total Value" feature="Contracting">
					<tr>
						<td align="left"><digi:trn
							key="aim:ipa:newPopup:contractTotalValue">Contract Total Value</digi:trn>
						</td>
						<td align="left"><c:set var="trnSum">
							<digi:trn key="aim:addNumericValueErrorMessage">
							Please enter the amount
						</digi:trn>
						</c:set> <html:text title="${trnSum}" property="contractTotalValue"
							style="text-align:right" onkeyup="fnChk1(this)" /></td>
						<td align="left" colspan="4"><digi:trn
							key="aim:ipa:newPopup:currencyType">Currency Type</digi:trn>
						&nbsp;&nbsp; <html:select property="totalAmountCurrency"
							styleClass="inp-text">
							<option value="-1"><digi:trn
								key="aim:addEditActivityCurrency">Currency</digi:trn></option>
							<html:optionsCollection name="aimIPAContractForm"
								property="currencies" value="ampCurrencyId" label="currencyName" />
						</html:select></td>
					</tr>
				</field:display>
				...
				<field:display name="Contracting Total Amount" feature="Contracting">
					<tr>
						<td align="left"><digi:trn key="aim:ipa:newPopup:totalAmount">Total Amount</digi:trn>
						</td>
						<td align="left"><c:set var="trnAutosum">
							<digi:trn key="aim:addNumericValueErrorMessage">
							This amount will auto-calculate!
						</digi:trn>
						</c:set> <html:text readonly="true" title="${trnAutosum}"
							property="totalAmount" style="text-align:right"
							onkeyup="fnChk(this)" /></td>
						<td align="left" colspan="4"><digi:trn
							key="aim:ipa:newPopup:currencyType">Currency Type</digi:trn>
						&nbsp;&nbsp; <html:select property="totalAmountCurrency"
							styleClass="inp-text">
				...
				<field:display name="Total EC Contribution" feature="Contracting">
					<tr>
						<td colspan="6" align="center"><b><digi:trn
							key="aim:ipa:newPopup:totalECContribution">Total EC Contribution</digi:trn></b>
						</td>
					</tr>
					<tr>
						<field:display name="Contracting IB" feature="Contracting">
							<td align="left"><digi:trn key="aim:ipa:newPopup:ib">IB</digi:trn>
							</td>
							<td align="left"><html:text
								property="totalECContribIBAmount" style="text-align:right"
								onkeyup="fnChk(this)" /></td>
							<td align="left"><html:text readonly="true" size="9"
								styleClass="inp-text" styleId="fdate1"
								property="totalECContribIBAmountDate" /> <a id="fimage1"
								href='javascript:pickDateByIdDxDyWOScroll("newmyContract","fdate1",-250,-230)'>
							<img src="../ampTemplate/images/show-calendar.gif"
								alt="Click to View Calendar" border=0> </a></td>
						</field:display>

						<field:display name="Contracting INV" feature="Contracting">
							<td align="left"><digi:trn key="aim:ipa:newPopup:inv">INV</digi:trn>
							</td>
							<td align="left"><html:text
								property="totalECContribINVAmount" style="text-align:right"
								onkeyup="fnChk(this)" /></td>
							<td align="left"><html:text readonly="true" size="9"
								styleClass="inp-text" styleId="fdate2"
								property="totalECContribINVAmountDate" /> <a
								href='javascript:pickDateByIdDxDyWOScroll("newmyContract","fdate2",-250,-230)'>
							<img src="../ampTemplate/images/show-calendar.gif"
								alt="Click to View Calendar" border=0> </a></td>
						</field:display>
					</tr>
				</field:display>
				<field:display name="Contracting Total National Contribution"
					feature="Contracting">
					<tr>
						<td align="center" colspan="6"><b><digi:trn
							key="aim:IPA:newPopup:totalNationalContribution">Total National Contribution</digi:trn></b>
						</td>
					</tr>
					<tr>
						<field:display name="Contracting Central Amount"
							feature="Contracting">
							<td align="left"><digi:trn key="aim:ipa:newPopup:central">Central</digi:trn>
							</td>
							<td align="left"><html:text
								property="totalNationalContribCentralAmount"
								style="text-align:right" onkeyup="fnChk(this)" /></td>
							<td align="left"><html:text readonly="true" size="9"
								styleClass="inp-text" styleId="fdate3"
								property="totalNationalContribCentralAmountDate" /> <a
								href='javascript:pickDateByIdDxDyWOScroll("newmyContract","fdate3",-250,-230)'>
							<img src="../ampTemplate/images/show-calendar.gif"
								alt="Click to View Calendar" border=0> </a></td>
						</field:display>

						<field:display name="Contracting IFIs" feature="Contracting">
							<td align="left"><digi:trn key="aim:ipa:newPopup:ifis">IFIs</digi:trn>
							</td>
							<td align="left"><html:text
								property="totalNationalContribIFIAmount"
								style="text-align:right" onkeyup="fnChk(this)" /></td>
							<td align="left"><html:text readonly="true" size="9"
								styleClass="inp-text" styleId="fdate4"
								property="totalNationalContribIFIAmountDate" /> <a
								href='javascript:pickDateByIdDxDyWOScroll("newmyContract","fdate4",-250,-230)'>
							<img src="../ampTemplate/images/show-calendar.gif"
								alt="Click to View Calendar" border=0> </a></td>
						</field:display>
					</tr>
					...
					<tr>
						<field:display name="Contracting Regional Amount"
							feature="Contracting">
							<td align="left"><digi:trn key="aim:ipa:newPopup:regional">Regional</digi:trn>
							</td>
							<td align="left"><html:text
								property="totalNationalContribRegionalAmount"
								style="text-align:right" onkeyup="fnChk(this)" /></td>
							<td align="left"><html:text readonly="true" size="9"
								styleClass="inp-text" styleId="fdate5"
								property="totalNationalContribRegionalAmountDate" /> <a
								href='javascript:pickDateByIdDxDyWOScroll("newmyContract","fdate5",-250,-230)'>
							<img src="../ampTemplate/images/show-calendar.gif"
								alt="Click to View Calendar" border=0> </a></td>
						</field:display>
					</tr>
				...
				<field:display name="Total Private Contribution"
					...
					<tr>
						<td align="center" colspan="6"><b><digi:trn
							key="aim:IPA:newPopup:totalPrivateContribution">Total Private Contribution</digi:trn></b>
						</td>
					</tr>
					<tr>
						<td align="left"><digi:trn key="aim:ipa:newPopup:ib">IB</digi:trn>
						...
						<td align="left"><html:text
							property="totalPrivateContribAmount" style="text-align:right"
							onkeyup="fnChk(this)" /></td>
						<td align="left"><html:text readonly="true" size="9"
							styleClass="inp-text" styleId="fdate6"
							property="totalPrivateContribAmountDate" /> <a
							href='javascript:pickDateByIdDxDyWOScroll("newmyContract","fdate6",-250,-230)'>
						<img src="../ampTemplate/images/show-calendar.gif"
							alt="Click to View Calendar" border=0> </a></td>
					</tr>
				</field:display>
		...
		<field:display name="Contract Donor Disbursements"
			feature="Contracting">
			<logic:notEmpty name="aimIPAContractForm"
				property="fundingDetailsLinked">
				<tr>
					<td colspan="2">
					<table width="100%">
						<tr>
							<th><field:display name="Adjustment Type Disbursement"
								feature="Disbursement">
								<digi:trn key="aim:adjustmentTyeDisbursement">Adjustment Type Disbursement</digi:trn>
							</field:display></th>
							<th><field:display name="Amount Disbursement"
								feature="Disbursement">
								<digi:trn key="aim:amountDisbursement">Amount Disbursement</digi:trn>
							</field:display></th>
							<th><field:display name="Currency Disbursement"
								feature="Disbursement">
								<digi:trn key="aim:currencyDisbursement">Currency Disbursement</digi:trn>
							</field:display></th>
							<th><field:display name="Date Disbursement"
								feature="Disbursement">
								<digi:trn key="aim:dateDisbursement">Date Disbursement</digi:trn>
							</field:display></th>

						</tr>
						<logic:iterate name="aimIPAContractForm"
							property="fundingDetailsLinked" id="fundingDetail"
							type="org.digijava.module.aim.helper.FundingDetail">
							<logic:equal name="fundingDetail" property="transactionType"
								value="1">
								<tr bgcolor="#ffffff">
									<td align="center"><field:display
										name="Adjustment Type Disbursement" feature="Disbursement">
										<digi:trn
									...
									<td align="center"><field:display
										name="Amount Disbursement" feature="Disbursement">
										<FONT color=blue>*</FONT>
										<bean:write name="fundingDetail" property="transactionAmount" />&nbsp;
																											</field:display></td>
									<td align="center"><field:display
										name="Currency Disbursement" feature="Disbursement">
										<bean:write name="fundingDetail" property="currencyCode" />
									</field:display></td>
									<td align="center"><field:display name="Date Disbursement"
										feature="Disbursement">
		...
		<field:display name="Contracting Disbursements" feature="Contracting">
			<tr>
				<td colspan="2" align="left"><field:display
					name="Contracting Add Disbursement" feature="Contracting">
					<html:button styleClass="dr-menu" property="adddisb"
						onclick="addDisb()">
						<digi:trn key="aim:IPA:newPopup:addDisbursement">Add Disbursement</digi:trn>
					</html:button>
				</field:display> &nbsp; <field:display name="Contracting Remove Disbursements"
					feature="Contracting">
					<c:if test="${!empty aimIPAContractForm.contractDisbursements}">
						<html:button styleClass="dr-menu" property="deldisbursement"
							onclick="delDisb();">
		...
		<field:display name="Contracting Disbursements Global Currency"
			feature="Contracting">
			<tr>
				<td colspan="2">
				<table width="100%">
					<tr>
						<td align="left" width="30%"><digi:trn
							key="aim:ipa:newPopup:dibusrsementsGlobalCurrency">Disbursements Global Currency</digi:trn>
						</td>
						<td align="left"><html:select
							property="dibusrsementsGlobalCurrency" styleClass="inp-text">
							<option value="-1"><digi:trn
								key="aim:addEditActivityCurrency">Currency</digi:trn></option>
							<html:optionsCollection name="aimIPAContractForm"
								property="currencies" value="ampCurrencyId" label="currencyName" />
		...
		<field:display name="Contracting Disbursements" feature="Contracting">
			<logic:notEmpty name="aimIPAContractForm"
				property="contractDisbursements">
				<tr>
					<td colspan="2">
					<table id="ContractDisbursmentsList">
						<c:forEach items="${aimIPAContractForm.contractDisbursements}"
							var="contractDisbursement" varStatus="idx">
							<tr>
								<td align="left" colspan="2"><html:hidden
									property="${contractDisbursement}" value="${id}" /> &nbsp; <html:multibox
									property="selContractDisbursements" value="${idx.count}" /> <html:select
									indexed="true" name="contractDisbursement"
									property="adjustmentType">
									<html:option value="0">
										<digi:trn key="aim:ipa:popup:actual"> Actual</digi:trn>
									</html:option>
									<html:option value="1">
										<digi:trn key="aim:ipa:popup:planned">Planned</digi:trn>
									</html:option>
								</html:select> &nbsp; <html:text indexed="true" name="contractDisbursement"
									property="amount" onkeyup="fnChk(this)">
									<digi:trn key="aim:ipa:popup:amount">Amount</digi:trn>
								</html:text> &nbsp; <html:select name="contractDisbursement" indexed="true"
									property="currCode" styleClass="inp-text">
									<html:optionsCollection name="aimIPAContractForm"
										property="currencies" value="currencyCode"
										label="currencyName" />
								</html:select> &nbsp; <html:text readonly="true" size="9" indexed="true"
									name="contractDisbursement" property="disbDate"
									styleClass="inp-text" styleId="date${idx.count}" /> <a
									id="image${idx.count}"
									href='javascript:pickDateByIdDxDyWOScroll("newmyContract","date${idx.count}",-250,-230)'>
								<img src="../ampTemplate/images/show-calendar.gif"
									alt="Click to View Calendar" border=0> </a></td>
							</tr>
						</c:forEach>
		...
		<tr>
			<td colspan="2" bgcolor="#006699" class="textalb" align="center">
			<b><digi:trn>Amendments</digi:trn></b></td>
		</tr>
		<field:display name="Contracting Amendments" feature="Contracting">
			<tr>
				<td colspan="2" align="left"><field:display
					name="Contracting Add Amendments" feature="Contracting">
					<html:button styleClass="dr-menu" property="addamendments"
						onclick="addAmendment();">
						<digi:trn>Add Amendments</digi:trn>
					</html:button>
				</field:display> &nbsp; <field:display name="Contracting Remove Amendments"
					feature="Contracting">
					<c:if test="${!empty aimIPAContractForm.contractAmendments}">
						<html:button styleClass="dr-menu" property="delamendments"
							onclick="delAmendment();calculer1();">
		...
		<field:display name="Contracting Amendments" feature="Contracting">
			<logic:notEmpty name="aimIPAContractForm"
				property="contractAmendments">
				<tr>
					<td colspan="2">
					<table id="ContractAmendmentsList">
						<c:forEach items="${aimIPAContractForm.contractAmendments}"
							var="contractAmendment" varStatus="idx">
							<tr>
								<td align="left" colspan="2"><html:hidden
									property="${contractAmendment}" value="${id}" /> &nbsp; <html:multibox
									property="selContractAmendments" value="${idx.count}" /> <html:text
									indexed="true" name="contractAmendment" property="amount"
									onkeyup="fnChk(this);calculer1();">
									<digi:trn key="aim:ipa:popup:amount">Amount</digi:trn>
								</html:text> &nbsp; <html:select indexed="true" name="contractAmendment"
									disabled="true" property="currCode" styleClass="inp-text">
									<html:optionsCollection name="aimIPAContractForm"
										property="currencies" value="currencyCode"
										label="currencyName" />
								</html:select> &nbsp; <html:text readonly="true" size="9" indexed="true"
									name="contractAmendment" property="amendDate"
									styleClass="inp-text" styleId="date${idx.count}" /> <a
									id="image${idx.count}"
									href='javascript:pickDateByIdDxDyWOScroll("newmyContract","date${idx.count}",-250,-230)'>
								<img src="../ampTemplate/images/show-calendar.gif"
									alt="Click to View Calendar" border=0> </a> &nbsp; <digi:trn>Reference:</digi:trn>&nbsp;<html:text
									size="12" indexed="true" name="contractAmendment"
									property="reference" styleClass="inp-text" /></td>
							</tr>
						</c:forEach>
					</table>
					</td>
		...
		<tr>
			...
			<table cellpadding="2" cellspacing="2" width="50%">
				<field:display name="Contracting Amendments" feature="Contracting">
					<tr>
						<td align="left" colspan="2"><digi:trn>Montant total du contrat part du bailleur</digi:trn>
						</td>
					</tr>
					<tr>
						<td align="left"><html:text
							property="totAmountDonorContractFunding" style="text-align:right"
							readonly="true" /></td>
						<td align="left"><html:select disabled="true"
							property="totalAmountCurrencyDonor" styleClass="inp-text">
							<html:optionsCollection name="aimIPAContractForm"
								property="currencies" value="currencyCode" label="currencyName" />
						</html:select></td>
					</tr>
			...
			<table cellpadding="2" cellspacing="2" width="50%">
				<field:display name="Contracting Amendments" feature="Contracting">
					<tr>
						<td align="left" colspan="2"><digi:trn>Montant total du contrat comprise la part de l'Etat</digi:trn>
						</td>
					</tr>
					<tr>
						<td align="left"><html:text
							property="totAmountCountryContractFunding"
							style="text-align:right" /></td>
						<td align="left"><html:select disabled="true"
							property="totalAmountCurrencyCountry" styleClass="inp-text">
							<html:optionsCollection name="aimIPAContractForm"
								property="currencies" value="currencyCode" label="currencyName" />
						</html:select></td>
					</tr>
		...
		<tr>
			<td colspan="2" align="center"><field:display
				name="Contracting Save Button" feature="Contracting">
				<html:button property="submit" styleClass="dr-menu"
					onclick="validate()">
					<digi:trn key="aim:save">Save</digi:trn>
				</html:button>
			</field:display> &nbsp;&nbsp; <field:display name="Contracting Cancel Saving"
				feature="Contracting">
				<html:button styleClass="dr-menu" property="cancel"
					onclick="hideAddContract()">
