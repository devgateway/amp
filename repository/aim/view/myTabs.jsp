...
<ul id="MyTabs" class="shadeTabs">
	<logic:iterate name="myReports" id="report" scope="session" type="org.digijava.module.aim.dbentity.AmpReports"> 
				...
				<li><a id='Tab-${report.name}' href="/aim/viewNewAdvancedReport.do~view=reset~viewFormat=foldable~ampReportId=<bean:write name="report" property="ampReportId"/>~widget=true" rel="ajaxcontentarea"><digi:trn key="aim:clickreport:tabs:${report.name}">${report.name}</digi:trn></a></li>
				</logic:equal>
	</logic:iterate>
<!-- 
