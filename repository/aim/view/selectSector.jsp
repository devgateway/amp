											...
											<table cellPadding=5>
												<tr>
													<td> 
														...
														<html:button styleClass="dr-menu"  property="addButton" onclick="buttonAdd()" styleId="addSectorBtn">
						...
						<tr>
							<td align="center" bgcolor=#ECF3FD>
								<table cellSpacing=2 cellPadding=2>
									...
									<tr>
										<td align="center" colspan=2>
											<html:button  styleClass="dr-menu" property="submitButton" onclick="return searchSector()" styleId="seachSectorBtn">
