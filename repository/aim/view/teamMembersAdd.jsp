	...
	<tr>
		...
		<td align=left vAlign=top width=750>
			...
			<table cellPadding=5 cellSpacing=0 width="100%">
				<tr>
					<td height=33>
						<span class="crumb">
							...
							<c:set var="translation">
								<digi:trn>Click here to view Workspace Members</digi:trn>
							</c:set>
							<digi:link href="/teamMemberList.do" styleClass="comment" title="${translation}" >
								<digi:trn>Workspace Members</digi:trn>
							</digi:link>&nbsp;&gt;&nbsp;					
				...
				<tr>
					<td height=16 vAlign=center width=571><span class=subtitle-blue><digi:trn>Team Workspace Setup</digi:trn></span>
					</td>
				</tr>
				<tr>
