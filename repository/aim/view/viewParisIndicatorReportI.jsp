...
<!--
	...
	function openPrinter(){
		...
		window.open('/aim/parisIndicatorReport.do~indcId='+val+'~reset=true~print=true','mywindow','toolbar=no,location=no,directories=no,status=no,menubar=yes,scrollbars=yes,copyhistory=yes,resizable=yes');
