...
var separator = "<%=org.digijava.kernel.util.DgUtil.getParamSeparator()%>";
	...
	function changeItemStatus (newStatus) {
      ...
      document.cmsContentItemForm.action = "<%= changeItemStatus %>" + "?itemStatus=" + newStatus;
...
<digi:form action="/viewContentItems.do">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td width="99%" class="mainHeader" align="center" valign="middle">
					<digi:trn key="cms:administer">Administer</digi:trn>
				</td>
...
<br>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<logic:iterate indexId="index" id="tab" name="tabList" type="org.digijava.module.cms.util.CmsTabItem">
					...
					<logic:notEqual name="tab" property="active" value="true">
						<td class="inactiveTab" nowrap>&nbsp;<digi:link styleClass="cmsCategory" href="<%= "/viewContentItems.do?viewMode=" + tab.getNavigationParam() %>"><bean:write name="tab" property="caprionKey"/></digi:link>&nbsp;</td>
					</logic:notEqual>
			...
			<tr>
				...
				<tr>
					<td class="itemRowSeparator" colspan="6"><digi:img src="module/cms/images/tree/spacer.gif" height="2" border="0"/></td>
				</tr>
				 <tr>
				    <th class="itemHeader">
					   &nbsp;
				...
				<tr>
				 ...
				 <logic:present name="cmsContentItemForm" property="itemsList">
				  ...
				  <td style="border-bottom: 1px solid #C8CEEA;">
				     <html:checkbox name="cmsContentItemForm" property="checkboxArray" value="<%= String.valueOf(itemsList.getId()) %>"/>
				  </td>					
				  ...
				  <td style="border-bottom: 1px solid #C8CEEA;" nowrap>
					<logic:equal name="itemsList" property="rejected" value="true">
						&nbsp;Rejected&nbsp;
					</logic:equal>
					<logic:equal name="itemsList" property="rejected" value="false">
						<logic:equal name="itemsList" property="published" value="false">
							&nbsp;Pending&nbsp;
						</logic:equal>
					</logic:equal>
					<logic:equal name="itemsList" property="published" value="true">
						<logic:equal name="itemsList" property="rejected" value="false">
						&nbsp;Approved&nbsp;
						</logic:equal>
					</logic:equal>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td nowrap class="rowItem" valign="middle" width="100%">
							...
							<logic:equal name="cmsContentItemForm" property="viewMode" value="<%= CMSContentItemForm.VIEW_MODE_PUBLISHED %>">
								<td class="rowItem" valign="middle" nowrap>
								 	<input type="Button" value="Reject" class="rowItemButton" onclick="changeItemStatus('<%= ItemStatus.REJECTED %>')">
								</td>
								<td class="rowItem" valign="middle" nowrap>
								 	<digi:img src="module/cms/images/tree/spacer.gif" width="2" border="0"/>
								</td>
								<td class="rowItem" valign="middle" nowrap>
								 	<input type="Button" value="Remove" class="rowItemButton" onclick="changeItemStatus('<%= ItemStatus.PENDING %>')">
								</td>
							</logic:equal>
							<logic:equal name="cmsContentItemForm" property="viewMode" value="<%= CMSContentItemForm.VIEW_MODE_PENDING %>">
								<td class="rowItem" valign="middle" nowrap>
								 	<input type="Button" value="Publish" class="rowItemButton" onclick="changeItemStatus('<%= ItemStatus.PUBLISHED %>')">
								</td>
								<td class="rowItem" valign="middle" nowrap>
								 	<digi:img src="module/cms/images/tree/spacer.gif" width="2" border="0"/>
								</td>
							...
							<logic:equal name="cmsContentItemForm" property="viewMode" value="<%= CMSContentItemForm.VIEW_MODE_REJECTED %>">
								<td class="rowItem" valign="middle" nowrap>
								 	<input type="Button" value="Republish" class="rowItemButton" onclick="changeItemStatus('<%= ItemStatus.PUBLISHED %>')">
								</td>
							</logic:equal>
							<logic:equal name="cmsContentItemForm" property="viewMode" value="<%= CMSContentItemForm.VIEW_MODE_ALL %>">
								<td class="rowItem" valign="middle" nowrap>
								 	<input type="Button" value="Publish" class="rowItemButton" onclick="changeItemStatus('<%= ItemStatus.PUBLISHED %>')">
								</td>
								<td class="rowItem" valign="middle" nowrap>
