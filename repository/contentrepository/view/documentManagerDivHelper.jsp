	...
	<table name="framingTable" border="1" cellPadding=5 cellSpacing=0 width="95%"
			...
			<tr>
				<td bgcolor="#006699" class="textalb">
					...
					<button type="button" name="otherDocumentsButton">Select</button>
					
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>&nbsp;</span>
				</td>
			</tr>
			<tr style="display: table-row" name="otherDocumentsTr">
				<td name="otherDocumentsTd">Empty<a name="otherDocumentsDiv">&nbsp;</a></td>
			</tr>
	</table>
</div>
