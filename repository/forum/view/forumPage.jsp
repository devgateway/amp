...
<logic:present name="forumPageForm" property="forum">
	<bean:define id="forumObj" name="forumPageForm" property="forum"/>
</logic:present>
...
<digi:form method="post" action="/index.do">
...
<digi:secure actions="ADMIN">
	<logic:notPresent name="forumPageForm" property="forum">
		...
		<digi:link href="/adminShowEditForum.do" styleClass="forum">
			<digi:trn key="forum:activateAccount">Activate forum account</digi:trn>
		</digi:link>
	</logic:notPresent>
</digi:secure>
...
<digi:secure authenticated="true">
	...
	<table width="100%" cellpadding="0" cellspacing="3">
		...
		<table class="forumListContainer" width="100%" cellpadding="3" cellspacing="0" border="1">
			...
			<logic:equal name="forumObj" property="sections.empty" value="false">
				<!-- Sections -->
				<logic:iterate id="section" name="forumObj" property="sections" type="ForumSection">
					<tr>
						<td colspan="5" class="sectionTitle" width="70%">
							<digi:link href="<%= "/showSection.do?sectionId=" + String.valueOf(section.getId()) %>" styleClass="forum">
						...
						<logic:iterate id="subsection" name="section" property="subsections" type="ForumSubsection">
							<tr>
								...
								<td class="forumTitle" width="70%">
									...
									<br>
									<font class="smallInfoTextItalic">Moderator:</font>
									<font class="smallLink"><a href="#">moder_name</a></font>
									--%>
								</td>
