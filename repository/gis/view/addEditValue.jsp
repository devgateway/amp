...
<script language="JavaScript">
    function addData(){
  <digi:context name="addEditIndVal" property="/gis/indSectRegManager.do~actType=addValue" />
      ...
      function deleteData(ind){
          ...
          if(flag == true){
  <digi:context name="deleleteValue" property="/gis/indSectRegManager.do~actType=removeValue" />
